  ...
  sections: [
    {
      ...
      paragraphs: [
        "植物工場は、全55業種の中でも「電力コストが事業の存否を決める」度合いが高い業態です。完全人工光型の植物工場では、LED照明が全電力の60〜70%、空調（温度・湿度・CO₂濃度管理）が20〜30%を占め、電力コストが生産コストの25〜40%に達します。レタス1kgを生産するために10〜20kWhの電力を消費するとされ、1kWhあたりの電力単価が1円上がるだけで、レタス1kgあたりのコストが10〜20円上がる計算です。",
    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          heading: "断熱性能の強化",
          paragraphs: [
            "施設の壁・天井・床の断熱性能を高めることで、外気温の影響を受けにくくなり、空調負荷が安定します。特に完全人工光型は窓がない（あるいは最小限）の設計が基本であり、断熱の強化は比較的容易です。空調が消費の20〜30%を占めるため、断熱改修の効果が出やすい構造です。",
          ],
        },
        {

...
const LOGISTICS_INFRASTRUCTURE_ARTICLES: LogisticsInfrastructureIndustryArticle[] = [
  {
    ...
    metadataDescription:
      "物流センターは照明が全電力の30〜40%を占め、EC拡大に伴う自動化で消費が構造的に増加しています。LED化の投資回収が早い業態の一つである物流施設の見直しポイントを整理します。",
  ...
  },
  {
    ...
    metadataDescription:
      "冷蔵・冷凍倉庫は冷凍機が電力消費の主因で、電力比率80〜90%と電力依存度が高い業態です。冷凍機の効率が全てを決める構造の中での見直しポイントを整理します。",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "冷蔵・冷凍倉庫は、電力依存度が高い業態です。電力比率は80〜90%に達し、冷凍機がほぼ全ての消費を占めます。庫内温度を-25℃〜+5℃に維持するため24時間365日稼働が必要であり、「冷凍機の効率が全てを決める」という極めてシンプルかつ厳しい構造です。",

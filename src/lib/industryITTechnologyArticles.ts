...
const IT_TECHNOLOGY_INDUSTRY_ARTICLES: ManufacturingIndustryArticle[] = [
  {
    ...
    keywords: ["データセンター 電気料金", "ハイパースケール 電気代", "データセンター 電力契約", "サーバー 電力コスト", "データセンター 電力見直し"],
    learnPoints: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "ハイパースケールDCは使用量が桁違いに大きいため、電力会社との直接交渉が基本です。数十〜数百MW規模の契約は、電力会社にとっても大口の需要家であり、契約条件の個別交渉が可能です。",
        ],
        subsections: [
          {
  ...
  },
  {
    ...
    keywords: ["中小データセンター 電気料金", "データセンター 電気代 削減", "サーバールーム 電力契約", "冷却 電力コスト", "データセンター 電力見直し"],
    learnPoints: [
  ...
  },
  {
    ...
    keywords: ["IT企業 電気料金", "ITオフィス 電気代", "IT企業 電力契約", "サーバールーム 電力コスト", "IT企業 電力見直し"],
    learnPoints: [

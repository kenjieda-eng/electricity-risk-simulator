...
// 値は git log -1 --format=%cs -- src/lib/foodProcurementScenarioAnalysis.ts src/app/special/food-procurement-scenario-analysis の実日付。
export const FOOD_SERIES_LAST_MODIFIED = "2026-05-06";

...
const pageDescription =
  "三重県の法人電気代の平均・相場を、契約区分別の全国確定単価（高圧22.78円/kWh等）を基準に読む手順で整理。中部電力エリアの燃料費調整の効き方、電力会社を比較する5観点、四日市石油化学コンビナート・亀山半導体・伊勢志摩観光の負荷特性と契約見直しを実務目線で解説します。";
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金17〜20円/kWh+調整項目。四日市石油化学・亀山半導体・鈴鹿自動車などが対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。新電力の競争入札による価格圧力が働く市場です。",
  },
  {
...
const faqItems = [
  { question: "三重県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の単価について、全国的な水準との差は契約区分・使用量・負荷率により変わるため、請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。四日市コンビナート・鈴鹿の大規模事業者では、複数社から同一条件で見積を取ることで単価の見直し余地が生じる場合があります。" },
  ...
  { question: "三重県の電気代の平均・相場はいくらですか？", answer: "県単位で法人の電気代平均を示した公的統計はないため、契約区分ごとの全国確定単価を基準に読むのが実務的です。電力取引報の最新確定分である2026年5月分（全国計・販売額÷販売電力量）は、特別高圧17.45円/kWh、高圧22.78円/kWh、低圧電灯27.85円/kWh、低圧電力34.42円/kWhでした。この販売額には基本料金・電力量料金・燃料費調整額が含まれ、消費税・再エネ賦課金は含まれません。三重県は四日市コンビナートの特別高圧から津市内の店舗の低圧まで需要の幅が広く、区分をまたいだ平均には意味がありません。自社の契約区分に対応する全国値と、請求書から消費税・再エネ賦課金を除いて求めた実質単価を比べてください。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              中部電力エリアの単価について、全国的な水準との差は契約区分・使用量・負荷率により変わります。四日市コンビナート・鈴鹿の大規模事業者では、複数社から同一条件で見積を取ることで単価の見直し余地が生じる場合があります。実質単価（電力量料金+燃料費調整額+再エネ賦課金）ベースで比較することが重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
              下記は電力取引報の最新確定分である2026年5月分の実績単価です。まず請求書に記載された契約種別を確認し、対応する区分の数値を基準値として使ってください。
            </p>
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計・販売額÷販売電力量で求めた値であり、三重県または中部電力エリアの平均値ではありません。販売額には基本料金・電力量料金・燃料費調整額を含み、消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年5月分・確定）。この単価の定義は{" "}

...
export default function DemandResponseSuitedCorporationsPage() {
  return (
    <>
      <ArticleJsonLd
        headline="DR活用が向く法人の特徴｜柔軟な需要調整ができる条件"
        description="需要応答（DR）プログラムへの参加が向く法人の特徴と条件を解説。電力使用の柔軟性・設備の特性・契約形態・業種別の傾向など、DR活用による収益・コスト削減の可能性を実務目線で整理します。"
        url="https://simulator.eic-jp.org/demand-response-suited-corporations"
    ...
    <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
      <nav aria-label="パンくず" className="text-sm text-slate-600">
        ...
        <span className="px-2">›</span>
        <span className="text-slate-800">DR活用が向く法人の特徴</span>
      </nav>

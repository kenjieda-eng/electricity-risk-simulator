...
const electricSituation = [
  {
    ...
    detail:
      "兵庫県は神戸製鋼所（神戸製鉄所・加古川製鉄所）、日本製鉄広畑（旧新日鐵住金広畑製鉄所）、川崎重工神戸工場、三菱重工神戸造船所、IHI播磨事業所など、鉄鋼・重工業の超大型事業所が立地する重工業集積地です。出荷額ベースで鉄鋼業は兵庫県工業出荷額の約2割を占め、特別高圧の超大型需要家として関西電力エリアの電力需給に大きな影響を持ちます（出典: 兵庫県工業統計・経産省工業統計・各社統合報告書）。",
  },
  {
...
const priceBenchmark = [
  ...
  },
  {
    ...
    detail:
      "関西エリアは原子力寄与で燃調感応度が相対的に低いとされます。鉄鋼業の場合、年間使用量が巨大なため絶対額の燃調インパクトは大きく、2022〜2023年高騰時には燃調変動だけで年間数百億円のコスト変動を経験した事業所もあります（出典: 関西電力供給計画／各社決算資料）。",
  },
];
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            兵庫県は神戸製鋼・日本製鉄広畑・川崎重工神戸・三菱重工神戸・IHI播磨など、鉄鋼・重工業の超大型事業所が集積する重工業集積地です。本ページでは「兵庫県 × 鉄鋼・重工業」というクロス領域に絞り、関西電力エリア固有の単価事情と、高炉一貫製鉄所／電炉特殊鋼／重機械部品工場の電力プロファイル、特別高圧契約最適化、水素還元製鉄・CN対応までを実務目線で整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              兵庫県、特に神戸・姫路・加古川・播磨臨海工業地帯は、高炉一貫製鉄所・電炉特殊鋼工場・重機械工業の超大型事業所が連続立地する重工業集積地です。年間使用電力数十億kWh級の特別高圧需要家が集中し、関西電力エリアの電力需給に大きな影響を持ちます。
            </p>

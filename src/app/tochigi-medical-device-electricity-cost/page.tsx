...
const priceBenchmark = [
  ...
  },
  {
    ...
    detail:
      "東京電力エリアは電源のLNG・石炭火力比率が高く、火力依存度が相対的に高いため、為替（円安）や燃料スポット価格の変動に対する燃料費調整額の感応度が中〜高となるのがエリア固有の特徴です。2022〜2023年の燃料高騰局面では、東京エリアの燃調変動幅は水力中心エリアと比べて大きく推移した側面があります。需要規模が国内最大であるため全国需給の影響も受けやすく、高騰時の上振れ幅が大きい点に留意が必要です（出典: 東京電力 単価実績・エネ庁エネルギー白書から整理）。",
  },
  {
    label: "再エネ賦課金の累積負担",
    detail:
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "東京電力エリアは電源のLNG・石炭火力比率が高く火力依存度が相対的に高いため、燃料費調整額の感応度が中〜高となるのがエリア固有の特徴です。これは燃料高騰局面で単価が上振れしやすいリスクとなり、需要規模が国内最大であるため全国需給の影響も受けやすく、高騰時の上振れ幅が大きくなります。栃木の医療機器工場では、この燃調感応度の高さを前提に固定vs市場連動の選択を検討するのが実務的です。どちらが適するかは使用パターン次第で一概には言えません。",
  },
  {

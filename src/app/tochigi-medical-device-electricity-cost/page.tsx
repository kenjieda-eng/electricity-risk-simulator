...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "栃木県は東京電力エリアの内陸部に属し、小売は東京電力エナジーパートナー（東電EP）、送配電は東京電力パワーグリッドが担います。東京エリアは需要規模が大きく、電源はLNG・石炭火力の比率が高いため、為替（円安）・燃料スポット価格に対する燃料費調整額の感応度が相対的に中〜高で、高騰時の上振れ幅が大きいのが特徴です。栃木県内の医療機器工場はこのエリア特性のもとで電力を調達しており、JEPX東京エリア価格を参照しつつ、燃調変動を織り込んだ契約戦略が求められます（出典: 東京電力パワーグリッド 系統情報・エネ庁から整理）。本記載はエリア特性の事実関係を整理したものです。",
  },
];
...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "市場参照",
    detail:
      "JEPX東京エリアのスポット価格は、需要規模が大きくLNG・石炭火力依存度が高い供給構造を背景に、燃料スポット価格・為替の変動を相対的に強く反映する局面が多いとされます。全国的な需給逼迫時には価格が大きく上昇することもあり、市場連動型契約では変動リスクが残ります。2022〜2023年には市場連動採用の工場で単価上昇を経験し、現在は固定回帰の動きが見られます。出典: 新電力ネット（https://pps-net.org/unit）を加工して整理。本記載は市場動向の整理を目的としたものです。",
  },
];
...
const priceBenchmark = [
  {
    ...
    detail:
      "大規模医療機器工場・大型精密加工（2,000kW超）の特別高圧電力量料金は、標準メニューで概ね15〜19円/kWh＋調整項目とされます。東京エリアはLNG・石炭火力比率が高く需要規模が大きいため、燃料費調整額の感応度が相対的に中〜高で、高騰時の上振れ幅が大きいのが特徴です。燃料費調整額と再エネ賦課金（2026年度4.18円/kWh・確定）を加算した実質単価は20〜26円/kWhレンジが目安です。数値は目安であり、実際の単価は契約条件・新電力選定で変動します（出典: 業界団体・経産省/エネ庁統計から整理）。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "東京電力エリアは電源のLNG・石炭火力比率が高く、火力依存度が相対的に高いため、為替（円安）や燃料スポット価格の変動に対する燃料費調整額の感応度が中〜高となるのがエリア固有の特徴です。2022〜2023年の燃料高騰局面では、東京エリアの燃調変動幅は水力中心エリアと比べて大きく推移した側面があります。需要規模が大きいため全国需給の影響も受けやすく、高騰時の上振れ幅が大きい点に留意が必要です（出典: 東京電力 単価実績・エネ庁エネルギー白書から整理）。",
  },
  {
    label: "再エネ賦課金の累積負担",
    detail:
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "東京電力エリアは電源のLNG・石炭火力比率が高く火力依存度が相対的に高いため、燃料費調整額の感応度が中〜高となるのがエリア固有の特徴です。これは燃料高騰局面で単価が上振れしやすいリスクとなり、需要規模が大きいため全国需給の影響も受けやすく、高騰時の上振れ幅が大きくなります。栃木の医療機器工場では、この燃調感応度の高さを前提に固定vs市場連動の選択を検討するのが実務的です。どちらが適するかは使用パターン次第で一概には言えません。",
  },
  {
...
const switchingReality = [
  {
    label: "東京エリアの新電力浸透度",
    detail:
      "東京電力エリアの新電力比率は、需要規模が大きいこともあり全国でも一定の水準にあるとされます（出典: 資源エネ庁・電力ガス取引監視等委員会から整理）。供給枠が比較的厚い一方、燃調感応度が中〜高のため、切替メリットは固定単価・燃調条件・契約期間・再エネ付加価値で総合判断する必要があります。年間使用量の大きい医療機器工場では競争入札による相見積が有効ですが、最終判断は自社の使用実態に即して行う必要があります。本記載は浸透状況の事実関係を整理したものです。",
  },
  {
...
const faqItems = [
  {
    ...
    answer:
      "東京電力エリアは需要規模が大きく、電源のLNG・石炭火力比率が高いため、燃料費調整額の感応度が相対的に中〜高で、燃料高騰局面での上振れ幅が大きいのがエリア固有の特徴です。栃木県は東京電力エリアの内陸部に位置し、この単価環境のもとで電力を調達しています。高騰時の上振れリスクが大きい分、固定化・自家消費（PPA）による単価安定化の検討余地が相対的に大きい点に留意が必要です。なお本回答はエリア特性の事実関係を整理したものです（出典: 東京電力 単価実績・エネ庁から整理）。",
  },
  {

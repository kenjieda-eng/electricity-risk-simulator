...
const pageDescription =
  "北陸電力エリア（富山・石川・福井・岐阜一部）の法人向け電気料金の推移と単価水準を、公的統計の概括をもとに整理。特別高圧・高圧・低圧の位置づけ、豊富な包蔵水力を背景にした水力比率の高さが推移に与える構造、2023年の大幅値上げの影響、賦課金など全国共通の上昇要因、見通しの考え方を中立的に解説します。";
const pageUrl =
...
const structuralFactors = [
  ...
  },
  {
    ...
    detail:
      "豊富な包蔵水力を背景に水力比率が高いほど、燃料市況の影響を直接受けにくくなります。志賀原子力発電所の稼働状況は中期的な燃料費の安定度を左右し得る要素で、再稼働審査の進展を注視する段階です。",
...
const faqItems = [
  {
    ...
    answer:
      "電力・ガス取引監視等委員会や資源エネルギー庁の公表統計から整理すると、北陸電力エリアの高圧単価は全国10エリアの中で割安グループ（概ね14〜15円/kWh前後で語られる水準）に位置します。豊富な包蔵水力を背景に水力比率が高く、燃料費調整額のプラス幅が他エリアより相対的に小さい構造的な優位があるためです。ただし2023年4月の大幅値上げでかつての全国最安水準の地位は揺らぎ、現在は関西・九州などと並ぶ割安グループという位置づけです。数値は時点で変わるため、最新は各公式でご確認ください。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "北陸電力エリアは急峻な地形と豊富な降雪・降雨に恵まれ、包蔵水力が豊富です。水力は燃料費がほとんどかからないため、燃料費調整額のプラス幅が他エリアより小さくなりやすく、これが割安グループに位置してきた構造的な理由です。一方で、水力は水況に左右されるため、渇水年には発電可能量が落ち、火力代替でコストが上振れするリスクがあります。推移を読む際は「水力比率による優位」と「渇水年の上振れリスク」を両面で捉えることが重要です。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-indigo-200 bg-indigo-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            北陸電力エリア（富山・石川・福井および岐阜県の一部）の法人向け電気料金は、豊富な包蔵水力を背景に長らく低い水準で推移してきましたが、
        ...
        <div className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              ...
              参考水準として概ね14〜15円/kWh前後で語られる区分です。関西・九州などと並んで低い部類にあり、これは豊富な包蔵水力を背景にした水力比率の高さが、
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-3">
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                ...
                <p className="mt-1 text-sm text-slate-700">高圧単価は全国割安グループ。参考水準として概ね14〜15円/kWh前後で語られる区分。2023年値上げ前はより低い水準。</p>
              </div>
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <div className="mt-4 space-y-4">
              <div className="rounded-xl border border-indigo-100 bg-indigo-50 p-4">
                <h3 className="text-base font-semibold text-indigo-900">豊富な包蔵水力と高い水力比率</h3>
                <p className="mt-2 text-sm leading-7 text-slate-700">
                  北陸電力エリアは急峻な地形と豊富な降雪・降雨に恵まれ、包蔵水力が豊富です。電源構成に占める水力の比率が高く、水力は燃料費がほとんどかからないため、

...
const pageDescription =
  "島根県の法人電気代の平均・相場を、全国の確定単価（高圧22.78円/kWh・特別高圧17.45円/kWh等）を基準に契約区分別で整理。中国電力エリアの石炭火力比率を踏まえた読み方、電力会社を比較する5観点、安来特殊鋼・出雲松江の観光業・隠岐離島の負荷特性と契約見直しを解説します。";
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、中国電力エリアの特別高圧電力単価は2024年度実績で約17〜20円/kWh（電力量料金ベース）。中国電力エリアは石炭火力への依存度が高いとされ、2024年12月の島根原発2号機再稼働は電源構成に関わる変化です。県内大型事業者（日立金属安来・島根富士通・出雲村田製作所）にとっては、新電力の競争入札で1〜2円/kWhの優遇を引き出せれば年間2,000〜5,000万円規模の差が出る。",
  },
  {
...
const costFactors = [
  {
    ...
    detail:
      "中国電力管内は石炭火力への依存度が高いとされます。石炭価格の国際市況変動（豪州・インドネシア炭）が燃料費調整額に直接影響し、2022〜2023年の石炭価格高騰時には島根県内事業者の電気代も大幅上昇した経緯がある。三隅石炭火力（浜田市）は県内立地の主力電源。",
  },
  {
    label: "島根原発再稼働のプラス影響",
    detail:
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇。年間9,000万kWh使用の特殊鋼工場で年3.6億円規模の負担。減免制度（年間1,000万kWh以上・電気使用密度要件）の対象になる事業者は申請を要検討。",
  },
  {
...
const faqItems = [
  { question: "島根県の法人電気代水準は全国比どれくらいですか？", answer: "中国電力エリアは石炭火力への依存度が高いとされます。2024年12月の島根原発2号機再稼働は電源構成に関わる変化ですが、今後の単価水準は断定できません。新電力競争で1〜2円/kWh安いケース多数。安来・出雲の中規模工業は新電力切替で年間1〜5億円規模のコスト削減事例も。" },
  ...
  { question: "島根県の電気代の平均・相場はいくらですか？", answer: "県単位で法人の電気代平均を示した公的統計はないため、契約区分別の全国確定単価を基準に読みます。電力取引報の最新確定分である2026年5月分（全国計・販売額÷販売電力量）は、特別高圧17.45円/kWh、高圧22.78円/kWh、低圧電灯27.85円/kWh、低圧電力34.42円/kWhでした（消費税・再エネ賦課金を含まない参考値）。島根県が属する中国電力エリアは石炭火力の比率が一定程度高く、燃料価格の変動が燃料費調整額を通じて単価に反映されやすい構造です。自社の実質単価は、請求書から消費税と再エネ賦課金を差し引いた額（基本料金・電力量料金・燃料費調整額の合計）を使用量で割って求め、同じ区分の全国値と比べてください。" },
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
              下記は電力取引報の最新確定分である2026年5月分の実績単価です。自社の請求書に記載された契約種別に対応する区分の数値を、比較の出発点として使ってください。
            </p>
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計（多くの事業者が検針期間ベースで報告・暦月ベースも可）であり、島根県または中国電力エリアの平均値ではありません。消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年5月分・確定）。この単価に含む費目・含まない費目の定義は{" "}

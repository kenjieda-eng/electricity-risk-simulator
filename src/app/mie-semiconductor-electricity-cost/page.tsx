...
const electricSituation = [
  {
    ...
    detail:
      "三重県は四日市市のキオクシア四日市工場（旧東芝メモリ、NAND型フラッシュメモリの世界主要拠点）とウェスタンデジタル四日市工場（合弁）、亀山市のシャープ亀山工場（液晶・カメラモジュール）を中心に、大規模な半導体・電子部品集積地です。出荷額ベースで電子部品・デバイスは三重県工業出荷額の主要構成要素で、特別高圧の超大型需要家が複数立地する電力需給上の重要エリアです（出典: 三重県工業統計・経産省工業統計・各社統合報告書）。",
  },
  {
...
const utilitiesList = [
  {
    ...
    role: "一般小売事業者（旧一電）",
    detail:
      "三重県内最大シェア。半導体・電子部品の特別高圧長期需要家を多数抱える。『高圧電力AS／BS』『特別高圧電力』が主軸メニュー。原子力停止下のLNG火力依存により2022〜2023年高騰時の燃調変動は大きく、長期固定＋燃調上限の選択が経営判断の中心。",
  },
  {
...
const priceBenchmark = [
  {
    ...
    detail:
      "NAND/液晶ファブ（特別高圧2,000kW超、年間億kWh級）の電力量料金は標準メニューで概ね16〜19円/kWh+調整項目。燃料費調整額（2024〜2025年で+2.0〜+4.0円/kWh目安・LNG依存が高く燃調感応度は相対的に高いとされる）と再エネ賦課金（2025年度3.98円/kWh）を加算した実質単価は22〜27円/kWhレンジ。新電力競争入札では標準比1〜2円/kWh下げが目安で、年間10億kWh級のキオクシア級ファブでは数十億円規模のインパクトです。",
  },
  {
...
const switchingReality = [
  ...
  },
  {
    ...
    detail:
      "2022〜2023年高騰で半導体メーカーの多くが市場連動から固定回帰。中部エリアの燃調感応度の高さから、固定3〜5年＋燃調上限ありが有力な選択肢となる構造。市場連動は再エネ自家消費・蓄電池等のヘッジ手段併用が前提となります。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            三重県は四日市市のキオクシアNAND型フラッシュメモリ拠点と亀山市のシャープ液晶・カメラモジュール拠点を中心に、大規模な半導体・電子部品集積地です。本ページでは「三重県 × 半導体・電子部品」というクロス領域に絞り、中部電力エリア固有の燃調感応度の高さと、クリーンルーム24時間稼働・露光装置電力品質要求・キオクシアRE100対応・補助金活用までを実務目線で整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              三重県、特に四日市市・亀山市はキオクシアNANDフラッシュメモリとシャープ液晶を中心とした大規模な半導体・電子部品集積地です。24時間連続のクリーンルーム空調と中部電力エリアの燃調感応度の高さが業種特性の中心となります。
            </p>

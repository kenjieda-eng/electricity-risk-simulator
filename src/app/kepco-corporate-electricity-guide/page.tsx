...
const pageTitle =
  "関西電力 法人向けプランガイド｜業務用電力・高圧電力・燃調感応度（原子力比率含む）と契約手続き";
...
const overview = [
  ...
  },
  {
    ...
    detail:
      "当サイトの『関西電力エリアの法人電気代事情』は、エリア全体の市況・新電力動向・JEPX関西エリア価格などの『面』の情報を扱います。一方、本ページは関西電力という『特定企業』の法人向けプラン体系・燃料費調整額の感応度・契約手続き・サポート体制という『個別企業のサービス詳細』を解説します。エリア全体の市況は地域一般記事を、特定企業のサービス詳細は本記事を、と読み分けてください。",
  },
  {

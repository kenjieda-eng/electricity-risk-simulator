...
const pageDescription =
  "山梨県は東京電力エリアです。法人電気代の相場を契約区分別の全国確定単価（高圧22.78円/kWh等）から読む手順、LNG火力依存が燃料費調整に及ぼす影響、電力会社を比較する5観点、精密機械・富士五湖の観光業・ワイン産業の負荷特性と契約見直しを実務目線で整理します。";
...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "甲府盆地は内陸性気候で寒暖差が大きい。夏季最高気温40℃超の日もあり記録的な暑さ（甲府40.7℃）。冬季は朝の最低気温-5℃前後で霜害対策が農業に不可欠。暖房度日2,400〜2,800、冷房度日1,200〜1,400で両方が顕著。",
  },
  {
    label: "需給ひっ迫 — 夏季冷房ピーク",
    detail:
...
const costFactors = [
  {
    ...
    detail:
      "甲府盆地は40.7℃の暑さ記録を持つ猛暑地帯。夏季冷房需要が極めて大きく、オフィスビル・商業施設・工場で年間電気代の30〜45%を冷房が占める。高効率空調更新の効果が大きい。",
  },
  {
    label: "観光業のシーズン需要変動",
    detail:
...
const subsidies = [
  ...
  },
  {
    ...
    note: "山梨県は日照時間が長く（年間2,100時間超）、太陽光発電量を確保しやすい。観光業・ワイン業界での導入が活発。",
  },
  {
...
const industryProfile = [
  ...
  },
  {
    ...
    detail:
      "桃・ぶどう・すもも・さくらんぼなど果樹生産。CA冷蔵庫・収穫期ピーク負荷。県内に冷蔵庫・選果場が100施設以上。",
  },
  {
...
const energySaving = [
  ...
  },
  {
    label: "自家消費太陽光（日照長め）",
    detail:
      "山梨県は年間日照時間2,100時間超。屋根面積1,500m²以上の事業所で300kW級導入が現実的。冬季も発電量確保しやすく、投資回収 7〜10年（補助金後 4〜6年）。",
  },
];
...
const faqItems = [
  { question: "山梨県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の単価について、全国的な水準との差は契約区分・使用量・負荷率により変わります。甲府盆地の夏季は冷房負荷が伸びやすく、単価が同程度でも年間総額が膨らむ場合があるため、単価と年間総額の両方で確認してください。請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。" },
  ...
  { question: "山梨県は何電力のエリアですか？電気代の相場はどう見ればよいですか？", answer: "山梨県は東京電力パワーグリッドの管内で、東京電力エリアに属します。相場については、県単位で法人の電気代平均を示した公的統計がないため、契約区分ごとの全国確定単価を基準にします。電力取引報の最新確定分である2026年5月分（全国計・販売額÷販売電力量）は、特別高圧17.45円/kWh、高圧22.78円/kWh、低圧電灯27.85円/kWh、低圧電力34.42円/kWhでした。この販売額には基本料金・電力量料金・燃料費調整額が含まれ、消費税・再エネ賦課金は含まれません。自社の契約区分に対応する全国値と、請求書から消費税・再エネ賦課金を除いて求めた実質単価を比べてください。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            山梨県は東京電力エリアで、甲府盆地の精密機械工業、富士五湖・山中湖の観光業、勝沼・甲州のワイン産業、桃・ぶどう果樹園など特色ある産業集積を持ちます。甲府盆地の猛暑による夏季冷房負荷、再エネ100%自治体宣言の活発化など県固有の論点があります。本ページでは県内法人の電気代水準、業種別影響度、契約見直しの具体策、補助金活用までを実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              甲府盆地の猛暑による夏季冷房負荷で年間使用量が多くなる業種では、単価が同程度でも年間総額が膨らむ場合があります。実質単価（電力量料金+燃料費調整額+再エネ賦課金）ベースで比較することが重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計・販売額÷販売電力量で求めた値であり、山梨県または東京電力エリアの平均値ではありません。販売額には基本料金・電力量料金・燃料費調整額を含み、消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年5月分・確定）。単価の定義は{" "}

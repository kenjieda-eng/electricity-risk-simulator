      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              力率はモーターや変圧器など誘導性負荷で下がりやすく、進相コンデンサ（力率改善用コンデンサ）を設置して改善するのが一般的です。既設のコンデンサが劣化・容量不足のまま放置されて、本来得られるはずの力率割引を取りこぼしているケースもあります。デマンド（kW）を下げる取り組みと、力率を高めて力率係数を下げる取り組みは、いずれも基本料金の式に直接効く「掛け算の要素」であり、両方を点検することで削減効果を最大化できます。
            </p>
            <div className="mt-4 rounded-lg border border-slate-200 bg-slate-50 p-4">
              <p className="text-sm font-semibold text-slate-900">基本料金の式で見る削減レバー</p>
              <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-6 text-slate-600">
                <li>契約電力（kW）を下げる … デマンド管理（ピークカット/シフト）</li>
                <li>力率係数を下げる（力率を高める） … 進相コンデンサの適正化・力率改善</li>

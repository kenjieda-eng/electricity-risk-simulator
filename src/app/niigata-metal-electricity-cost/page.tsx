...
const electricSituation = [
  {
    label: "燕三条の金属加工産業集積 — 刃物・洋食器・金属ハウスウェアの産地",
    detail:
      "新潟県の燕三条地域（燕市・三条市）は、包丁・カトラリーなどの刃物、洋食器（スプーン・フォーク）、金属ハウスウェア（鍋・やかん・キッチン用品）、作業工具の産地です。江戸時代の和釘づくりを起源に、プレス・板金・研磨／バフ・めっき・熱処理・鍛造・溶接といった工程が地域内で高度に分業され、多数の中小事業所が連携してものづくりを支えています。本ページは特定の電力会社・契約形態を推奨するものではありませんが、こうした集積構造を前提に東北電力エリア固有の論点を整理します（出典: 業界団体・経産省工業統計から整理）。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            新潟県の燕三条（燕市・三条市）は、刃物・洋食器・金属ハウスウェア・作業工具の産地です。本ページでは「新潟県 × 金属加工業」というクロス領域に絞り、東北電力エリア固有の単価事情（火力・水力・風力に女川2号機の再稼働進行が加わる電源構成、燃調感応度は中位）と、プレス・研磨／バフ・めっき・熱処理の電力プロファイル、契約最適化、補助金・PPA活用までを実務目線で整理します。なお本ページは特定の電力会社・契約形態を推奨するものではありません。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              新潟県の燕三条（燕市・三条市）は、和釘づくりを起源に刃物・洋食器・金属ハウスウェア・作業工具の産地として発展してきました。プレス・板金・研磨／バフ・めっき・熱処理・鍛造・溶接の工程が地域内で高度に分業され、多数の中小事業所が連携しています。研磨集塵ブロワ・めっき整流器・コンプレッサー・熱処理炉を抱える高圧・低圧の事業所が燕市・三条市・長岡市等に多数立地しています。
            </p>

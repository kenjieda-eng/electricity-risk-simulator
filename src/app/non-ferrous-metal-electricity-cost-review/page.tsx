...
const usageProfile = [
  {
    ...
    detail:
      "アルミ電解（ホール・エルー法）はアルミナを電気分解で還元する工程で、電力多消費の工業プロセス。1tのアルミ製造に13,000〜15,000kWh（=高炉鉄の130〜300倍）の電力が必要。日本国内のアルミ精錬は1980年代に電力コスト要因で大半が撤退し、現在は再生アルミ（リサイクル）が主力。",
  },
  {
    label: "銅製錬（電解精製・溶解）",
    detail:
...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。年間3億kWh使用の中規模非鉄メーカーで年12.54億円の負担、5年で62.7億円。減免制度（年間1,000万kWh以上等）対象は必須。",
  },
  {
...
const faqItems = [
  ...
  { question: "自家消費型太陽光は非鉄金属工場で投資回収できますか？", answer: "工場敷地が広大、24h連続稼働の非鉄金属業は自家消費型太陽光との相性が良好です。20MWで年2,200〜2,600万kWh発電、年22〜26億円削減、投資回収6〜8年（補助金後4〜6年）。100MW級でも検討余地。" },

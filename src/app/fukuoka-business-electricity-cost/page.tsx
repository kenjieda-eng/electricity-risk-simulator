...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "県内は温暖湿潤気候で夏季猛暑日多発、冬季は穏やか。年間冷房度日（CDD24）1,500〜1,800（高い水準）、暖房度日400〜600（全国下位）。夏季ピーク需要が冬季を上回り、特に7〜9月の最大需要時間帯の電気代が経営課題。福岡市・北九州市の都市圏ヒートアイランド現象も加わり、商業施設・オフィスの空調需要が高水準。",
  },
  {
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金14〜17円/kWh+調整項目。福岡県内では北九州工業地帯の大口需要家（日本製鉄、三菱化学、TOTO、安川電機、日産・トヨタ・ダイハツ系自動車）、博多都市圏の大型データセンターが対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。競争入札による削減余地は個別条件により異なります。",
  },
  {
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、九州電力エリアの特別高圧電力単価は2024年度実績で約14〜17円/kWh（電力量料金ベース）。九州エリアは玄海・川内の原子力4基の稼働と大規模な太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。福岡県内の北九州工業地帯大口需要家（日本製鉄、三菱化学、TOTO、安川電機、自動車3社）にとっては、競争入札による更なる1〜3円/kWh削減で年間1〜5億円規模のコスト削減余地。",
  },
  {
    label: "九州電力エリアの高圧単価水準",
    detail:
      "高圧電力（500〜2,000kW級）の単価は16〜20円/kWh。県内中規模事業者（博多都市圏オフィス、福岡空港周辺物流、商業施設、データセンター）にとっての標準帯域。pps-net.org のエリア別データを再加工して試算すると、福岡県内の典型的な高圧契約（200〜500kW、年間使用量100〜400万kWh）では、新電力切替で年間100〜300万円規模のコスト削減が見込める。",
  },
  {
    label: "九州電力エリアの低圧単価水準",
    detail:
      "低圧電力9〜12円/kWh、低圧電灯17〜21円/kWhの水準。県内中小事業者（中小商店・サービス業・小規模物流）は新電力切替で年間5〜30万円規模の削減余地が中心。太陽光自家消費・蓄電池併設で更なる効果。",
  },
  {
...
const costFactors = [
  {
    label: "夏季猛暑とピーク需要",
    detail:
      "福岡県は温暖湿潤気候で夏季猛暑日多発。7〜9月の冷房ピーク需要が経営課題。年間冷房度日1,500〜1,800（高い水準）。博多都市圏のヒートアイランド現象も加わり、商業施設・オフィスの空調需要が高水準。",
  },
  {
...
const faqItems = [
  { question: "福岡県の法人電気代水準は全国比どれくらいですか？", answer: "九州エリアは玄海・川内の原子力4基の稼働と大規模な太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。福岡県内法人の実質単価は22〜27円/kWh（高圧）が標準帯域で、新電力切替により1〜2円/kWh改善余地があります。北九州工業地帯の特高大口は競争入札で年間1〜5億円規模の削減も可能です。" },
  { question: "なぜ福岡県の電気代は本州エリアより安いのですか？", answer: "①玄海・川内原発の稼働により燃料費調整額の上振れリスクが相対的に小さいとされること、②太陽光大量導入による昼間電源コスト低下、③九州経済産業局の産業集積向け補助制度の充実、④関門連系線による本州との需給融通効率化、の4つが主な要因です。一方、太陽光出力制御の頻発による昼間余剰電力の活用機会も大きい特徴があります。" },

...
const pageTitle =
  "高知県の法人電気料金ガイド｜四国電力エリア単価分析・紙パルプ・施設園芸ナスピーマン・カツオ水産加工の契約最適化";
const pageDescription =
  "高知県の法人電気料金を地域特化で解説。四国電力エリアの単価水準を業種別に再加工して提示し、土佐紙パルプ、施設園芸（ナス・ピーマン）、カツオ水産加工、四万十川観光業、太平洋型台風BCPの電力負荷プロファイル、契約見直し・補助金活用まで実務的に整理します。";
...
const electricSituation = [
  {
    ...
    detail:
      "高知県は四国電力のエリア。高知・南国・土佐・須崎・宿毛・四万十・室戸の7地域から構成。県内総電力需要は約25億kWhで四国電力管内の約10%を占める。土佐市・伊野町の紙パルプ工業、安芸郡・南国市の施設園芸（ナス・ピーマン）、カツオ水産加工（高知・土佐清水・宿毛）、四万十川・室戸岬の観光業が県内電力消費の中核。人口減少県だが第一次産業集積による電力需要が特徴。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "県内は太平洋気候で温暖湿潤・年間降水量3,000mm超（多雨地域）。年間冷房度日（CDD24）1,300〜1,600、暖房度日1,300〜1,700。冬季積雪はほぼなし。台風常襲地域として停電リスクが高く、BCP対応が経営の必須要件。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "土佐市・いの町・須崎市は土佐和紙発祥地で日本製紙土佐パルプ・大王製紙関連の紙パルプ工業集積。安芸郡・南国市・四万十市は施設園芸（ナス・ピーマン・ミョウガ）の温室加温・冷蔵需要。室戸市・土佐清水市・宿毛市・高知市はカツオ・マグロ水産加工。観光業は四万十川・室戸岬・桂浜・四国カルストに集積。",
  },
];
...
const priceBenchmark = [
  ...
  },
  {
    ...
    detail:
      "四国電力エリアの単価水準は、小売と卸で見え方が異なる二面性があるとされます。燃料費調整額は中国電力エリアより0.5〜1円/kWh低水準で推移しており、高知県内事業者にも直接的なメリット。",
  },
];
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、四国電力エリアの特別高圧電力単価は2024年度実績で約16〜19円/kWh（電力量料金ベース）。四国エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは低い水準で推移してきたという二面性があります。関西電力エリアと並んで全国でも安価な部類。県内大型事業者（日本製紙土佐パルプ・施設園芸大規模団地）にとっては、新電力の競争入札で1〜2円/kWhの優遇を引き出せれば年間1〜3億円規模の差が出る。",
  },
  {
...
const industryImpact = [
  ...
  },
  {
    ...
    before:
      "Before: 安芸郡・南国市の施設園芸団地B社（ナス・ピーマン・ミョウガの温室加温・冷蔵保管・選果機械）。年間電気代 1.9億円。温室加温（冬季）・冷蔵保管・選果機械・換気ファンが消費電力の主要要素。冬季加温需要が電力ピーク。",
    after:
...
const costFactors = [
  ...
  },
  {
    label: "施設園芸の冬季加温電力需要",
    detail:
      "高知県は施設園芸（ナス・ピーマン・ミョウガ）の一大産地で、冬季温室加温の電力需要が大きい。原油・LPG価格高騰時には電気加温（ヒートポンプ）への転換ニーズが高まり、補助金併用での投資回収シミュレーションが重要。",
  },
  {
    label: "伊方原発稼働のプラス影響",
    detail:
      "四国電力エリアの単価水準は、小売と卸で見え方が異なる二面性があるとされます。高知県内事業者にも直接的なメリット。",
  },
  {
...
const industryProfile = [
  ...
  },
  {
    ...
    detail:
      "ナス・ピーマン・ミョウガ・ショウガの施設園芸団地、冷蔵倉庫・選果機械。年間使用量100〜800万kWh規模。",
  },
  {
...
const faqItems = [
  { question: "高知県の法人電気代水準は全国比どれくらいですか？", answer: "四国電力エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは低い水準で推移してきたという二面性があります。固定型か市場連動型かで効く指標が異なるため、単価水準を一括りにはできません。土佐紙パルプ・施設園芸大規模団地は新電力切替で年間1〜3億円規模のコスト削減事例も。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            高知県は四国電力エリアで、土佐市・いの町の日本製紙土佐パルプ・大王製紙関連の紙パルプ工業、安芸郡・南国市の施設園芸（ナス・ピーマン・ミョウガ）、室戸・土佐清水・宿毛のカツオマグロ水産加工、四万十川・室戸岬・桂浜の観光業など多様な第一次・素材産業を持ちます。太平洋型台風の常襲地域であり、BCP対応が重要な県です。本ページでは新電力ネット（pps-net.org/unit）のエリア別単価データを県の産業構造に紐づけて再加工し、業種別の契約見直し・補助金活用を実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              高知県は土佐紙パルプ・施設園芸・カツオ水産加工・伊方原発稼働メリット・太平洋型台風BCP対応が必要な地域です。シミュレーターで自社条件における上振れ幅を試算し、固定プラン切替・オフサイトPPA・省エネ投資のメリットを定量化できます。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

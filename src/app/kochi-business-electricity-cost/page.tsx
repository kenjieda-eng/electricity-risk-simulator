...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、四国電力エリアの特別高圧電力単価は2024年度実績で約16〜19円/kWh（電力量料金ベース）。四国エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは全国最低水準で推移してきたという二面性があります。関西電力エリアと並んで全国でも安価な部類。県内大型事業者（日本製紙土佐パルプ・施設園芸大規模団地）にとっては、新電力の競争入札で1〜2円/kWhの優遇を引き出せれば年間1〜3億円規模の差が出る。",
  },
  {
...
const faqItems = [
  { question: "高知県の法人電気代水準は全国比どれくらいですか？", answer: "四国電力エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは全国最低水準で推移してきたという二面性があります。固定型か市場連動型かで効く指標が異なるため、単価水準を一括りにはできません。土佐紙パルプ・施設園芸大規模団地は新電力切替で年間1〜3億円規模のコスト削減事例も。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            高知県は四国電力エリアで、土佐市・いの町の日本製紙土佐パルプ・大王製紙関連の紙パルプ工業、安芸郡・南国市の施設園芸（ナス・ピーマン・ミョウガ全国1位）、室戸・土佐清水・宿毛のカツオマグロ水産加工、四万十川・室戸岬・桂浜の観光業など多様な第一次・素材産業を持ちます。太平洋型台風の常襲地域であり、BCP対応が重要な県です。本ページでは新電力ネット（pps-net.org/unit）のエリア別単価データを県の産業構造に紐づけて再加工し、業種別の契約見直し・補助金活用を実務的に整理します。
          </p>

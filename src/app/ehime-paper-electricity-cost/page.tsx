...
const pageTitle =
  "愛媛県の製紙・紙加工工場の電気料金ガイド｜四国中央市の紙産業集積と四国電力";
...
const electricSituation = [
  {
    ...
    detail:
      "愛媛県四国中央市は、紙・パルプ・紙加工品の製造品出荷額が大きい「日本一の紙のまち」とされ、製紙・板紙・家庭紙・衛生用品・紙加工の専業企業が高密度に集積しています。大王製紙、丸住製紙、ユニ・チャームなどの拠点を含むサプライチェーンが川之江・三島地区を中心に半径数km圏に凝集し、パルプ蒸解・抄紙機・乾燥・塗工・加工が連続稼働する装置産業クラスターを形成しています。装置集約度が高いため、特別高圧・高圧の大口需要家が一地域に集中する全国的にも特徴的な構造です（出典: 愛媛県統計・経産省工業統計／業界団体資料から整理）。",
  },
  {
...
const energySaving = [
  ...
  },
  {
    ...
    detail:
      "抄紙機の真空系、エア漏れ・過剰圧力のコンプレッサー、ブロワの高効率インバータ更新＋集中管理で電力▲15〜25%。製紙・紙加工いずれでも投資効率が高く、SII補助1/2で回収可能（1.5〜2.5年）とされます。",
  },
  {
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              愛媛県四国中央市は、紙・パルプ・紙加工品の製造品出荷額が大きい「日本一の紙のまち」です。製紙・板紙・家庭紙・衛生用品・紙加工の専業企業が川之江・三島地区を中心に高密度に集積し、パルプ蒸解・抄紙機・乾燥・塗工・加工が連続稼働する装置産業クラスターを形成しています。装置集約度が高いため、特別高圧・高圧の大口需要家が一地域に集中する全国的にも特徴的な構造です。
            </p>

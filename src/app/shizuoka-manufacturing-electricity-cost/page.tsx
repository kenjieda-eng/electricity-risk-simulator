...
const electricSituation = [
  {
    ...
    detail:
      "静岡県は製造品出荷額の大きい工業県で、東海道沿いに多様な製造業が集積。浜松・磐田・湖西の輸送機器（スズキ・ヤマハ発動機・ホンダ二輪等）と楽器（ヤマハ・河合楽器）、富士・富士宮の製紙（王子・日本製紙・大興製紙等）、静岡市・東部の電機・食品・化学まで、業種の幅が広いのが特徴です。輸送機器・製紙はいずれも電力多消費の特別高圧需要家で、県内総電力需要の主要構成要素となっています（出典: 静岡県工業統計・経産省工業統計・各社統合報告書）。",
  },
  {
...
const industryProfile = [
  ...
  },
  {
    ...
    detail:
      "富士市・富士宮市は王子・日本製紙・大興製紙等の製紙工場が集積する大規模な製紙産地。富士川以東のため東京電力エリア（50Hz）で、抄紙機・パルプ・乾燥の超大型特別高圧需要家。黒液・バイオマス自家発電を併設する工場が多い。",
  },
  {
...
const switchingReality = [
  ...
  },
  {
    ...
    detail:
      "2022〜2023年高騰で製造業の多くが市場連動から固定回帰。中部・東京両エリアともLNG依存で燃調変動が大きかったため、固定3〜5年＋燃調上限ありが有力な選択肢となります。メーカーCN対応で非化石証書付き／再エネトラッキング付きメニューも標準化。",
  },
  {
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              静岡県は製造品出荷額の大きい工業県で、浜松の輸送機器・楽器、富士の製紙を中心に多様な製造業が集積しています。富士川を境とした中部電力・東京電力の2エリア構造という全国でも珍しい特性が、静岡の製造業の電力事情の最大の論点です。
            </p>

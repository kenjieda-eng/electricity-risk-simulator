...
const electricSituation = [
  {
    ...
    detail:
      "鹿児島県は九州電力エリアに属し、川内原発（1・2号機）の立地県。種子島・屋久島・奄美大島・喜界島・徳之島・沖永良部島・与論島等の離島系統を含む。県内総電力需要は約80億kWhで、焼酎産業（蒸留・発酵）が約10%、農業・畜産（肉用牛、サツマイモ、茶葉、豚）が約20%、桜島・指宿・霧島温泉・屋久島の観光業が約15%、鹿児島市の都市圏オフィス・商業が約25%、離島が約10%、住宅・小規模事業者が約20%の構成。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "県内は温暖湿潤気候で夏季は高温多湿、冬季も穏やか。年間冷房度日（CDD24）1,700〜1,900、暖房度日300〜500。桜島の火山灰により設備機器の故障・清掃需要が高く、空調フィルター・電気機器の保守コストが経営課題。台風常襲地域でもあり、BCP対応が経営課題。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "薩摩川内市は川内原発立地。焼酎産業（蒸留・発酵：薩摩酒造、本坊酒造、田苑酒造、霧島酒造関連等）。肉用牛（鹿児島黒牛）、サツマイモ、茶葉、豚（黒豚）、ブロイラーの農業・畜産集積（県全域）。桜島・指宿温泉・霧島温泉・屋久島・知覧の観光業。鹿児島市は薩摩半島都市圏オフィス・商業。種子島宇宙センター（JAXA、南種子町）、奄美群島の離島観光業・農水産業。",
  },
];
...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "市場動向",
    detail:
      "鹿児島県の新電力シェアは2024年時点で約15〜20%。焼酎大手・鹿児島市内オフィス・観光業大手で新電力切替が活発。離島事業者は九州電力依存度が高い。",
  },
];
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金14〜17円/kWh+調整項目。鹿児島県内では焼酎大手（薩摩酒造・本坊酒造等）、大型農業法人、指宿霧島・屋久島の大型観光リゾート、JAXA関連事業者が対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。競争入札による削減余地は個別条件により異なります。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "鹿児島県は川内原発立地県として、電源立地地域対策交付金・原子力立地給付金等の優遇制度を一部受ける。一方、離島（種子島・屋久島・奄美等）は独立系統で石油火力・ディーゼル発電への依存度が高く、供給構造が異なります。離島事業者は太陽光自家消費＋蓄電池＋島嶼型マイクログリッドが電気代削減と台風BCP対応の両立に最も効果的。",
  },
];
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、九州電力エリアの特別高圧電力単価は2024年度実績で約14〜17円/kWh（電力量料金ベース）。九州エリアは玄海・川内の原子力4基の稼働と太陽光導入が進んだ電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。鹿児島県内の焼酎大手・大型農業法人・指宿霧島観光業・JAXA関連にとっては、競争入札による更なる1〜3円/kWh削減で年間1,000万〜5億円規模のコスト削減余地。",
  },
  {
    label: "九州電力エリアの高圧単価水準",
    detail:
      "高圧電力（500〜2,000kW級）の単価は16〜20円/kWh。県内中規模事業者（焼酎中堅、農業法人、指宿霧島観光業中堅、鹿児島市内オフィス）にとっての標準帯域。pps-net.org のエリア別データを再加工して試算すると、鹿児島県内の典型的な高圧契約（200〜500kW、年間使用量100〜400万kWh）では、新電力切替で年間100〜300万円規模のコスト削減が見込める。",
  },
  {
    label: "離島系統・低圧単価水準",
    detail:
      "種子島・屋久島・奄美大島・喜界島・徳之島・沖永良部島・与論島等の離島は独立系統で石油火力・ディーゼル発電への依存度が高く、本土とは供給構造が異なります。低圧電力11〜14円/kWh、低圧電灯19〜22円/kWh水準。離島事業者（観光業・農水産業・小規模商業）は新電力切替の余地が限られるが、太陽光自家消費＋蓄電池＋島嶼型マイクログリッドで電気代を大幅削減可能。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "種子島・屋久島・奄美大島・喜界島・徳之島・沖永良部島・与論島等の離島は独立系統で石油火力・ディーゼル発電への依存度が高く、本土とは供給構造が異なります。台風常襲地域でもあり、離島事業者は太陽光自家消費＋蓄電池＋島嶼型マイクログリッドが電気代削減と台風BCP対応の両立に最も効果的。",
  },
  {
...
const industryProfile = [
  ...
  },
  {
    ...
    detail:
      "肉用牛（鹿児島黒牛）、サツマイモ、茶葉、豚（黒豚）。畜舎温度管理・冷蔵倉庫・茶葉乾燥。年間使用量100万〜1,500万kWh規模。",
  },
  {
...
const switchingReality = [
  {
    label: "新電力切替の県内浸透度",
    detail:
      "2024年時点で県内法人の新電力シェアは約15〜20%。焼酎大手・鹿児島市内オフィス・観光業大手で新電力切替が活発。離島事業者は九州電力依存度が高い。",
  },
  {
    label: "市場連動プランの選択肢",
    detail:
...
const faqItems = [
  { question: "鹿児島県の法人電気代水準は全国比どれくらいですか？", answer: "九州エリアは玄海・川内の原子力4基の稼働と太陽光導入が進んだ電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。鹿児島県内法人の実質単価は22〜27円/kWh（高圧）が標準帯域で、新電力切替により1〜2円/kWh改善余地があります。一方、離島（種子島・屋久島・奄美等）は独立系統で石油火力への依存度が高く、供給構造が異なります。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            鹿児島県は九州電力エリアに属し、川内原発（1・2号機）の立地県として地域振興メニューの恩恵を一部受けます。焼酎産業（薩摩酒造・本坊酒造等の蒸留・発酵）、肉用牛（鹿児島黒牛）・サツマイモ・茶葉・豚（黒豚）の畜産・農業集積、桜島・指宿温泉・霧島温泉・屋久島の観光業、種子島宇宙センター（JAXA）、奄美群島の離島事業者と多様な産業構造を持ちます。太陽光発電適地メリット＋桜島火山灰対策＋台風常襲BCP対応＋離島島嶼型マイクログリッドを組合せた契約最適化戦略が主流です。本ページでは新電力ネット（pps-net.org/unit）のエリア別単価データを県の産業構造に紐づけて再加工し、業種別の契約見直し・補助金活用を実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              九州電力エリアは原発稼働メリットにより本州より1〜2円/kWh安い水準を維持。鹿児島県は川内原発立地県として地域振興メニューの恩恵も一部受けます。一方、離島は独立系統で石油火力への依存度が高く、供給構造が異なります。実質単価ベースで本土と離島を分けて比較することが重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              鹿児島県の新電力シェアは2024年時点で約15〜20%。焼酎大手・鹿児島市内オフィス・観光業大手で新電力切替が活発です。離島事業者は九州電力依存度が高く、島嶼型マイクログリッドの活用が重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

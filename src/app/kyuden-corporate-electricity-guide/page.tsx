...
const pageTitle =
  "九州電力（きゅうでん）の法人向けプランガイド｜九州7県の特高/高圧契約・玄海/川内原発4基稼働と太陽光の大量導入";
...
const overview = [
  ...
  },
  {
    ...
    detail:
      "当サイトの『九州電力エリアの法人電気代事情』は、エリア全体の市況・新電力動向・JEPX九州エリア価格などの『面』の情報を扱います。一方、本ページはきゅうでんという『特定企業』の法人向けプラン体系・燃料費調整額の算定方式・契約手続き・サポート体制という『個別企業のサービス詳細』を解説します。エリア全体の市況は地域一般記事を、特定企業のサービス詳細は本記事を、と読み分けてください。",
  },
  {
    label: "九州エリアの電源構成と需給の特徴（公表情報）",
    detail:
      "九州電力エリアは、玄海原子力発電所3・4号機、川内原子力発電所1・2号機の計4基の原子力に加え、太陽光発電の導入量が大きいことが公表されています。太陽光の大量導入により、春秋の昼間など軽負荷期には出力制御が実施されることがあります。原子力・再エネの比率が相対的に高い構成は、燃料費調整額への感応度の前提に関わる要素として整理されますが、構成の特徴が料金の優劣を意味するものではありません（出典: 九州電力公式サイト・資源エネルギー庁エネルギー基本計画・OCCTO供給計画）。",
  },
  {
...
const dataPoints = [
  ...
  },
  {
    ...
    detail:
      "九州電力エリアは、玄海3・4号機、川内1・2号機の計4基の原子力に加え、太陽光発電の導入量が大きいことが公表されています。原子力・再エネ比率が相対的に高い構成は、燃料費調整額への感応度が相対的に低い傾向の背景として整理されることがあります。一方で太陽光大量導入により出力制御が発生する点も需給の特徴です（出典: 資源エネルギー庁・OCCTO供給計画・九州電力統合報告書）。",
  },
  {
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "九州電力エリアは玄海3・4号機、川内1・2号機の計4基の原子力に加え、太陽光発電の導入量が大きいことが公表されています。原子力・再エネ比率が相対的に高い構成は、燃料費調整額への感応度が相対的に低い傾向の背景として整理されることがあります。一方で太陽光の大量導入により春秋の昼間などに出力制御が発生する点も特徴です。稼働状況・出力制御は変動するため、最新の公表情報で確認してください。構成の特徴が料金の優劣を意味するものではありません（出典: 九州電力公式サイト・資源エネルギー庁・OCCTO）。",
  },
  {
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <div className="mt-4 rounded-lg border border-sky-300 bg-white p-4">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-7 text-slate-700">
              ...
              <li>原発4基稼働・太陽光の大量導入を含む九州エリアの電源構成と燃料費調整額の算定方式（公表情報）</li>

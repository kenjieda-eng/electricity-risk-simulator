...
// --- 定数 ---
const pageTitle = "電気料金の改定・値上げはどう決まる？規制料金の認可プロセスと自由料金（法人向け）の通知方式";
const pageDescription =
  "電力会社の料金改定は規制料金（経産大臣認可）と自由料金（通知のみ）で仕組みが全く異なる。2023〜2025年の大手電力改定事例、法人契約者の確認事項、値上げ通知を受けたときの対応フローまで実務視点で解説します。";

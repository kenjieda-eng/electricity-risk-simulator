...
const areaBasicInfo = [
  ...
  { label: "産業用電力の特性", value: "製造業・自動車関連の大口産業電力需要が大きい。特別高圧の契約件数が多い" },
...
const manufacturingFeatures = [
  {
    title: "産業用電力需要が大規模",
    body: "愛知県を中心とする中部エリアは自動車・機械・航空宇宙などの製造業が高密度で集積しており、24時間稼働の大型工場も多いです。特別高圧（2万V以上）の大口需要家数が多いエリアで、電力調達コストの管理が製品原価に直結します。",
  },
  {
  ...
  return (
    ...
    <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
      <nav aria-label="パンくず" className="text-sm text-slate-600">
        ...
        <span className="px-2">›</span>
        <span className="text-slate-800">中部電力エリアの事情</span>
      </nav>
      ...
      <section className="mt-6 rounded-xl border border-slate-200 bg-white p-5">
        ...
        <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
          名古屋は猛暑日179日（2020年代、主要都市の中でも多い水準）、冷房度日の増加率+40%も顕著。内陸性の気候により夏の暑さが年々深刻化しており、冷房ピーク対策の優先度が高いエリアです。
        </p>
        <p className="mt-2 text-xs text-slate-500">
          ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
        </p>

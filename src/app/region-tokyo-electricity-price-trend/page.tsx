...
// =============================================================
// B-83 エリア別 法人電気料金 推移深掘りシリーズ（東京／関東）
//  - 本ページ = 「1エリア（東京電力エリア）の推移・単価水準の縦深掘り」
//  - 全国10エリア横断比較の総論は /electricity-price-trend-by-area（親）
//  - エリア総合（市況・新電力動向）は /region-tokyo-business-electricity
//  - 全国・月次・契約区分別の推移データは /business-electricity-retrospective
//  データ規律: 単価の具体数値は公的統計の概括のみ。予測値の断定はしない。
// =============================================================

const pageTitle =
  "東京（関東）エリアの法人電気料金 推移と単価水準｜特高・高圧・低圧の位置づけと見通しの考え方";
const pageDescription =
  "東京電力エリア（関東9都県）の法人向け電気料金の推移と単価水準を、公的統計の概括をもとに整理。特別高圧・高圧・低圧の位置づけ、LNG火力依存が推移に与える構造、賦課金など全国共通の上昇要因、見通しの考え方を中立的に解説します。";
const pageUrl =
  "https://simulator.eic-jp.org/region-tokyo-electricity-price-trend";
...
const structuralFactors = [
  {
    ...
    detail:
      "東京電力エリアはLNG火力の比率が高く、国際LNG価格の変動が燃料費調整額を通じて単価に反映されやすい構造です。",
  ...
  {
    factor: "電源構成（LNG依存度・原子力）",
    detail:
      "LNG火力への依存度が高いほど燃料市況の影響を直接受けます。原子力の稼働状況は燃料費の安定度を左右します。",
...
const savingsScenarios = [
  ...
  {
    label: "大規模需要（高圧〜特別高圧・年間1,500万kWh）",
    usageManKwh: 1500,
    improvementYen: 1.0,
    annualSavingMan: 1500,
    fiveYearMan: 7500,
...
const checkList = [
  ...
  "LNG市況・為替の変動が自社の燃調費にどの程度反映されるかを試算しているか",
  "全国平均の推移と、東京エリアの相対位置（中位）を分けて理解しているか",
...
const faqItems = [
  {
    question: "東京（関東）エリアの法人電気料金は、推移として高いのですか？",
    answer:
      "電力・ガス取引監視等委員会や資源エネルギー庁の公表統計から整理すると、東京電力エリアの高圧単価は全国10エリアの中で概ね中位に位置します。北海道・沖縄などより低く、関西・九州・北陸などより高い水準で推移してきました。ただしLNG火力への依存度が高いため、燃料費調整額のプラス幅が大きくなりやすく、燃料高騰局面では実質単価が上振れしやすい特徴があります。数値は時点で変わるため、最新は各公式でご確認ください。",
  },
  {
    question: "2019〜2025年で、東京エリアの単価はどのように推移しましたか？",
    answer:
      "全国平均でみると、2022年の燃料高騰で特別高圧・高圧を中心に水準が大きく切り上がり、2023〜2025年は急騰前の2019〜2021年水準には戻っていません。東京エリアもこの全国的な高止まりの傾向を共有しており、LNG依存の構造から燃料市況に敏感な推移となっています。本ページの数値は公的統計の概括であり、実際の請求単価は契約・使用量・時期で異なります。",
  },
  {
    question: "東京エリアの単価が動く主な要因は何ですか？",
    answer:
      "燃料市況（特にLNG）・為替・電源構成・制度コスト（再エネ賦課金・容量拠出金・託送料金）の4つが主因です。短期の変動は燃料市況と為替に連動しやすく、制度コストは燃料が落ち着いても下がりにくい固定的な上昇要因として残ります。東京エリアはLNG火力比率が高いため、燃料市況の影響が相対的に表れやすい構造です。",
  },
  {
  ...
  {
    question: "東京エリアの今後の単価見通しはどう考えればよいですか？",
    answer:
      "将来の単価を断定することはできません。見通しは、燃料市況（LNG・原油）・為替・電源構成の変化・制度コストという構造要因の組み合わせで考えるのが中立的です。燃料が落ち着けば燃調費のプラス幅は縮小し得ますが、賦課金・容量拠出金などの制度コストは下がりにくく、急落は見込みにくいという整理になります。最新の告示・市況は各公式でご確認ください。",
  },
  {
    question: "JEPXの東京エリアプライスは料金にどう関係しますか？",
    answer:
      "JEPX（日本卸電力取引所）のエリアプライスは、市場連動型プランの仕入れコストに直結します。東京エリアは需要が大きく、需給の逼迫時に価格が上振れしやすい傾向があります。ただし具体的な価格差は時期・時間帯で大きく変動するため、本ページでは傾向・構造の説明にとどめます。市場連動型を検討する場合は、価格変動リスクの範囲を必ず確認してください。",
  },
  {
    question: "全国横断の比較や、他エリアとの違いはどこで確認できますか？",
    answer:
      "10エリアを横並びで比較する総論は「エリア別（電力会社別）の電気料金推移比較」を、東京エリア全体の市況・新電力動向は「東京電力エリアの法人電気代事情」をご覧ください。本ページはその中で、東京エリアの推移と単価水準に絞って深掘りする位置づけです。全国・月次・契約区分別の推移データは月次振り返りシリーズで確認できます。",
  },
  {
...
export default function RegionTokyoElectricityPriceTrendPage() {
  return (
    <>
      <ArticleJsonLd
        headline={pageTitle}
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <nav aria-label="パンくず" className="text-sm text-slate-600">
          ...
          <span className="px-2">›</span>
          <span className="text-slate-800">東京（関東）エリアの推移と単価水準</span>
        </nav>
        ...
        <header className="mt-4 rounded-xl border border-indigo-200 bg-indigo-50 p-6">
          ...
          <h1 className="mt-2 text-3xl font-bold tracking-tight text-slate-900">
            東京（関東）エリアの法人電気料金 推移と単価水準
          </h1>
          <p className="mt-1 text-base font-medium text-indigo-800">特別高圧・高圧・低圧の位置づけと見通しの考え方</p>
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            東京電力エリア（関東9都県）の法人向け電気料金は、全国的な高止まりの流れを共有しつつ、LNG火力への高い依存度から燃料市況の影響を受けやすい推移をたどってきました。
            本ページでは、公的統計の概括をもとに、東京エリアの単価水準がどの位置にあるのか、推移を動かす構造要因は何か、そして将来を断定しない「見通しの考え方」を中立的に整理します。
          </p>
        </header>
        ...
        <div className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-4 text-sm leading-7 text-slate-700 sm:text-base">
          ...
          東京エリア全体の市況・新電力動向は{" "}
          <Link href="/region-tokyo-business-electricity" className="font-semibold text-sky-700 underline underline-offset-2 hover:text-sky-900">東京電力エリアの法人電気代事情</Link>、
          全国・月次・契約区分別の推移データは{" "}
          ...
          をご覧ください。<span className="font-semibold">本ページは、東京エリアの「推移・単価水準」に特化</span>しています。
        </div>
        ...
        <div className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            <h2 className="text-xl font-semibold text-slate-900">
              全国の法人電気料金推移（2019〜2025）と東京エリアの位置づけ
            </h2>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              まず全国平均の年次単価で、推移の大きな流れを確認します。下表は再エネ賦課金を含まない年平均単価（円/kWh）で、2022年を境に水準が切り上がり、
              2025年時点でも2019年水準には戻っていないことが読み取れます。東京エリアも、この全国的な高止まりの傾向を共有しています。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            <h2 className="text-xl font-semibold text-slate-900">
              東京エリアの単価水準はどの位置にあるか（公的統計の概括）
            </h2>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              電力・ガス取引監視等委員会や資源エネルギー庁の公表統計から整理すると、東京電力エリアの高圧単価は全国10エリアの中で概ね<span className="font-semibold">中位</span>に位置します。
              北海道・沖縄など単価の高いエリアより低く、関西・九州・北陸など割安グループより高い、という相対的な位置づけです。
              これは統計上の相対位置を概括したものであり、エリア間の優劣を断定するものではありません。
            </p>
            <div className="mt-4 grid gap-3 md:grid-cols-3">
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                <p className="text-xs font-semibold text-slate-800">相対位置</p>
                <p className="mt-1 text-sm text-slate-700">高圧単価は全国中位。参考水準として概ね15〜16円/kWh前後で語られることが多い区分。</p>
              </div>
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            <h2 className="text-xl font-semibold text-slate-900">
              東京エリアで単価を動かす構造要因（燃料市況・為替・電源構成・制度）
            </h2>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              単価の推移は、偶然ではなく構造的な要因の組み合わせで動きます。東京エリアで特に効きやすいのは、LNGを中心とした燃料市況と為替です。
            </p>
            <div className="mt-4 overflow-x-auto">
              <table className="w-full min-w-[560px] border-collapse text-sm">
                <thead>
                  <tr className="bg-indigo-50">
                    ...
                    <th className="border border-slate-200 px-3 py-2 text-left font-semibold text-slate-700">東京エリアでの効き方</th>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            <h2 className="text-xl font-semibold text-slate-900">
              電源構成と東京エリア固有の事情（LNG依存・原子力の位置づけ）
            </h2>
            <div className="mt-4 space-y-4">
              <div className="rounded-xl border border-indigo-100 bg-indigo-50 p-4">
                <h3 className="text-base font-semibold text-indigo-900">LNG火力への高い依存</h3>
                <p className="mt-2 text-sm leading-7 text-slate-700">
                  東京電力エリアは電源構成に占めるLNG火力の比率が高く（概ね5割前後で語られる規模）、国際LNG価格が上がると燃料費調整額を通じて単価が押し上げられます。
                  これが、燃料高騰局面で東京エリアの実質単価が上振れしやすい最大の構造的理由です。
                </p>
              </div>
              <div className="rounded-xl border border-indigo-100 bg-indigo-50 p-4">
                <h3 className="text-base font-semibold text-indigo-900">原子力の稼働状況（2026年時点）</h3>
                <p className="mt-2 text-sm leading-7 text-slate-700">
                  柏崎刈羽原子力発電所は再稼働に向けた手続きの段階にあり、稼働の有無は中期的な燃料費の安定度に影響します。
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            <h2 className="text-xl font-semibold text-slate-900">
              JEPX 東京エリアプライスの傾向（構造の説明）
            </h2>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              市場連動型プランを検討する場合、JEPX（日本卸電力取引所）の東京エリアプライスが仕入れコストの目安になります。
              東京エリアは需要規模が大きく、猛暑・厳寒による需給逼迫時や燃料市況の変化で価格が振れやすい傾向があります。
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              推移を読むうえで、燃料市況と切り分けて把握したいのが制度コストです。これらは全国共通で、東京エリアにも同様に上乗せされます。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              将来の単価を断定することはできません。ここでは、東京エリアの推移を「予測」ではなく「構造要因の組み合わせ」で捉えるための視点を整理します。
            </p>
          ...
          <ConsultCta
            from="region-tokyo-price-trend"
            heading="東京エリアの電気料金、推移を踏まえて見直せるか無料で相談しませんか？"
          ...
          <section className="rounded-xl border border-indigo-200 bg-indigo-50 p-5">
            <h2 className="text-xl font-semibold text-slate-900">
              代表シナリオ：契約見直しによる削減の試算例（東京エリア・高圧水準ベース）
            </h2>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              以下は、東京エリアの一般的な高圧需要を想定した「契約見直しで得られうる削減」の試算例です。将来の単価を予測するものではなく、
          ...
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <ul className="mt-3 space-y-2 text-sm leading-7 text-slate-700">
              <li>・東京エリアの高圧単価は全国中位。LNG依存で燃料高騰局面に上振れしやすい構造。</li>
              <li>・全国平均は2022年に水準が切り上がり、2025年も2019年水準には戻っていない（東京も同傾向）。</li>
        ...
        <div className="mt-8">
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/region-tokyo-business-electricity", title: "東京電力エリアの法人電気代事情", description: "東京エリア全体の市況・料金改定・新電力動向を解説（エリア総合）。" },
              { href: "/tepco-ep-corporate-electricity-guide", title: "東京電力エナジーパートナーの法人向けプラン解説", description: "エリア市況に対し、特定企業のプラン体系・サポートを中立的に解説。" },
        ...
        <div className="mt-6">
          <ContentCta
            heading="東京エリアの推移を踏まえて、自社の電気料金を点検する"
            description="全国的な高止まりと東京エリアのLNG依存構造を前提に、現行契約と候補プランを同条件で比較すると、次の打ち手を具体化しやすくなります。"
            links={[

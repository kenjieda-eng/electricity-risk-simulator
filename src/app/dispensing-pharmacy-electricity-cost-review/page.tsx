...
const faqItems = [
  ...
  { question: "調剤薬局の固定プランと市場連動プランどちらが向きますか？", answer: "冷所保管24h連続稼働、医薬品保管温度逸脱の許容ゼロという条件下では、固定プランが向きます。市場連動プランは2022〜2023年の市場高騰局面で店舗単位で月数万円の追加負担事例あり、安定運営の観点でも固定プラン推奨です。" },

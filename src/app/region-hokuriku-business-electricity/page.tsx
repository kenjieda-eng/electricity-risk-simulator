...
const faqItems = [
  { question: "北陸電力の高水力比率は法人料金にどう影響しますか？", answer: "北陸電力エリアは黒部・神通川・庄川など豊富な水力資源を持ち、水力比率が高い水準です。水力は燃料費がほぼかからず、燃料費調整額のプラス幅が他エリアより小さい構造的優位があります。結果、北陸電力の高圧電力量料金は全国比で割安グループ（14〜15円/kWh前後）に位置します。ただし渇水年は出水率低下で火力代替が増え、料金優位が縮小するリスクがあります。" },
...
const areaBasicInfo = [
  ...
  { label: "管内面積（概算）", value: "約 12,600 km²（小さい部類）" },
  { label: "管内世帯数（概算）", value: "約 130万世帯" },
  { label: "法人需要家数の目安", value: "約 15万口（高圧以上：約 1万口）" },
  { label: "電源構成の特徴", value: "水力約 25〜30%（包蔵水力が豊富）、原子力（志賀原発の動向注視）、石炭火力約 20%、LNG約 15%" },
  { label: "市場シェア（新電力）", value: "電力量ベースで約 10〜15%（低い水準）" },
];
...
const revisionHistory = [
  {
    date: "2023年4月",
    content: "規制料金（家庭向け）が約 46% の大幅値上げ。企業向けも約 20〜25% 上昇し、低い水準の地位が揺らぎ始めた。",
  },
  {
    date: "2023年12月",
...
const newPowerStatus = [
  {
    category: "参入状況",
    detail:
      "需要規模が小さい部類であり、新電力にとって採算が取りにくいエリア。参入社数は少ない水準で、高圧向けに実績のある事業者は数十社程度（2024年時点）。",
  },
  {
    category: "撤退・解除状況",
    detail:
  ...
  },
  {
    category: "価格競争力",
    detail:
      "2023年の大幅値上げ前は北陸電力の料金が低い水準であったため、新電力の削減メリットが薄かった。値上げ後は競争余地が若干拡大しているが、需要規模の小ささから参入社数は依然として少ない。",
  },
];
    ...
    <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
      ...
      <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
        ...
        <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
          北陸電力エリア（富山・石川・福井・岐阜一部）は豊富な包蔵水力を背景に長らく低い水準の電気料金でしたが、
      ...
      <section className="mt-6 rounded-xl border border-slate-200 bg-white p-5">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <div className="rounded-xl border border-sky-100 bg-sky-50 p-4">
            <h3 className="text-base font-semibold text-sky-900">低い水準の電力量料金（2023年値上げで変動）</h3>
            <p className="mt-2 text-sm leading-7 text-slate-700">
              北陸電力は長年にわたり低い水準の電気料金でした。
          ...
          <div className="rounded-xl border border-sky-100 bg-sky-50 p-4">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700">
              北陸は急峻な地形と豊富な降雪・降雨に恵まれ、豊富な包蔵水力を保有しています。
          ...
          <div className="rounded-xl border border-sky-100 bg-sky-50 p-4">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700">
              需要規模が小さい部類であるため、新電力にとって参入メリットが薄いエリアです。
              高圧向けの新電力選択肢は少なく、料金競争の恩恵を受けにくい状況です。
      ...
      {/* 電源構成の実績データ */}
      <section className="mt-6 rounded-xl border border-slate-200 bg-white p-5">
        <h2 className="text-xl font-semibold text-slate-900">北陸電力の高水力比率の電源構成</h2>
        <p className="mt-2 text-sm leading-7 text-slate-600">

...
import IndustryBenchmarkCalculator from "../../components/market-data/IndustryBenchmarkCalculator";
...
export default function IndustryElectricityGuidePage() {
  return (
    <>
      <ArticleJsonLd
        headline="業種別の電気料金見直しガイド一覧｜業種特性を踏まえた契約見直しの考え方"
        description="スーパー・倉庫・病院・オフィス・飲食店・ホテルなど業種ごとの電気料金見直しポイントを一覧で整理。負荷特性・固定vs市場連動の向き不向き・設備対策まで業種別に解説します。"
        url="https://simulator.eic-jp.org/industry-electricity-guide"

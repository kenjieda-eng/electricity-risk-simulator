...
const basicChargeTopics = [
  {
    ...
    content: [
      ...
      "例えば、契約電力が500kW・基本料金単価が1,500円/kW・力率割引率が0.97（力率88%の場合）であれば、基本料金は500 × 1,500 × 0.97 = 727,500円（消費税別）となります。月間使用量がどれだけ少なくても、この金額は毎月固定で発生します。",
    ],
    checkPoints: [
      "自社の現行の契約電力（kW）",
  ...
  },
  {
    heading: "力率割引・割増の仕組み",
    content: [
      "力率とは、電力設備に供給された電力のうち、実際に仕事（熱・光・動力）として使われた割合を示す指標です。100%に近いほど効率よく電力が使われていることを示します。高圧電力では一般的に、力率85%を上回る1%につき基本料金が1%割り引かれます（中部電力ミライズ・関西電力の公表資料。電力会社・メニューによって異なる）。",
      "一方、力率が85%を下回る1%につき1%割増となり、基本料金が増加します。工場などで誘導電動機（モーター）を多用している施設は力率が低くなりやすい傾向があります。進相コンデンサーの設置によって力率を改善し、基本料金の割引を受けることは、初期投資に対して高いコスト削減効果が見込める対策の一つです。",
    ],
    checkPoints: [
      "現在の力率の実績値（月次）",
      "力率割引・割増の適用状況",
...
const faq = [
  ...
  { question: "力率割引とは何ですか？", answer: "力率（有効電力と皮相電力の比）が高いほど電気を効率よく使っているとみなされ、基本料金の割引が適用されます。高圧契約では一般的に、力率85%を基準として、上回る1%につき基本料金が1%割引、下回る1%につき1%割増になります（中部電力ミライズ・関西電力の公表資料）。適用条件は契約種別・電力会社で異なるため、自社の約款でご確認ください。" },
];
...
<div className="mt-4 overflow-x-auto">
        ...
        <SourcesAndFaq
          ...
          sources={[
            ...
            { name: "経済産業省 資源エネルギー庁", url: "https://www.enecho.meti.go.jp", description: "電力料金の制度・統計の公表元" },

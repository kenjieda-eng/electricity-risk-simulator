...
const pageTitle =
  "青森県の法人電気料金ガイド｜風力発電・原子力立地・りんご倉庫の契約最適化";
const pageDescription =
  "青森県の法人電気料金を地域特化で解説。東北電力エリア、東通原発・大間原発の立地、風力発電集積の特性、りんご冷蔵倉庫・水産加工業の電力負荷、補助金活用、固定vs市場連動の判断まで実務的に整理します。";
...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "東通原子力発電所（110万kW、停止中）、大間原子力発電所（138万kW、建設中）が立地。風力発電は陸上風力58万kW、洋上風力プロジェクトも複数進行中（むつ小川原・八峰沖など）。再エネ大量導入で全国でも特異な電源プロファイルを持つ。",
  },
  {
    label: "気象条件 — 寒冷地・豪雪・日照短い",
    detail:
      "暖房度日（HDD18）は青森市で約3,600、十和田・むつで約3,800と本州でも高い水準。降雪量は青森市平年値で年間約8m、八甲田山系では20m超。冬季日射量は北海道並みに少なく、12〜2月の発電可能量は年間平均の40%以下に低下する。",
  },
  {
    label: "再エネ出力制御の実態",
    detail:
...
const priceBenchmark = [
  {
    ...
    detail:
      "東北電力『業務用高圧電力』の電力量料金は青森県内で18〜22円/kWh（季節・時間帯により変動）。燃料費調整額（2024〜2025年は+3.0〜+4.5円/kWh）と再エネ賦課金（2025年度3.98円/kWh）を加味した実質単価は25〜30円/kWhレンジ。全国的な水準との差は契約区分・使用量・負荷率により変わります。",
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
...
const costFactors = [
  {
    label: "寒冷地暖房需要",
    detail:
      "暖房度日3,600〜3,800で本州でも高い水準。暖房に電気を利用する事業所では冬季月別電気代が他季の2〜3倍。年間電気代に占める暖房分は青森県内事業所平均で20〜35%、ホテル・病院等の連続稼働事業所では45%超に達することも。",
  },
  {
...
const switchingReality = [
  {
    label: "新電力切替の県内浸透度",
    detail:
      "2024年時点で青森県内法人の新電力シェアは15〜20%（経産省統計）。八戸・青森・弘前等の都市圏では切替が進む一方、地方部では東北電力EP継続が多数。",
  },
  {
    label: "市場連動プランのリスク認識",
    detail:
...
const faqItems = [
  { question: "青森県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の実質単価について、全国的な水準との差は契約区分・使用量・負荷率により変わるため、請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。寒冷地の暖房需要、火力への依存度、原子力の稼働状況といった要因が指摘されています。差額の規模は自社の使用量と契約区分により変わるため、実質単価の差に年間使用量を乗じて確認してください。" },
  ...
  { question: "青森県で固定プランと市場連動プランのどちらが向きますか？", answer: "冬季ピーク負荷の大きい青森県では、24時間稼働事業所・暖房負荷の大きい業種は固定プランが向きます。2022〜2023年の市場高騰で県内事業者の多くが固定プランへ回帰しました。市場連動は夏季のみ稼働等の限定的なケースのみ検討対象です。" },
  { question: "風力発電PPAは青森県でどう活用できますか？", answer: "青森県は陸上風力58万kW、洋上風力プロジェクトも進行中。PPA契約で20年程度の長期固定単価（15〜18円/kWh水準）でCO2フリー電力を調達できる選択肢があります。出力制御リスクの分担を契約で明確化することが重要です。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            青森県は東北電力エリア・東通/大間原発立地・風力発電の集積・豪雪寒冷地という4つの構造的特徴を持ちます。本ページでは県内法人の電気代水準、りんご加工・水産加工・観光業の業種別影響、寒冷地・豪雪地帯固有のコスト要因、補助金活用、契約見直しの具体策を実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              青森県の電力供給は『東北電力ネットワーク管轄』『東通・大間原発の立地（停止/建設中）』『風力発電の集積（陸上58万kW）』『豪雪寒冷地需要』という4つの構造的特徴を持ちます。再エネ集積地としての特性と、原発立地県としての特性を併せ持つ独特なエリアです。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              全国的な水準との差は契約区分・使用量・負荷率により変わります。寒冷地暖房需要・火力依存度・原発停止状況が主要因。実質単価（電力量料金+燃料費調整額+再エネ賦課金）ベースで比較することが重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

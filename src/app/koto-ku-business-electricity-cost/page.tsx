...
const pageTitle =
  "江東区の法人電気料金ガイド｜湾岸データセンター集積・豊洲再開発・有明ビッグサイト";
...
const electricSituation = [
  {
    ...
    detail:
      "江東区は東京電力エナジーパートナーの供給エリアで、首都圏データセンター集積の中核区。区内年間電力需要は推計40〜50億kWh規模。データセンター（東陽町・木場・有明）、湾岸物流（辰巳・新木場）、豊洲・有明の大型商業施設、清澄白河・亀戸の中小製造が並列する複合構造。",
  },
  {
...
const switchingReality = [
  {
    label: "江東区内の新電力切替浸透度",
    detail:
      "2024年時点で江東区法人の新電力シェアは推計35〜40%。DC・大型商業施設・物流DCで競争入札による切替が標準化、清澄白河・亀戸の中小事業者でも切替が拡大。",
  },
  {
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              江東区は首都圏データセンター集積地の中核で、AI需要拡大期の電力需要急増の主役エリア。豊洲再開発・有明MICE・湾岸物流・中小製造が並列する複合構造です。23区の中でも特別高圧契約が極めて多く、年間電力需要は推計40〜50億kWh。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              江東区の新電力シェアは2024年時点で推計35〜40%。DC・大型施設・物流DCで競争入札による切替が標準化、需要家主導型オフサイトPPAも大規模に普及しています。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

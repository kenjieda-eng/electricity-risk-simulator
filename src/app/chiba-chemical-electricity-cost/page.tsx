...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "東京電力エリアはLNG・石炭火力への依存度が高く需要規模が国内最大のため、燃料費調整額の感応度は相対的に中〜高とされるのがエリア固有の特徴です。これは燃料高騰局面で単価が上振れしやすいというリスクであり、連続運転で使用量が大きい石油化学では燃調の上振れが経営に与える影響が大きくなります。固定vs市場連動の選択が単価の安定性に直結するため、この相対的に高い燃調感応度を前提に契約を検討するのが実務的です。どちらが適するかは使用パターン・リスク許容度次第で一概には言えません。",
  },
  {

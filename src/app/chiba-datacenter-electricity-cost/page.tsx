...
const electricSituation = [
  {
    label: "印西を核とする大規模なDC集積",
    detail:
      "千葉県印西市・白井市は、いわゆる『印西エリア』として大規模なデータセンター集積地。1980年代以降、銀行勘定系・証券系の基幹システム拠点として整備が始まり、2010年代以降はクラウド事業者（AWS・GCP・Azure等）・国内大手キャリア・コロケーション専業事業者（Equinix・NTT Com・KDDI・三菱地所・大和ハウス系等）のハイパースケールDCが連続立地。延床数十万m²級・受電契約電力1〜10万kW級の特別高圧需要家が一帯に集中する稀有なエリアです（出典: 千葉県統計年鑑・経産省産業立地統計）。",
  },
  {
...
const industryProfile = [
  {
    label: "印西エリア — 大規模なDC集積",
    detail:
      "印西市・白井市エリアは1980年代の銀行勘定系拠点整備に始まり、2010年代以降のクラウド・ハイパースケール開発で大規模なDC集積地に。NTT Comムサシノ／NTTデータ印西／Equinix／三菱地所／大和ハウス系等の大型DCが連続立地し、東京電力PG特別高圧受電が常態化しています。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            千葉県は印西・白井・佐倉を中心とする大規模なデータセンター集積地です。本ページでは「千葉県 × データセンター」というクロス領域に絞り、東京電力エリア固有の単価事情と、24時間高負荷率・AI/HPC高密度ラック・PUE改善・RE100調達・系統容量制約までを実務目線で整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              千葉県、特に印西エリアは大規模なデータセンター集積地として、銀行勘定系から最新のハイパースケール・AI/HPC DCまでが連続立地しています。24時間連続・高負荷率という特殊な電力プロファイルと、AI需要急増による新規受電申込逼迫が現在の最大論点です。
            </p>

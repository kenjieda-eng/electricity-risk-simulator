...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "日本パーキングビジネス協会・国交省自動車局・立体駐車場工業会の統計によれば、駐車場施設の電気料金は売上高の5〜20%（機械式駐車場は高め）。粗利ベースでは15〜35%に達する。機械式駐車装置・換気設備・EV充電器が業種特有のコスト構造を形成する電力依存度の高い業種。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。中規模機械式駐車場（年60万kWh）で年250.8万円の負担。容量拠出金も24h稼働業種に影響大。",
  },
  {
...
const faqItems = [
  { question: "駐車場施設の電気代水準はどれくらいですか？", answer: "売上高比5〜20%（機械式駐車場は高め）、粗利比15〜35%が業界平均。中規模機械式駐車場で年600〜3,000万円、大規模立体駐車場で年6,000万〜4.5億円規模の電気代になります。電力依存度が高い業種です。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。駐車場の中規模機械式駐車場では負担額が請求総額の10〜15%に達します。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

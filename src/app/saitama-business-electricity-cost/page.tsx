...
const pageDescription =
  "埼玉県の法人電気代について、平均・相場を全国の確定単価（高圧22.78円/kWh・低圧電力34.42円/kWh等）から読む手順を整理。電力会社を比較する5観点、圏央道・関越道の物流拠点や熊谷の猛暑がもたらす夏季ピーク負荷を踏まえた契約見直しを解説します。";
...
const electricSituation = [
  {
    ...
    detail:
      "埼玉県は東京電力パワーグリッド管轄。首都圏電力供給の重要拠点で、人口は740万人規模。県内の電力消費は『さいたま市・川口市の都市部』『川越・所沢の住宅商業地』『熊谷・本庄の工業』『久喜・春日部の物流』『秩父・飯能の山間部』の5層構造。",
  },
  {
    label: "電源構成 — 県内発電は限定的",
    detail:
  ...
  },
  {
    label: "首都圏物流2大拠点",
    detail:
      "圏央道沿線（久喜・幸手・桶川・坂戸）と関越道沿線（川越・東松山・所沢）の物流拠点が大規模に集積。Amazon・楽天・ヤマト運輸・佐川急便等の大型物流センターが集積、24時間稼働で大量電力を消費。",
  },
  {
    label: "工業団地と東京近郊型製造業",
    detail:
...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "市場動向",
    detail:
      "2022〜2023年の市場高騰で県内でも新電力の新規受付停止・撤退が発生したが、2024年以降は15社以上が法人向け高圧で新規受付中。東京電力エリアは新電力競争が活発。",
  },
];
...
const industryProfile = [
  {
    ...
    detail:
      "Amazon・楽天・ヤマト・佐川等の大型物流センターが大規模に集積。久喜・幸手・桶川・川越・東松山・所沢・坂戸の物流拠点。冷凍冷蔵・仕分けライン・空調の24時間稼働。",
  },
  {
...
const faqItems = [
  { question: "埼玉県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の実質単価で全国平均並み〜やや低めです。東京電力エリアは供給事業者の選択肢が多く、複数社から同一条件で見積を取って比較しやすい環境にあります。大型物流センターは競争入札で更に有利な条件を引き出せます。" },
  ...
  { question: "埼玉県で固定プランと市場連動プランのどちらが向きますか？", answer: "24時間稼働の大型物流センター・自動車部品工場・大型商業施設は固定プランが向きます。中小オフィス・店舗は使用量が小さいため市場連動でも影響限定的ですが、2022〜2023年の市場高騰経験から固定プランが主流です。" },
  ...
  { question: "埼玉県の電気代の平均・相場はいくらですか？", answer: "県別に法人の電気代平均を示した公的統計はないため、契約区分ごとの全国確定単価を基準にします。電力取引報の最新確定分である2026年5月分（全国計・販売額÷販売電力量）は、特別高圧17.45円/kWh、高圧22.78円/kWh、低圧電灯27.85円/kWh、低圧電力34.42円/kWhでした（消費税・再エネ賦課金を含まない参考値）。埼玉県は東京電力エリアのため、LNG火力比率の高さに由来する燃料費調整額の振れやすさを加味して読みます。自社の位置は、請求書から消費税と再エネ賦課金を差し引いた額（基本料金・電力量料金・燃料費調整額の合計）を使用量で割って求めた実質単価を、同じ区分の全国値と比べれば把握できます。" },
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              埼玉県は『東京電力エリアの首都圏中核』『大規模な物流拠点集積』『東京近郊型製造業』『熊谷猛暑日地帯』『県南北の地域差』という構造的特徴を持ちます。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              埼玉県では2024年時点で約15社の新電力が法人向け高圧で新規受付中。東京電力エリアは新電力競争が活発です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              全国的な水準との差は契約区分・使用量・負荷率により変わります。新電力競争が活発で切替メリットも大きいエリアです。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
              基準として使うのは、電力取引報の最新確定分である2026年5月分の実績単価です。同じ「電気代」でも区分によって水準が異なるため、請求書の契約種別欄を先に確認してください。
            </p>
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計（多くの事業者が検針期間ベースで報告・暦月ベースも可）であり、埼玉県または東京電力エリアの平均値ではありません。消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年5月分・確定）。この単価に含む費目・含まない費目の定義は{" "}

...
const peakStructure = [
  ...
  },
  {
    label: "再エネ賦課金との累積効果",
    detail:
      "再エネ賦課金は2026年度4.18円/kWh（確定）と上昇トレンドで、使用量の多い夏季は絶対額が大きくなる。年間500万kWh使用の法人で8月分の賦課金は約170万円規模。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              夏季電気代の影響度は業種で大きく異なります。製造業（24h稼働）はベースロード比重が高く、相対的に夏季比率が低い（28〜32%）。オフィス・商業施設は冷房中心で夏季比率が高い（40〜45%）。データセンターは年中稼働で冷却負荷増の比率が低い（26〜30%）が、絶対額は大きくなりやすい。
            </p>

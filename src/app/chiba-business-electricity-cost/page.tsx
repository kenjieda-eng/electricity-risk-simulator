...
const electricSituation = [
  ...
  },
  {
    label: "電源構成 — 火力発電基地",
    detail:
      "東京電力の富津火力（LNG、504万kW）、袖ヶ浦火力（LNG、360万kW）、千葉火力（LNG、288万kW）、五井火力（LNG、118.6万kW＋新設）等が東京湾岸に集積。県内総発電容量は1,500万kW超で大規模な発電拠点。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇。京葉コンビナートの大口需要家（年間1億kWh）で年4億円規模の負担、5年で20億円超。減免制度（年間1,000万kWh以上・電気使用密度要件）の対象になりやすい化学・鉄鋼は申請を要検討。",
  },
  {
...
const faqItems = [
  { question: "千葉県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の実質単価で全国平均並み〜やや低めです。東京電力エリアは供給事業者の選択肢が多く、複数社から同一条件で見積を取って比較しやすい環境にあります。京葉コンビナートのような超大口需要家は競争入札で更に有利な条件を引き出せます。" },
  ...
  { question: "千葉県で固定プランと市場連動プランのどちらが向きますか？", answer: "24時間稼働の京葉コンビナート・成田物流・舞浜観光業は固定プランが向きます。中小オフィス・店舗は使用量が小さいため市場連動でも影響限定的ですが、2022〜2023年の市場高騰経験から固定プランが主流です。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              千葉県では2024年時点で約15社の新電力が法人向け高圧で新規受付中。東京電力エリアは新電力競争が活発です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/chemical-electricity-cost-review", title: "化学工業の電気料金見直し", description: "京葉コンビナート向け。" },
              ...
              { href: "/corporate-ppa-overview", title: "コーポレートPPAの類型", description: "銚子沖洋上風力PPA活用パターン整理。" },

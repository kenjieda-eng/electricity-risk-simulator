...
const pageTitle =
  "台東区の法人電気料金ガイド｜浅草上野観光・宿泊・合羽橋御徒町問屋街の契約最適化";
...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "合羽橋（業務用厨房機器・食器の問屋街、約170店）、浅草橋（玩具・文具卸の問屋街）、御徒町（宝飾・服飾の問屋街）と大規模な問屋街が集中。各店舗は中小規模（年間使用量3〜30万kWh）で低圧電力中心、商品ショーケース・店舗照明・空調が消費電力の中心となります。",
  },
  {
    label: "宿泊業の大型化トレンド",
    detail:
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金17〜20円/kWh+調整項目。台東区内では国立博物館・大規模公共文化施設、大型ホテル等が対象。新電力競争による圧力大で、競争入札で1〜2円/kWh単位の単価交渉が可能なケース多数。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              区内事業者の電気代は契約区分（特別高圧・高圧・低圧電力・低圧電灯）によって単価水準が大きく異なります。国立博物館・大型ホテルは特別高圧、観光ホテル・上野駅商業施設は高圧、問屋街・観光飲食は低圧が標準です。
            </p>
            <div className="mt-4 space-y-3">

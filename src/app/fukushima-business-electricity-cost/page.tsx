...
const pageDescription =
  "福島市・郡山・いわきを含む福島県の法人電気代の相場を、契約区分別の全国確定単価（高圧22.78円/kWh等）を基準に読む手順で整理。東北電力エリアの再エネ比率と女川原発再稼働が単価に及ぼす構造、電力会社を比較する5観点、浜通り工業・港湾物流・会津の寒冷地負荷の特性を解説します。";
...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇。浜通り工業地帯の大規模事業者（年間1,000万kWh以上・電気使用密度要件）は減免制度の対象になりやすく、申請を要検討。",
  },
];
...
const industryProfile = [
  ...
  },
  {
    label: "いわき港・小名浜港物流",
    detail:
      "小名浜港は東北の主要な物流港湾。水産物・石炭・コンテナの取扱が中心。冷凍倉庫・荷役機械・港湾施設の電力消費が中心。年間使用量200〜2,000万kWh規模。",
  },
  {
...
const faqItems = [
  { question: "福島県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の単価について、全国的な水準との差は契約区分・使用量・負荷率により変わるため、請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。浜通り工業地帯の大規模事業者では、複数社から見積を取ることで単価の見直し余地が生じる場合があります。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              全国的な水準との差は契約区分・使用量・負荷率により変わります。浜通り工業地帯では複数社からの相見積による見直し余地が生じる場合があります。実質単価（電力量料金+燃料費調整額+再エネ賦課金）ベースで比較することが重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計・販売額÷販売電力量で求めた値であり、福島県または東北電力エリアの平均値ではありません。販売額には基本料金・電力量料金・燃料費調整額を含み、消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年5月分・確定）。単価の定義は{" "}

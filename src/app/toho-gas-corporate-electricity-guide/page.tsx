...
const pageTitle =
  "東邦ガスの電気 法人向けプラン完全ガイド｜中部の都市ガス系新電力・自動車サプライチェーン対応とガス電気一括最適化";
const pageDescription =
  "東邦ガスの法人向け電力サービスを、公開情報に基づき中立的に整理。愛知・岐阜・三重を地盤とする都市ガス大手の電力小売事業の位置づけ、自動車産業サプライチェーンのCN対応、ガス・電気の一括最適化、特別高圧・高圧の契約メニュー体系、燃料費調整額の連動条件、契約手続き・相見積活用のポイントを、第三者・社団法人視点で契約者の判断材料としてまとめます。特定企業の優劣評価は行いません。";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://simulator.eic-jp.org/toho-gas-corporate-electricity-guide",
  },
  robots: { index: true, follow: true },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: "https://simulator.eic-jp.org/toho-gas-corporate-electricity-guide",
    siteName: "法人電気料金ナビ",
    locale: "ja_JP",
    type: "article",
...
const overview = [
  {
    label: "東邦ガスの位置づけ",
    detail:
      "東邦ガス株式会社は、愛知・岐阜・三重の中部圏を地盤とする都市ガス大手で、ガス事業を母体に電力小売事業（『東邦ガスの電気』ブランド等）を展開しています。都市ガス・電力・LNG・エンジニアリング等を手がける総合エネルギー企業の一つで、2016年の電力小売全面自由化を契機に法人・家庭向けの電力サービスを拡大してきた都市ガス系新電力の代表的存在の一つです。本ページは特定企業の優劣を評価するものではなく、公開情報に基づき法人契約者が自社条件に照らして判断するための材料を中立的に整理するものです（出典: 東邦ガス公式サイト・東邦ガス統合報告書・参照日2026年6月時点）。一般社団法人エネルギー情報センターは、特定企業を推奨も否定もしない中立的立場で判断材料を整理します。",
  },
  {
    label: "本ページの位置づけ（中部の都市ガス系新電力の代表例として）",
    detail:
      "当サイトの『電力会社別解説』カテゴリでは、旧一電大手だけでなく、都市ガス系新電力（東邦ガス・大阪ガス・東京ガス等）、石油系新電力、商社系新電力、自治体系・地産地消の地域新電力など、新電力の主要類型ごとの代表例を中立的に整理しています。本ページは『中部を地盤とする都市ガス系新電力』の典型例として東邦ガスの公開情報を解説します。自動車産業のサプライチェーンが集積する中部エリアという地域特性も合わせて整理します。",
  },
  {
    label: "事業特性（公表情報）",
    detail:
      "東邦ガスは都市ガス販売を中核に、電力小売・発電（LNG火力等）・LNGバリューチェーン・コージェネレーションや空調などの設備提案を組み合わせたエネルギーサービスを公開情報で示しています。知多地区のLNG受入基地等を背景としたガス調達基盤や、ガス機器・コージェネ・ガス空調（GHP）の提案知見が、ガスと電気を合わせた法人向けエネルギー最適化の文脈で語られることが一般的です。具体的な電源構成・発電所の詳細は、統合報告書・公式公表で確認してください（出典: 東邦ガス公式サイト・統合報告書）。",
  },
  {
    label: "法人需要家の構成（想定）",
    detail:
      "東邦ガスの法人需要家には、中部圏の自動車・機械・部品の製造業、商業施設、オフィスビル、病院、ホテル等が含まれる可能性があります。自動車産業のサプライチェーンでは、完成車メーカーの脱炭素要請を背景に再エネ調達・CN対応の関心が高く、ガスと電気を合わせたエネルギー最適化の文脈で電力契約を検討するケースが想定されます。具体的な業種別の特典・割引・セットメニュー等は公式公表で確認してください。本記述は公開情報に基づく一般的な想定です。",
  },
  {
    label: "中立的な判断のための前提",
    detail:
      "電力会社の選択は、単価だけでなく、燃料費調整の条件（連動方式・上限の有無）、契約期間、サポート体制、BCP対応、再エネ調達メニューの有無、ガスとのセット効果など複数の観点を総合して判断すべきものです。本ページは東邦ガスの公開情報を整理しますが、旧一電（中部電力ミライズ）継続・他の新電力との相見積・比較を行ったうえで、自社条件に最適な選択をすることを推奨します。当センターは特定企業の優劣を断定する立場にありません。",
  },
];
...
const planTypes = [
  {
    ...
    detail:
      "東邦ガスは法人向けに特別高圧区分の供給に対応していることが公開情報で示されています。料金は基本料金（契約電力×単価）＋電力量料金（使用kWh×単価）＋燃料費調整額＋再エネ賦課金で構成される一般的な体系が想定されます。大規模需要家は個別協議・個別見積となるケースが多く、契約期間・解約条件・燃調算定方式（独自の燃調式やガスとのセット条件を用いる場合あり）等を契約書で詳細に確認することが重要です。具体的な単価・条件は公式の料金公表および個別見積で確認してください（出典: 東邦ガス公式サイト料金プラン・参照日2026年6月時点）。",
  },
  {
    name: "高圧電力（契約電力50kW以上2,000kW未満の需要家向け）",
    role: "中規模工場・ビル・商業施設・物流倉庫等",
    detail:
      "高圧需要家向けには、業務用メニューやガスとのセットメニュー等が公開情報で示されています。基本料金は契約電力（デマンド実量に基づく）に応じて決まる一般的な構造です。都市ガス系新電力の高圧メニューは、旧一電の標準メニューと比較して燃調算定方式・契約期間・解約条件・ガスセット条件等で違いがあることが一般的なため、相見積で同一条件比較を行うことが重要です（出典: 東邦ガス公式サイト料金プラン）。",
  },
  {
    name: "ガス・電気の一括最適化／コージェネ併用・自動車SC対応",
    role: "コージェネ・ガス空調を持つ工場、CN対応を進める製造業向け",
    detail:
      "都市ガス系新電力の特徴として、ガスと電気を合わせたエネルギー最適化の提案が語られることが一般的です。中部圏は自動車産業のサプライチェーンが集積し、完成車メーカーの脱炭素要請を背景に再エネ調達・CN対応の関心が高い地域です。コージェネレーションやガス空調を導入する事業者は、ガス料金と電力料金、自家発電と購入電力のバランスを総合的に設計する文脈で電力契約を検討するケースがあります。セット効果の有無・大きさは契約条件・使用実態により異なるため、相見積による中立的な比較が前提です（出典: 東邦ガス公式サイト・統合報告書）。",
  },
  {
    name: "再エネ関連メニュー・CN対応／燃料費調整額の算定",
    role: "RE100対応・脱炭素志向の需要家、全メニュー共通の変動要素",
    detail:
      "東邦ガスは再生可能エネルギーの開発・調達やCO2フリーメニュー、非化石証書の活用を公開情報で示しており、自動車サプライチェーンの脱炭素を進める法人需要家向けの調達手段の一つとなります。また、新電力の燃料費調整は、旧一電と同様の方式（貿易統計の原油・LNG・石炭価格に基づく算定）を採用する場合と、JEPXスポット価格に連動する独自方式（市場連動）を採用する場合があります。メニュー区分・契約区分により算定方式が異なる可能性があり、契約書で必ず確認してください（出典: 東邦ガス公式サイト・電力ガス取引監視等委員会）。",
  },
];
...
const dataPoints = [
  {
    label: "供給エリア（公表情報）",
    detail:
      "東邦ガスは中部エリア（愛知・岐阜・三重）を地盤としつつ、電力小売では供給可能エリアが公開情報で示されています。具体的な対応エリアと契約区分の組合せは公式サイト・個別見積で確認してください（出典: 東邦ガス公式サイトサービス提供エリア公表）。中部エリアの市況は地域別の解説記事も合わせて参照すると理解が深まります。",
  },
  {
    label: "電源・調達（公表情報）",
    detail:
      "東邦ガスはガス火力発電・再生可能エネルギー等の電源開発やLNG調達を公開情報で示しています。電源ポートフォリオの詳細は統合報告書・有価証券報告書で公表されています。電源構成と燃調算定方式・燃料調達の関係を確認することで、価格変動リスクの構造を理解できます（出典: 東邦ガス統合報告書・有価証券報告書）。",
  },
  {
    label: "JEPX市場での取扱い",
    detail:
...
const caseStudies = [
  {
    title: "ケース1: 自動車部品メーカー（高圧・CN対応志向）",
    before:
      "Before: 完成車メーカーのサプライチェーンに属する部品メーカーが、脱炭素要請を受けて再エネ調達を検討。ガスは東邦ガス、電気は旧一電（中部電力ミライズ）という別契約で、CN対応とコスト最適化の両立に課題。",
    after:
      "After: 東邦ガスの電力・再エネメニューと、他の新電力・旧一電継続＋再エネ調達の条件を相見積で取得し、同一条件で比較。再エネメニュー・非化石証書・コーポレートPPAの選択肢を整理し、CN対応とコストのバランスを中立的に評価（特定社の優劣ではなく条件適合で判断）。",
    result:
      "Result: サプライチェーンの脱炭素要請に応えつつ、コスト最適化を両立する判断軸を整理。※具体的な削減額・CO2削減量は契約条件・使用実態により異なり、推測値は記載しません。",
  },
  {
    title: "ケース2: コージェネ併用の中規模工場（高圧・ガス併用）",
    before:
      "Before: コージェネレーションとガス空調を導入する工場が、ガスは東邦ガス、電気は旧一電という別契約。ガスと電気の最適化が分断され、総合的なエネルギーコストを俯瞰できていない。",
    after:
      "After: ガス・電気の一括提案（東邦ガス等）と、電気の旧一電継続＋ガス最適化の二つの選択肢で相見積を取得し、同一条件で比較。コージェネの自家発電量と購入電力量のバランス、ガスセット効果の有無を総合評価。",
    result:
      "Result: ガスと電気を一体で見るメリットと、別々に最適化するメリットのトレードオフを定量化し、中立的に選択。※実際の条件は個別見積で確認が必要です。",
  },
  {
    title: "ケース3: 中部圏の大規模需要家（特別高圧・エネルギー一括）",
    before:
      "Before: 特別高圧の大規模需要家が、ガス・電気・熱を含むエネルギー総コストの一括最適化を検討。複数の調達先・契約形態が候補。",
    after:
      "After: 東邦ガスの電力・ガス一括提案と、他の新電力・旧一電継続＋ガス個別の条件を相見積で比較。統合管理のメリット（請求一元化・サポート一元化）と、複数社比較で得られる単価メリットの両方を中立的に評価し、自社にとっての最適解を選定。",
    result:
...
const procedures = [
  ...
  },
  {
    ...
    detail:
      "東邦ガスは法人向けの問い合わせ窓口・Web会員サービス等を公開しています。請求・使用量の確認、契約変更の手続き、ガス・電気の一括サポート等の体制は公式サイトで確認できます。停電時の物理的な復旧は一般送配電事業者（エリア別の送配電会社）が担うため、契約小売事業者によらず復旧対応は共通である点も理解しておくと良いでしょう。",
  },
  {
    label: "新電力切替時の留意事項",
    detail:
...
const cautionItems = [
  {
    ...
    detail:
      "電力会社の選択は、電力量料金単価だけでなく、基本料金・燃調条件（算定方式・上限有無）・契約期間・解約条件・サポート・再エネメニュー・ガスセット効果を総合して判断すべきです。本ページは東邦ガスの情報を整理しますが、特定社が一律に有利・不利と断定するものではありません。",
  },
  {
    label: "ガスセット効果は条件次第",
    detail:
  ...
  },
  {
    ...
    detail:
      "新電力の事業撤退・小売登録の取消し等のリスクは、過去にも事例がありました。新電力契約時は最終保障供給制度（一般送配電事業者がセーフティネットとして提供）の仕組みを理解しておくことが重要です。中立的な判断のためには、東邦ガス・他の新電力・旧一電（中部電力ミライズ）継続の複数社からの相見積を取得し、同一条件（契約電力・使用量・期間）で比較することが基本です。",
  },
];
...
const compareViewpoints = [
  ...
  {
    label: "自動車SCのCN対応・再エネ調達",
    detail:
      "完成車メーカーのサプライチェーン脱炭素要請に応える再エネメニュー、非化石証書、コーポレートPPAなどRE100対応の調達手段を比較します。東邦ガスの再エネ・CO2フリーメニューの活用可能性も検討対象です。",
  },
  {
    label: "ガス・電気の総合最適化",
    detail:
...
const energySaving = [
  ...
  },
  {
    label: "自動車SCのCN対応・再エネ調達",
    detail:
      "完成車メーカーのサプライチェーン脱炭素要請に応えるため、再エネメニュー・非化石証書・コーポレートPPAを組合せることで、RE100対応とCO2削減を進められます。東邦ガスの再エネ・CO2フリーメニュー活用も選択肢の一つです。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "東邦ガス継続・他新電力切替・旧一電（中部電力ミライズ）継続の複数パターンで相見積を取得し、同一条件で比較することで、自社に最適な契約条件を選定できます。固定単価・燃調上限ありの条件や、再エネ自家消費によるヘッジで、燃調変動リスクへの備えを契約に反映できます。",
  },
];

const checklistItems = [
  "自社拠点が東邦ガスの電気の供給対応エリアに含まれるか確認したか",
  ...
  "完成車メーカーのCN要請への対応水準を再エネ調達計画に反映したか",
  "新電力撤退時の最終保障供給への切替フローを理解したか",
  "東邦ガス・他新電力・旧一電（中部電力ミライズ）継続の複数で相見積を取得したか",
  "単価だけでなく総合的な条件で中立的に判断したか",
];

const faqItems = [
  {
    question: "東邦ガスの電気とはどんなサービスですか？",
    answer:
      "東邦ガス株式会社が展開する電力小売サービスのブランド（『東邦ガスの電気』等）です。愛知・岐阜・三重の中部圏を地盤とする都市ガス大手として、ガス事業を母体に2016年の電力小売全面自由化を契機に法人・家庭向けの電力サービスを拡大してきた都市ガス系新電力の代表的存在の一つです。本ページは特定企業の優劣評価ではなく、公開情報に基づき法人契約者の判断材料を中立的に整理するものです（出典: 東邦ガス公式サイト・統合報告書）。",
  },
  {
    question: "都市ガス系新電力と旧一電（中部電力ミライズ等）の違いは？",
    answer:
  ...
  {
    question: "東邦ガスの電気の法人向けにはどんなプランがありますか？",
    answer:
      "公開情報では、特別高圧電力（契約電力2,000kW以上）、高圧電力（50kW以上2,000kW未満）の業務用メニュー、ガスとのセットメニュー、再エネ・CO2フリー関連メニュー等の提供が示されています。料金は基本料金＋電力量料金＋燃料費調整額＋再エネ賦課金で構成されます。特別高圧・大型高圧は個別協議・個別見積となるケースが多いため、具体的な単価・条件は公式の料金公表および個別見積で確認してください（出典: 東邦ガス公式サイト料金プラン・参照日2026年6月時点）。",
  },
  {
    question: "自動車サプライチェーンの脱炭素要請に電力契約はどう関係しますか？",
    answer:
      "完成車メーカーは自社のサプライチェーン全体でのCO2削減を求める動きを強めており、部品メーカー等は再エネ調達による電力のCO2削減が取引上の評価項目になる場合があります。再エネメニュー・非化石証書・コーポレートPPAなどの調達手段を、コストとのバランスを取りながら計画することが重要です。東邦ガスを含む新電力・旧一電のいずれを選ぶかは、再エネ調達の選択肢とコストを相見積で中立的に比較して判断することをおすすめします。",
  },
  {
  ...
  {
    question: "東邦ガスと中部電力ミライズ・他の新電力はどちらが有利ですか？",
    answer:
...
const sourcesItems = [
  ...
  { name: "東邦ガス 公式サイト（電力小売・法人向け料金プラン）", url: "https://www.tohogas.co.jp/" },
  { name: "東邦ガス 統合報告書／IR（事業構成・電源・LNG）", url: "https://www.tohogas.co.jp/corporate/" },
...
export default function TohoGasCorporateElectricityGuidePage() {
  return (
    <>
      <ArticleJsonLd
        headline={pageTitle}
        ...
        breadcrumbItems={[
          ...
          { name: "東邦ガスの電気の法人向けプラン", url: "https://simulator.eic-jp.org/toho-gas-corporate-electricity-guide" },
        ]}
        faq={faqItems}
      />
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        <nav aria-label="パンくず" className="text-sm text-slate-600">
          ...
          <span className="px-2">›</span>
          <span className="text-slate-800">東邦ガスの電気の法人向けプラン</span>
        </nav>
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            東邦ガスの法人向け電力サービスを、公開情報に基づき中立的に整理します。愛知・岐阜・三重を地盤とする都市ガス大手としての事業特性、自動車産業サプライチェーンのCN対応、ガス・電気の一括最適化、特別高圧・高圧の契約メニュー体系、燃料費調整額の連動条件、契約手続き・相見積活用のポイントを、第三者・社団法人視点で契約者の判断材料としてまとめます。特定企業の優劣を評価するものではありません。
          </p>
          <AuthorBadge publishedAt="2026-06-08" updatedAt="2026-06-08" />
          <div className="mt-4 rounded-lg border border-sky-300 bg-white p-4">
            <p className="text-sm font-semibold text-slate-900">このページでわかること</p>
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-7 text-slate-700">
              <li>東邦ガスの電気の法人向けプラン体系（特別高圧／高圧／ガスセット／再エネメニュー）</li>
              <li>中部の都市ガス系新電力としての事業特性と自動車SCのCN対応（公表情報）</li>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            <h2 className="text-xl font-semibold text-slate-900">東邦ガスの電気の概要と本ページの位置づけ</h2>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              東邦ガスは中部を地盤とする都市ガス系新電力の代表例です。本ページは旧一電・新電力の主要類型を読み比べる『電力会社別解説』の一つとして、特定企業の法人向けサービス詳細を公開情報に基づき中立的に整理します。特定社の優劣評価は行いません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              東邦ガスが公開する法人向けプラン体系を、特別高圧・高圧・ガスセット・再エネメニュー・燃調算定方式の観点で整理します。具体的単価は公式公表・個別見積で確認してください。
            </p>
            <div className="mt-4 space-y-3">
              {planTypes.map((item) => (
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-xs text-slate-500">
              ※ 本セクションのデータは2026年6月時点の公開情報を基に整理した目安です。最新の料金・電源構成・制度単価は各出典元で必ずご確認ください。出典: 東邦ガス公式サイト・統合報告書・電力ガス取引監視等委員会等から整理。
            </p>
          </section>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              都市ガス系新電力の活用パターンを3規模で、東邦ガスの公開情報を踏まえた中立的な判断プロセスをケース別に整理します。特定社の優劣評価ではなく、自社条件に照らした判断の進め方を示すものです。具体的削減額は契約条件・使用実態により異なり、推測値は記載しません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              東邦ガスの公開情報を活用するうえでの留意点を整理します。燃調算定方式の確認、ガスセット効果の見極め、市場連動メニューのリスク、新電力撤退時の備えに注意が必要です。
            </p>
            <div className="mt-4 space-y-3">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              東邦ガス契約の有無にかかわらず、法人需要家が取り得る電気代最適化の打ち手を整理します。契約電力適正化・自動車SCのCN対応・ガスとの総合最適化・省エネ投資・相見積・燃調ヘッジが柱です。
            </p>
            <div className="mt-4 space-y-3">
          ...
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              東邦ガスを含む新電力切替を検討する法人需要家は、契約条件・燃調方式・ガスセット・使用実態に応じて電気代の上振れリスクが変わります。シミュレーターで自社条件の年間電気代・上振れ幅を試算し、契約見直し・再エネ調達・省エネ投資の優先順位づけに活用できます。
            </p>
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/chuden-miraiz-corporate-electricity-guide", title: "中部電力ミライズの法人向けプラン", description: "旧一電（中部エリア）の参考。" },
              ...
              { href: "/region-chubu-business-electricity", title: "中部電力エリアの法人電気代事情", description: "中部エリアの市況・新電力動向。" },
              { href: "/aichi-business-electricity-cost", title: "愛知県の法人電気代ガイド", description: "愛知×自動車の地域クロス。" },
          ...
          <ContentCta
            ...
            description="東邦ガスを含む都市ガス系新電力への切替や自動車SCのCN対応を検討する法人需要家向けに、シミュレーターで自社の上振れリスクと削減余地を試算できます。一般社団法人エネルギー情報センターは特定の電力会社を推奨も否定もしない中立的立場で、相見積・再エネ調達・省エネ投資の優先順位づけの判断材料を整理します。"
            links={[
        ...
        <div className="mt-8">
          <ContactCtaCard
            ...
            description="一般社団法人エネルギー情報センターは、特定の電力会社を推奨も否定もしない中立的立場で、法人・自治体の電力契約の判断材料を整理します。新電力切替・旧一電継続の比較や自動車SCの再エネ調達の進め方について、初回相談は無料です。"
          />
        </div>
      </main>
    </>

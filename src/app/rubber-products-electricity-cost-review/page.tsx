...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・日本ゴム工業会の統計によれば、ゴム製品業の電気料金は売上高の5〜12%（タイヤ・大型工業用ゴムは高水準）。製造原価に占める比率は8〜18%。加硫・混練工程の電力依存度が高い業種。",
  },
  {
...
const faqItems = [
  { question: "ゴム製品業の電気代水準はどれくらいですか？", answer: "売上高比5〜12%（タイヤ・大型工業用ゴムは高水準）、製造原価比8〜18%が業界平均。中規模ゴム工場（年商200億円級）で年4.5〜18億円、大規模タイヤメーカー（年商500億円超）で年18〜90億円規模の電気代になります。" },
  ...
  { question: "ゴム製品業の固定プランと市場連動プランどちらが向きますか？", answer: "加硫プレス24h連続稼働、生産ライン連続稼働でベースロードが大きく、加硫サイクル途中停止が品質劣化につながるため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続企業で月数千万円の追加負担が発生しました。" },

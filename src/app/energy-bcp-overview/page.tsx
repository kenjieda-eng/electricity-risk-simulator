...
import BcpLoadSizer from "../../components/market-data/BcpLoadSizer";
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              電力BCP分野は、日本では2000年代の電力自由化を出発点に段階的に形成されてきました。2016年の小売全面自由化以降、法人向け電気料金は「燃料調達コスト」「市場価格」「政策コスト」の三層構造が明確になり、2020-2022年の燃料高騰・需給ひっ迫危機を経て、企業の電力マネジメントは単なる経費管理から経営戦略の中核課題へと位置づけが変わりました。
            </p>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">

...
const faqItems = [
  { question: "福井県の法人電気代水準は全国比どれくらいですか？", answer: "2023年4月に北陸電力の料金改定（45.84%）が実施され、その後の水準が比較の起点になっています。全国的な水準との差は契約区分・使用量・負荷率により変わるため、請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。新電力への切替による単価最適化の余地があるかは、複数社から同一条件で見積を取って比較してください。" },

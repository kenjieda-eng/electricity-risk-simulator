...
const electricSituation = [
  {
    ...
    detail:
      "世田谷区は約94万人（2025年推計）と23区最大の人口を擁し、面積も58.05km²と23区2位の広さ。住宅地が区面積の大半を占めるため、低圧電灯（住宅・小規模事業所）の契約口数が多い。法人需要は中小飲食・小売・クリニック・学習塾など小規模事業者が多数を占め、低圧電力（動力）契約が主軸となります。",
  },
  {
...
const industryProfile = [
  ...
  },
  {
    ...
    detail:
      "区内の主要再開発エリアのオフィス・商業複合施設。年間使用量500万〜2,500万kWh規模の高圧・特別高圧契約。楽天本社は区内でも大規模な電力需要家の一つ。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            世田谷区は人口約94万人と23区最大、住宅地が区面積の大半を占め、中小飲食・小売・クリニック・学習塾など低圧契約の小規模事業者が多数です。一方で二子玉川ライズ・楽天本社といった特別高圧大口需要家、関東中央病院・国立成育医療研究センター等の大型医療機関、昭和女子大・成城大などの大学キャンパスも集積する多層構造の電力需要を持ちます。本ページでは区内法人の電気代水準、業種別影響度、固有の課題、契約見直しの具体策、世田谷区独自補助の活用までを実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              世田谷区の事業者構成は、中小飲食・小売、医療機関、大学キャンパス、大型複合施設・再開発エリア、公共施設・教育施設の5層構造です。それぞれ電力消費パターンと契約区分が大きく異なります。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

...
const electricSituation = [
  {
    ...
    detail:
      "新潟県は米どころで、米を原料とする食品加工が県の基幹産業のひとつです。米菓（せんべい・あられ）は全国シェアの過半を占め、亀田製菓・三幸製菓・栗山米菓（ばかうけ）など大手・中堅が新潟市・新発田・長岡等に集積。清酒は県内に約90の酒蔵が立地する酒どころ。さらに包装米飯（サトウ食品等）・精米・餅・米粉等の米加工食品工場が県内各地に立地します（出典: 新潟県工業統計・経産省工業統計・農水省統計）。",
  },
  {
...
const industryProfile = [
  ...
  },
  {
    label: "県内全域 — 清酒蔵（約90蔵）",
    detail:
      "新潟県は酒どころで県内に約90の酒蔵が立地。八海醸造（八海山）、朝日酒造（久保田）、〆張鶴、越乃寒梅等の有名銘柄を擁する。吟醸・大吟醸の低温醸造・貯蔵で冷却電力が中心、仕込み期（冬季）にピークの季節性を持ちます。",
  },
  {
    label: "上越・中越・下越の食品工場",
    detail:
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              新潟県は米どころで、米菓（全国シェア過半）・清酒（県内約90蔵）・包装米飯・精米等の米加工食品が基幹産業です。米菓の乾燥焙焼、清酒の低温醸造という業種特性と、東北電力エリアの水力資源の豊かさが電力事情の中心です。
            </p>

...
const pageDescription =
  "香川県・高松の法人電気代の平均と相場を、契約区分別の全国確定単価（高圧22.78円/kWh等）を基準に読む手順で整理。四国電力エリアが持つ「小売は割高グループ・卸は低水準」という二面性の読み方、電力会社を比較する5観点、讃岐うどん製造・坂出造船・小豆島観光の負荷特性と契約見直しを解説します。";
...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "県内は瀬戸内気候で温暖少雨。渇水リスクが定期的。年間冷房度日（CDD24）1,200〜1,500、暖房度日1,500〜2,000。夏季の渇水・水不足が経営課題となるため、農業・うどん製造業では水・電力管理が一体化。",
  },
  {
...
const utilitiesList = [
  {
    ...
    role: "一般小売事業者",
    detail:
      "県内シェア最大。高圧・特別高圧の標準メニューは『高圧電力A』『業務用季節別時間帯別電力』など。2023年6月に規制料金値上げを実施した。",
  },
  {
...
const priceBenchmark = [
  {
    ...
    detail:
      "四国電力『高圧電力A』の電力量料金は17〜21円/kWh（夏季・その他季・時間帯により変動）。燃料費調整額（2024〜2025年は+1.5〜+3.0円/kWh、伊方原発稼働により比較的低水準）と再エネ賦課金（2025年度3.98円/kWh）を加味すると実質単価は23〜27円/kWhレンジ。小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは低い水準で推移してきたという二面性があります。単価の高低は見る指標によって変わります。",
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
  ...
  },
  {
    ...
    detail:
      "四国電力エリアの単価水準は、小売と卸で見え方が異なる二面性があるとされます。燃料費調整額は中国電力エリアより0.5〜1円/kWh低水準で推移しており、香川県内事業者にも直接的なメリット。",
  },
];
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、四国電力エリアの特別高圧電力単価は2024年度実績で約16〜19円/kWh（電力量料金ベース）。四国エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは低い水準で推移してきたという二面性があります。関西電力エリアと並んで全国でも安価な部類。県内大型事業者（JMU坂出造船・川崎重工坂出・高松データセンター）にとっては、新電力の競争入札で1〜2円/kWhの優遇を引き出せれば年間1〜5億円規模の差が出る。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    label: "伊方原発稼働のプラス影響",
    detail:
      "四国電力エリアの単価水準は、小売と卸で見え方が異なる二面性があるとされます。香川県内事業者にも直接的なメリット。",
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
...
const faqItems = [
  { question: "香川県の法人電気代水準は全国比どれくらいですか？", answer: "四国電力エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは低い水準で推移してきたという二面性があります。固定型か市場連動型かで効く指標が異なるため、単価水準を一括りにはできません。坂出造船・讃岐うどん大手は新電力切替で年間数千万円〜数億円規模のコスト削減事例も。" },
  ...
  { question: "香川県・高松の電気代の平均・相場はいくらですか？", answer: "県や市の単位で法人の電気代平均を示した公的統計はないため、契約区分ごとの全国確定単価を基準にします。電力取引報の最新確定分である2026年5月分（全国計・販売額÷販売電力量）は、特別高圧17.45円/kWh、高圧22.78円/kWh、低圧電灯27.85円/kWh、低圧電力34.42円/kWhでした。この販売額には基本料金・電力量料金・燃料費調整額が含まれ、消費税・再エネ賦課金は含まれません。なお四国電力エリアは、小売の高圧単価では全国のなかで割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは低い水準という二面性があり、どちらの指標を見るかで印象が変わります。自社の位置は、請求書から消費税・再エネ賦課金を除いて求めた実質単価を同じ区分の全国値と比べて確認してください。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            香川県は四国電力エリアで、讃岐うどん製造（県内600軒超・大手テーブルマーク・カトキチ）、坂出造船（JMU・川崎重工）、高松都市圏のオフィス・データセンター、小豆島オリーブ・直島アートの観光業など多様な産業構造を持ちます。四国電力坂出火力発電所の立地県として、地域の電力供給の一翼を担っています。本ページでは新電力ネット（pps-net.org/unit）のエリア別単価データを県の産業構造に紐づけて再加工し、業種別の契約見直し・補助金活用を実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              四国電力エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは低い水準で推移してきたという二面性があります。固定型か市場連動型かで効く指標が異なるため、単価水準を一括りにはできません。実質単価（電力量料金+燃料費調整額+再エネ賦課金）ベースで比較することが重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計・販売額÷販売電力量で求めた値であり、香川県または四国電力エリアの平均値ではありません。販売額には基本料金・電力量料金・燃料費調整額を含み、消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年5月分・確定）。単価の定義は{" "}
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
              四国電力エリアには、旧一般電気事業者の標準メニューをベースにした小売の高圧電力量料金でみると全国のなかで割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは低い水準で推移してきたという二面性があります。「四国は安い」「四国は高い」という評価が併存するのはこのためで、どちらか一方だけを根拠に契約形態を決めると判断を誤ります。自社が固定型か市場連動型かによって、どちらの指標が効くのかが変わる点を先に整理してください。
            </p>
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">

...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、四国電力エリアの特別高圧電力単価は2024年度実績で約16〜19円/kWh（電力量料金ベース）。四国エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは全国最低水準で推移してきたという二面性があります。関西電力エリアと並んで全国でも安価な部類。県内大型事業者（JMU坂出造船・川崎重工坂出・高松データセンター）にとっては、新電力の競争入札で1〜2円/kWhの優遇を引き出せれば年間1〜5億円規模の差が出る。",
  },
  {
...
const faqItems = [
  { question: "香川県の法人電気代水準は全国比どれくらいですか？", answer: "四国電力エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは全国最低水準で推移してきたという二面性があります。固定型か市場連動型かで効く指標が異なるため、単価水準を一括りにはできません。坂出造船・讃岐うどん大手は新電力切替で年間数千万円〜数億円規模のコスト削減事例も。" },

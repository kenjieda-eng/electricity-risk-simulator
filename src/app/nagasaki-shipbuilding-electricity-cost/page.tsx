...
const pageDescription =
  "長崎県の造船・重工業に特化。長崎・佐世保の造船・舶用機械・重機械の集積を核に、大型構造物溶接・クレーン・機械加工・塗装乾燥の電力プロファイル、九州電力エリアの単価事情（原子力4基＋太陽光導入量が多く燃調感応度が相対的に低め）、特別高圧の契約最適化、補助金・PPA活用までを実務目線で整理します（広島=呉の造船とは検索意図を分離）。";
...
const electricSituation = [
  {
    ...
    detail:
      "長崎県は長崎港の造船・舶用機械・重機械の中核集積と、佐世保港の造船・艦船修繕・重機械の集積という二大拠点を軸に、諫早・大村・西海方面の造船関連サプライヤーや金属加工・鉄工の事業所が広く立地する、造船・重工業の県です。半島・離島が多い地形のもと、大型構造物の建造・艤装・修繕を担う特別高圧・高圧の大口需要家は臨海部の受電点に集中しています。本ページは特定の電力会社・契約形態を推奨するものではありませんが、こうした造船・舶用機械の事業所群の集積構造を前提に、九州電力エリア固有の論点を整理します（出典: 長崎県統計・経産省工業統計から整理）。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "長崎県は九州電力エリアに属し、小売は九州電力（九州電力本体が法人小売を担う）、送配電は九州電力送配電が担います。九州エリアは原子力4基（玄海3・4号機、川内1・2号機）が稼働し、加えて太陽光の導入が大規模に進んでおり、晴天日中には出力制御が実施されるほど再エネ比率が高いのが特徴です。この電源構成により燃料費調整額の感応度は相対的に低めとされます。長崎は半島・離島が多く系統の端に位置する地域もあり、造船・重工の大口需要家は臨海部の受電点に集中しています。玄海原発は県境（佐賀側）に近い立地で、JEPX九州エリア価格は晴天日中に太陽光で低下する局面があります（出典: 九州電力送配電 供給・系統情報／エネ庁から整理）。",
  },
];
...
const utilitiesList = [
  {
    ...
    role: "一般小売事業者（旧一電）",
    detail:
      "長崎県内最大シェア。長崎・佐世保の特別高圧・高圧の造船・舶用機械・重機械の長期需要家を多数抱えます。法人向けの特別高圧・高圧メニューが整備され、固定単価型・燃料費調整連動型ともに用意されています。九州は原子力4基稼働＋太陽光導入が大規模で、燃料費調整額の感応度は相対的に低めとされ、造船所の単価安定にはプラス材料です。長期安定供給と災害復旧体制の優位性から大手取引は維持基調ですが、本記載は事実関係の整理を目的としたものです（出典: 九州電力 法人向け料金プランから整理）。",
  },
  {
  ...
  },
  {
    ...
    role: "再エネ特化型／PPA",
    detail:
      "造船・舶用機械はグローバル供給網や海運の脱炭素要請に組み込まれることが多く、Scope2/Scope3対応の再エネ調達ニーズが高まっています。造船所は広い屋根面積・ヤードを持つため、屋根オンサイトPPA（自家消費）、オフサイトPPA（県内・九州圏の太陽光案件）、コーポレートPPAの引合いが拡大傾向です。九州は太陽光導入が大規模で再エネ調達の選択肢が比較的広い一方、出力制御による発電機会損失も論点となります。導入可否は屋根面積・契約期間・系統条件で変わり、画一的な調達形態を勧める趣旨ではありません。",
  },
  {
  ...
  },
  {
    ...
    role: "市場参照",
    detail:
      "JEPX九州エリアのスポット価格は、原子力4基稼働＋太陽光の大規模導入という供給構造を背景に、晴天日中には太陽光で価格が低下する局面が見られる一方、太陽光の出力が落ちる夕方・夜間には上昇するなど時間帯による振れが特徴的です。出力制御が実施されるほど再エネ比率が高いことはエリアの限界費用の低位安定に寄与し得ますが、全国的な需給逼迫時にはエリア間連系を通じて価格が上昇することもあり、市場連動型契約では変動リスクが残ります。2022〜2023年には市場連動採用の工場でも単価上昇を経験し、現在は固定回帰の動きが見られます。出典: 新電力ネット（https://pps-net.org/unit）を加工して整理。本記載は市場動向の整理を目的としたものです。",
  },
];
...
const priceBenchmark = [
  {
    ...
    detail:
      "大型造船所・重機械工場（2,000kW超）の特別高圧電力量料金は、標準メニューで概ね13〜17円/kWh＋調整項目とされます。九州は原子力4基稼働＋太陽光導入が大規模で、燃料費調整額の感応度が相対的に低めとされるため、燃料高騰局面でも単価の上ぶれが抑えられやすいのが特徴です。燃料費調整額と再エネ賦課金（2026年度4.18円/kWh・確定）を加算した実質単価は特別高圧で19〜24円/kWhレンジ（九州の低燃調を反映）が目安です。数値は目安であり、実際の単価は契約条件・新電力選定で変動します（出典: 業界団体・エネ庁統計から整理）。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "九州電力エリアは原子力4基（玄海3・4号機、川内1・2号機）が稼働し、加えて太陽光の導入が大規模であるため、為替（円安）や燃料スポット価格の変動に対する燃料費調整額の感応度が相対的に低めとされるのがエリア固有の特徴です。2022〜2023年の全国的な燃料高騰局面でも、原子力・再エネ比率の高さが緩衝材となり、火力依存度の高いエリアに比べて燃調の拡大が抑えられやすい傾向がありました。この低い燃調感応度は造船所の単価安定にプラスですが、当面も固定vs市場連動の選択は使用パターン次第で判断する必要があります（出典: 九州電力 単価実績・エネ庁エネルギー白書から整理）。",
  },
  {
    label: "再エネ賦課金の累積負担",
    detail:
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "九州電力エリアは原子力4基稼働＋太陽光導入が大規模であるため、燃料費調整額の感応度が相対的に低めとされるのがエリア固有の特徴です。これは燃料高騰局面でも単価の上ぶれが抑えられやすい点でプラスで、造船所の単価安定に寄与します。一方、低い燃調感応度のもとでも溶接・クレーンのデマンドピークによる基本料金の影響は残るため、長崎の造船・重工業では燃調安定を前提に、契約電力最適化と固定vs市場連動の選択を検討するのが実務的です。どちらが適するかは使用パターン次第で一概には言えません。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "再エネ賦課金は2026年度4.18円/kWh（確定）で、年々の制度動向を経営計画に織り込む必要があります。加えて造船・舶用機械は海運の脱炭素やグローバル供給網からScope3 GHG排出削減要請が強まり、造船所・舶用機械の事業者でも再エネ電源調達（PPA・非化石証書）が求められる場面が増えています。九州は太陽光導入が大規模で再エネ調達の選択肢が比較的広い点が特徴ですが、調達形態の要否は供給網の要請次第です。本記載は特定の調達形態を推奨するものではありません。",
  },
];
...
const industryProfile = [
  ...
  },
  {
    ...
    detail:
      "長崎の造船・重工業は、長崎・佐世保の二大拠点を核に、諫早・大村・西海方面の造船関連サプライヤー・鉄工・金属加工が裾野を支えるサプライチェーン構造の上に成り立っています。設計・加工・建造・艤装・修繕・物流までの裾野が県内で広がり、造船・舶用機械の集積を支えるエコシステムが形成されています。これらの事業所群は、九州電力エリアの原子力4基稼働＋太陽光の大規模導入という電源構成のもとで電力を調達しています。",
  },
];
...
const switchingReality = [
  ...
  },
  {
    ...
    detail:
      "海運・造船サプライチェーンのCN要請と歩調を合わせ、屋根オンサイトPPA（自家消費）／オフサイトPPA（県内・九州圏の太陽光案件）／コーポレートPPAが検討材料になります。九州は太陽光導入が大規模で追加性のある調達を比較的検討しやすい環境ですが、出力制御による発電機会損失も論点です。導入可否は屋根面積・ヤード・契約期間・系統条件で変わり、自社の屋根条件と調達目標に応じた検討が前提です。",
  },
];
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "屋根面積・ヤードを確保できる造船所・重機械工場では現実的な選択肢になり得ます。初期投資ゼロでPPA事業者が設備を所有し、自社は一定期間の電力購入契約を結ぶ形が標準で、再エネ調達と電気代単価下げの両立が期待できます。九州は太陽光導入が大規模で追加性のある調達を比較的検討しやすい環境ですが、出力制御による発電機会損失も論点となります。導入可否は屋根面積・ヤード・契約期間・系統条件・建屋構造で変わるため、複数事業者の試算比較が前提となります。本回答は一般的な整理であり、個別案件の成立を保証するものではありません。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <div className="mt-4 rounded-lg border border-sky-300 bg-white p-4">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-7 text-slate-700">
              ...
              <li>九州電力エリアの単価水準と燃調感応度（相対的に低め・原子力4基＋太陽光の大規模導入）</li>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              長崎県内の造船・重工業は、九州電力に加えて全国系新電力・地域系新電力・再エネ特化型・PPA事業者と多様なプレイヤーが供給対象としています。九州は原子力4基稼働＋太陽光導入が大規模で燃調感応度が相対的に低めという特性のもと、固定の単価安定が活きやすい局面が増えています。なお本セクションは各プレイヤーの位置づけを中立的に整理したものです。
            </p>
            <div className="mt-4 space-y-3">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              特別高圧・高圧の単価レンジ、燃料費調整額の感応度（九州は相対的に低め）、再エネ賦課金の累積負担を、造船・重工業の代表的な契約タイプ別に整理します。九州固有の原子力4基稼働＋太陽光の大規模導入・燃調相対的に低めの特性を踏まえつつ、溶接・クレーンのデマンドピーク対策を組合せた契約戦略が経営判断の中心となります。
            </p>
            <div className="mt-4 space-y-3">

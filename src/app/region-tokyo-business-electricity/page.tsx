...
const faqItems = [
  { question: "東京電力エリアの法人電気料金は他エリアと比べて高いですか？", answer: "高圧電力量料金の業界標準メニューベースで、東京電力エリアは全国10エリア中で中位（15〜16円/kWh前後）に位置します。北海道・沖縄・四国・中国エリアより安く、関西・九州・北陸エリアより高い水準です。ただしLNG火力依存のため燃調費プラス幅は大きめで、燃料価格高騰局面では実質単価が上振れしやすい特徴があります。" },
  ...
  { question: "東京エリアで法人向けに有利な新電力はどう選びますか？", answer: "競争が活発なエリアのため100社超の選択肢がある一方、2022〜2023年の撤退・解約通知ラッシュも起きたエリアです。選定時は『提示単価の安さ』だけでなく『財務安定性・調達手段の多様性・供給責任条項』を必ず確認してください。地場系・親会社の信用力が高い事業者を優先するのが、撤退リスクを抑える定石です。" },
...
const newPowerStatus = [
  {
    category: "参入状況",
    detail:
      "大規模な需要エリアであり、新電力の参入社数は多い。100社超が高圧向けプランを展開（2024年時点）。競争が最も活発なエリア。",
  },
  {
    category: "撤退・解除状況",
    detail:
    ...
    <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
      ...
      <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
        ...
        <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
          東京電力エリア（関東9都県）は大規模な電力消費地域であり、新電力の競争が最も活発です。
      ...
      <section className="mt-6 rounded-xl border border-slate-200 bg-white p-5">
        ...
        <p className="mt-2 text-sm leading-7 text-slate-600">
          東京電力エリアの規模感・事業者構成を確認したうえで、関東圏業務集積と LNG 火力依存という二つの構造から、なぜいま見直しが他エリアより重要なのかを整理します。大規模な業務需要集積地であり、LNG火力55%超の電源構成は燃料価格の上振れリスクを直接的に法人請求に反映する構造です。
        </p>
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <div className="rounded-xl border border-sky-100 bg-sky-50 p-4">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700">
              東京電力エリアは大規模な LNG（液化天然ガス）火力発電を保有しており、電源構成の約50〜55%を占めます。
          ...
          <div className="rounded-xl border border-sky-100 bg-sky-50 p-4">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700">
              ...
              大きいエリアです。需要集中は送配電インフラへの設備投資を必要とし、
          ...
          <div className="rounded-xl border border-sky-100 bg-sky-50 p-4">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700">
              ...
              ただし撤退リスクも多くの事例が発生しており、契約先の財務安定性の確認が重要です。
            </p>
          </div>
          <div className="rounded-xl border border-sky-100 bg-sky-50 p-4">
      ...
      <section className="mt-6 rounded-xl border border-sky-200 bg-sky-50 p-5">
        ...
        <div className="mt-5 rounded-lg border border-slate-200 bg-white p-4">
          ...
          <ol className="mt-2 list-decimal list-inside space-y-1 text-xs leading-6 text-slate-700">
            ...
            <li>最低 3 社以上の新電力から相見積もり（競争が活発なエリアの優位を活用）</li>
            <li>契約先の財務安定性確認（2022〜2023 年撤退が相次いだエリアのため必須）</li>

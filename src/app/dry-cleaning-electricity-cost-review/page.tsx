...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "全国クリーニング生活衛生同業組合連合会・経産省生活衛生関係営業統計によれば、クリーニング業の電気料金は売上高の5〜12%（工場併設店舗では高水準）。事業原価に占める比率は8〜18%。大型乾燥機・ボイラー・プレス機の連続稼働が業種固有のコスト構造を形成。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。年間200万kWh使用の中規模工場で年836万円超の負担。大規模工場では負担額が請求総額の10〜15%に達する。",
  },
  {
...
const faqItems = [
  { question: "クリーニング業の電気代水準はどれくらいですか？", answer: "売上高比5〜12%（工場併設店舗では高水準）、事業原価比8〜18%が業界平均。中規模工場併設店（年商3億円級）で年1,400〜7,000万円、大規模クリーニング工場（年商10億円超）で年1.7〜7億円規模の電気代になります。" },
  ...
  { question: "クリーニング業の固定プランと市場連動プランどちらが向きますか？", answer: "大型乾燥機・ボイラー24h連続稼働、プレス機の稼働ピークがある業種では、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続企業で月最大200万円の追加負担事例あり。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。クリーニング業の中規模工場では負担額が請求総額の10〜15%に達します。
            </p>
            <div className="mt-4 space-y-3">
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-6 text-slate-600">
                  ...
                  <li>2026年度（4.18円/kWh）：年 836万円（+138万円）</li>
                </ul>
              </div>
            </div>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">

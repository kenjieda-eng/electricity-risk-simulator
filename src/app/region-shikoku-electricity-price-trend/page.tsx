...
const pageTitle =
  "四国エリアの法人電気料金 推移と単価水準｜JEPX低水準・伊方3号機・本四連系の構造（代表シナリオ）";
const pageDescription =
  "四国電力エリア（香川・徳島・愛媛・高知）の法人向け電気料金の推移と単価水準を、公的統計とJEPX実績の概括をもとに整理。小売の高圧単価は全国では割高グループでありながら、JEPX四国エリアプライスは低い水準（2026年6月で約7.88円/kWh・前年同月比マイナスは全国で四国のみ）という二面性、伊方3号機の稼働を含む電源構成、本四連系線での融通、製紙・造船・化学の産業構成、賦課金など全国共通の上昇要因を中立的に解説します。将来価格は断定しません。";
const pageUrl =
...
const jepxShikokuRef = [
  { label: "2026年6月", price: "7.88", note: "低い水準。前年同月比マイナスは全国で四国のみ。" },
...
const structuralFactors = [
  ...
  },
  {
    ...
    detail:
      "四国エリアは小規模需要に対し太陽光導入量が大きく、昼間の余剰で出力制御（再エネ抑制）が全国でも起きやすいエリアです。これがJEPX四国エリアプライスを低い水準に押し下げる一因で、市場連動プランの仕入れ指標に直結します。",
...
const checkList = [
  ...
  "小売の高圧単価は全国では割高グループでも、JEPX四国エリアプライスは低い水準という二面性を分けて理解しているか",
...
const faqItems = [
  ...
  {
    question: "JEPX四国エリアプライスが低い水準なのはなぜですか？",
    answer:
      "四国エリアは小規模需要に対して太陽光の導入量が大きく、晴天時の昼間に余剰が発生しやすい構造です。系統の受け入れ余力に限界があるため出力制御（再エネ抑制）が全国でも起きやすく、抑制発動時間帯のスポット価格が大きく下がることがあります。加えて伊方3号機のベースロードが供給力を底支えします。これらが重なり、JEPX四国エリアプライスは低い水準となりやすく、2026年6月は約7.88円/kWhでした。ただし需給逼迫時や燃料市況の変化で価格が振れることもあり、具体的な価格差は時期・時間帯で大きく変動します。本ページでは傾向・構造の説明にとどめ、将来の価格水準は断定しません。",
  },
  {
    ...
    <>
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-teal-200 bg-teal-50 p-6">
          ...
          <p className="mt-1 text-base font-medium text-teal-800">JEPX低水準・伊方3号機・本四連系の構造（代表シナリオ）</p>
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            四国電力エリア（香川・徳島・愛媛・高知の4県）の法人向け電気料金は、小売の高圧単価では全国の割高グループにありながら、
            JEPX（日本卸電力取引所）の四国エリアプライスは低い水準という「二面性」が特徴です。2026年6月のJEPX四国は約7.88円/kWhで、
        ...
        <div className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              ...
              小売の高圧単価では全国の割高グループにありながら、卸市場（JEPX）では低い水準という二面性を持つ点が特徴です。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              ...
              一方、<span className="font-semibold">JEPX（日本卸電力取引所）の四国エリアプライス</span>は低い水準で、伊方3号機のベースロードと太陽光の出力制御が卸価格を押し下げます。
              この「小売は割高グループ・卸は低い水準」という二面性が四国エリアの推移を読むうえでの要点です。これは統計上の相対位置の概括であり、エリア間の優劣を断定するものではありません。
            </p>
            <div className="mt-4 grid gap-3 md:grid-cols-3">
              ...
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                ...
                <p className="mt-1 text-sm text-slate-700">四国エリアプライスは低い水準。2026年6月は約7.88円/kWhで、前年同月比マイナスは全国で四国のみ。太陽光出力制御と原子力が押し下げ要因。</p>
              </div>
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="rounded-xl border border-teal-100 bg-teal-50 p-4">
                <h3 className="text-base font-semibold text-teal-900">太陽光出力制御とJEPX低水準</h3>
                <p className="mt-2 text-sm leading-7 text-slate-700">
                  四国エリアは小規模需要に対し太陽光の導入量が大きく、晴天時の昼間に余剰が発生しやすい構造です。系統の受け入れ余力に限界があるため出力制御（再エネ抑制）が全国でも起きやすく、
                  抑制発動時間帯のスポット価格が大きく下がることがあります。伊方3号機のベースロードと相まって、JEPX四国エリアプライスは低い水準となりやすく、2026年6月は約7.88円/kWhでした。
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            <h2 className="text-xl font-semibold text-slate-900">
              JEPX 四国エリアプライスの傾向（低い水準の構造）
            </h2>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              市場連動型プランを検討する場合、JEPX（日本卸電力取引所）の四国エリアプライスが仕入れコストの目安になります。
              四国エリアは伊方3号機のベースロードと太陽光の出力制御が重なり、エリアプライスは低い水準で推移する傾向があります。
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              これらは燃料価格や卸価格が落ち着いた局面でも実質単価の下支え要因として残るため、「卸市場は低い水準なのに請求は思ったほど安くならない」という体感の背景になります。
              四国のようにJEPX卸が低い水準のエリアでも、小売の実質単価では制度コストの比重が意識されやすい点に留意が必要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <ul className="mt-3 space-y-2 text-sm leading-7 text-slate-700">
              <li>・四国エリアは「小売の高圧単価は全国の割高グループ（概ね17円/kWh前後）」でありながら「JEPX四国エリアプライスは低い水準」という二面性を持つ。</li>
        ...
        <div className="mt-6">
          <ContentCta
            ...
            description="小売の割高グループとJEPX卸の低い水準という二面性、伊方3号機の稼働リスクを前提に、現行契約と候補プランを同条件で比較すると、次の打ち手を具体化しやすくなります。"
            links={[

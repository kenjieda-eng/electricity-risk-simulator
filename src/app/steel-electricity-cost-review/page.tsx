...
const industryBenchmark = [
  ...
  },
  {
    label: "製品単位あたりの電力使用量",
    detail:
      "電炉粗鋼1tで350〜500kWh、高炉粗鋼1tで50〜100kWh、特殊鋼1tで500〜800kWh、ステンレス1tで800〜1,500kWh。電炉メーカーが電力集約的で、鉄鋼業全体の電力消費の中核。",
  },
  {
    label: "工場規模別の年間使用量",
    detail:
...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。年間5億kWh使用の中規模電炉メーカーで年20.9億円の負担、5年で104.5億円。減免制度（年間1,000万kWh以上等）対象は必須。",
  },
  {
...
const faqItems = [
  ...
  { question: "自家消費型太陽光は鉄鋼工場で投資回収できますか？", answer: "工場敷地が広大、24h連続稼働の鉄鋼業は自家消費型太陽光との相性が良好です。20MWで年2,200〜2,600万kWh発電、年22〜26億円削減、投資回収6〜8年（補助金後4〜6年）が目安。100MW級でも検討余地。" },

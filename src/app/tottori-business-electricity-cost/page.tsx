...
const pageTitle =
  "鳥取県の法人電気料金ガイド｜中国電力エリア単価分析・砂丘観光・製紙電子部品・水産加工の契約最適化";
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、中国電力エリアの特別高圧電力単価は2024年度実績で約17〜20円/kWh（電力量料金ベース）。中国電力エリアは石炭火力への依存度が高いとされ、2024年12月の島根原発2号機再稼働は電源構成に関わる変化です。県内大型事業者（製紙・フェロアロイ・電子部品）にとっては、新電力の競争入札で1〜2円/kWhの優遇を引き出せれば年間1,000万円規模の差が出る。",
  },
  {
...
const costFactors = [
  {
    ...
    detail:
      "中国電力管内は石炭火力への依存度が高いとされます。石炭価格の国際市況変動（豪州・インドネシア炭）が燃料費調整額に直接影響し、2022〜2023年の石炭価格高騰時には鳥取県内事業者の電気代も大幅上昇した経緯がある。",
  },
  {
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇。年間6,000万kWh使用の製紙工場で年2.4億円規模の負担。減免制度（年間1,000万kWh以上・電気使用密度要件）の対象になる事業者は申請を要検討。",
  },
  {
    label: "境港水産加工の季節変動需要",
    detail:
...
const faqItems = [
  { question: "鳥取県の法人電気代水準は全国比どれくらいですか？", answer: "中国電力エリアは石炭火力への依存度が高いとされます。2024年12月の島根原発2号機再稼働は電源構成に関わる変化ですが、今後の単価水準は断定できません。新電力競争で1〜2円/kWh安いケース多数。米子・境港の中規模工業は新電力切替で年間1〜3億円規模のコスト削減事例も。" },

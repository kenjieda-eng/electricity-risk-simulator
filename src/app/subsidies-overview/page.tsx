...
const subsidyList = [
  {
    ...
    target: "高効率空調・照明・ボイラー・変圧器など設備更新",
    rate: "中小1/2、大企業1/3（上限あり）",
    limit: "最大15億円程度",
    timing: "2026年4月〜6月（1次）、8月〜10月（2次）予定",
    slug: "subsidy-sii-energy-saving",
  },
  {
    name: "需要家主導型太陽光発電導入支援事業（オフサイトPPA）",
    agency: "環境省",
    target: "オフサイトPPA・コーポレートPPAを活用した再エネ調達",
    rate: "初期費用の一部（概ね1/3〜1/2が目安）",
    limit: "案件規模による",
    timing: "2026年度公募：要確認",
  ...
  },
  {
    ...
    agency: "環境省",
    target: "SBT取得・GHG削減計画策定・省エネ設備導入",
    rate: "削減計画策定費用等の一部補助",
    limit: "事業規模・区分による",
    timing: "2026年度：要確認",
  ...
  },
  {
    ...
    agency: "各都道府県・市区町村",
    target: "太陽光・蓄電池・省エネ設備（自治体ごとに異なる）",
    rate: "自治体により異なる（10〜50%程度）",
    limit: "自治体ごとに設定",
    timing: "随時〜年1回（自治体による）",

...
const faqItems = [
  ...
  { question: "北海道で固定プランと市場連動プランのどちらが向きますか？", answer: "冬季ピーク時のスポット価格高騰リスクを考えると、24時間稼働の事業所・冬季暖房負荷の大きい業種は固定プランが圧倒的に向きます。市場連動プランは、夏季のみ稼働・週末停止可能な事業所など限定的なケースのみ検討対象です。2022〜2023年の市場高騰で道内事業者の多くが固定プラン回帰しました。" },

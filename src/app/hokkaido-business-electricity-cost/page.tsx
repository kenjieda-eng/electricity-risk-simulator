...
const faqItems = [
  { question: "北海道の法人電気代水準は全国比どれくらい高いですか？", answer: "高圧電力（業務用）の実質単価で全国平均より2〜4円/kWh高い水準です。寒冷地暖房需要・石炭火力依存・離島供給コストの按分が主要因。中規模事業所（年間100万kWh）で年200〜400万円、大規模工場（年間1,000万kWh）で年2,000〜4,000万円の差が生じます。" },

...
const faqItems = [
  ...
  { question: "北海道電力（ほくでん）の燃料費調整額の特徴は？", answer: "電源構成で石炭・LNG火力が60%超を占めるため、燃料費調整額の上振れ幅が他エリアより大きいです。2022〜2023年は月最大+8円/kWh、2024〜2025年は+3.5〜+5.0円/kWhレンジで推移。為替・原油価格次第で再度上振れリスクがあるため、上限付きプランへの切替を強く推奨します。" },

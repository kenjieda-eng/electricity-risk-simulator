 ...
 * 事後訂正あり得る・多くの事業者が検針期間ベースで報告（暦月ベースも可））。再エネ賦課金は経産省告示、JEPX は同取引所の公表データ。
 */
const MAR_2026_DATA = {
  year: 2026,
  month: 3,
...
const fuelAdjustmentMar = [
  ...
  { area: "九州電力", high: "1.06", extra: "1.05", note: "3月単価 1.06円/kWh（高圧）、原発比率が高い構成で低い水準" },
...
const industryImpactMar = [
  ...
  { industry: "データセンター", impact: "高", reason: "高ベースロードで補助縮小・終了の絶対額が大きい。3月のうちに容量拠出金4月開始の織り込みを完了" },
        ...
        <section className="mt-6 space-y-6">
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/fuel-cost-adjustment", title: "燃料費調整額の解説", description: "3月動向の理解に必須の基礎解説" },

...
const pageDescription =
  "2026年6月使用分の法人向け電気料金動向を、6/12認可の7〜9月電気・ガス料金支援、JEPXスポット6月平均15.10円/kWh（前年同月比約+39%）、主要10社の燃料費調整、梅雨・台風による気象の4観点で整理。4区分の実績単価は電力取引報の公表待ち（6月分＝9月中旬見込み）のため、確定値と定性整理を明確に分けて解説します。";
...
const reviewChecklist = [
  ...
  "4区分の6月実績単価は電力取引報の公表待ち（9月中旬見込み）である点を踏まえ、確定値が出たタイミングで予算前提を更新する",
];
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "2026年6月分の4区分実績単価は、本記事公開時点では未公表です。出典としている電力・ガス取引監視等委員会「電力取引報」は2026年5月分までが公表済みで、6月分は9月中旬の公表見込みです。このため本ページのカードは最新の確定分（2026年5月分）を表示し、6月の動向は燃料費調整・JEPX・気象・支援策から定性的に整理しています。確定値が公表され次第、順次更新します。",
  },
  {
...
const sourcesItems = [
  {
    ...
    description: "4区分の確定単価（販売額÷販売電力量・全国計、事後訂正あり得る。多くの事業者が検針期間ベースで報告・暦月ベースも可）。2026年5月分まで公表済み",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
            一方で、低圧・高圧・特別高圧の4区分の6月実績単価は、出典としている電力・ガス取引監視等委員会「電力取引報」が2026年5月分までしか公表していないため、本記事公開時点では確定していません。そこで本記事では、確定値（2026年5月分まで）と、6月の動向に関する定性整理を明確に分けて解説します。数値の断定は確定値に限り、公表待ちの項目は「公表待ち」と明記します。
          </p>
          <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
        ...
        <p className="mt-2 rounded-md bg-slate-50 px-3 py-2 text-xs leading-6 text-slate-500">
          ※上記カードは電力・ガス取引監視等委員会「電力取引報」の最新確定分（2026年5月分・確定）です（販売額÷販売電力量・全国計、事後訂正あり得る。多くの事業者が検針期間ベースで報告・暦月ベースも可）。
          2026年6月分以降は未公表（6月分＝9月中旬の公表見込み）。5月分まで確定値を反映済みです。確定値が公表され次第、順次更新します。
        </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
              同じ6月で過去の水準と比べると、現在の料金がどのあたりに位置するかを把握しやすくなります。2026年6月分は電力取引報の公表待ち（9月中旬見込み）のため、確定値が出るまでは2023〜2025年の6月分を参照します。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              低圧（電灯・電力）は、小規模事業所・店舗・サービス拠点で広く使われる契約区分です。2026年6月分の低圧の実績単価は電力取引報の公表待ち（9月中旬見込み）のため、ここでは断定を避け、確定値・燃料費調整・支援策から動向を定性的に整理します。参考として、電力取引報の最新確定分である2026年5月分は、低圧電灯27.85円/kWh・低圧電力34.42円/kWhでした（消費税・賦課金を含まない参考値）。
            </p>
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              高圧は、工場・商業施設・病院・学校・物流施設・オフィスビルで広く使われる主力契約区分です。2026年6月分の高圧の実績単価は電力取引報の公表待ちのため、ここでは動向を定性的に整理します。参考として、最新確定分の2026年5月分は高圧22.78円/kWhでした。今回7〜9月の電気・ガス料金支援に高圧が対象として含まれた点は、6月号の大きな論点です。
            </p>
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              特別高圧は、大規模工場・データセンター・大型商業施設・自治体の基幹施設・大規模病院など、非常に大きな電力需要を持つ事業者が中心です。2026年6月分の特別高圧の実績単価は電力取引報の公表待ちのため、ここでは動向を定性的に整理します。参考として、最新確定分の2026年5月分は特別高圧17.45円/kWhでした。
            </p>
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
          ...
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              2026年6月使用分の法人電気料金は、(1) 6月12日に認可された7〜9月使用分の電気・ガス料金支援（高圧も対象・8月分増額見込み）、(2) JEPXシステムプライスの月間平均15.10円/kWh・前年同月比約+39%と東西価格差、(3) 燃調本体は全社ほぼ横ばい〜小幅上昇の一方で市場価格調整込みでは会社差が大きい、という3点が重なる月でした。再エネ賦課金は4.18円/kWh（2026年度確定）で据え置きです。4区分の6月実績単価は電力取引報の公表待ち（9月中旬見込み）のため、本記事では確定値と定性整理を分けて解説しました。
            </p>
            ...
            <p className="mt-4 rounded-md bg-white px-3 py-2 text-xs leading-6 text-slate-500">
              ※本記事の数値は、電力・ガス取引監視等委員会「電力取引報」（4区分の確定値、2026年5月分まで公表済み）、JEPX（スポット取引結果CSVの全コマ単純平均）、主要電力10社の2026年4月28日プレス（6月分燃料費調整・燃調本体）、気象庁（2026年6月の気象）、経済産業省・資源エネルギー庁（7〜9月支援・夏季需給）に基づきます。2026年6月分以降の4区分実績単価は公表待ちで、公表され次第、順次更新します。本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          </section>

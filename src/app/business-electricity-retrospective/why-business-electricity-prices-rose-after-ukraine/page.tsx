...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "ja_JP",
    type: "article",
    images: [{ url: "/api/og/monthly-review", width: 1200, height: 630, alt: "法人電気料金上昇の連鎖" }],
  },
    ...
    <>
      ...
      <section className="mt-6 space-y-6">
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
            日本は年間約7,000万トンのLNGを輸入する大口の買い手ですが、そのうちスポット調達の比率は約10%です。残り約90%は長期契約でカバーされており、長期契約価格の多くは原油価格連動（JCC連動）で設定されています。この構造はスポット価格の急騰を直接受けにくい緩衝材となりましたが、原油価格自体も上昇していたため、3〜6か月のタイムラグを経て長期契約価格も上昇に転じ、燃料費調整額に反映される形で法人電気料金を押し上げました。
          </p>
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
            さらに、2023年6月には大手電力7社が規制料金の本格改定を実施し、基本料金・電力量料金の水準自体が引き上げられました。これにより、燃料価格が下がっても単価の下限が以前より高い水準に固定される構造が生まれています。再生可能エネルギー発電促進賦課金も年度ごとに変動しており、2022年度の3.45円/kWhから2023年度に1.40円/kWhへ下がった後、2024年度には3.49円/kWhへ再上昇するなど、制度面のコスト変動も法人の負担構造に影響を与え続けています。
          </p>
        </section>

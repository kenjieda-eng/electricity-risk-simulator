...
export const MONTHLY_RETROSPECTIVE_ITEMS: RetrospectiveCardItem[] = [
  {
    ...
    description:
      "JEPXスポット8月平均19.14円/kWh（前年同月比+59.7%）と8月26日夕方に6エリアで並んだ55.23円/kWh、3か月で最も厚い8月使用分の電気・ガス料金支援（低圧▲4.5円・高圧▲2.3円/kWh・特別高圧は対象外）、主要10社の燃料費調整（8月分・9月分／値引き前と支援反映後）、西日本中心の高温と東京の多雨（平年差▲0.2℃・月降水量286.0mm）を整理。4区分の8月実績単価は電力取引報の公表待ちのため、確定値と定性整理を分けて解説します。",
    href: "/business-electricity-retrospective/2026-08",
    ctaLabel: "記事を読む",
  },
  {
    title: "【2026年7月】法人の電気料金はどう動いた？猛暑でJEPX前年比+40.5%・電気ガス料金支援の初適用・燃調は上昇局面へ",
    description:
      "平年を大きく上回る猛暑を背景にJEPXスポット7月平均17.91円/kWh（前年同月比+40.5%）と夕方の58円台スパイク、7月使用分から始まった電気・ガス料金支援（低圧▲3.5円・高圧▲1.8円/kWh・特別高圧は対象外）、主要10社の燃料費調整（7月分・8月分／値引き前と支援反映後）、東京の猛暑日9日と7/22の自家発焚き増し依頼を整理。4区分の7月実績単価は電力取引報の公表待ちのため、確定値と定性整理を分けて解説します。",
    href: "/business-electricity-retrospective/2026-07",
    ctaLabel: "記事を読む",
  },
  {

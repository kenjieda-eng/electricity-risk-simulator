...
const fuelAdjustmentApr = [
  ...
  { area: "九州電力", high: "1.14", extra: "1.12", note: "4月単価 1.14円/kWh（高圧）、原発比率最大で低い水準" },
  { area: "沖縄電力", high: "3.72", extra: "3.65", note: "4月単価 3.72円/kWh（高圧）、島嶼系統で高い水準" },
];
...
const industryImpactApr = [
  { industry: "製造業（24時間操業）", impact: "高", reason: "連続稼働で容量拠出金本格化の絶対額が大きい。東電法人料金改定の電力量料金値上げで実質値上げになりやすい" },
  ...
  { industry: "データセンター", impact: "高", reason: "高ベースロードで容量拠出金の絶対額が大きい。年間数千万〜数億円規模の追加負担。再エネPPA併用の検討必須" },

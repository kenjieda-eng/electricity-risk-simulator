    ...
    <>
      ...
      <section className="mt-6 space-y-6">
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <p className="mt-3 text-xs text-slate-500">※水準は電力・ガス取引監視等委員会「電力取引報」から算出した確定単価（販売額÷販売電力量・全国計・事後訂正あり得る・多くの事業者が検針期間ベースで報告（暦月ベースも可））にもとづく目安です。2025年10月分の確定値は特別高圧 16.57 円/kWh・高圧 20.11 円/kWh・低圧電灯 26.16 円/kWh・低圧電力 29.29 円/kWh。実際の請求額は電力会社・契約条件により異なります。</p>
        </section>

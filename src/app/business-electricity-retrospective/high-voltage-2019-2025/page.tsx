  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
      ...
      <section className="mt-6 rounded-xl border border-slate-200 bg-white p-5">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
          2020年の年平均は14.7円/kWhで、2019年より約8.7%低下しました。特に年後半にかけて下がり、12月は
      ...
      <section className="mt-6 rounded-xl border border-slate-200 bg-white p-5">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
          2021年の年平均は14.3円/kWhで、2020年よりさらにやや低下しました。ただし、月別に見ると前半の
          12.9円～14.2円/kWhから、年末には15.6円/kWhまで上がっており、後半から上昇基調に転じています。
      ...
      <section className="mt-6 rounded-xl border border-slate-200 bg-white p-5">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
          2022年の年平均は20.6円/kWhで、前年比44.1%増という急上昇でした。1月の15.8円/kWhから12月には
          27.0円/kWhまで上がり、年間を通じて右肩上がりに近い動きです。最大の転機は、2022年2月24日のロシアに
      ...
      <section className="mt-6 rounded-xl border border-slate-200 bg-white p-5">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
          2023年の年平均は23.0円/kWhで、2022年よりさらに11.7%上昇しました。1月27.5円/kWh、2月24.7円/kWh、
          4月24.8円/kWhと非常に高い水準が続きます。政府の電気・ガス価格激変緩和対策により高圧向け値引きが入った
          年ですが、それでも年平均が高いのは、燃料高騰の影響が年初に強く残り、市場価格の高止まりが続いたためです。
        </p>
      </section>
      ...
      <section className="mt-6 rounded-xl border border-slate-200 bg-white p-5">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
          2024年の年平均は21.5円/kWhで、前年比6.5%低下しました。2023年より下がったものの、2019年の
      ...
      <section className="mt-6 rounded-xl border border-slate-200 bg-white p-5">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
          2025年の年平均は21.1円/kWhで、2024年からさらに1.9%低下しました。月別では年初22.2円/kWh前後から、

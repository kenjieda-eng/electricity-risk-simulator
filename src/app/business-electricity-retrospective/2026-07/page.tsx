 ...
 * 2026年6月分以降は未公表（6月分＝9月中旬、7月分＝10月頃の公表見込み）。
 */
...
const jepxAreaJul = [
  ...
  { area: "中部", jul2026: "18.84", jun2026: "17.92", jul2025: "13.83", yoy: "+5.01", mom: "+0.92", up: true },
  { area: "北陸", jul2026: "17.26", jun2026: "13.94", jul2025: "13.37", yoy: "+3.89", mom: "+3.32", up: true },
  { area: "関西", jul2026: "17.19", jun2026: "13.88", jul2025: "13.37", yoy: "+3.82", mom: "+3.31", up: true },
...
const fuelMarketIndicators = [
  ...
  { item: "LNG（6月貿易統計）", value: "576.7 米ドル/トン", meaning: "同上。液化天然ガスの輸入CIF価格" },
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "2026年7月分の4区分実績単価は、本記事公開時点では未公表です。出典としている電力・ガス取引監視等委員会「電力取引報」は2026年5月分までが公表済みで、6月分は9月中旬、7月分は10月頃の公表見込みです。このため本ページのカードは最新の確定分（2026年5月分）を表示し、7月の動向は燃料費調整・JEPX・気象・支援策から定性的に整理しています。参考として、過去の7月分は2023年7月が特別高圧20.73円/kWh・高圧21.69円/kWh・低圧電灯25.06円/kWh・低圧電力26.51円/kWh、2025年7月が同17.18・21.12・27.88・29.14円/kWhでした。確定値が公表され次第、順次更新します。",
  },
  {
...
const sourcesItems = [
  {
    ...
    description: "4区分の確定単価（販売額÷販売電力量・全国計、事後訂正あり得る。多くの事業者が検針期間ベースで報告・暦月ベースも可）。2026年5月分まで公表済み（6月分は9月中旬、7月分は10月頃の公表見込み）",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
            一方で、低圧・高圧・特別高圧の4区分の7月実績単価は、出典としている電力・ガス取引監視等委員会「電力取引報」が2026年5月分までしか公表していないため、本記事公開時点では確定していません。そこで本記事では、確定値（2026年5月分まで）と、7月の動向に関する定性整理を明確に分けて解説します。数値の断定は確定値に限り、公表待ちの項目は「公表待ち」と明記します。
          </p>
          <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
        ...
        <p className="mt-2 rounded-md bg-slate-50 px-3 py-2 text-xs leading-6 text-slate-500">
          ...
          2026年6月分以降は公表待ちです（6月分＝9月中旬、7月分＝10月頃の公表見込み）。確定値が公表され次第、順次更新します。
        </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              低圧（電灯・電力）は、小規模事業所・店舗・サービス拠点で広く使われる契約区分です。2026年7月分の低圧の実績単価は電力取引報の公表待ち（10月頃見込み）のため、ここでは断定を避け、確定値・燃料費調整・支援策から動向を定性的に整理します。参考として、電力取引報の最新確定分である2026年5月分は、低圧電灯27.85円/kWh・低圧電力34.42円/kWhでした（消費税・賦課金を含まない参考値）。
            </p>
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              高圧は、工場・商業施設・病院・学校・物流施設・オフィスビルで広く使われる主力契約区分です。2026年7月分の高圧の実績単価は電力取引報の公表待ちのため、ここでは動向を定性的に整理します。参考として、最新確定分の2026年5月分は高圧22.78円/kWhでした。7月の高圧は、支援の値引き（▲1.8円/kWh・7月使用分）と、燃料費調整の上昇という2つの力が反対方向に働いた月です。
            </p>
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              特別高圧は、大規模工場・データセンター・大型商業施設・自治体の基幹施設・大規模病院など、非常に大きな電力需要を持つ事業者が中心です。2026年7月分の特別高圧の実績単価は電力取引報の公表待ちのため、ここでは動向を定性的に整理します。参考として、最新確定分の2026年5月分は特別高圧17.45円/kWhでした。
            </p>
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              8月分の燃料費調整に反映されているのは2026年3〜5月の実績（原油86.7米ドル/バレル・為替158円/米ドル）で、これが10社中9社の上昇の背景にあります。一方、直近の6月貿易統計では原油117.2米ドル/バレル・LNG576.7米ドル/トン・石炭145.3米ドル/トン、為替159.7円/米ドルとなっており、この水準が反映されるのは秋以降の単価です。参考として、アジアのLNGスポット指標であるJKMは7月下旬に21〜22米ドル/百万BTU台で推移したと報じられています（報道ベースの二次情報のため参考扱いです）。
            </p>
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
          ...
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-4 rounded-md bg-white px-3 py-2 text-xs leading-6 text-slate-500">
              ※本記事の数値は、電力・ガス取引監視等委員会「電力取引報」（4区分の確定値、2026年5月分まで公表済み）、JEPX（スポット取引結果CSVの全1,488コマ単純平均）、主要電力10社の2026年5月28日・6月26日・7月30日プレス（7月分・8月分の燃料費調整）、気象庁の観測値（2026年7月）、電力広域的運営推進機関（OCCTO）、経済産業省・資源エネルギー庁（電気・ガス料金支援）、財務省貿易統計（2026年6月）に基づきます。2026年6月分以降の4区分実績単価は公表待ちで、公表され次第、順次更新します。本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。また、今後の価格水準を予測するものでもありません。
            </p>
          </section>

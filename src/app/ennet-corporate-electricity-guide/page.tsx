...
const pageTitle =
  "エネット（ENNET）法人向けプランガイド｜法人特化の新電力大手・特高/高圧対応とエネマネ支援・相見積活用";
const pageDescription =
  "エネット（ENNET）の法人向け電力サービスを、公開情報に基づき中立的に整理。法人需要家に特化した新電力大手の一つとしての事業特性、特別高圧・高圧の契約メニュー体系、エネルギーマネジメント支援、燃料費調整額の連動条件、全国対応、契約手続き・相見積活用のポイントを、第三者・社団法人視点で契約者の判断材料としてまとめます。特定企業の優劣評価は行いません。";
...
const overview = [
  {
    ...
    detail:
      "株式会社エネットは、電力小売自由化の黎明期から法人需要家向けに電力供給を行ってきた新電力（特定規模電気事業者を起源とする小売電気事業者）で、公開情報では新電力の中でも規模・実績のある事業者の一つとされています。NTTグループ（NTTアノードエナジー）や都市ガス事業者の出資による設立経緯が公開情報で示されており、法人・自治体の高圧・特別高圧需要家を主な対象としてきたことが特徴として語られます。本ページは特定企業の優劣を評価するものではなく、公開情報に基づき法人契約者が自社条件に照らして判断するための材料を中立的に整理するものです（出典: エネット公式サイト・会社情報／参照日2026年6月時点）。一般社団法人エネルギー情報センターは、特定企業を推奨も否定もしない中立的立場で判断材料を整理します。",
  },
  {
...
const faqItems = [
  {
    ...
    answer:
      "株式会社エネットは、電力小売自由化の黎明期から法人需要家向けに電力供給を行ってきた新電力で、公開情報では新電力の中でも規模・実績のある事業者の一つとされています。NTTグループや都市ガス事業者の出資による設立経緯が公開情報で示されており、法人・自治体の高圧・特別高圧需要家を主な対象としてきたことが特徴です。本ページは特定企業の優劣評価ではなく、公開情報に基づき法人契約者の判断材料を中立的に整理するものです（出典: エネット公式サイト・会社情報）。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            エネット（ENNET）の法人向け電力サービスを、公開情報に基づき中立的に整理します。法人需要家に特化した新電力大手の一つとしての事業特性、特別高圧・高圧の契約メニュー体系、エネルギーマネジメント支援、燃料費調整額の連動条件、全国対応、契約手続き・相見積活用のポイントを、第三者・社団法人視点で契約者の判断材料としてまとめます。特定企業の優劣を評価するものではありません。
          </p>

...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・全国水産加工業協同組合連合会の統計によれば、水産加工業の電気料金は売上高の7〜13%（冷凍水産加工は高水準）。製造原価に占める比率は12〜22%。冷凍冷蔵設備で電力依存度が高い。",
  },
  {
...
const faqItems = [
  { question: "水産加工業の電気代水準はどれくらいですか？", answer: "売上高比7〜13%（冷凍水産加工は高水準）、製造原価比12〜22%が業界平均。中規模水産加工メーカー（年商200億円級）で年3〜7.5億円、大規模水産加工工場（年商500億円超）で年7.5〜30億円規模の電気代になります。" },
  ...
  { question: "水産加工業の固定プランと市場連動プランどちらが向きますか？", answer: "24h冷凍倉庫稼働でベースロードが大きく、漁期集中時の電力ピークも大きいため、固定プランが向きます。漁期外でも冷凍倉庫を停止できないため逃げ場がなく、市場高騰時のリスクが極めて大きいです。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。水産加工業の中規模工場では負担額が請求総額の10〜15%に達します。
            </p>
            <div className="mt-4 space-y-3">
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">

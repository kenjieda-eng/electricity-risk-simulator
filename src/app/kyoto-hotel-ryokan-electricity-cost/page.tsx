...
const electricSituation = [
  {
    ...
    detail:
      "京都府は観光都市として、2024〜2025年にかけてインバウンド観光客数が過去最高水準に回復。府内宿泊施設は約3,000〜3,500軒、客室数約5万〜6万室規模で、祇園・東山・嵐山の老舗旅館、四条河原町・京都駅周辺のシティホテル、宇治・伏見・大原野の観光ホテルまで多様な業態が共存します（出典: 京都府観光統計・観光庁宿泊旅行統計調査）。インバウンド客の長期滞在・高単価化に伴い、稼働率と客室単価の上昇が継続しています。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "関西電力エリアの電源構成は原子力（高浜・大飯・美浜の3基稼働中）＋LNG火力＋大規模太陽光で多様化。原子力寄与で燃調感応度が相対的に低いとされます。京都の宿泊業は通年稼働・通年空調の業種特性から、燃調安定性の優位性を享受しやすい立地と言えます（出典: 関西電力供給計画／エネ庁エネルギー基本計画）。",
  },
];
...
const priceBenchmark = [
  {
    ...
    detail:
      "京都市内のシティホテル・大型旅館（高圧500kW〜2,000kW級）の電力量料金は標準メニューで概ね17〜21円/kWh+調整項目。燃料費調整額（2024〜2025年で+1.5〜+3.5円/kWh目安・原子力比率が高く変動幅は相対的に小さいとされる）と再エネ賦課金（2025年度3.98円/kWh）を加算した実質単価は23〜28円/kWhレンジ。新電力競争入札では標準比1〜3円/kWh下げが目安で、年間使用量200〜500万kWh級のホテルでは年間数百万円規模のインパクトです。",
  },
  {
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              京都府は観光都市として、祇園・東山・嵐山の老舗旅館、四条河原町・京都駅周辺のシティホテル、宇治・伏見・大原の観光ホテルまで多様な宿泊業態が共存しています。インバウンド需要の復活と燃調高騰の両方を受け、電気代管理の経営重要度が高まる業種です。
            </p>

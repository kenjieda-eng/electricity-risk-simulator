...
const pageTitle =
  "電気代の1kWhあたり単価とは｜法人の契約区分別・確定単価と自社単価の出し方（2026年4月分・確定）";
const pageDescription =
  "「1kWhあたりの電気代はいくらか」を法人・事業者向けに整理します。電力・ガス取引監視等委員会「電力取引報」から算出した2026年4月分（確定・最新公表）の全国計単価は、特別高圧17.56円/kWh・高圧21.37円/kWh・低圧電灯25.94円/kWh・低圧電力32.12円/kWhです。1kWhという単位の意味（kWとkWhの違い）、自社の1kWh単価を請求書から出す2通りの方法、単価を構成する要素（電力量料金・燃料費調整・再エネ賦課金4.18円/kWh・容量拠出金の転嫁）、単価が同じでも請求額が変わる理由（デマンド・力率・時間帯）まで、計算の考え方に絞って解説します。数値は2026年度時点の整理です。";
...
const unitBasics = [
  ...
  },
  {
    ...
    detail:
      "検索では「1kW 電気代」という問いも多く見られますが、1kWは瞬間の電力であり、それ単体では金額になりません。1kWの機器を1時間使えば1kWh、8時間使えば8kWhとなり、そこに1kWhあたりの単価を掛けて金額が出ます。仮に単価を高圧の21.37円/kWhとすれば、1kWの機器を8時間使ったときの電力量料金の目安は21.37円×8＝171.0円程度という計算になります（検算：21.37×8＝170.96）。この「時間を掛ける」という一手間を挟むことが、kWとkWhを取り違えないための実務的なコツです。実際の請求額には基本料金や各種調整額も加わるため、この計算はあくまで電力量料金部分の目安です。",
  },
  {
...
const currentUnitPrices = [
  {
    name: "特別高圧: 17.56円/kWh",
    role: "大規模工場・データセンター・大型商業施設など",
    detail:
      "特別高圧は、非常に大きな電力需要を持つ事業者が用いる契約区分で、2026年4月分（確定）の全国計単価は17.56円/kWhです。4区分のなかで最も低い水準で、これは大口需要家ほど1kWhあたりの単価が下がる構造を反映しています。ただし、特別高圧は受電設備の規模・保安体制・契約手続きの負担が大きく、単価が低いというだけで選べる区分ではありません。自社がどの区分に該当するかは需要規模で決まるため、区分そのものを比較して選ぶ性質のものではない点に注意してください。数値は電力取引報から算出した参考値で、実際の請求額は電力会社・契約条件により異なります。",
  },
  {
    name: "高圧: 21.37円/kWh",
    role: "工場・商業施設・病院・学校・物流施設・オフィスビルなど",
    detail:
      "高圧は法人でもっとも広く使われる主力の契約区分で、2026年4月分（確定）の全国計単価は21.37円/kWhです。工場・商業施設・病院・学校・物流施設・オフィスビルなど、事業用途の多くがこの区分に該当します。「法人の1kWhあたりの電気代はいくらか」という問いに対して、まず基準にすべきなのがこの水準です。特別高圧の17.56円/kWhとの差は3.81円/kWh（検算：21.37－17.56＝3.81）で、需要規模による単価差の大きさが読み取れます。ただし全国計の平均であるため、エリア・電力会社・契約条件によって実際の単価は上下します。",
  },
  {
    name: "低圧電灯: 25.94円/kWh",
    role: "小規模事業所・店舗・事務所（照明・コンセント中心の契約）",
    detail:
      "低圧電灯は、小規模な事業所・店舗・事務所などで用いられる契約区分で、2026年4月分（確定）の全国計単価は25.94円/kWhです。この区分は家庭の電灯契約と同じ枠組みで集計されているため、「家庭の電気代の単価」に近い水準として読むこともできます。高圧の21.37円/kWhと比べると4.57円/kWh高い水準です（検算：25.94－21.37＝4.57）。規模が小さいほど1kWhあたりの単価が高くなる傾向が、この数字に表れています。低圧から高圧への切り替えは受電設備の設置が前提になるため、単価差だけで判断できるものではありません。",
  },
  {
    name: "低圧電力: 32.12円/kWh",
    role: "動力設備を持つ小規模事業所（業務用エアコン・厨房機器・小型機械など）",
    detail:
      "低圧電力は、業務用エアコン・厨房機器・小型の生産設備など動力を使う小規模事業所向けの契約区分で、2026年4月分（確定）の全国計単価は32.12円/kWhと4区分でもっとも高い水準です。高圧の21.37円/kWhとの差は10.75円/kWh（検算：32.12－21.37＝10.75）で、同じ電力量を使っても契約区分によって金額が大きく変わることが分かります。動力設備を持つ小規模事業所で電気代の負担感が大きいのは、この単価水準が背景にあります。ただし、区分の変更には受電設備・工事・契約手続きが伴うため、単価差がそのまま削減額になるわけではありません。",
  },
  {
    name: "4区分の関係: 需要規模が大きいほど1kWhあたりは下がる",
    role: "単価表の読み方／全国計・検針期間ベースの参考値",
    detail:
      "4つの区分を並べると、特別高圧17.56円/kWh＜高圧21.37円/kWh＜低圧電灯25.94円/kWh＜低圧電力32.12円/kWhという順になり、需要規模が大きい区分ほど1kWhあたりの単価が低いという関係が読み取れます。最も低い特別高圧と最も高い低圧電力の差は14.56円/kWh（検算：32.12－17.56＝14.56）で、同じ1kWhでも区分によって倍近い開きがあります。これは、送配電の経路が短いほど損失やコストが小さいこと、大口ほど設備を効率的に使えることなどが背景にあります。自社の単価がこの水準と大きく離れている場合、契約区分・契約条件・使い方のいずれかに理由があると考えられます。",
  },
  {
    name: "この単価はいつ時点の、どういう性質の数字か",
    role: "データの基準／2026年4月分が確定・最新公表",
    detail:
      "本ページで示す4区分の単価は、電力・ガス取引監視等委員会「電力取引報」から算出した確定単価で、販売額÷販売電力量・全国計・検針期間ベースの数値です。2026年4月分が確定・最新公表で、5月分以降は未公表です（2026年8月中旬の公表見込み）。したがって「今この瞬間の単価」ではなく、直近で確定した月の全国平均という性質の数字です。また、消費税・再エネ賦課金を含まない参考値であり、事後に訂正される可能性もあります。自社の単価と比較する際は、この基準の違いを踏まえてください。月次の推移は法人電気料金の振り返りシリーズで継続的に整理しています。",
  },
];
...
const householdVsCorporate = [
  {
    ...
    detail:
      "家庭で使われるのは電灯契約で、事業所でも小規模なものは同じ低圧電灯の枠に入ります。電力取引報でも低圧電灯は家庭を含む電灯契約として集計されており、その全国計は2026年4月分（確定）で25.94円/kWhです。一方、法人で主流の高圧は21.37円/kWhで、両者には4.57円/kWhの差があります（検算：25.94－21.37＝4.57）。つまり「家庭と法人で単価が違う」という現象の大部分は、企業努力の差ではなく契約区分の違いによる構造的なものです。自社が低圧電灯であれば、家庭向けの単価感覚に近い水準になるのは自然なことといえます。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "本ページは法人・事業者を対象に、事業所の電気代を分解して考えるための整理です。ただし「1kWhあたりいくらか」という問いは家庭でも共通のため、家庭に近い水準として低圧電灯25.94円/kWhを併記しています。家庭向けの節電や料金プラン選びを目的とされている場合、本ページで扱う契約電力・力率・負荷率といった論点は当てはまらない部分が多くなります。その場合は、ご契約中の電力会社が公表する家庭向けの料金表をご確認いただくのが確実です。本サイトのシミュレーターや相談導線は法人・事業者向けの内容です。",
  },
];
...
const howToCalculate = [
  {
    ...
    detail:
      "もっとも実感に近いのは、月の請求総額を同じ月の使用電力量（kWh）で割る方法です。この値は基本料金・電力量料金・燃料費調整額・再エネ賦課金などをすべて含んだうえでの1kWhあたりのコストになり、「結局いくらで電気を買っているのか」を表します。たとえば月の請求額が213,700円で使用量が10,000kWhなら、実質単価は21.37円/kWhという計算です（検算：213,700÷10,000＝21.37）。この方法の利点は、料金メニューの構造が違う会社どうしでも同じ土俵で比較できることです。一方、基本料金が含まれるため、使用量が少ない月ほど実質単価は高く出ます。月ごとの変動を見るときはこの性質を踏まえてください。",
  },
  {
...
const priceComponents = [
  ...
  },
  {
    ...
    detail:
      "再エネ賦課金は、再生可能エネルギーの導入を支えるために電気の使用量に応じて全需要家が負担する仕組みで、2026年度は4.18円/kWhです。使用量に比例して加算されるため、使用量が多い事業所ほど負担の絶対額が大きくなります。本ページで示す4区分の単価は消費税・再エネ賦課金を含まない参考値であるため、賦課金は別途上乗せして考える必要があります。たとえば高圧の21.37円/kWhに賦課金を加えると25.55円/kWh相当という計算になります（検算：21.37＋4.18＝25.55）。賦課金は事業者側で選べる項目ではないため、負担を減らすには使用量そのものを減らすか自家消費を増やすかになります。詳細は再エネ賦課金の解説のページをご覧ください。",
  },
  {
...
const sameUnitDifferentBill = [
  ...
  },
  {
    ...
    detail:
      "電気料金は検針日から検針日までの期間で計算されるため、月によって対象日数が異なります。日数が多い月は使用量も基本料金の日割り計算も増えるため、単純に「先月と比べて増えた」と判断すると誤ることがあります。前年同月と比較する場合も、検針期間がずれていれば比較の前提が揃いません。本ページで示す4区分の単価も検針期間ベースの集計です。月次の比較を行う際は、日数を揃えるか1日あたりに換算するといった調整をすると、実態が見えやすくなります。",
  },
  {
...
const industryAndArea = [
  ...
  },
  {
    ...
    detail:
      "電力取引報の4区分確定単価は毎月公表されるため、水準は月ごとに変わります。本サイトでは、月次の確定単価とその背景を法人電気料金の振り返りシリーズで継続的に整理しています。本ページに掲載しているのは2026年4月分（確定・最新公表）で、5月分以降は未公表です（2026年8月中旬の公表見込み）。最新の水準を確認したい場合は同シリーズをご覧ください。単価の推移を追うことで、自社の増減が市況によるものか自社要因かを切り分けやすくなります。",
  },
];
...
const faqItems = [
  {
    ...
    answer:
      "法人の契約区分によって異なります。電力・ガス取引監視等委員会「電力取引報」から算出した2026年4月分（確定・最新公表）の全国計単価は、特別高圧17.56円/kWh、高圧21.37円/kWh、低圧電灯25.94円/kWh、低圧電力32.12円/kWhです。法人でもっとも広く使われる高圧を基準にすると21.37円/kWhが目安になります。これらは販売額÷販売電力量・全国計・検針期間ベースの参考値で、消費税・再エネ賦課金を含みません。事後訂正の可能性もあります。エリア・電力会社・契約条件・使い方によって実際の単価は上下するため、自社の水準は請求書から算出して確認してください。",
  },
  {
    question: "法人と家庭で1kWhの単価が違うのはなぜですか？",
    answer:
      "主な理由は契約区分の違いです。家庭で使われる電灯契約と同じ枠に入る低圧電灯は25.94円/kWh、法人で主流の高圧は21.37円/kWhで、差は4.57円/kWhです（検算：25.94－21.37＝4.57）。需要規模が大きい区分ほど1kWhあたりは低くなる構造があります。加えて、法人の高圧契約では基本料金が契約電力（kW）で決まり、力率による割引・割増の仕組みもあるため、同じ使用量でも総額の決まり方が家庭とは異なります。単価だけを比べても、この構造差は見えません。なお本記事は法人・事業者向けの整理です。",
  },
  {
    question: "自社の1kWhあたりの単価はどう計算しますか？",
    answer:
      "2通りあります。1つは請求総額を使用電力量で割る方法で、基本料金や各種調整額を含んだ実質単価が出ます（例：請求額213,700円÷10,000kWh＝21.37円/kWh）。もう1つは請求書の電力量料金だけを使用電力量で割る方法で、使った分にかかる従量単価が出ます。他社との比較や前年比較には総額ベース、省エネによる削減額の試算には従量ベースが適しています。いずれの場合も、燃料費調整額や再エネ賦課金を含めたかどうかを揃えて比較することが重要です。季節変動をならすため、12か月分を合計してから割る方法もお勧めです。",
  },
  {
    question: "1kWの電気代はいくらですか？",
    answer:
      "kWは瞬間の電力を表す単位のため、それ単体では金額を計算できません。使用時間を掛けてkWh（電力量）に直して初めて、単価を掛けた金額が出ます。1kWの機器を1時間使えば1kWh、8時間使えば8kWhです。仮に高圧の21.37円/kWhで計算すると、1kWの機器を8時間使ったときの電力量料金の目安は約171.0円になります（検算：21.37×8＝170.96）。これは電力量料金部分の目安で、実際の請求額には基本料金や各種調整額も加わります。なお法人契約では、契約電力（kW）が基本料金の算定根拠になる点も押さえておく必要があります。",
  },
  {
    question: "1kWh単価にはどんな費用が含まれていますか？",
    answer:
      "料金メニューで定められた電力量料金の従量単価を土台に、燃料費調整額、再生可能エネルギー発電促進賦課金（2026年度4.18円/kWh）、料金メニューによっては容量拠出金の転嫁分が加わります。本ページで示す4区分の単価は消費税・再エネ賦課金を含まない参考値であるため、賦課金は別途上乗せして考える必要があります（例：高圧21.37＋4.18＝25.55円/kWh相当・検算：21.37＋4.18＝25.55）。なお基本料金は契約電力に対してかかるため従量単価には現れませんが、請求総額を使用量で割った実質単価には反映されます。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "本ページの4区分単価は2026年4月分（確定・最新公表）です。電力取引報は月次で公表されており、5月分以降は本ページ作成時点で未公表です（2026年8月中旬の公表見込み）。最新の確定単価とその背景は、本サイトの法人電気料金の振り返りシリーズで継続的に整理しています。一次情報は電力・ガス取引監視等委員会の「電力取引の状況（電力取引報結果）」でご確認いただけます。なお集計は検針期間ベースであり、事後に訂正される可能性がある点にもご留意ください。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            「1kWhあたりの電気代はいくらか」を、法人・事業者の視点で整理します。電力・ガス取引監視等委員会「電力取引報」から算出した2026年4月分（確定・最新公表）の全国計単価は、特別高圧17.56円/kWh・高圧21.37円/kWh・低圧電灯25.94円/kWh・低圧電力32.12円/kWhです。本ページでは、1kWhという単位の意味（kWとkWhの違い）、この4区分の水準、自社の1kWh単価を請求書から出す2通りの方法、単価を構成する要素、そして単価が同じでも請求額が変わる理由まで、計算の考え方に絞って解説します。業種別・エリア別の相場水準は専用ページへ、請求書の項目の読み方は内訳ページへ誘導する構成です。
          </p>
          ...
          <div className="mt-4 rounded-lg border border-sky-300 bg-white p-4">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-7 text-slate-700">
              ...
              <li>契約区分別の確定単価4区分（2026年4月分・全国計・検針期間ベース）</li>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              法人の1kWhあたりの電気代は、契約区分によって水準が異なります。下表は電力・ガス取引監視等委員会「電力取引報」から算出した2026年4月分（確定・最新公表）の全国計単価です。法人で主流の高圧を基準にすると21.37円/kWhが目安になります。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              「家庭より法人のほうが安いのか」という疑問は、契約区分の構造を知ると整理できます。家庭の電灯契約と同じ枠に入る低圧電灯は25.94円/kWh、法人で主流の高圧は21.37円/kWhで、差は4.57円/kWhです。ただし、法人には基本料金・力率・負荷率という別の要素が加わるため、単価の差がそのまま有利不利にはなりません。
            </p>
            <p className="mt-2 text-xs text-slate-500">{NEUTRAL}</p>
            <div className="mt-4 space-y-3">
          ...
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <ul className="mt-3 list-disc space-y-1 pl-5 text-sm leading-7 text-slate-700 sm:text-base">
              ...
              <li>算出した単価を契約区分の水準（高圧21.37円/kWh等）と突き合わせる</li>

...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "日本映画製作者連盟・日本映像ソフト協会・経産省コンテンツ産業課によれば、撮影スタジオ・映像制作の電気料金は売上高の3〜8%（撮影主体は高め）。撮影日と非撮影日の負荷格差大、機材点数による変動大。",
  },
  {
...
const faqItems = [
  { question: "撮影スタジオ・映像制作の電気代水準はどれくらいですか？", answer: "売上高比3〜8%（撮影主体は高め）が業界平均。小規模スタジオ（年商1億円級）で年600万〜3,000万円、中規模映像プロダクション（年商10億円級）で年4,500万〜1.8億円、大規模撮影所（年商100億円級）で年2.4〜15億円規模の電気代になります。" },
        ...
        <section className="mt-6 space-y-6">
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/peak-demand-management", title: "ピークデマンド管理の実務", description: "撮影日ピーク稼働法人のデマンド管理。" },

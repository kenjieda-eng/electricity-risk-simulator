...
const FAQ_ITEMS: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "力率は電力の利用効率を示す指標(%)で、高圧契約の場合は基本料金の割引・割増に直結します。標準力率 85% を上回る 1% につき基本料金が 1% 割引、下回る 1% につき 1% 割増となります（中部電力ミライズ・関西電力の公表資料）。力率 100% なら 15% 割引になる計算ですが、これは増減幅を各力率に当てはめた換算値で、割引・割増の上限は各社の約款によります。製造業など電動機が多い業種は力率が低下しやすく、進相コンデンサ設置で改善できます。年間数十万円の差額になるため無視できません。",
  },
  {

...
const electricSituation = [
  {
    ...
    detail:
      "文京区は面積11.29km²と23区5番目に狭いが、東京大学本郷キャンパス（年間電力消費量推定1億kWh級、特別高圧）、お茶の水女子大、順天堂大、東京医科歯科大、日本医大、東洋大、拓殖大、東京家政大など教育・研究機関が極めて高密度に集積。区内法人需要に占める大学・研究機関の電力比率は高い構造です。",
  },
  {
    label: "大型病院の集中による医療機器電力負荷",
    detail:
      "順天堂大学医学部附属順天堂医院（本郷）、東京医科歯科大学医学部附属病院（湯島）、日本医科大学付属病院（千駄木）、東京大学医学部附属病院（本郷）など、大型大学病院が複数立地。CT・MRI・PET・手術室・ICU・クリーンルーム・冷凍冷蔵等の医療機器電力が需要の中心を占めます。",
  },
  {
    label: "東京ドームシティ — 大規模イベント電力の特殊性",
    detail:
      "東京ドーム（収容5万人）・ラクーア・東京ドームホテル・後楽園ホール・アトラクションズ等を含む後楽の東京ドームシティ複合施設は区内でも大規模な電力需要家。コンサート・スポーツイベント開催時の瞬間需要が特に大きく、イベントピーク需要への対応が電力契約上の課題です。",
  },
  {
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              文京区は東京大学本郷・お茶の水・順天堂・医科歯科・日本医大・東洋・拓殖など大学が極めて高密度に集積し、大型大学病院と東京ドームシティを擁する、研究・医療・教育の電力負荷比率が高い構造を持つエリアです。
            </p>

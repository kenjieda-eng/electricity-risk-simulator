...
const pageDescription =
  "富山県・富山市の法人電気代の平均と相場を、契約区分別の全国確定単価（高圧22.78円/kWh等）を基準に読む手順で整理。北陸電力エリアの水力比率と2023年値上げが単価に及ぼす構造、電力会社を比較する5観点、アルミ産業・医薬品工業・宇奈月温泉の負荷特性と契約見直しを解説します。";
...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "北陸電力エリアは水力発電比率約30%と高水準。黒部川・神通川・庄川水系の水力発電所群がベースロード。志賀原発（石川県）は2011年以降停止中で、火力（七尾大田・敦賀）と水力の組合せで供給。再エネ比率（太陽光・風力含む）は40%超。",
  },
  {
  ...
  {
    label: "産業集積 — アルミ産業の一大拠点",
    detail:
      "富山県は日本のアルミ製錬・圧延発祥の地で、アルミ生産の集積地。三協立山アルミ・YKK AP・ナルメックス・タカギ等の大手企業本社・工場が集積。アルミは電力消費が極めて大きい『電気の缶詰』と呼ばれる業種で、県内産業電力需要の中核。",
  },
];
...
const utilitiesList = [
  {
    ...
    role: "一般送配電事業者・小売",
    detail:
      "県内シェア最大。高圧・特別高圧の標準メニューは『業務用季節別時間帯別電力』『業務用高圧電力』など。2023年4月の規制料金改定では家庭向け45.84%値上げ（北陸電力管内）で大幅改定。法人向けも同等の大幅改定を実施。値上げ幅は大きい。",
  },
  {
...
const priceBenchmark = [
  {
    ...
    detail:
      "北陸電力『業務用高圧電力』の電力量料金は20〜24円/kWh（2023年4月改定後）。燃料費調整額（2024〜2025年は+3.5〜+5.0円/kWh）と再エネ賦課金（2025年度3.98円/kWh）を加味すると実質単価は28〜33円/kWhレンジ。2023年4月の改定を経た水準です。全国的な水準との差は契約区分・使用量・負荷率により変わります。",
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
...
const costFactors = [
  {
    ...
    detail:
      "大規模な値上げ。家庭向け45.84%、法人向けも同等の大幅改定。中規模事業所（年間100万kWh）で年800〜1,200万円、大規模工場（年間1,000万kWh）で年8,000万〜1.2億円の値上げ。県内法人にとって最大のコスト圧力。",
  },
  {
    label: "アルミ産業の電力多消費体質",
    detail:
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇。年間1,000万kWh使用の大規模事業者で年4,000万円規模の負担。アルミ・医薬品は減免制度（年間1,000万kWh以上・電気使用密度要件）の対象になりやすく、申請を要検討。",
  },
];
...
const industryProfile = [
  {
    ...
    detail:
      "三協立山・YKK AP・タカギ・ナルメックスなど。アルミ製造の一大拠点。年間使用量1,000万〜2億kWh規模の大規模事業者多数。電力消費が極めて大きく、電気代コスト構造の中核。",
  },
  {
    label: "医薬品工業（富山市・砺波市）",
    detail:
...
const switchingReality = [
  ...
  },
  {
    label: "水力電源活用のメリット",
    detail:
      "北陸電力エリアは水力比率30%と高水準。水力電源は燃料費調整額の影響を受けにくく、長期的に安定単価。水力中心電源の新電力との契約は燃料価格高騰時にメリット大。",
  },
];
...
const faqItems = [
  { question: "富山県の法人電気代水準は全国比どれくらいですか？", answer: "2023年4月に北陸電力の料金改定（45.84%）が実施され、その後の水準が比較の起点になっています。全国的な水準との差は契約区分・使用量・負荷率により変わるため、請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。新電力への切替による単価最適化の余地があるかは、複数社から同一条件で見積を取って比較してください。" },
  ...
  { question: "富山県で固定プランと市場連動プランのどちらが向きますか？", answer: "冬季ピーク時のスポット価格高騰リスクと2023年大幅値上げの経験を考えると、24時間稼働のアルミ・医薬品・機械工業は固定プランが向きます。市場連動プランは限定的なケースのみ検討対象です。" },
  ...
  { question: "富山県の電気代の平均・相場はどのくらいですか？", answer: "県単位で法人の電気代平均を示した公的統計はないため、契約区分ごとの全国確定単価を基準にして読みます。電力取引報の最新確定分である2026年5月分（全国計・販売額÷販売電力量）は、特別高圧17.45円/kWh、高圧22.78円/kWh、低圧電灯27.85円/kWh、低圧電力34.42円/kWhでした。この販売額には基本料金・電力量料金・燃料費調整額が含まれ、消費税・再エネ賦課金は含まれません。富山県はアルミ製錬のような電力多消費型の特別高圧需要と、市内店舗の低圧需要の差が大きく、区分をまたいだ平均には意味がありません。自社の契約区分に対応する全国値と、請求書から消費税・再エネ賦課金を除いて求めた実質単価を比べてください。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            富山県は北陸電力エリアの中核で、アルミ製錬・圧延、医薬品工業、黒部水力発電など特殊な電力構造を持ちます。2023年4月の北陸電力45.84%大幅値上げの影響を大きく受けたエリアで、電気代見直しの緊急度が極めて高い県です。本ページでは県内法人の電気代水準、業種別影響度、契約見直しの具体策、補助金活用までを実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              富山県は北陸電力エリアの中核県で、エリア最大の電力需要を持ちます。アルミ製錬・圧延の一大拠点、医薬品工業集積、黒部川・神通川・庄川水系の豊富な水力発電が特徴。2023年4月の北陸電力45.84%大幅値上げが県内法人にとって最大のコスト圧力となっています。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              北陸電力エリアの単価は2023年4月の45.84%の料金改定を経た水準です。全国的な水準との差は契約区分・使用量・負荷率により変わります。実質単価（電力量料金+燃料費調整額+再エネ賦課金）ベースで比較することが重要です。改定後の単価を前提に、複数社から同一条件で見積を取って比較してください。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
              基準に使うのは、電力取引報の最新確定分である2026年5月分の実績単価です。請求書の契約種別を確認し、対応する区分の数値を出発点にしてください。
            </p>
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計・販売額÷販売電力量で求めた値であり、富山県または北陸電力エリアの平均値ではありません。販売額には基本料金・電力量料金・燃料費調整額を含み、消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年5月分・確定）。単価の定義は{" "}
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
              富山県は北陸電力エリアの中核に位置します。同エリアは豊富な包蔵水力を背景に水力の比率が高く、燃料価格の変動が単価に伝わる経路は火力中心のエリアと同じではありません。他方で2023年の大幅な料金改定は県内法人にとって大きな転換点となり、比較の起点をどの時点に置くかで見え方が変わります。全国値との差を検討するときは、燃調の効き方に加えて、現在の契約が改定後のどのメニューに基づくものかを確認してください。
            </p>
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              富山県の新電力シェアは2024年時点で20〜25%。2023年北陸電力大幅値上げを受けて切替が加速し、新電力シェアが上昇しています。アルミ・医薬品の大規模事業者では競争入札が標準化しています。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              富山県は2023年北陸電力大幅値上げの影響を大きく受けたエリアで、アルミ・医薬品の電力多消費業種特化型対策が必要です。シミュレーターで自社条件における上振れ幅を試算し、固定プラン切替・水力PPA・省エネ投資のメリットを定量化できます。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "日本自動車整備振興会連合会・日本自動車車体整備協同組合連合会・経産省自動車課の統計によれば、自動車整備・板金塗装業の電気料金は売上高の1.5〜4%（板金塗装業は塗装ブース稼働で高水準）。粗利ベースでは5〜15%に達する。塗装ブース・コンプレッサーが業種特性。",
  },
  {
...
const faqItems = [
  { question: "自動車整備・板金塗装業の電気代水準はどれくらいですか？", answer: "売上高比1.5〜4%（板金塗装業は高水準）、粗利比5〜15%が業界平均。中規模認証工場（年商5億円級）で年150〜750万円、大規模板金センター（年商15億円超）で年1,200〜6,000万円規模の電気代になります。" },

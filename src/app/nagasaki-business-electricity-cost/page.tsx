...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "九州電力管内は原発再稼働（玄海3・4号機、川内1・2号機）と太陽光大量導入により、エリア電源構成は原子力約35%、太陽光等再エネ約20%、LNG火力約25%、石炭火力約15%、その他5%。長崎県の離島は独立系統で石油火力・ディーゼル発電への依存度が高く、本土系統とは供給構造が異なります。県内には九電の松島火力（石炭）等が立地。",
  },
  {
...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "市場動向",
    detail:
      "長崎県の新電力シェアは2024年時点で約15〜20%。三菱重工長崎造船・ハウステンボス・長崎市内オフィスで新電力切替が活発。離島事業者は九州電力依存度が高い。",
  },
];
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金14〜17円/kWh+調整項目。長崎県内では三菱重工長崎造船所、佐世保重工業、ハウステンボス、長崎市内の大型商業施設が対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。競争入札による削減余地は個別条件により異なります。",
  },
  {
  ...
  },
  {
    label: "離島系統の単価特殊事情",
    detail:
      "壱岐・対馬・五島・平戸等の離島は独立系統で石油火力・ディーゼル発電への依存度が高く、本土とは供給構造が異なります。離島事業者は太陽光自家消費＋蓄電池の組合せが電気代削減と台風BCP対応の両立に最も効果的。島嶼型マイクログリッド補助の活用余地大。",
  },
];
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、九州電力エリアの特別高圧電力単価は2024年度実績で約14〜17円/kWh（電力量料金ベース）。九州エリアは玄海・川内の原子力4基の稼働と全国最大級の太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。長崎県内の三菱重工長崎造船・佐世保重工・ハウステンボスにとっては、競争入札による更なる1〜3円/kWh削減で年間1,000万〜1億円規模のコスト削減余地。",
  },
  {
    label: "九州電力エリアの高圧単価水準",
    detail:
      "高圧電力（500〜2,000kW級）の単価は16〜20円/kWh。県内中規模事業者（長崎市内オフィス・佐世保観光業中堅・水産加工大手）にとっての標準帯域。pps-net.org のエリア別データを再加工して試算すると、長崎県内の典型的な高圧契約（200〜500kW、年間使用量100〜400万kWh）では、新電力切替で年間100〜300万円規模のコスト削減が見込める。",
  },
  {
    label: "離島系統・低圧単価水準",
    detail:
      "壱岐・対馬・五島・平戸等の離島は独立系統で石油火力・ディーゼル発電への依存度が高く、本土とは供給構造が異なります。低圧電力11〜14円/kWh、低圧電灯19〜22円/kWh水準。離島事業者（観光業・水産加工・小規模商業）は新電力切替の余地が限られるが、太陽光自家消費＋蓄電池＋島嶼型マイクログリッドの組合せで電気代を大幅削減可能。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇。年間9,500万kWh使用の大型造船で年3.8億円規模の負担。減免制度（年間1,000万kWh以上・電気使用密度要件）の対象になる事業者は申請を要検討。",
  },
];
...
const switchingReality = [
  {
    label: "新電力切替の県内浸透度",
    detail:
      "2024年時点で県内法人の新電力シェアは約15〜20%。三菱重工長崎造船・ハウステンボス・長崎市内オフィスで新電力切替が活発。離島事業者は九州電力依存度が高い。",
  },
  {
    label: "市場連動プランの選択肢",
    detail:
...
const faqItems = [
  { question: "長崎県の法人電気代水準は全国比どれくらいですか？", answer: "九州エリアは玄海・川内の原子力4基の稼働と全国最大級の太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。長崎県内法人の実質単価は22〜27円/kWh（高圧）が標準帯域で、新電力切替により1〜2円/kWh改善余地があります。一方、離島（壱岐・対馬・五島・平戸）は独立系統で石油火力への依存度が高く、供給構造が異なります。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              九州電力エリアは原発稼働メリットにより本州より1〜2円/kWh安い水準を維持。一方、離島は独立系統で石油火力への依存度が高く、供給構造が異なります。実質単価（電力量料金+燃料費調整額+再エネ賦課金）ベースで本土と離島を分けて比較することが重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              長崎県の新電力シェアは2024年時点で約15〜20%。三菱重工長崎造船・ハウステンボス・長崎市内オフィスで新電力切替が活発です。離島事業者は九州電力依存度が高く、島嶼型マイクログリッドの活用が重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、九州電力エリアの特別高圧電力単価は2024年度実績で約14〜17円/kWh（電力量料金ベース）。九州エリアは玄海・川内の原子力4基の稼働と太陽光導入が進んだ電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。長崎県内の三菱重工長崎造船・佐世保重工・ハウステンボスにとっては、競争入札による更なる1〜3円/kWh削減で年間1,000万〜1億円規模のコスト削減余地。",
  },
  {
...
const faqItems = [
  { question: "長崎県の法人電気代水準は全国比どれくらいですか？", answer: "九州エリアは玄海・川内の原子力4基の稼働と太陽光導入が進んだ電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。長崎県内法人の実質単価は22〜27円/kWh（高圧）が標準帯域で、新電力切替により1〜2円/kWh改善余地があります。一方、離島（壱岐・対馬・五島・平戸）は独立系統で石油火力への依存度が高く、供給構造が異なります。" },

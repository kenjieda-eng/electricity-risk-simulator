...
const pageTitle =
  "電気料金見直しを社内稟議で通すための説明資料の作り方｜上司・経営層向け5ステップ";
const pageDescription =
  "電力契約見直しを社内で承認してもらうための稟議資料の構成、上司・経営層への説明ポイント、シミュレーター結果の活用方法を5ステップで中立社団が解説。比較表テンプレート、リスク説明のフレーズ例、想定質問への回答集付き。";
...
<div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
        ...
        <SourcesAndFaq
          ...
          sources={[
            ...
            { name: "電力・ガス取引監視等委員会", url: "https://www.egc.meti.go.jp", description: "電力市場の監視データ・料金比較情報" },

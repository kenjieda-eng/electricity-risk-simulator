...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "盛岡市の暖房度日（HDD18）は約3,400で寒冷な地域。北上盆地は内陸寒冷気候で冬は-15℃以下になることも。一方で沿岸部（宮古・釜石・大船渡）は内陸より温暖で暖房負荷が軽い。同一県内でも電力消費プロファイルが大きく異なる。",
  },
  {
    label: "震災復興と電力インフラ",
    detail:
...
const priceBenchmark = [
  {
    ...
    detail:
      "東北電力『業務用高圧電力』の電力量料金は岩手県内で18〜22円/kWh（季節・時間帯により変動）。燃料費調整額（2024〜2025年は+3.0〜+4.5円/kWh）と再エネ賦課金（2025年度3.98円/kWh）を加味した実質単価は25〜30円/kWhレンジ。全国的な水準との差は契約区分・使用量・負荷率により変わります。",
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
...
const costFactors = [
  {
    label: "内陸寒冷地暖房需要",
    detail:
      "盛岡・北上の暖房度日3,400〜3,500で本州でも高い水準。冬季月別電気代が他季の2倍以上になる事業所が多数。年間電気代に占める暖房分は県内事業所平均で20〜30%、ホテル・病院等で40%超に達することも。",
  },
  {
    label: "自動車部品工場の高負荷",
    detail:
...
const switchingReality = [
  {
    label: "新電力切替の県内浸透度",
    detail:
      "2024年時点で岩手県内法人の新電力シェアは15〜20%（経産省統計）。北上・盛岡等の都市圏では切替が進む一方、地方部では東北電力EP継続が多数。",
  },
  {
    label: "市場連動プランのリスク認識",
    detail:
...
const faqItems = [
  { question: "岩手県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の実質単価について、全国的な水準との差は契約区分・使用量・負荷率により変わるため、請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。寒冷地の暖房需要や火力への依存度といった要因が指摘されています。差額の規模は自社の使用量と契約区分により変わるため、実質単価の差に年間使用量を乗じて確認してください。" },
  ...
  { question: "岩手県で固定プランと市場連動プランのどちらが向きますか？", answer: "冬季ピーク負荷の大きい岩手県では、24時間稼働事業所・暖房負荷の大きい業種は固定プランが向きます。2022〜2023年の市場高騰で県内事業者の多くが固定プランへ回帰しました。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              全国的な水準との差は契約区分・使用量・負荷率により変わります。寒冷地暖房需要・火力依存度が主要因。実質単価ベースでの比較が重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

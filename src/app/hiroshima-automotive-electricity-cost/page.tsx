...
const electricSituation = [
  {
    ...
    detail:
      "広島県はマツダを核とする自動車産業と、呉・江田島・尾道の造船業が集積する重工業県です。マツダ本社・宇品工場・三次事業所を中心に、府中町（マツダ本社所在）・安芸郡を中心としたTier1・Tier2サプライヤーが県内に広がります。瀬戸内海沿岸には呉のジャパンマリンユナイテッド（JMU）、江田島・因島の造船所が立地し、福山にはJFEスチール西日本製鉄所（鉄鋼）も。自動車・造船・鉄鋼の特別高圧需要家が集中する電力多消費の産業構造です（出典: 広島県工業統計・経産省工業統計・各社統合報告書）。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            広島県はマツダを核とする自動車産業と、呉・江田島の造船業が集積する重工業県です。本ページでは「広島県 × 自動車・造船業」というクロス領域に絞り、中国電力エリア固有の単価事情（島根原発再稼働の影響含む）と、塗装／プレス／大型溶接の電力プロファイル、マツダCN対応、特別高圧契約最適化までを実務目線で整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              広島県はマツダを核とする自動車産業と、呉・江田島・尾道の造船業が集積する重工業県です。福山の鉄鋼も含め、自動車・造船・鉄鋼の特別高圧需要家が集中する電力多消費の産業構造が業種特性の中心です。
            </p>

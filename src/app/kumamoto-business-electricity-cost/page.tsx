...
const pageTitle =
  "熊本県の法人電気料金ガイド｜九州電力エリア単価分析・TSMC/JASM進出・農業トマトい草・阿蘇天草観光業の契約最適化";
...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "TSMC/JASM（台湾積体電路製造の日本子会社、菊陽町）、ソニーセミコンダクタソリューションズ（菊陽町）、東京エレクトロン（合志市）等の半導体産業集積（シリコンアイランド九州の中核）。トマト、い草、スイカ、肉用牛・豚等の農業・畜産。阿蘇・草千里・黒川温泉・天草の観光業。熊本市は熊本城・水前寺成趣園周辺都市圏オフィス・商業。八代港・水俣港の物流・水産業。",
  },
];
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金14〜17円/kWh+調整項目。熊本県内ではTSMC/JASM、ソニーセミコンダクタ、東京エレクトロン等の半導体大手、八代港物流大手が対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。競争入札による削減余地は個別条件により異なります。",
  },
  {
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、九州電力エリアの特別高圧電力単価は2024年度実績で約14〜17円/kWh（電力量料金ベース）。九州エリアは玄海・川内の原子力4基の稼働と大規模な太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。熊本県内のTSMC/JASM・ソニーセミコンダクタ・東京エレクトロンにとっては、競争入札による更なる1〜3円/kWh削減で年間1〜10億円規模のコスト削減余地（巨大需要のため絶対額大）。",
  },
  {
    label: "九州電力エリアの高圧単価水準",
    detail:
      "高圧電力（500〜2,000kW級）の単価は16〜20円/kWh。県内中規模事業者（熊本市内オフィス、菊陽町・大津町の半導体関連サプライヤー、八代港物流中堅）にとっての標準帯域。pps-net.org のエリア別データを再加工して試算すると、熊本県内の典型的な高圧契約（200〜500kW、年間使用量100〜400万kWh）では、新電力切替で年間100〜300万円規模のコスト削減が見込める。",
  },
  {
    label: "九州電力エリアの低圧単価水準",
    detail:
      "低圧電力9〜12円/kWh、低圧電灯17〜21円/kWhの水準。県内中小事業者（中小商店・農業法人・観光業中堅）は新電力切替で年間5〜30万円規模の削減余地が中心。太陽光自家消費・蓄電池併設で更なる効果。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "熊本県はトマト・い草・スイカ等の農業県。ハウス施設園芸の温湿度制御・LED栽培照明・冷蔵倉庫の電力需要が増加傾向。農協系新電力・農水省補助との連携で電気代削減と高付加価値化の両立が可能。",
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
...
const industryProfile = [
  ...
  },
  {
    ...
    detail:
      "トマト、い草、スイカの農業県。ハウス施設園芸・冷蔵倉庫・畜舎。年間使用量100万〜1,000万kWh規模。",
  },
  {
...
const faqItems = [
  { question: "熊本県の法人電気代水準は全国比どれくらいですか？", answer: "九州エリアは玄海・川内の原子力4基の稼働と大規模な太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。熊本県内法人の実質単価は22〜27円/kWh（高圧）が標準帯域で、新電力切替により1〜2円/kWh改善余地があります。TSMC/JASM等の半導体大手の特高契約は競争入札で年間1〜10億円規模の削減も可能です。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            熊本県は九州電力エリアに属し、TSMC/JASM進出（菊陽町）による半導体電力需要急増がエリア最大の経営課題。シリコンアイランド九州の中核として半導体産業集積（TSMC/JASM・ソニーセミコンダクタ・東京エレクトロン）、トマト・い草・スイカの農業、阿蘇山・黒川温泉・天草の観光業、熊本市の都市圏オフィス・商業と多様な産業構造を持ちます。太陽光発電適地として自家消費＋蓄電池の経済性が極めて高く、原発稼働メリット＋半導体電力需要急増＋太陽光出力制御活用のシナジーを最大化する契約最適化戦略が主流です。本ページでは新電力ネット（pps-net.org/unit）のエリア別単価データを県の産業構造に紐づけて再加工し、業種別の契約見直し・補助金活用を実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              熊本県は九州電力エリアに属し、TSMC/JASM進出による半導体電力需要急増がエリア最大の経営課題。半導体産業（菊陽町・大津町・合志市）、トマト・い草・スイカの農業、阿蘇・天草の観光業、熊本市の都市圏オフィス・商業が県内電力消費の中核を形成します。原発稼働メリット＋太陽光発電適地＋半導体需要急増のシナジーが県固有の競争優位です。
            </p>

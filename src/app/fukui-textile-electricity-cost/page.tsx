...
const industryProfile = [
  {
    label: "鯖江市 — 眼鏡（フレーム）の産地と繊維",
    detail:
      "鯖江市は研磨・切削・電気めっき・成形を担う眼鏡（フレーム）の地場集積を擁し、あわせて繊維の事業所も立地するエリアです。眼鏡はメッキ整流器・研磨・洗浄・乾燥の用役負荷を抱える高圧契約の中小製造業が中心で、品種・ロット切替に伴うデマンド変動が大きい点が共通します。多工程小ロットゆえに契約電力最適化の余地があります。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            福井県は鯖江の眼鏡（地場産地）と越前・福井の合繊織物・染色加工という二大地場産業が広く集積する地域です。本ページでは「福井県 × 繊維・眼鏡製造業」というクロス領域に絞り、北陸電力エリア固有の単価事情（水力比率が高く燃調感応度が相対的に低め）と、染色のボイラー蒸気・乾燥／織機／眼鏡の研磨・メッキ・成形の電力プロファイル、契約最適化、補助金・PPA活用までを実務目線で整理します。なお同じ北陸電力エリアでも、富山＝医薬品、福井＝繊維・眼鏡で業種・電力プロファイルが異なる点を分離して扱います。本ページは特定の電力会社・契約形態を推奨するものではありません。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              福井県は鯖江市を中心とした眼鏡（フレーム）の産地、越前市（武生）・福井市を核とした合繊織物・染色加工の北陸繊維産地、あわら市・坂井市のニット・染色周辺と、県内に繊維と眼鏡という二大地場産業が広く集積しています。染色加工のボイラー蒸気・温水・乾燥や、織機の多数台運転、眼鏡の研磨・メッキ・成形を抱える高圧・特別高圧の工場が多数立地し、地場産業の脱炭素を背景とした設備更新も進んでいます。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              福井の繊維・眼鏡サプライチェーンは、鯖江の眼鏡（フレーム）産地を中心に、越前（武生）の合繊織物・染色加工集積、福井市の繊維・染色と本社機能、あわら・坂井の繊維・染色・ニット周辺、県内全域の北陸の地場産業を軸とした中小製造業の基盤という構造です。
            </p>
            <div className="mt-4 space-y-3">

...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "全国カラオケ事業者協会・経産省特定サービス産業実態調査の統計によれば、カラオケボックスの電気料金は売上高の5〜12%（24h営業店は高水準）。粗利ベースでは10〜25%に達する。個室AV機器＋個室空調＋24h深夜営業で電力依存度が極めて高い業種。客足変動が経営課題。",
  },
  {
    label: "1個室あたりの電力使用量",
    detail:
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。中規模カラオケ店（年100万kWh）で年418万円の負担。",
  },
];
...
const faqItems = [
  { question: "カラオケボックスの電気代水準はどれくらいですか？", answer: "売上高比5〜12%（24h営業店は高水準）、粗利比10〜25%が業界平均。中規模店（30〜60室）で年1,500〜6,000万円、大手チェーン本部含む合計（100〜300店舗）で年1.5〜9億円規模の電気代になります。客足変動と固定的なベースロードのバランスが課題です。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。カラオケ業の中規模店では負担額が請求総額の10〜15%に達します。
            </p>
            <div className="mt-4 space-y-3">
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-6 text-slate-600">
                  ...
                  <li>2026年度（4.18円/kWh）：年 543.4万円（+89.4万円）</li>
                </ul>
              </div>
            </div>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">

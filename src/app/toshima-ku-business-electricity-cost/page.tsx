...
const pageTitle =
  "豊島区の法人電気料金ガイド｜池袋ターミナル・サンシャインシティ・大型商業ホテルの契約最適化";
...
const electricSituation = [
  {
    label: "池袋ターミナル — 電力需要の密集地",
    detail:
      "豊島区は面積13.01km²と23区2番目に狭いが、池袋駅の1日あたり乗降客数は約260万人（JR・東武・西武・東京メトロ4社合計）。駅周辺1km圏内に大型百貨店（西武・東武・パルコ）・サンシャインシティ・東池袋Brillia Tower・Hareza池袋等の大型商業/オフィス複合施設が密集し、23区内でも極めて高い電力需要密度を持つエリアです。",
  },
  {
    label: "サンシャインシティの自家発電・地域冷暖房システム",
    detail:
      "サンシャインシティ（ワールドインポートマート・プリンスホテル・サンシャイン60等を含む複合施設、延床約59万m²）は自家発電設備と地域冷暖房（DHC）システムを保有する大規模な電力需要家。特別高圧契約に加え、冷温水の地域供給も行う独自エネルギーインフラを持ち、周辺施設へのエネルギー安定供給に貢献しています。",
  },
  {

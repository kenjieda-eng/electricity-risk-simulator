...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "東京電力グループでは、テプコカスタマーサービス株式会社などのグループ会社が顧客サービス・小売関連の機能を担っています。なお、テプコカスタマーサービスは2024年4月から電力販売事業を休止しています（最新は公式で要確認）。こうした本体とは別のグループ会社は、広義には本ページで整理する『旧一電グループ系』の枠組みで理解できます。ただし各社の担う機能・対応範囲・受付現況は会社ごとに異なり、公開情報の範囲でしか本ページでは触れられないため、具体的なサービス内容・法人契約の可否は各社公式公表で確認してください。本ページは特定企業の優劣評価は行いません。",
  },
  {

...
const pageTitle =
  "データセンター・IT業の補助金活用戦略｜経産省DC支援・GX税制でPUE改善・液冷を導入するガイド";
...
const targetEquipment = [
  {
    ...
    detail:
      "AI/HPCの高密度ラックを液浸冷却・ダイレクト液冷・リアドア水冷で直接冷却し、空冷より大幅にPUEを改善。冷却電力を大きく削減でき、経産省DC支援・GX税制の対象。高密度化が進むDCの先進的な設備です。",
  },
  {
    label: "外気冷房（フリークーリング）",
    detail:

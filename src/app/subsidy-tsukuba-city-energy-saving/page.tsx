...
const overview = [
  ...
  },
  {
    ...
    detail:
      "つくば市の産業振興課が公開する事業者向け支援制度は全9件で、その内容は融資・空き店舗・創業・展示会・研究開発などであり、省エネ・再エネ・電気料金に関する制度は1件も掲載されていません。環境政策課のメニューが個人・賃貸オーナー向けであることと合わせると、つくば市には2026年度時点で、法人の設備省エネや電気代対策を直接支援する市独自の補助制度が、本ページで整理した範囲では確認できないことになります。これは「探し方が悪い」のではなく、市の制度設計の結果です。したがって、つくば市の事業者の検討は、市の制度を探し続けるより、茨城県の制度を軸に組み立てるほうが早く確実に前に進みます。最新の情報は市・県の公式ページで必ずご確認ください。",
  },
  {

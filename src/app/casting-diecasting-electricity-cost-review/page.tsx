...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・日本鋳造協会の統計によれば、鋳造・ダイカスト業の電気料金は売上高の8〜18%（鉄鋳物業は高水準）。製造原価に占める比率は12〜25%。電気炉・誘導炉の溶解電力依存度が極めて高い。",
  },
  {
...
const faqItems = [
  { question: "鋳造・ダイカスト業の電気代水準はどれくらいですか？", answer: "売上高比8〜18%（鉄鋳物業は高水準）、製造原価比12〜25%が業界平均で高水準。中規模ダイカスト工場（年商200億円級）で年4.5〜15億円、大規模鋳造メーカー（年商500億円超）で年15〜60億円規模の電気代になります。" },
  ...
  { question: "鋳造業の固定プランと市場連動プランどちらが向きますか？", answer: "電気炉・保持炉の24h連続稼働でベースロードが大きく、生産停止が極めて困難なため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続企業で月数千万円の追加負担が発生しました。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            鋳造・ダイカスト業は、電気炉・誘導炉による金属溶解の大電力、保持炉24h連続稼働、ダイカストマシン射出工程、集塵・排煙処理など多面的な電力負荷を持ち、製造原価に占める電気代比率は高水準です。本ページでは業界特有の電力負荷特性、業界平均水準、規模別事例、補助金活用、契約見直しチェックリストまで実務に直結する観点を整理します。
          </p>

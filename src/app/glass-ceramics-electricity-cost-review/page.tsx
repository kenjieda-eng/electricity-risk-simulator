...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・板硝子協会・日本ガラスびん協会の統計によれば、ガラス・窯業の電気料金は売上高の8〜18%（電気溶融比率の高い工場）に達する。製造原価に占める比率は12〜25%。エネルギー多消費型業種として高い電力依存度を持つ。",
  },
  {
...
const faqItems = [
  { question: "ガラス・窯業の電気代水準はどれくらいですか？", answer: "売上高比8〜18%、製造原価比12〜25%が業界平均で、エネルギー多消費型業種として高い電力依存度を持ちます。中規模工場（年産10,000トン級）で年3〜11億円、大規模板ガラス工場（年産40,000トン）で年12〜50億円規模の電気代になります。" },
  ...
  { question: "ガラス・窯業の固定プランと市場連動プランどちらが向きますか？", answer: "24時間連続稼働でベースロードが大きく、停止が困難なガラス・窯業は市場高騰のリスクが最も大きい業種の1つです。固定プラン（3〜10年）が向きやすく、2022〜2023年の市場高騰局面では市場連動継続企業で月数千万円の追加負担が発生しました。" },
  ...
  { question: "自家消費型太陽光はガラス・窯業で投資回収できますか？", answer: "屋根面積1万m²以上、24時間連続稼働の工場は自家消費型太陽光との相性が良好です。1MWで年100〜130万kWh発電、年1,000〜1,500万円の削減、投資回収7〜10年（補助金後5〜7年）が目安です。自家消費率90%超になりやすく投資効率が高いです。" },

...
const pageTitle =
  "工場の電気代は1kWhあたりいくらか｜高圧22.78円/kWhを基準にした単価の見方と原単位（2026年5月分・確定）";
const pageDescription =
  "工場の1kWhあたり電気代を、契約区分別の確定単価を基準に整理します。電力・ガス取引監視等委員会「電力取引報」から算出した2026年5月分（確定・最新公表）の全国計単価は、高圧22.78円/kWh・低圧電力34.42円/kWh・特別高圧17.45円/kWhです。工場では同じ単価でも、負荷率（連続操業か二交代か）、契約電力（デマンド）、力率によって実質単価が変わります。本ページでは、区分別の目安、単価に効く要素、生産量あたりの原単位（kWh/生産単位）での見方、単価が高い工場が確認すべき点までを、計算の手順に沿って解説します。本記事は法人・事業者向けの内容です。";
...
const factoryUnitPrice = [
  {
    name: "多くの工場は高圧 — 22.78円/kWhが出発点の目安",
    role: "契約区分／2026年5月分（確定）・全国計",
    detail:
      "受電設備を持つ一般的な規模の工場は高圧契約が中心で、2026年5月分（確定）の全国計単価は22.78円/kWhです。「工場の電気代は1kWhいくらか」という問いに対しては、まずこの水準を出発点に置くのが実務的です。ただしこれは全国計の平均であり、エリア・電力会社・料金メニュー・使い方によって実際の単価は上下します。自社の水準を知るには、請求総額を使用電力量で割った実質単価を12か月分で算出し、この22.78円/kWhと突き合わせるのが確実です。工場は使用量が大きいぶん、わずかな単価差が年間では大きな金額差になります。",
  },
  {
    name: "小規模な工場・作業所は低圧電力 — 34.42円/kWh",
    role: "契約区分／動力設備を持つ小規模事業所",
    detail:
      "受電設備を持たず、動力設備を低圧で使う小規模な工場・作業所は低圧電力の区分に入り、2026年5月分（確定）の全国計単価は34.42円/kWhです。高圧の22.78円/kWhとの差は11.64円/kWhで（検算：34.42－22.78＝11.64）、4区分のなかで最も高い水準です。小規模な工場ほど1kWhあたりの負担が重くなる構造がここに表れています。ただし、低圧から高圧への切り替えにはキュービクル等の受電設備の設置と保安管理の体制が前提になるため、単価差がそのまま削減額になるわけではありません。設備投資と保安コストを含めた総額で判断する必要があります。",
  },
  {
    name: "大規模工場は特別高圧 — 17.45円/kWh",
    role: "契約区分／大規模工場・連続操業の重工業など",
    detail:
      "非常に大きな電力需要を持つ大規模工場は特別高圧の区分となり、2026年5月分（確定）の全国計単価は17.45円/kWhです。高圧との差は5.33円/kWh（検算：22.78－17.45＝5.33）で、需要規模が大きいほど1kWhあたりが下がる構造を示しています。ただし契約区分は需要規模と受電設備によって決まるもので、単価が低いからという理由で選べるものではありません。自社がどの区分に該当するかは既に決まっていることがほとんどで、検討の余地があるのは区分内での料金メニュー・契約電力・使い方の最適化です。",
  },
  {
    name: "使用量が大きいほど「1円/kWhの差」が効く",
    role: "工場の特性／年間インパクトの考え方",
    detail:
      "工場の電気代を考えるうえで重要なのは、使用量が大きいぶん単価差の影響が増幅されることです。たとえば月間10万kWhを使う工場であれば、1円/kWhの差は月10万円、年間では120万円の差になります（検算：100,000×12＝1,200,000）。高圧22.78円/kWhで月10万kWhを使う場合、電力量料金相当の目安は月227万8,000円、年間で約2,733万6,000円という計算です（検算：22.78×100,000＝2,278,000／2,278,000×12＝27,336,000）。これは電力量料金部分の目安で、実際には基本料金や各種調整額が加わります。規模が大きいほど、単価と使い方の両面での改善余地が金額として大きく現れます。",
  },
  {
  ...
  },
  {
    ...
    role: "データの読み方／比較の前提",
    detail:
      "本ページで示す単価は全国計の平均であるため、エリア差・電力会社差・契約条件差は平均に吸収されています。自社の実質単価が22.78円/kWhより高い場合でも、直ちに契約が不利とは限らず、負荷率が低い、ピークが高い、エリアの水準がもともと高いといった理由が考えられます。平均はあくまで位置づけを知るための基準です。自社の値との差がどこから来ているかを、契約区分・負荷率・デマンド・力率の順に分解して確認するのが、本ページの以降の章の狙いです。",
  },
];
...
const perUnitOutput = [
  ...
  },
  {
    ...
    detail:
      "原単位に1kWhあたりの単価を掛ければ、製品1単位あたりの電気コストが算出できます。原単位18kWh/個の工場が高圧22.78円/kWhで電気を購入している場合、製品1個あたりの電力量料金相当は410.04円という計算です（検算：18×22.78＝410.04）。この数字は原価管理や値決めの議論に直接使えるため、経営層への説明でも通りやすくなります。実際には基本料金や賦課金も加わるため、より正確に見るなら総額ベースの実質単価を掛ける方法もあります。目的に応じて使い分けてください。",
  },
  {
...
const howToEstimate = [
  ...
  {
    label: "STEP2: 契約区分の水準（高圧22.78円/kWh等）と突き合わせる",
    detail:
      "算出した実質単価を、自社の契約区分に対応する全国計の水準と比較します。高圧なら22.78円/kWh、低圧電力なら34.42円/kWh、特別高圧なら17.45円/kWhが2026年5月分（確定）の目安です。ここで注意すべきは、全国計の単価が消費税・再エネ賦課金を含まない参考値である一方、自社の実質単価には賦課金が含まれている点です。条件を揃えるなら、全国計に賦課金4.18円/kWhを加えた水準と比べるか、自社側から賦課金相当を除いて比べる必要があります。この前提を揃えないと、差を過大に見積もることになります。",
  },
  {
...
const faqItems = [
  {
    ...
    answer:
      "契約区分によって異なります。電力・ガス取引監視等委員会「電力取引報」から算出した2026年5月分（確定・最新公表）の全国計単価は、受電設備を持つ一般的な工場が該当する高圧で22.78円/kWh、小規模な工場・作業所が該当する低圧電力で34.42円/kWh、大規模工場が該当する特別高圧で17.45円/kWhです。多くの工場は高圧のため、22.78円/kWhを出発点の目安に置くのが実務的です。これらは販売額÷販売電力量・全国計の参考値（多くの事業者が検針期間ベースで報告・暦月ベースも可）で、消費税・再エネ賦課金を含みません。実際の単価はエリア・電力会社・契約条件・使い方によって上下します。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "月間の使用電力量に単価を掛け、12か月分を積み上げるのが基本です。たとえば月間10万kWhを使う工場が高圧22.78円/kWhで購入している場合、電力量料金相当の目安は月227万8,000円、年間で約2,733万6,000円という計算になります（検算：22.78×100,000＝2,278,000／2,278,000×12＝27,336,000）。これに基本料金（契約電力×単価×12か月）と再エネ賦課金（4.18円/kWh×使用量）が加わります。より正確に把握するには、直近12か月の請求総額と総使用量から実質単価を算出し、そこから逆算する方法が確実です。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "月間の使用電力量を同じ期間の生産量で割ると、原単位（kWh/生産単位）が出ます。たとえば月間216,000kWhで12,000個を生産したなら、原単位は18kWh/個です（検算：216,000÷12,000＝18）。これに1kWhあたりの単価を掛ければ、製品1単位あたりの電気コストが算出できます。高圧22.78円/kWhなら、1個あたりの電力量料金相当は410.04円です（検算：18×22.78＝410.04）。原単位で見ると生産量の増減に左右されずに効率の変化を追えるため、単価要因と効率要因を切り分けられます。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "2026年5月分（確定・最新公表）です。電力取引報は月次で公表されており、6月分以降は本ページ作成時点で未公表です（6月分＝2026年9月中旬の公表見込み）。集計は販売額÷販売電力量・全国計（多くの事業者が検針期間ベースで報告・暦月ベースも可）で、事後に訂正される可能性があります。最新の確定単価とその背景は、本サイトの法人電気料金の振り返りシリーズで継続的に整理しています。一次情報は電力・ガス取引監視等委員会の「電力取引の状況（電力取引報結果）」でご確認ください。",
  },
  {
    question: "低圧電力から高圧に切り替えれば単価は下がりますか？",
    answer:
      "全国計の単価で見ると低圧電力34.42円/kWhに対し高圧22.78円/kWhで、差は11.64円/kWhです（検算：34.42－22.78＝11.64）。ただし、この差がそのまま削減額になるわけではありません。高圧受電にはキュービクル等の受電設備の設置と保安管理の体制が前提となり、設備投資と維持管理のコストが発生します。また契約区分は需要規模によって決まる面が大きく、任意に選べるものではありません。切り替えの可否と採算は、使用量の規模・設備投資額・保安コストを含めた総額で判断する必要があります。",
  },
];
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">
            工場の電気代は1kWhあたりいくらか｜高圧22.78円/kWhを基準にした単価の見方と原単位
          </h1>
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            工場の1kWhあたり電気代を、契約区分別の確定単価を基準に整理します。電力・ガス取引監視等委員会「電力取引報」から算出した2026年5月分（確定・最新公表）の全国計単価は、高圧22.78円/kWh・低圧電力34.42円/kWh・特別高圧17.45円/kWhです。受電設備を持つ一般的な工場は高圧が中心のため、22.78円/kWhが出発点の目安になります。ただし工場では、同じ単価でも負荷率（連続操業か二交代か）、契約電力（デマンド）、力率によって実質単価が変わります。本ページでは、区分別の目安、単価に効く要素、生産量あたりの原単位での見方、単価が高い工場が確認すべき点までを、計算の手順に沿って解説します。
          </p>
          <AuthorBadge publishedAt="2026-08-08" updatedAt="2026-08-19" />
          <div className="mt-4 rounded-lg border border-sky-300 bg-white p-4">
            <p className="text-sm font-semibold text-slate-900">このページでわかること</p>
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-7 text-slate-700">
              <li>工場の契約区分別の1kWh単価の目安（高圧22.78・低圧電力34.42・特高17.45円/kWh）</li>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              工場の電気代を1kWhあたりで捉えるとき、基準になるのは契約区分別の単価です。下表は電力・ガス取引監視等委員会「電力取引報」から算出した2026年5月分（確定・最新公表）の全国計単価で、受電設備を持つ一般的な工場が該当する高圧は22.78円/kWhです。
            </p>
          ...
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <ul className="mt-3 list-disc space-y-1 pl-5 text-sm leading-7 text-slate-700 sm:text-base">
              ...
              <li>契約区分の水準（高圧22.78円/kWh等）と突き合わせ、差の大きさを確認する</li>

...
const TAGS = [
  ...
  { tag: "補助金", count: 18, articles: ["sme-subsidy-funding-guide", "ev-charging-subsidies"] },
  ...
  { tag: "業種別", count: 35, articles: ["factory-electricity-cost-review", "logistics-warehouse-electricity-cost-review"] },
  { tag: "東日本", count: 12, articles: ["east-japan-electricity-trends"] },
  { tag: "西日本", count: 12, articles: ["west-japan-electricity-trends"] },
  { tag: "GX-ETS", count: 6, articles: ["gx-ets-impact-business-electricity", "gx-ets-regulation-timeline"] },
];

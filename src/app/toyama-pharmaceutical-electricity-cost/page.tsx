...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "全国展開新電力",
    detail:
      "富山県内の高圧・特別高圧医薬品工場の競争入札における主要な対抗候補です。固定単価メニュー（2〜5年契約）が中心で、年間使用量の大きい受託製造（CMO/CDMO）大型案件で実績を積み上げています。ただし北陸エリアは水力比率が高く燃調感応度が低めとされるため、大きな価格差が出にくい局面もあり、供給可能kWh枠と燃調条件を含めた総合比較が必要です。なお本記載は特定の電力会社・契約形態の優劣を述べるものではありません。",
  },
  {
...
const priceBenchmark = [
  ...
  },
  {
    ...
    detail:
      "富山市・高岡・滑川・立山町の高圧医薬品工場（500kW〜2,000kW級）は『業務用高圧電力』が中心で、電力量料金は15〜19円/kWh＋調整項目とされます。再エネ賦課金（2026年度4.18円/kWh・確定）と燃調を加えた実質単価は21〜26円/kWhレンジが目安です。北陸は水力比率が高く燃調感応度が低めとされるため、新電力切替による下げ幅が出にくい局面もある一方、単価の安定性が得られる点はメリットになり得ます。いずれにせよ自社の使用実態に即した比較検討が前提です。",
  },
  {
...
const switchingReality = [
  ...
  },
  {
    ...
    detail:
      "メリット: 災害時復旧体制・大口需要家向けエネルギーマネジメント支援・水力中心の安定供給。デメリット: 新電力との比較で単価がやや高めになる局面、燃料費調整額の条件差。北陸は水力比率が高く燃調感応度が低めとされるため、新電力との価格差が出にくい局面もあり、継続か切替かは総合的な比較が必要です。いずれにせよ本記載は特定の電力会社を推奨するものではありません。",
  },
  {
...
const faqItems = [
  {
    ...
    answer:
      "北陸電力エリアは水力発電比率が全国的にも高く、電力単価が相対的に低位とされるのがエリア固有の特徴です。火力依存度が低いため燃料費調整額の感応度も相対的に低めで、燃料高騰局面で単価が急騰しにくいメリットがあります。ただし渇水年には水力出力が落ち火力比率が上がるため燃調がゼロになるわけではありません。水力比率の高さから燃調感応度が低めとされ、新電力切替による下げ幅が出にくい局面もある点に留意が必要です。なお本回答は特定の電力会社・契約形態を推奨するものではありません（出典: 北陸電力 単価実績・エネ庁から整理）。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "全国系（ENEOSでんき・出光・サミットエナジー等）と地域系・ガス系新電力が主要なプレイヤーです。北陸エリアは水力比率が高く燃調感応度が低めとされるため、大きな価格差が出にくい局面もあり、燃調条件・契約期間・非化石証書付の有無を含めた総合比較が重要になります。特定企業の供給実績は入札情報公開やIR・業界紙の範囲で確認可能です。いずれにせよ本回答は実情の整理を目的としたものです。",
  },
  {

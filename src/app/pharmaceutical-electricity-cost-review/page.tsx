...
const industryBenchmark = [
  ...
  },
  {
    label: "製品単位あたりの電力使用量",
    detail:
      "錠剤1万錠製造で5〜15kWh、注射剤1万本で8〜25kWh、バイオ医薬品1バッチ（5,000L）で50,000〜150,000kWh。バイオ医薬品が電力集約的で、製薬業全体の電力消費の中核。",
  },
  {
    label: "工場規模別の年間使用量",
    detail:
...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。年間3,600万kWh使用の中規模製薬工場で年1.5億円の負担、5年で7.52億円。減免制度（年間1,000万kWh以上等）の対象規模だが申請要件は厳格。",
  },
  {

...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "日本複合カフェ協会・経産省特定サービス産業実態調査によれば、ネットカフェ・マンガ喫茶業の電気料金は売上高の8〜15%（24h営業・個室PC多い店舗で高水準）。事業原価に占める比率は15〜25%。24h個室空調＋PC連続稼働が業種固有のコスト構造を形成。",
  },
  {
...
const faqItems = [
  { question: "ネットカフェ・マンガ喫茶の電気代水準はどれくらいですか？", answer: "売上高比8〜15%（24h営業・個室PC多い店舗で高水準）、事業原価比15〜25%が業界平均。中規模FC加盟店（年商2億円級）で年850〜2,800万円、100店舗超大手チェーン（年商200億円超）で年17〜52億円規模の電気代になります。" },

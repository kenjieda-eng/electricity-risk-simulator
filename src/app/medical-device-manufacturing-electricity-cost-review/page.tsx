...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・日本医療機器産業連合会の統計によれば、医療機器製造業の電気料金は売上高の3〜10%（クリーンルーム多い工場は高水準）。製造原価に占める比率は5〜15%。クリーンルーム空調24h稼働で電力依存度が高い業種。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。年間2,500万kWh使用の中規模工場で年1.045億円の負担。",
  },
  {
...
const faqItems = [
  { question: "医療機器製造業の電気代水準はどれくらいですか？", answer: "売上高比3〜10%（クリーンルーム多い工場は高水準）、製造原価比5〜15%が業界平均。中規模医療機器工場（年商150億円級）で年2.4〜10.5億円、大規模医療機器メーカー（年商500億円超）で年10.5〜60億円規模の電気代になります。" },
  ...
  { question: "医療機器業の固定プランと市場連動プランどちらが向きますか？", answer: "クリーンルーム空調・滅菌設備の連続稼働、GMP対応の品質管理電力で連続稼働必須のため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続企業で月数千万円の追加負担が発生しました。" },
  ...
  { question: "自家消費型太陽光は医療機器工場で投資回収できますか？", answer: "屋根面積2,500m²以上、24hクリーンルーム稼働の工場は相性が良好です。1MWで年100〜130万kWh発電、年1,000〜1,500万円の削減、投資回収7〜10年（補助金後5〜7年）が目安です。自家消費率80%超になりやすく投資効率が高いです。" },
];
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。医療機器業の中規模工場では負担額が請求総額の10〜15%に達します。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。年間2,000万kWh使用の中規模工場で年8,000万円超の負担。減免制度対象になりやすい大規模工場は申請を要検討。",
  },
  {
    label: "夏季ピーク需要の集中",
    detail:
...
const faqItems = [
  ...
  { question: "飲料業の固定プランと市場連動プランどちらが向きますか？", answer: "夏季ピーク（清涼飲料）または発酵期（酒類）に大量電力を使う特性上、市場連動プランは高騰時のリスクが極めて大きいです。固定プラン（3〜5年）が向き、2022〜2023年の市場高騰局面では市場連動継続企業で月数千万円の追加負担が発生しました。" },
  ...
  { question: "自家消費型太陽光は飲料工場で投資回収できますか？", answer: "屋根面積3,000m²以上、夏季ピーク需要の高い清涼飲料工場は相性が良好です。夏季発電量と需要のマッチングが良好で、自家消費率80%超になりやすく投資回収は7〜10年（補助金後 5〜7年）が目安です。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。中規模清涼飲料工場では負担額が請求総額の10〜15%に達します。
            </p>
            <div className="mt-4 space-y-3">
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">

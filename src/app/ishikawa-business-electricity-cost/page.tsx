...
const pageDescription =
  "石川県・金沢の法人電気代の相場を、契約区分別の全国確定単価（高圧22.78円/kWh等）を基準に読む手順で整理。北陸電力エリアの水力比率と2023年値上げが単価に及ぼす構造、電力会社を比較する5観点、機械工業・金沢の観光業・加賀温泉郷の負荷特性と契約見直しを実務目線で解説します。";
...
const faqItems = [
  { question: "石川県の法人電気代水準は全国比どれくらいですか？", answer: "2023年4月に北陸電力の料金改定（45.84%）が実施され、その後の水準が比較の起点になっています。全国的な水準との差は契約区分・使用量・負荷率により変わるため、請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。新電力への切替による単価最適化の余地があるかは、複数社から同一条件で見積を取って比較してください。" },
  ...
  { question: "石川県で固定プランと市場連動プランのどちらが向きますか？", answer: "冬季ピーク時のスポット価格高騰リスクと2023年大幅値上げの経験を考えると、24時間稼働の機械工業・観光業・冷凍倉庫は固定プランが向きます。市場連動プランは限定的なケースのみ検討対象です。" },
  ...
  { question: "石川県・金沢の電気代の平均・相場はどれくらいですか？", answer: "県や市の単位で法人の電気代平均を示した公的統計はないため、契約区分ごとの全国確定単価を基準に置いて読みます。電力取引報の最新確定分である2026年5月分（全国計・販売額÷販売電力量）は、特別高圧17.45円/kWh、高圧22.78円/kWh、低圧電灯27.85円/kWh、低圧電力34.42円/kWhでした。この販売額には基本料金・電力量料金・燃料費調整額が含まれ、消費税・再エネ賦課金は含まれません。金沢の宿泊施設と加賀の工場では契約区分も負荷の形も異なるため、県平均という一つの数字ではなく、自社と同じ区分の全国値と請求書の実質単価を突き合わせる形で確認してください。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計・販売額÷販売電力量で求めた値であり、石川県または北陸電力エリアの平均値ではありません。販売額には基本料金・電力量料金・燃料費調整額を含み、消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年5月分・確定）。単価の定義は{" "}
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
              石川県は北陸電力エリアに属します。同エリアは豊富な包蔵水力を背景に水力の比率が高く、燃料価格の変動が単価に伝わる経路が火力中心のエリアとは異なります。一方で2023年には大幅な料金改定があり、その水準がその後の比較の起点になっている事業者も少なくありません。全国値との差を見るときは、燃料費調整額の効き方に加えて、改定後の料金メニューを前提に置けているかを確認してください。
            </p>
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">

...
const pageTitle =
  "愛知県の自動車・輸送機器工場の電気料金ガイド｜豊田・刈谷・田原・みよしの特別高圧プレス／塗装／溶接ライン";
...
const electricSituation = [
  {
    ...
    detail:
      "愛知県は出荷額ベースで大規模な自動車産業集積地。豊田市（トヨタ自動車本社・本社工場・元町・上郷・高岡・堤・下山・三好・衣浦）、刈谷市（デンソー本社・アイシン本社・豊田自動織機）、田原市（トヨタ田原工場：レクサス）、みよし市・安城市・西尾市・岡崎市までを含むサプライチェーンが県全体に広がります。完成車・Tier1・Tier2・金型・治工具・物流・試験までが半径30km圏に集積する構造で、特別高圧契約の集中度が高いエリアです（出典: 愛知県統計年鑑・経産省工業統計）。",
  },
  {
...
const industryProfile = [
  {
    ...
    detail:
      "トヨタ自動車本社・本社工場・元町・上郷・高岡・堤・下山・三好・衣浦の各工場が集中。完成車組立＋エンジン＋トランスミッション＋一部部品まで内製領域が広く、特別高圧契約の集中度が高い。年間総電力需要は数十億kWh規模に達するとされます。",
  },
  {
...
const energySaving = [
  ...
  },
  {
    ...
    detail:
      "工場のエア漏れ・過剰圧力設定の見直し＋高効率インバータコンプレッサー更新で電力▲15〜25%。Tier1・Tier2いずれでも投資効率が高く、SII補助1/2で回収可能（1.5〜2.5年）。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">
            愛知県の自動車・輸送機器工場の電気料金ガイド
          </h1>
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            愛知県はトヨタ自動車本社を中心に、豊田・刈谷・田原・みよし・安城・西尾・岡崎までを含む大規模な自動車産業集積地です。本ページでは「愛知県 × 自動車・輸送機器製造業」というクロス領域に絞り、中部電力エリア固有の単価事情と、プレス／塗装／溶接／組立ラインの電力プロファイル、特別高圧の競争入札、補助金活用、EV化に伴う需要構造変化までを実務目線で整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              愛知県は出荷額・事業所数・従業員数のいずれでも大規模な自動車産業集積地です。完成車・Tier1・Tier2・素材・物流・試験までが半径30km圏内に完結する構造で、特別高圧契約の集中度が極めて高いエリアとなっています。
            </p>

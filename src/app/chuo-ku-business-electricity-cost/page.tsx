...
const electricSituation = [
  {
    ...
    detail:
      "中央区は銀座・日本橋・八重洲の伝統的商業金融地区、月島・晴海・勝どき・豊海の湾岸住商開発、築地・新富町の食品流通＋再開発進行エリアの三層構造です。区内の事業所密度は高く、平日昼夜・週末の負荷パターンがエリア別に大きく異なります（出典: 中央区統計）。",
  },
  {
    label: "銀座エリアのファサード照明・ブランド店舗の電力負荷",
    detail:
      "銀座中央通り・並木通り・銀座6〜8丁目はブランド店舗の集積地。ファサード照明・ショーウィンドウ照明・店内高演色LEDが営業時間外も含めて電力を消費し、店舗当たり契約電力50〜200kW級が一般的。深夜帯のベース負荷も比較的高い「都心商業型」のプロファイルです。",
  },
  {

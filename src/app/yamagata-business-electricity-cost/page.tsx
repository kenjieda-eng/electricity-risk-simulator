...
const electricSituation = [
  ...
  },
  {
    label: "気象条件 — 寒冷地と豪雪",
    detail:
      "暖房度日（HDD18）は年間3,500〜3,800と高水準。冬季の降雪量は新庄・米沢で年間8〜12mに達し、屋根融雪・ロードヒーティング・除排雪電力需要が法人事業所コストを押し上げる。夏季は山形盆地で日中35℃超の猛暑日となり、冷房負荷も高い『寒暖両極の県』。",
  },
  {
...
const priceBenchmark = [
  {
    ...
    detail:
      "東北電力『業務用高圧電力』の電力量料金は18〜22円/kWh（夏季・その他季・時間帯により変動）。燃料費調整額（2024〜2025年は+3.0〜+4.5円/kWh）と再エネ賦課金（2025年度3.98円/kWh）を加味すると実質単価は25〜30円/kWhレンジ。寒冷地特有の冬季使用量増により、単価だけでなく年間電気代総額でも確認が必要。",
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
...
const costFactors = [
  {
    label: "寒冷地暖房需要のインパクト",
    detail:
      "暖房度日3,500超と高水準。電気パネルヒーター・電気温風機・エアコンによる暖房負荷で、冬季月別電気代が他季の2〜3倍に。年間電気代に占める暖房分は県内事業所平均で25〜35%、温泉ホテル等で50%超。",
  },
  {
    label: "豪雪・融雪設備の電力消費",
    detail:
...
const industryProfile = [
  ...
  },
  {
    ...
    detail:
      "さくらんぼの一大生産地。CA冷蔵庫（低酸素貯蔵）・予冷庫・選果場の電力負荷が大きい。果樹園農協・農業生産法人の所有で県内に100施設以上。",
  },
  {
...
const switchingReality = [
  {
    label: "新電力切替の県内浸透度",
    detail:
      "2024年時点で山形県内法人の新電力シェアは15〜20%（経産省統計）。山形市・米沢市の都市部では切替が進んだが、地方部では東北電力継続が多数。地域新電力（やまがた新電力）の存在感も中位水準。",
  },
  {
    label: "市場連動プランのリスク認識",
    detail:
...
const faqItems = [
  { question: "山形県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の単価について、全国的な水準との差は契約区分・使用量・負荷率により変わります。冬季の暖房負荷と夏季の冷房負荷で年間使用量が伸びやすいため、単価だけでなく年間総額でも確認してください。請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。" },
  ...
  { question: "山形県で固定プランと市場連動プランのどちらが向きますか？", answer: "冬季ピーク時のスポット価格高騰リスクを考えると、24時間稼働の工場・果樹冷蔵・温泉ホテルは固定プランが向きます。市場連動プランは、夏季のみ稼働・週末停止可能な事業所など限定的なケースのみ検討対象です。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              山形県は冬季暖房・夏季冷房の両ピークで使用量が多くなるため、単価だけでなく年間総額でも確認してください。実質単価（電力量料金+燃料費調整額+再エネ賦課金）ベースで比較することが重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/akita-business-electricity-cost", title: "秋田県の法人電気料金", description: "隣接県・風力発電が集積する秋田県の事情。" },
              ...
              { href: "/food-processing-electricity-cost-review", title: "食品加工業の電気料金見直し", description: "庄内・村山の食品加工業の見直し論点。" },

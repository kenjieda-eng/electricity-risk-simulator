...
const faqItems = [
  ...
  { question: "放送業の固定プランと市場連動プランどちらが向きますか？", answer: "送信所24h連続稼働＋本社放送センター連続稼働でベースロードが大きく、固定プランが向きます。市場高騰のリスクが事業損益直撃する業種であり、2022〜2023年の高騰局面では市場連動継続局で月数千万円の追加負担が発生しました。" },

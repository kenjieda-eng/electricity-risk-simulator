    ...
    <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
      ...
      <section className="mt-6 space-y-6">
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-5">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
            容量拠出金は、<Link href="/renewable-energy-surcharge" className="text-sky-700 underline underline-offset-2 hover:text-sky-900">再エネ賦課金</Link>（2025年度: 約4.0円/kWh）と比べると金額は小さいものの、
      ...
      <div className="mt-6">
        <GlossaryLinks currentSlug="capacity-contribution-cost-impact" terms={["容量拠出金", "再エネ賦課金", "燃料費調整額", "電力量料金", "基本料金", "電気料金の内訳"]} />
      </div>

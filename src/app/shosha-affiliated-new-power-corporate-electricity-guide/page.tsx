        ...
        <section className="mt-6 space-y-6">
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/summit-energy-corporate-electricity-guide", title: "サミットエナジー（法人向け）ガイド", description: "商社系新電力（住友商事系）の例。" },
              { href: "/marubeni-shinden-corporate-electricity-guide", title: "丸紅新電力（法人向け）ガイド", description: "商社系新電力（丸紅系）の例。" },
              { href: "/itochu-enex-corporate-electricity-guide", title: "伊藤忠エネクス（法人向け）ガイド", description: "商社系・流通系新電力の例。" },
              { href: "/ennet-corporate-electricity-guide", title: "エネット（法人向け）ガイド", description: "法人特化の新電力の例。" },

...
const relatedLinks = [{"href":"/aquarium-zoo-electricity-cost-review","title":"水族館・動物園の電気料金見直しポイント","description":"生命維持設備の常時稼働・ろ過ポンプ・水温管理の電力構造と契約見直しの着眼点を整理。"},{"href":"/industry-electricity-calculator","title":"業種別電気代計算機","description":"業種・規模・契約・エリアから推定年間電気代と削減余地を即時試算。"},{"href":"/articles/case-studies","title":"事例・削減実績を知る（カテゴリ一覧）","description":"業種別・状況別のケーススタディ集。"},{"href":"/electricity-cost-reduction-case-studies","title":"法人の電気代を下げた事例集","description":"複数業種の削減施策・投資回収を構造化。"},{"href":"/electricity-glossary#demand-power","title":"法人電気料金の総合用語集 200+ 用語","description":"「②デマンド・力率関連」の節で確認できます。"},{"href":"/demand-control-guide","title":"デマンド制御ガイド","description":"ピークカットで基本料金を抑える考え方。"},{"href":"/energy-management-roi-calculation","title":"エネマネ投資のROI計算","description":"投資回収の考え方。"},{"href":"/contract-review-practice-guide","title":"契約見直しの実務ガイド","description":"相見積・契約最適化の進め方。"},{"href":"/subsidy-sii-energy-saving","title":"SII省エネ補助金の活用","description":"設備更新の補助金スキーム。"},{"href":"/subsidy-gx-cn-investment-tax","title":"GX・CN投資促進税制ガイド","description":"省エネ・低炭素投資の税制優遇。"},{"href":"/amusement-facility-electricity-cost-review","title":"アミューズメント施設の電気代見直し","description":"空調中心の電力構造。"},{"href":"/karaoke-box-electricity-cost-review","title":"カラオケ店の電気代見直し","description":"個室空調の論点（近縁業種）。"},{"href":"/internet-cafe-electricity-cost-review","title":"インターネットカフェの電気代見直し","description":"24時間空調・機器の論点（近縁業種）。"},{"href":"/cultural-facility-electricity-cost-review","title":"文化施設の電気代見直し","description":"ホール空調の電力構造。"},{"href":"/film-production-studio-electricity-cost-review","title":"映像制作スタジオの電気代見直し","description":"撮影照明・空調（制作側の読み分け）。"},{"href":"/subsidy-hotel-leisure-strategy","title":"ホテル・レジャーの補助金戦略","description":"レジャー施設の投資支援。"},{"href":"/led-air-conditioning-reduction-effect","title":"LED・空調の削減効果","description":"空調・照明の効果目安。"},{"href":"/demand-control-reduction-effect","title":"デマンド削減の効果","description":"上映スケジュール連動の効果目安。"}];

...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "九州電力エリアは玄海・川内の原子力（4基稼働中）＋大規模太陽光（九州は太陽光導入量国内最大級）＋LNG火力で電源構成が多様。原子力＋太陽光比率の高さから燃料費調整額の感応度は相対的に低めとされ、商業・小売の電力コストの安定性に寄与。一方、春秋の太陽光出力大で昼間の市場価格が下がる九州固有のパターンもあり、商業の昼間営業との相性が論点です（出典: 九州電力供給計画／エネ庁エネルギー基本計画）。",
  },
];
...
const faqItems = [
  {
    ...
    answer:
      "相対的に安定しています。九州電力エリアは玄海・川内の原子力4基稼働と太陽光導入量が国内最大級であることから、LNG/石炭への依存度が相対的に低く、燃料費調整額の変動幅は小さめで推移してきたとされます。2022〜2023年の燃料高騰時の単価上昇も東京・中部・北海道より小さく、商業・小売にとっては電力コストの安定性が確保しやすい構造です。固定契約での安定運用に適したエリアと言えます（出典: 九州電力供給計画／エネ庁エネルギー白書）。",
  },
  {

...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "九州電力エリアは玄海・川内の原子力（4基稼働中）＋大規模太陽光（九州は太陽光導入量が大きい）＋LNG火力で電源構成が多様。原子力＋太陽光比率の高さから燃料費調整額の感応度は相対的に低めとされ、商業・小売の電力コストの安定性に寄与。一方、春秋の太陽光出力大で昼間の市場価格が下がる九州固有のパターンもあり、商業の昼間営業との相性が論点です（出典: 九州電力供給計画／エネ庁エネルギー基本計画）。",
  },
];
...
const utilitiesList = [
  {
    ...
    role: "一般小売事業者（旧一電）",
    detail:
      "福岡県内商業・小売の最大シェア。『高圧電力』『業務用季節別時間帯別電力』が主軸メニュー。原子力＋太陽光の電源構成を背景に、燃料費調整額の感応度は相対的に低めとされ、商業施設の電力コスト安定性に寄与。天神・博多の大型商業施設の高圧需要家を多数抱えています。",
  },
  {
    name: "九電みらいエナジー",
    role: "九電グループ新電力",
...
const priceBenchmark = [
  {
    ...
    detail:
      "百貨店・大型商業施設（高圧500kW〜2,000kW級）の電力量料金は標準メニューで概ね17〜21円/kWh+調整項目。燃料費調整額（2024〜2025年で+1.5〜+3.0円/kWh目安・原子力＋太陽光により変動幅は相対的に小さいとされる）と再エネ賦課金（2025年度3.98円/kWh）を加算した実質単価は23〜28円/kWhレンジ。新電力競争入札では標準比1〜3円/kWh下げが目安です。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "九州電力エリアは原子力4基稼働＋太陽光導入量が多く、LNG/石炭依存度が他エリアより低い。2022〜2023年の燃料高騰時の燃調変動幅も東京・中部・北海道より小幅で推移しました。商業・小売の単価変動リスクは相対的に低めで、固定契約での安定運用に適した構造です（出典: 九州電力供給計画／エネ庁エネルギー白書）。",
  },
];
...
const costFactors = [
  ...
  },
  {
    label: "九州エリアの燃調感応度（相対的に低い）",
    detail:
      "九州電力エリアは原子力＋太陽光比率が高く、燃調の変動幅は相対的に小さいとされます。2022〜2023年高騰時の単価上昇リスクは相対的に小さく、商業・小売にとっては電力コストの安定性が確保しやすい構造。固定契約での安定運用に適しています。",
  },
  {
...
const industryProfile = [
  ...
  },
  {
    label: "九州電力・系統・太陽光資源",
    detail:
      "九州電力の原子力（玄海・川内）＋太陽光（九州は導入量が大きい）＋火力が主軸。太陽光出力が大きい春秋は出力制御も発生する一方、商業の昼間営業との相性は良い。福岡の商業施設の屋上太陽光・PPA調達のポテンシャルも大きいエリアです。",
  },
];
...
const faqItems = [
  {
    ...
    answer:
      "相対的に安定しています。九州電力エリアは玄海・川内の原子力4基稼働と太陽光導入量が多いことから、LNG/石炭への依存度が相対的に低く、燃料費調整額の変動幅は小さめで推移してきたとされます。2022〜2023年の燃料高騰時の単価上昇も東京・中部・北海道より小さく、商業・小売にとっては電力コストの安定性が確保しやすい構造です。固定契約での安定運用に適したエリアと言えます（出典: 九州電力供給計画／エネ庁エネルギー白書）。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "プラスに働く面があります。九州は太陽光導入量が大きく、春秋の昼間は太陽光出力が大きく市場価格が下がる（時にゼロ円・出力制御）独自パターンがあります。商業施設は昼間営業が中心のため、市場連動型プランで昼間の安価な電力を活用できる余地があります。一方、夕方〜夜間のピークは高値のため、固定契約＋部分的な市場活用、または屋上太陽光自家消費との組合せが現実的。九州は商業施設の屋上太陽光・PPA調達の適地でもあります。",
  },
  {

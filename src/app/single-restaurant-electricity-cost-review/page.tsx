...
export default function SingleRestaurantElectricityCostReviewPage() {
  return (
    <>
      <ArticleJsonLd
        headline="単独飲食店の電気料金見直しポイント｜調理設備と低利益率を踏まえた考え方"
        description="単独飲食店の電気料金が上がりやすい要因と、契約見直しの着眼点を解説。調理設備・空調・冷蔵の負荷特性、低利益率業種での判断基準、固定プランと市場連動の向き不向きまで整理します。"
        url="https://simulator.eic-jp.org/single-restaurant-electricity-cost-review"
    ...
    <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
      <nav aria-label="パンくず" className="text-sm text-slate-600">
        ...
        <span className="px-2">›</span>
        <span className="text-slate-800">単独飲食店の見直しポイント</span>
      </nav>
...
<div className="mt-6">
        ...
        />
          ...
          <GlossaryLinks currentSlug="single-restaurant-electricity-cost-review" terms={["燃料費調整額", "市場価格調整額", "再エネ賦課金", "市場連動プラン", "固定プラン", "電気料金の内訳"]} />
        </div>

...
const pageTitle =
  "電力会社の調達構成が法人料金に与える影響｜JEPX依存度・自社電源比率の見方";
const pageDescription =
  "電力会社がJEPX依存型か自社電源中心型かによって、法人向け電気料金の安定性とコスト水準が大きく変わります。新電力 vs 大手電力の調達構造の違い、それぞれの料金リスク、契約時に確認すべき調達情報の見方を法人担当者向けに中立社団が解説。";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: [
      { url: "/api/og/power-procurement", width: 1200, height: 630, alt: pageTitle },
    ],
  },
  twitter: {

...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "港区は東京ガス本社所在地で、芝・浜松町・汐留・大門エリアで東京ガス系の地域冷暖房（DHC）・コージェネ普及率が高水準。電気＋ガスの一体契約・GHP・エネファーム導入ビルが多く、買電量を抑える設計が定着しています。",
  },
  {
...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "ガス系新電力",
    detail:
      "港区は東京ガス本社所在地で、電気＋ガスの一体契約・コージェネ既設ビルでの実績がある。芝・浜松町・汐留・大門エリアで強み。電気＋ガス＋熱の総合エネルギーマネジメント提案が差別化ポイントです。",
  },
  {

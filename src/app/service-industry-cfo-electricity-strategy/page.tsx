...
const industryBenchmark = [
  ...
  },
  {
    ...
    detail:
      "データセンター事業者（さくらインターネット・ソフトバンクテクノロジー等）、IT受託開発業（NTTデータ・大塚商会等）。サーバ・空調電力で売上高比率が高水準。PUE改善・外気冷房・液浸冷却が主要省エネ手段。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "NTTドコモ・KDDI・ソフトバンク・楽天モバイル等。基地局・ネットワーク機器・データセンターの24時間稼働。年間使用量数十億kWh規模で、業態として大規模な電力需要家。5G普及で電力需要急増中。",
  },
];

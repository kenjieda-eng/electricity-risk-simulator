...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、中国電力エリアの特別高圧電力単価は2024年度実績で約17〜20円/kWh（電力量料金ベース）。全国的な水準との差は契約区分・使用量・負荷率により変わります。県内大型事業者（マツダ・呉造船・福山JFE・マイクロン）にとっては、新電力の競争入札で1〜2円/kWhの優遇を引き出せれば年間10〜30億円規模の差が出る。広島県は中国電力管内最大需要県として共同調達・包括契約の選択肢も豊富。",
  },
  {
...
const faqItems = [
  { question: "広島県の法人電気代水準は全国比どれくらいですか？", answer: "中国電力エリアは石炭火力への依存度が高いとされます。2024年12月の島根原発2号機再稼働は電源構成に関わる変化ですが、今後の単価水準は断定できません。新電力競争で1〜2円/kWh安いケース多数。マツダ・呉造船・福山JFEスチールは新電力切替で年間1〜30億円規模のコスト削減事例も。" },

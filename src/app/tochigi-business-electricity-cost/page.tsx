...
const pageDescription =
  "栃木県の法人電気代を、平均・相場の考え方から整理。全国の確定単価（高圧22.78円/kWh等）を基準に東京電力エリアの燃料費調整・JEPX特性で読み替える手順、電力会社を比較する5つの観点、宇都宮・小山の自動車工業や日光・那須の観光業の負荷特性と契約見直しを解説します。";
...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇。自動車部品工場（年間3,000万kWh）で年1.2億円規模の負担、5年で6億円。",
  },
  {
...
const faqItems = [
  ...
  { question: "栃木県で固定プランと市場連動プランのどちらが向きますか？", answer: "24時間稼働の自動車部品工場・物流冷凍倉庫・大型リゾートホテルは固定プランが向きます。中小オフィス・店舗は使用量が小さいため市場連動でも影響限定的ですが、2022〜2023年の市場高騰経験から固定プランが主流です。" },
  ...
  { question: "栃木県の電気代の平均・相場はいくらですか？", answer: "県単位で法人の電気代の平均額を示した公的統計はないため、全国の確定単価を基準に読むのが実務的です。電力取引報の最新確定分である2026年5月分（全国計・販売額÷販売電力量）は、特別高圧17.45円/kWh、高圧22.78円/kWh、低圧電灯27.85円/kWh、低圧電力34.42円/kWhでした（消費税・再エネ賦課金を含まない参考値）。栃木県は東京電力エリアのため、この全国値にLNG火力比率の高さに由来する燃料費調整額の振れやすさを重ねて読みます。自社の位置を知るには、請求書から消費税と再エネ賦課金を差し引いた額（基本料金・電力量料金・燃料費調整額の合計）を使用量で割って実質単価を算出し、同じ契約区分の全国値と比べてください。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              栃木県では2024年時点で約12社の新電力が法人向け高圧で新規受付中。東京電力エリアは新電力競争が活発です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
              最初に契約区分ごとの全国水準を押さえます。下記は電力取引報の最新確定分である2026年5月分の実績単価です。自社がどの区分に属するかで基準値が10円/kWh以上変わるため、まず契約区分の確認から始めてください。
            </p>
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計（多くの事業者が検針期間ベースで報告・暦月ベースも可）であり、栃木県または東京電力エリアの平均値ではありません。消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年5月分・確定）。この単価に含む費目・含まない費目の定義は{" "}
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/auto-parts-electricity-cost-review", title: "自動車部品工場の電気料金見直し", description: "宇都宮・小山の自動車工業に直結。" },

...
const pageTitle =
  "自家消費型太陽光が向く法人の特徴｜屋根面積・電力使用パターン・自社所有 vs PPA 完全ガイド";
const pageDescription =
  "自家消費型太陽光発電の投資対効果が出やすい法人の特徴を、屋根面積（500m²以上推奨）・電力使用パターン（昼間負荷比率40%以上）・契約区分（高圧・特高）・業種別の4軸で完全整理。自社所有モデルと PPA モデルの選び分け基準、業種別の投資回収期間目安まで一般社団法人エネルギー情報センターが中立解説。";
...
export default function SolarSuitedCorporationsPage() {
  return (
    <>
      <ArticleJsonLd
        headline="自家消費型太陽光が向く法人の特徴｜屋根面積と使用パターンの条件"
        description="自家消費型太陽光発電の投資対効果が出やすい法人の特徴と条件を解説。屋根面積・電力使用パターン・契約形態・業種別の傾向など、費用対効果を左右する主要な判断軸を実務目線で整理します。"
        url="https://simulator.eic-jp.org/solar-suited-corporations"

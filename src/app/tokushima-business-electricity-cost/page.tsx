...
const priceBenchmark = [
  {
    ...
    detail:
      "四国電力『高圧電力A』の電力量料金は17〜21円/kWh（夏季・その他季・時間帯により変動）。燃料費調整額（2024〜2025年は+1.5〜+3.0円/kWh、伊方原発稼働により比較的低水準）と再エネ賦課金（2025年度3.98円/kWh）を加味すると実質単価は23〜27円/kWhレンジ。小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは全国最低水準で推移してきたという二面性があります。単価の高低は見る指標によって変わります。",
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、四国電力エリアの特別高圧電力単価は2024年度実績で約16〜19円/kWh（電力量料金ベース）。四国エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは全国最低水準で推移してきたという二面性があります。関西電力エリアと並んで全国でも安価な部類。県内大型事業者（日亜化学・大塚製薬・大塚化学）にとっては、新電力の競争入札で1〜2円/kWhの優遇を引き出せれば年間5〜30億円規模の差が出る。",
  },
  {
...
const faqItems = [
  { question: "徳島県の法人電気代水準は全国比どれくらいですか？", answer: "四国電力エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは全国最低水準で推移してきたという二面性があります。固定型か市場連動型かで効く指標が異なるため、単価水準を一括りにはできません。日亜化学・大塚製薬は新電力切替で年間1〜10億円規模のコスト削減事例も。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            徳島県は四国電力エリアで、阿南市の日亜化学工業（青色LED発明・世界トップシェア・パワー半導体）、徳島市・松茂の大塚製薬・大塚化学の医薬品工業、鳴門わかめ水産加工、阿波踊り・鳴門うずしお・祖谷渓の観光業など多様な産業構造を持ちます。新電力を含めた競争入札を検討する余地がある県です。本ページでは新電力ネット（pps-net.org/unit）のエリア別単価データを県の産業構造に紐づけて再加工し、業種別の契約見直し・補助金活用を実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              四国電力エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは全国最低水準で推移してきたという二面性があります。固定型か市場連動型かで効く指標が異なるため、単価水準を一括りにはできません。実質単価（電力量料金+燃料費調整額+再エネ賦課金）ベースで比較することが重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

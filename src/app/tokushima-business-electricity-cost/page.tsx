...
const pageTitle =
  "徳島県の法人電気料金ガイド｜四国電力エリア単価分析・日亜化学LED・医薬品・阿波踊り観光の契約最適化";
...
const electricSituation = [
  {
    ...
    detail:
      "徳島県は四国電力のエリア。徳島市・鳴門・阿南・吉野川・美馬・三好の6地域から構成。県内総電力需要は約50億kWhで四国電力管内の約20%を占める。阿南市の日亜化学工業（LED・半導体）、徳島市大塚製薬・医薬品工業、鳴門わかめ水産加工、阿波踊り観光業が県内電力消費の中核。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "阿南市は日亜化学工業（青色LED発明・半導体）の大型工場立地。徳島市は大塚製薬・大塚化学・大塚倉庫の医薬品・食品工業集積。鳴門市は鳴門わかめ水産加工。観光業は阿波踊り（徳島市・8月）、鳴門うずしお、祖谷渓に集積。三好市・美馬市は山間部の小規模事業者中心。",
  },
];
...
const priceBenchmark = [
  ...
  },
  {
    ...
    detail:
      "四国電力エリアの単価水準は、小売と卸で見え方が異なる二面性があるとされます。燃料費調整額は中国電力エリアより0.5〜1円/kWh低水準で推移しており、徳島県内事業者にも直接的なメリット。新電力経由でさらに優遇可能性。",
  },
];
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、四国電力エリアの特別高圧電力単価は2024年度実績で約16〜19円/kWh（電力量料金ベース）。四国エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは低い水準で推移してきたという二面性があります。関西電力エリアと並んで全国でも安価な部類。県内大型事業者（日亜化学・大塚製薬・大塚化学）にとっては、新電力の競争入札で1〜2円/kWhの優遇を引き出せれば年間5〜30億円規模の差が出る。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "pps-net.org/unit の単価データを徳島県の産業構造に紐づけて再加工すると、①日亜化学（LED）のような24時間連続稼働特高契約は固定5年で年間5〜15億円の安定化効果、②大塚製薬・大塚化学の医薬品工業特高契約は厳格な品質管理（クリーンルーム・恒温恒湿）を支える安定電源が必須、③鳴門わかめ・阿波踊り関連の中小高圧契約は地域密着型新電力との連携で年間100〜300万円規模の最適化余地、という3層構造で契約判断を行うべき。伊方原発稼働メリットを織り込んだ見積取得が重要。",
  },
];
...
const costFactors = [
  ...
  },
  {
    label: "伊方原発稼働のプラス影響",
    detail:
      "四国電力エリアの単価水準は、小売と卸で見え方が異なる二面性があるとされます。燃料費調整額は中国電力エリアより0.5〜1円/kWh低水準で推移しており、徳島県内事業者にも直接的なメリット。",
  },
  {
...
const industryProfile = [
  {
    label: "LED半導体（阿南）",
    detail:
      "日亜化学工業（青色LED発明・パワー半導体）。年間使用量5〜15億kWh規模の超大型事業者。",
  },
  {
...
const faqItems = [
  { question: "徳島県の法人電気代水準は全国比どれくらいですか？", answer: "四国電力エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは低い水準で推移してきたという二面性があります。固定型か市場連動型かで効く指標が異なるため、単価水準を一括りにはできません。日亜化学・大塚製薬は新電力切替で年間1〜10億円規模のコスト削減事例も。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            徳島県は四国電力エリアで、阿南市の日亜化学工業（青色LED発明・パワー半導体）、徳島市・松茂の大塚製薬・大塚化学の医薬品工業、鳴門わかめ水産加工、阿波踊り・鳴門うずしお・祖谷渓の観光業など多様な産業構造を持ちます。新電力を含めた競争入札を検討する余地がある県です。本ページでは新電力ネット（pps-net.org/unit）のエリア別単価データを県の産業構造に紐づけて再加工し、業種別の契約見直し・補助金活用を実務的に整理します。
          </p>

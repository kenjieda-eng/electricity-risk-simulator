...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "東濃の多治見・土岐・瑞浪は陶磁器産業（タイル・洋食器）の一大集積地。電気窯・トンネル窯の電力消費が中心。関市は刃物産地として知られる。大垣・各務原・各務原は精密機械・繊維・航空機関連工業の集積。年間使用量500万〜5,000万kWh規模の中規模事業者が中心。",
  },
];
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金17〜20円/kWh+調整項目。大規模陶磁器工場・自動車部品工場・航空機関連工場などが対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。新電力の競争入札による価格圧力が働く市場です。",
  },
  {
...
const faqItems = [
  { question: "岐阜県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の単価について、全国的な水準との差は契約区分・使用量・負荷率により変わるため、請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。東濃陶磁器工場・大垣自動車部品工場の大規模事業者では、複数社から同一条件で見積を取ることで単価の見直し余地が生じる場合があります。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              中部電力エリアの単価について、全国的な水準との差は契約区分・使用量・負荷率により変わります。東濃陶磁器・大垣自動車部品の中規模事業者では、複数社から同一条件で見積を取ることで単価の見直し余地が生じる場合があります。実質単価（電力量料金+燃料費調整額+再エネ賦課金）ベースで比較することが重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

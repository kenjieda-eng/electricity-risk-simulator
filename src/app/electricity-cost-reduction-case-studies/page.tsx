...
// --- 定数 ---
const pageTitle =
  "法人電気代削減 業種別7事例集｜オフィス・製造・飲食・医療・倉庫・小売・ホテルの月額削減額と施策";
const pageDescription =
  "法人の電気代削減事例7件を業種別に紹介。オフィスビル（月-12万円）、製造業（月-58万円）、飲食チェーン、医療、倉庫、小売、ホテルの月額削減額・施策内容・投資回収期間・担当者の声まで構造化。匿名化フィクションで実務再現可能、自社に近い事例を見つけて見直しの判断材料に。一般社団法人エネルギー情報センターが中立解説。";
const pageUrl =

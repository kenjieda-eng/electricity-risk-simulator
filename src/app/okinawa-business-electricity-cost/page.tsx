...
const priceBenchmark = [
  {
    ...
    detail:
      "沖縄電力『高圧電力A』の電力量料金は20〜25円/kWh（夏季・その他季・時間帯により変動、全国で最も高い水準）。燃料費調整額（2024〜2025年は+2.5〜+4.0円/kWh、石油・石炭依存により本土より高水準）と再エネ賦課金（2025年度3.98円/kWh）を加味すると実質単価は27〜33円/kWhレンジ。全国的な水準との差は契約区分・使用量・負荷率により変わります。離島を含む供給構造から、新電力の選択肢が限られる場合があります。",
  },
  {
    label: "特別高圧電力の単価水準",
    detail:

...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・全国乳業協会の統計によれば、乳製品業の電気料金は売上高の5〜10%（チーズ・ヨーグルト工場は高水準）。製造原価に占める比率は8〜18%。24h発酵管理・冷蔵保管で電力依存度が高い。",
  },
  {
...
const faqItems = [
  { question: "乳製品業の電気代水準はどれくらいですか？", answer: "売上高比5〜10%（チーズ・ヨーグルト工場は高水準）、製造原価比8〜18%が業界平均。中規模乳業工場（年商200億円級）で年4.5〜10.5億円、大規模乳製品メーカー（年商800億円超）で年10.5〜60億円規模の電気代になります。" },
  ...
  { question: "乳製品業の固定プランと市場連動プランどちらが向きますか？", answer: "ヨーグルト発酵・チーズ熟成・原料乳冷蔵の24h連続稼働でベースロードが大きく、温度管理を停止できないため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続企業で月数千万円の追加負担が発生しました。" },
  ...
  { question: "自家消費型太陽光は乳製品工場で投資回収できますか？", answer: "屋根面積3,000m²以上、24h発酵冷蔵稼働の工場は相性が良好です。1MWで年100〜130万kWh発電、年1,000〜1,500万円の削減、投資回収7〜10年（補助金後5〜7年）が目安です。自家消費率80%超になりやすく投資効率が高いです。" },
];
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。乳製品業の中規模工場では負担額が請求総額の10〜15%に達します。
            </p>
            <div className="mt-4 space-y-3">
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">

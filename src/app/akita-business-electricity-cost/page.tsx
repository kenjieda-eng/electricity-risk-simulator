...
const pageTitle =
  "秋田県の法人電気料金ガイド｜風力発電・豪雪・製紙木材の契約最適化";
const pageDescription =
  "秋田県の法人電気料金を地域特化で解説。東北電力エリア、風力発電集積の特性、豪雪地帯の電力構造、製紙・木材加工業の電力負荷、洋上風力PPA活用、補助金、契約見直しを実務的に整理します。";
...
const electricSituation = [
  {
    label: "東北電力エリア・風力先進県",
    detail:
      "秋田県は東北電力ネットワーク管轄。陸上風力発電が約60万kW、洋上風力プロジェクトでも全国先進地（能代・秋田港・男鹿・八峰など）。再エネ電源の集積が県内系統運用に大きな影響を与える特異な電源プロファイル。",
  },
  {
...
const priceBenchmark = [
  {
    ...
    detail:
      "東北電力『業務用高圧電力』の電力量料金は秋田県内で18〜22円/kWh。燃料費調整額・再エネ賦課金を加味した実質単価は25〜30円/kWhレンジ。全国的な水準との差は契約区分・使用量・負荷率により変わります。風力PPAの活用が選択肢になる場合がありますが、調達単価は案件条件により異なります。",
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
...
const costFactors = [
  ...
  },
  {
    label: "寒冷地暖房需要",
    detail:
      "秋田・横手の暖房度日3,300〜3,800で本州でも高い水準の寒冷地。冬季月別電気代が他季の2倍以上になる事業所が多数。年間電気代に占める暖房分は県内事業所平均で20〜35%。",
  },
  {
    label: "風力出力制御リスク",
    detail:
      "東北電力エリアの再エネ出力制御は2022年以降散発的に発生。秋田県は風力発電の導入量が多く出力制御の影響を受けやすい。PPA契約では出力制御リスクを需要家負担とするか発電事業者負担とするかが交渉論点。",
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇。年間1,000万kWh使用の中規模製紙工場で年4,000万円規模の負担、5年で2億円超。減免制度の対象になりやすい紙・パルプ・木材加工は申請を要検討。",
  },
  {
    label: "燃料費調整額の感応度",
    detail:
...
const industryProfile = [
  ...
  },
  {
    ...
    detail:
      "陸上風力60万kW、洋上風力プロジェクト多数。再エネ事業者・PPA仲介事業者の集積地でもあり、関連サービス産業も発展。",
  },
  {
    label: "農業・食品加工（県全域）",
    detail:
...
const switchingReality = [
  {
    label: "新電力切替の県内浸透度",
    detail:
      "2024年時点で秋田県内法人の新電力シェアは15〜20%（経産省統計）。秋田・大館・横手等の都市圏では切替が進む一方、地方部では東北電力EP継続が多数。",
  },
  {
    label: "市場連動プランのリスク認識",
    detail:
...
const faqItems = [
  { question: "秋田県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の実質単価について、全国的な水準との差は契約区分・使用量・負荷率により変わるため、請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。風力PPAの活用が選択肢になる場合がありますが、調達単価は案件条件により異なります。" },
  { question: "風力PPAは秋田県でどう活用できますか？", answer: "秋田県は陸上風力60万kW、洋上風力プロジェクトでも全国先進地。PPA契約で20年程度の長期固定単価（15〜18円/kWh水準）でCO2フリー電力を調達できます。出力制御リスクの分担を契約で明確化することが重要です。" },
  ...
  { question: "秋田県で固定プランと市場連動プランのどちらが向きますか？", answer: "豪雪・寒冷地・24時間稼働事業所が多い秋田県では、固定プランが向きます。2022〜2023年の市場高騰で県内事業者の多くが固定プランへ回帰しました。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            秋田県は東北電力エリア、風力発電の集積、豪雪地帯、製紙・木材加工集積という4つの構造的特徴を持ちます。本ページでは県内法人の電気代水準、製紙・木材加工・温泉旅館の業種別影響、風力PPA活用、豪雪地帯固有のコスト構造、補助金活用、契約見直しを実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              秋田県は『東北電力エリア・風力発電の集積』『豪雪・寒冷地需要』『製紙・木材加工集積』『再エネ出力制御の最前線』という4つの構造的特徴を持ちます。
            </p>
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/aomori-business-electricity-cost", title: "青森県の法人電気料金", description: "風力発電が集積する隣接県事情。" },

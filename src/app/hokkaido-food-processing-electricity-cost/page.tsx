...
const electricSituation = [
  {
    ...
    detail:
      "北海道は農業・酪農・水産業の大規模な生産地であり、それと直結した食品加工業が道内各地に集積。十勝・オホーツク・根釧の酪農・乳製品（チーズ・バター・粉乳）、釧路・函館・稚内・根室の水産加工（冷凍・すり身・干物・缶詰）、石狩・苫小牧・千歳の冷凍冷蔵倉庫・総合食品工場が代表的です。食料品製造業は北海道の製造業出荷額の約3分の1を占める基幹産業で、電力多消費の冷却・乾燥・加熱工程を抱えます（出典: 北海道経済産業局工業統計・北海道農政部統計）。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "北海道電力エリアは泊原子力発電所（停止中）の停止後、石炭・LNG・石油火力依存度が高く、本州とは北本連系線（北海道本州間連系設備）で限定的に接続。エリア内で需給を完結させる必要性が高く、冬季ピーク（暖房需要）の系統制約や燃料費調整額の感応度が高くなりやすい構造です。食品加工の大口需要家は道内電力需給の重要構成要素となっています（出典: 北海道電力供給計画／エネ庁エネルギー基本計画）。",
  },
];
...
const utilitiesList = [
  {
    ...
    role: "一般小売事業者（旧一電）",
    detail:
      "道内食品加工業の最大シェア。『高圧電力AS／BS』『業務用季節別時間帯別電力』が主軸メニュー。泊原発停止下の火力依存により、2022〜2023年高騰時の燃調変動は大きく推移。冬季ピーク（暖房需要）と食品加工の通年冷却が重なる時期の契約電力管理が経営判断の中心です。",
  },
  {
    name: "ほくでんグループ・地域新電力",
    role: "地域系新電力",
...
const priceBenchmark = [
  {
    ...
    detail:
      "中堅食品加工工場の高圧電力（300kW〜2,000kW）の電力量料金は標準メニューで概ね18〜22円/kWh+調整項目。燃料費調整額（2024〜2025年で+2.5〜+4.5円/kWh目安・火力依存が高く上振れしやすい）と再エネ賦課金（2025年度3.98円/kWh）を加算した実質単価は25〜31円/kWhレンジ。新電力競争入札では標準比1〜2円/kWh下げが目安です。",
  },
  {
...
const industryProfile = [
  {
    ...
    detail:
      "十勝（帯広・音更・芽室）、オホーツク、根釧（中標津・別海）は大規模な酪農地帯。生乳生産・チーズ・バター・脱脂粉乳の乳製品工場が集積。生乳冷却・殺菌・乾燥・低温熟成の電力負荷が中心で、家畜糞尿バイオガス発電の活用も進む。",
  },
  {
...
const faqItems = [
  {
    ...
    answer:
      "標準メニュー単価は北海道電力エリア固有で、火力依存度の高さから燃料費調整額の変動幅が大きく、2022〜2023年高騰時は実質単価が高くなる局面がありました。一方で、冬季の外気冷熱・雪氷冷熱を冷却に活用できる立地優位があり、冷却電力を大幅に削減できるのが寒冷地ならではの特徴。固定単価＋燃調上限契約と省エネ投資の組合せでコスト最適化が可能です（出典: 北海道電力供給計画／エネ庁エネルギー白書）。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            北海道は酪農・乳製品、水産加工、冷凍冷蔵を中心とした大規模な食品加工集積地です。本ページでは「北海道 × 食品加工業」というクロス領域に絞り、北海道電力エリア固有の単価事情と、冷凍冷蔵24時間稼働・寒冷地の暖房融雪と通年冷却の両立・外気冷熱活用・酪農バイオガスまでを実務目線で整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              北海道は農業・酪農・水産業の大規模な生産地で、それと直結した食品加工業が道内各地に集積しています。冷凍冷蔵・凍結の通年負荷と、寒冷地の外気冷熱活用という二面性、北海道電力エリアの燃調感応度の高さが業種特性の中心です。
            </p>

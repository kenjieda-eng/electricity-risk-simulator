        ...
        <section className="mt-6 space-y-6">
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/subsidy-solar-carport-canopy", title: "ソーラーカーポート・駐車場太陽光の補助金", description: "駐車場PVとEV充電・蓄電池の連動導入。" },
              { href: "/subsidy-grid-storage-battery", title: "系統用・大型蓄電池の補助金", description: "充電需要増に備える大型蓄電池の補助。" },

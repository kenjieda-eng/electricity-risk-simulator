...
const pageDescription =
  "大分県の半導体・電子製造業に特化。大分・国東・中津の先端電子・半導体関連の集積を核に、クリーンルーム24時間稼働・実装・検査の電力プロファイル、九州電力エリアの単価事情（原子力4基＋太陽光導入量が多く燃調感応度が相対的に低め）、契約最適化、補助金・PPA活用までを実務目線で整理します。";
...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "大分県は九州電力エリアに属し、小売は九州電力（九州電力本体が法人小売を担う）、送配電は九州電力送配電が担います。九州エリアは原子力4基（玄海3・4号機、川内1・2号機）が稼働し、太陽光の導入量が多く、春・秋の晴天日中には出力制御（再エネ出力抑制）が実施されるほど再エネ比率が高いのが特徴です。原子力＋太陽光の比率が高く火力依存度が相対的に低いため、燃料費調整額の感応度は低めとされます。JEPX九州エリア価格は晴天日中に太陽光で低下する局面があり、日中の太陽光余剰を活かす自家消費・蓄電の余地も大きいエリアです（出典: 九州電力送配電 供給・系統情報／エネ庁から整理）。",
  },
];
...
const utilitiesList = [
  {
    ...
    role: "一般小売事業者（旧一電）",
    detail:
      "大分県内最大シェア。大分・国東・中津の高圧・特別高圧の半導体・電子工場の長期需要家を多数抱えます。法人向けの高圧・特別高圧メニューが整備され、固定単価型・燃料費調整連動型ともに用意されています。九州は原子力4基＋太陽光導入量が多く火力依存度が相対的に低く、燃料費調整額の感応度が他エリアより低めとされる点がエリアの特徴です。長期安定供給と災害復旧体制の優位性から大手取引は維持基調ですが、本記載は事実関係の整理を目的としたものです（出典: 九州電力 法人向け料金プランから整理）。",
  },
  {
  ...
  },
  {
    ...
    role: "再エネ特化型／PPA",
    detail:
      "半導体・電子はグローバル供給網に組み込まれることが多く、Scope2/Scope3対応の再エネ調達ニーズが高まっています。屋根オンサイトPPA（広い屋根面積を活かす自家消費）、オフサイトPPA（県内・九州圏の太陽光案件）、コーポレートPPAの引合いが拡大傾向です。九州は太陽光導入量が多く、晴天日中の太陽光余剰を自家消費・蓄電で活かす余地が大きく、追加性のある調達を求める需要家にはPPAが有力な選択肢となります。導入可否は屋根面積・契約期間・系統条件で変わり、画一的な調達形態を勧める趣旨ではありません。",
  },
  {
  ...
  },
  {
    ...
    role: "市場参照",
    detail:
      "JEPX九州エリアのスポット価格は、太陽光の導入量が多いことを背景に、春・秋の晴天日中には太陽光で価格が大きく低下する局面があり、出力制御（再エネ出力抑制）が実施される日もあります。一方で夕方の太陽光減少時や全国的な需給逼迫時にはエリア間連系を通じて価格が上昇することもあり、市場連動型契約では変動リスクが残ります。日中の低価格を活かす自家消費・蓄電との組合せは九州エリアの強みですが、変動への耐性は各社で異なります。出典: 新電力ネット（https://pps-net.org/unit）を加工して整理。本記載は市場動向の整理を目的としたものです。",
  },
];
...
const priceBenchmark = [
  {
    ...
    detail:
      "大規模半導体工場・電子工場（2,000kW超）の特別高圧電力量料金は、標準メニューで概ね14〜17円/kWh＋調整項目とされます。九州は原子力＋太陽光の比率が高く火力依存度が相対的に低いため、燃料高騰局面でも燃調の上ぶれが抑えられやすい点がエリアの特徴です。燃料費調整額（九州はエリア特性として感応度が相対的に低め）と再エネ賦課金（2026年度4.18円/kWh・確定）を加算した実質単価は19〜24円/kWhレンジが目安です。数値は目安であり、実際の単価は契約条件・新電力選定で変動します（出典: 業界団体・エネ庁統計から整理）。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "九州電力エリアは原子力4基（玄海3・4号機、川内1・2号機）が稼働し、太陽光の導入量が多く火力（LNG・石炭）への依存度が他エリアより低いため、為替（円安）や燃料スポット価格の変動に対する燃料費調整額の感応度が相対的に低めとされるのがエリア固有の特徴です。2022〜2023年の全国的な燃料高騰局面でも、九州の燃調拡大は火力依存度の高いエリアに比べて相対的に抑えられる傾向がありました。この低い燃調感応度は半導体・電子工場の単価安定にプラスに働きますが、市場連動採用時は夕方の需給や全国連系の影響も見据えた固定vs市場連動の選択が経営判断の中心となります（出典: 九州電力 単価実績・エネ庁エネルギー白書から整理）。",
  },
  {
    label: "再エネ賦課金の累積負担",
    detail:
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "再エネ賦課金は2026年度4.18円/kWh（確定）で、年々の制度動向を経営計画に織り込む必要があります。加えて半導体・電子はグローバル供給網からScope3 GHG排出削減要請が強まり、後工程・実装の事業者でも再エネ電源調達（PPA・非化石証書）が求められる場面が増えています。九州は太陽光導入量が多く追加性のある自家消費・PPAの選択肢が比較的広い点が特徴ですが、調達形態の要否は供給網の要請次第です。本記載は特定の調達形態を推奨するものではありません。",
  },
];
...
const subsidies = [
  ...
  },
  {
    ...
    note: "屋根面積の大きい半導体・電子工場で活用が想定されます。半導体サプライチェーンのCN要請とリンクして、自家消費PPA・コーポレートPPAの検討材料になります。九州は太陽光導入量が多く晴天日中の余剰活用余地が大きく、追加性のある調達を検討しやすい点も踏まえて整理することが重要です。最新の公募要件は所管窓口で確認してください。",
  },
  {
...
const switchingReality = [
  ...
  },
  {
    ...
    detail:
      "半導体サプライチェーンのCN要請と歩調を合わせ、屋根オンサイトPPA（自家消費）／オフサイトPPA（県内・九州圏の太陽光案件）／コーポレートPPAが検討材料になります。九州は太陽光導入量が多く晴天日中の余剰活用余地が大きく、追加性のある調達を比較的検討しやすい環境です。導入可否は屋根面積・契約期間・系統条件で変わり、自社の屋根条件と調達目標に応じた検討が前提です。",
  },
];
...
const energySaving = [
  ...
  },
  {
    ...
    detail:
      "屋根面積を確保できる半導体・電子工場では、屋根太陽光の自家消費PPAが現実的な打ち手となり得ます。初期投資ゼロで再エネ調達と電気代単価下げの両立が期待できます。九州は太陽光導入量が多く日中の発電量・余剰活用余地が大きく、あわせてBEMSで需要を見える化し、空調ピークの平準化・蓄電池併用でデマンド（契約kW）を抑えることで基本料金を削減できます。本記載は特定の調達形態を推奨するものではありません。",
  },
];
...
const faqItems = [
  {
    ...
    answer:
      "九州電力エリアは原子力4基（玄海3・4号機、川内1・2号機）が稼働し、太陽光の導入量が多く火力（LNG・石炭）への依存度が他エリアより低いため、燃料費調整額の感応度が相対的に低めとされるのがエリア固有の特徴です。これは燃料高騰局面でも単価の上ぶれが相対的に抑えられやすい安心材料です。一方、市場連動を採用する場合は、夕方の太陽光減少時や全国的な需給逼迫時の価格変動には注意が必要です。火力依存度が相対的に低いぶん、固定でも単価が安定しやすく、晴天日中の太陽光余剰を自家消費で取り込むメリットも大きい局面があります。なお本回答は特定の電力会社・契約形態を推奨するものではありません（出典: 九州電力 単価実績・エネ庁から整理）。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "屋根面積を確保できる工場では現実的な選択肢になり得ます。初期投資ゼロでPPA事業者が設備を所有し、自社は一定期間の電力購入契約を結ぶ形が標準で、再エネ調達と電気代単価下げの両立が期待できます。九州は太陽光導入量が多く晴天日中の発電量・余剰活用余地が大きく、自家消費型のPPAと相性が良い環境です。導入可否は屋根面積・契約期間・系統条件・建屋構造で変わるため、複数事業者の試算比較が前提となります。本回答は一般的な整理であり、個別案件の成立を保証するものではありません。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            大分県は大分・国東・中津に先端電子・半導体関連が広く集積し、九州の半導体サプライチェーンの一角を担う地域です。本ページでは「大分県 × 半導体・電子製造業」というクロス領域に絞り、九州電力エリア固有の単価事情（原子力4基＋太陽光導入量が多く燃調感応度が相対的に低め）と、クリーンルーム24時間稼働／実装／検査の電力プロファイル、契約最適化、補助金・PPA活用までを実務目線で整理します。なお同じ九州の半導体でも、熊本＝菊陽町（JASM等の前工程ファブ）、大分＝先端電子・関連の集積と検索意図・対象を分離します。本ページは特定の電力会社・契約形態を推奨するものではありません。
          </p>
          ...
          <div className="mt-4 rounded-lg border border-sky-300 bg-white p-4">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-7 text-slate-700">
              ...
              <li>九州電力エリアの単価水準と燃調感応度（相対的に低め・原子力4基＋太陽光導入の多さ）</li>

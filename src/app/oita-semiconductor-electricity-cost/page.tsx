...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "大分県は九州電力エリアに属し、小売は九州電力（九州電力本体が法人小売を担う）、送配電は九州電力送配電が担います。九州エリアは原子力4基（玄海3・4号機、川内1・2号機）が稼働し、太陽光の導入量が国内最大級で、春・秋の晴天日中には出力制御（再エネ出力抑制）が実施されるほど再エネ比率が高いのが特徴です。原子力＋太陽光の比率が高く火力依存度が相対的に低いため、燃料費調整額の感応度は低めとされます。JEPX九州エリア価格は晴天日中に太陽光で低下する局面があり、日中の太陽光余剰を活かす自家消費・蓄電の余地も大きいエリアです（出典: 九州電力送配電 供給・系統情報／エネ庁から整理）。",
  },
];

...
const faqItems = [
  ...
  { question: "染色工場と縫製工場ではどちらが電気代インパクトが大きいですか？", answer: "染色工場のほうが大きく、同規模の縫製工場と比べて単位面積あたりで5〜10倍の電気代になります。染色は温水・蒸気・乾燥工程の連続稼働があり、24時間ベースロードが大きいためです。縫製工場は8〜10時間稼働が主で、電気代インパクトは中程度です。" },

...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "全国展開新電力",
    detail:
      "石川県内の高圧・特別高圧機械工場の競争入札における主要な対抗候補です。固定単価メニュー（2〜5年契約）が中心で、年間使用量の大きい大型加工拠点で実績を積み上げています。ただし北陸エリアは水力比率が高く燃調感応度が低めとされるため、大きな価格差が出にくい局面もあり、供給可能kWh枠と燃調条件を含めた総合比較が必要です。なお本記載は特定の電力会社・契約形態を推奨するものではありません。",
  },
  {
...
const priceBenchmark = [
  ...
  },
  {
    ...
    detail:
      "金沢市・白山市・能美市・加賀市の高圧機械工場（500kW〜2,000kW級）は『業務用高圧電力』が中心で、電力量料金は15〜19円/kWh＋調整項目とされます。再エネ賦課金（2026年度4.18円/kWh・確定）と燃調を加えた実質単価は21〜26円/kWhレンジが目安です。北陸は水力比率が高く燃調感応度が低めとされるため、新電力切替による下げ幅が出にくい局面もある一方、単価の安定性が得られる点はメリットになり得ます。いずれにせよ自社の使用実態に即した比較検討が前提です。",
  },
  {
...
const switchingReality = [
  ...
  },
  {
    ...
    detail:
      "メリット: 災害時復旧体制・大口需要家向けエネルギーマネジメント支援・水力中心の安定供給。デメリット: 新電力との比較で単価がやや高めになる局面、燃料費調整額の条件差。北陸は水力比率が高く燃調感応度が低めとされるため、新電力との価格差が出にくい局面もあり、継続か切替かは総合的な比較が必要です。いずれにせよ本記載は特定の電力会社・契約形態を推奨するものではありません。",
  },
  {

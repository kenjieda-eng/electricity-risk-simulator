...
const faqItems = [
  ...
  { question: "工場屋根への自家消費太陽光は紙パルプ業で投資回収できますか？", answer: "屋根面積10,000 m²以上、24h連続稼働ベースロード極大の製紙工場は相性が良好です。1 MW級で年1,000〜1,500万円の削減、投資回収7〜10年（補助金後5〜8年）が目安です。バイオマス発電と組み合わせて再エネ比率向上の経営目標達成にも寄与します。" },

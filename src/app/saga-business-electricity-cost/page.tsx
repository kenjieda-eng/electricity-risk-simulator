...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "有田町・伊万里市は有田焼・伊万里焼の窯業集積地（陶磁器・磁器の電気炉・ガス炉）。玄海町は玄海原発立地。県全域で米（佐賀米）・小麦・大豆・玉ねぎ・玉露茶等の農業、肉用牛・豚等の畜産。佐賀市・鳥栖市は都市圏オフィス・商業、鳥栖物流拠点（高速道路インターチェンジ）。唐津港・伊万里港は中継物流。",
  },
];
...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "市場動向",
    detail:
      "佐賀県の新電力シェアは2024年時点で約15〜20%。有田伊万里窯業大手と鳥栖物流の高圧契約で新電力切替が進む一方、中小事業者・農業法人は九州電力継続が多数派。",
  },
];
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金14〜17円/kWh+調整項目。佐賀県内では有田焼・伊万里焼窯業大手、鳥栖物流の大型物流施設、佐賀市内の大型商業施設・データセンターが対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。競争入札による削減余地は個別条件により異なります。",
  },
  {
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、九州電力エリアの特別高圧電力単価は2024年度実績で約14〜17円/kWh（電力量料金ベース）。九州エリアは玄海・川内の原子力4基の稼働と大規模な太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。佐賀県内の有田焼伊万里焼窯業大手、鳥栖物流大手、大型商業施設・データセンターにとっては、競争入札による更なる1〜3円/kWh削減で年間1,000万〜1億円規模のコスト削減余地。",
  },
  {
    label: "九州電力エリアの高圧単価水準",
    detail:
      "高圧電力（500〜2,000kW級）の単価は16〜20円/kWh。県内中規模事業者（有田町伊万里市窯業中堅、鳥栖物流中堅、佐賀市内オフィス・商業）にとっての標準帯域。pps-net.org のエリア別データを再加工して試算すると、佐賀県内の典型的な高圧契約（200〜500kW、年間使用量100〜400万kWh）では、新電力切替で年間100〜300万円規模のコスト削減が見込める。",
  },
  {
    label: "九州電力エリアの低圧単価水準",
    detail:
      "低圧電力9〜12円/kWh、低圧電灯17〜21円/kWhの水準。県内中小事業者（有田町伊万里市の中小窯業事業者・農業法人・小規模物流）は新電力切替で年間5〜30万円規模の削減余地が中心。太陽光自家消費・蓄電池併設で更なる効果。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "佐賀県は玉ねぎ、玉露茶、佐賀牛等の高付加価値農業に注力。施設園芸・冷蔵倉庫・畜舎の電力需要が増加傾向。農協系新電力・農水省補助との連携で電気代削減と高付加価値化の両立が可能。",
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
...
const switchingReality = [
  {
    label: "新電力切替の県内浸透度",
    detail:
      "2024年時点で県内法人の新電力シェアは約15〜20%。有田伊万里窯業大手と鳥栖物流の高圧契約で新電力切替が進む一方、中小事業者・農業法人は九州電力継続が多数派。",
  },
  {
    label: "市場連動プランの選択肢",
    detail:
...
const faqItems = [
  { question: "佐賀県の法人電気代水準は全国比どれくらいですか？", answer: "九州エリアは玄海・川内の原子力4基の稼働と大規模な太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。佐賀県内法人の実質単価は22〜27円/kWh（高圧）が標準帯域で、新電力切替により1〜2円/kWh改善余地があります。有田伊万里窯業大手の特高契約は競争入札で年間1,000万〜1億円規模の削減も可能です。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            佐賀県は九州電力エリアに属し、玄海原発（3・4号機）の立地県として地域振興メニューの恩恵を一部受けます。有田焼・伊万里焼の窯業（電気炉・ガス炉24時間連続稼働）、米・小麦・玉ねぎ・玉露茶・佐賀牛等の農業・畜産、鳥栖インターチェンジ周辺の九州物流ハブ、佐賀市・鳥栖市の都市圏オフィス・商業と多様な産業構造を持ちます。太陽光出力制御頻発エリアとして自家消費＋蓄電池の経済性が極めて高く、玄海原発立地県メリットと組合せた契約最適化戦略が主流です。本ページでは新電力ネット（pps-net.org/unit）のエリア別単価データを県の産業構造に紐づけて再加工し、業種別の契約見直し・補助金活用を実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              佐賀県の新電力シェアは2024年時点で約15〜20%。有田伊万里窯業大手と鳥栖物流の高圧契約で新電力切替が進む一方、中小事業者・農業法人は九州電力継続が多数派です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

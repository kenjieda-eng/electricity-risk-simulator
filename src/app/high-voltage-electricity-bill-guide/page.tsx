...
const billSections = [
  ...
  },
  {
    heading: "基本料金の算出構造",
    content: [
      "高圧電力の基本料金は「契約電力（kW）× 基本料金単価（円/kW）× 力率割引率」で算出されます。一般的に力率85%を基準として、85%を上回る場合に割引が適用され、下回る場合は逆に割増が課されます（85%ちょうどは割引・割増なし）。力率は使用している電気機器の特性によって決まるため、コンデンサ設置等で改善できるケースがあります。",

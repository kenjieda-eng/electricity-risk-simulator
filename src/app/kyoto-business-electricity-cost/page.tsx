...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "関西電力管内は原発依存度が国内最高（高浜・大飯・美浜の再稼働で約30%）。LNG火力約30%、石炭火力約20%、再エネ・水力約20%。京都府内には関電の水力発電所が複数立地（京北・嵐山等）。原発再稼働により燃料費調整額は相対的に低めで推移しているとされます。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            京都府は関西電力エリアで、京都市内の国内最大級観光業、西陣・友禅・京焼等の伝統工芸、洛南・けいはんな学研都市の京セラ・村田製作所・任天堂等の半導体電子部品・ハイテク産業、伏見の酒造、舞鶴港の物流と多様な産業構造を持ちます。関電の原発再稼働により燃料費調整額の変動が相対的に小さい局面があるとされる点が特徴。本ページでは府内法人の電気代水準、業種別影響度、観光業・京都市景観条例特有の論点、契約見直しの具体策、補助金活用までを実務的に整理します。
          </p>

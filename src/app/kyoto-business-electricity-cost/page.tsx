...
const pageDescription =
  "京都府の法人電気代について、平均・相場を全国の確定単価（高圧22.78円/kWh等）から読む手順を整理。関西電力エリアの電源構成が燃料費調整に与える影響、電力会社を比較する5観点、観光業・西陣友禅の伝統工芸・半導体電子部品工場の負荷特性と契約見直しを解説します。";
...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "関西電力管内は原発依存度が高い（高浜・大飯・美浜の再稼働で約30%）。LNG火力約30%、石炭火力約20%、再エネ・水力約20%。京都府内には関電の水力発電所が複数立地（京北・嵐山等）。原発再稼働により燃料費調整額は相対的に低めで推移しているとされます。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "京都市内（東山・伏見・嵐山等）の観光業は大規模でホテル・寺社・店舗が多数集積。インバウンド回復で電力需要急増中。洛南（長岡京・向日・八幡）は京セラ・島津製作所・任天堂等の半導体・電子部品・精密機械の集積地。年間使用量2,000万〜2億kWh規模の事業者多数。",
  },
];
...
const utilitiesList = [
  {
    ...
    role: "一般小売事業者",
    detail:
      "府内シェア最大。高圧・特別高圧の標準メニューは『高圧電力AB』『特高季節別時間帯別電力』など。2023年6月の規制料金改定で家庭向け値上げを実施した。",
  },
  {
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金16〜19円/kWh+調整項目。京セラ・村田製作所・任天堂・島津製作所等の大規模事業者などが対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。新電力の競争入札による価格圧力が働く市場です。",
  },
  {
...
const faqItems = [
  { question: "京都府の法人電気代水準は全国比どれくらいですか？", answer: "関西エリアは原子力のベースロードが厚く、国際燃料価格の変動が燃料費調整額に反映される度合いが相対的に小さい局面があるとされます。全国的な水準との差は契約区分・使用量・負荷率により変わります。洛南・けいはんなの半導体電子部品工場は新電力切替で年間1〜2億円規模のコスト削減事例も。観光業も電気代削減余地が大きいエリアです。" },
  ...
  { question: "京都府の電気代の平均・相場はいくらですか？", answer: "府県単位で法人の電気代平均を示した公的統計はないため、契約区分別の全国確定単価を基準にします。電力取引報の最新確定分である2026年5月分（全国計・販売額÷販売電力量）は、特別高圧17.45円/kWh、高圧22.78円/kWh、低圧電灯27.85円/kWh、低圧電力34.42円/kWhでした（消費税・再エネ賦課金を含まない参考値）。京都府が属する関西電力エリアは原子力のベースロードが厚く、燃料価格の変動が燃料費調整額に反映される度合いが相対的に小さい局面があります。自社の位置は、請求書から消費税と再エネ賦課金を差し引いた額（基本料金・電力量料金・燃料費調整額の合計）を使用量で割って求めた実質単価を、同じ区分の全国値と比べて確認してください。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            京都府は関西電力エリアで、京都市内の大規模な観光業、西陣・友禅・京焼等の伝統工芸、洛南・けいはんな学研都市の京セラ・村田製作所・任天堂等の半導体電子部品・ハイテク産業、伏見の酒造、舞鶴港の物流と多様な産業構造を持ちます。関電の原発再稼働により燃料費調整額の変動が相対的に小さい局面があるとされる点が特徴。本ページでは府内法人の電気代水準、業種別影響度、観光業・京都市景観条例特有の論点、契約見直しの具体策、補助金活用までを実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計（多くの事業者が検針期間ベースで報告・暦月ベースも可）であり、京都府または関西電力エリアの平均値ではありません。消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年5月分・確定）。この単価に含む費目・含まない費目の定義は{" "}

...
const electricSituation = [
  {
    ...
    detail:
      "愛知県は中部電力ミライズのエリア。名古屋・尾張・三河（西三河・東三河）の各地域から構成され、中京工業地帯（豊田・刈谷・安城・岡崎・名古屋南部）が大きな製造品出荷額を誇る。県内電力需要は中部電力管内の約45%を占め、特別高圧契約事業者数も多い。",
  },
  {
  ...
  },
  {
    label: "中京工業地帯と多業種集積",
    detail:
      "豊田・刈谷・安城・岡崎・西尾の西三河はトヨタおよびデンソー・アイシン・豊田自動織機等のトヨタグループ集積、東三河（豊橋・蒲郡・新城）は自動車部品・農業・観光、名古屋南部臨海部は石油化学・鉄鋼・物流。特別高圧契約事業者が多く、年間使用量1億kWh超の超大型事業者が複数立地。",
  },
];
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金17〜20円/kWh+調整項目。トヨタ系自動車工場・知多石油化学・半導体工場などが対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。新電力の競争入札による価格圧力が働く市場です。",
  },
  {
...
const industryProfile = [
  ...
  },
  {
    label: "名古屋港・中部国際空港物流",
    detail:
      "名古屋港は大規模な貿易港。中部国際空港（セントレア）と合わせて物流拠点。冷凍倉庫・荷役機械・空港施設の電力消費が中心。冷凍倉庫は24時間稼働で電力負荷高い。",
  },
  {
...
const faqItems = [
  { question: "愛知県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の単価について、全国的な水準との差は契約区分・使用量・負荷率により変わるため、請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。中京工業地帯の大規模事業者では、複数社から同一条件で見積を取ることで単価の見直し余地が生じる場合があります。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            愛知県は中部電力エリアの中京工業地帯を擁し、トヨタグループを核とした自動車・電子部品・化学・物流の大規模事業者が集積します。名古屋港・中部国際空港物流、半導体製造装置工場、東三河の観光・農業も主要産業です。本ページでは県内法人の電気代水準、業種別影響度、中京工業地帯特有の論点、契約見直しの具体策、補助金活用までを実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              中部電力エリアの単価について、全国的な水準との差は契約区分・使用量・負荷率により変わります。中京工業地帯の大規模事業者では、複数社から同一条件で見積を取ることで単価の見直し余地が生じる場合があります。実質単価（電力量料金+燃料費調整額+再エネ賦課金）ベースで比較することが重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・日本冷凍食品協会の統計によれば、冷凍食品業の電気料金は売上高の8〜15%（食品加工業の中でも高水準）。製造原価に占める比率は15〜25%で、エネルギー多消費型業種。",
  },
  {
...
const faqItems = [
  { question: "冷凍食品業の電気代水準はどれくらいですか？", answer: "売上高比8〜15%（食品加工業の中でも高水準）、製造原価比15〜25%が業界平均。中規模冷凍食品工場（年商200億円級）で年4.5〜15億円、大規模工場（年商800億円超）で年15〜60億円規模の電気代になります。" },
  ...
  { question: "冷凍食品業の固定プランと市場連動プランどちらが向きますか？", answer: "-25℃冷凍倉庫の24h連続稼働でベースロードが極めて大きく、停止が即座に品質劣化につながるため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続企業で月数千万〜数億円の追加負担が発生しました。" },
  ...
  { question: "自家消費型太陽光は冷凍食品工場で投資回収できますか？", answer: "屋根面積3,000m²以上、24h冷凍稼働の工場は相性が良好です。1MWで年100〜130万kWh発電、年1,000〜1,500万円の削減、投資回収7〜10年（補助金後5〜7年）が目安です。自家消費率80%超になりやすく投資効率が高いです。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              冷凍食品業の電気代水準は食品加工業の中でも高水準で、製品種別（冷凍野菜／冷凍肉水産／冷凍調理食品）と冷凍機の方式（IQF／トンネル／ブラストチラー）で大きく異なります。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

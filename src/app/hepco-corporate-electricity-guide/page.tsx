...
const pageTitle =
  "北海道電力（ほくでん）の法人向けプランガイド｜特高/高圧契約・寒冷地需要と泊原発停止後の燃調感応度";
...
const overview = [
  ...
  },
  {
    ...
    detail:
      "当サイトの『北海道エリアの法人電気代事情』は、エリア全体の市況・新電力動向・JEPX北海道エリア価格などの『面』の情報を扱います。一方、本ページはほくでんという『特定企業』の法人向けプラン体系・燃料費調整額の算定方式・契約手続き・サポート体制という『個別企業のサービス詳細』を解説します。エリア全体の市況は地域一般記事を、特定企業のサービス詳細は本記事を、と読み分けてください。",
  },
  {
        ...
        <section className="mt-6 space-y-6">
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/tohoku-epco-corporate-electricity-guide", title: "東北電力の法人向けプランガイド", description: "隣接エリア（東北6県＋新潟）の電力会社別解説。" },

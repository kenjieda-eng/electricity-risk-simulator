...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "仙台の暖房度日（HDD18）は約2,800で東北6県のなかでは温暖な部類。冬季の積雪量も少なく、本州他県と近い気候条件。一方で夏季冷房需要は大きく、年間電力消費の季節変動は平準化されやすい。",
  },
  {
...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "市場動向",
    detail:
      "2022〜2023年の市場高騰で県内でも新電力の新規受付停止・撤退が複数発生したが、2024年以降は12社程度が法人向け高圧で新規受付中。仙台都市圏は東北エリアのなかでも新電力競争が活発。",
  },
];
...
const costFactors = [
  {
    label: "夏冬両方のピーク負荷",
    detail:
      "仙台は東北のなかでは温暖で、冬季暖房と夏季冷房の双方でピーク需要が立つ。年間最大需要は夏季14〜15時と冬季17〜18時の両方で発生する事業所が多く、デマンド管理の複雑さが他東北県より高い。",
  },
  {
...
const switchingReality = [
  {
    label: "新電力切替の県内浸透度",
    detail:
      "2024年時点で宮城県内法人の新電力シェアは20〜25%（経産省統計）。仙台都市圏では切替が進む一方、地方部では東北電力EP継続が多数。",
  },
  {
    label: "市場連動プランのリスク認識",
    detail:
...
const energySaving = [
  ...
  },
  {
    label: "自家消費太陽光・屋上太陽光",
    detail:
      "仙台都市圏では、屋根面積1,000m²以上のビル・工場で1MW級導入も現実的。年間110〜130万kWh発電、投資回収 7〜10年（補助金後 5〜7年）。",
  },
  {
...
const faqItems = [
  { question: "宮城県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の実質単価について、全国的な水準との差は契約区分・使用量・負荷率により変わるため、請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。仙台都市圏は事業者数が多く、複数社から同一条件で見積を取って比較しやすい環境にあります。" },
  ...
  { question: "宮城県で固定プランと市場連動プランのどちらが向きますか？", answer: "24時間稼働の半導体工場・物流冷凍倉庫・大型ホテルは固定プランが向きます。中小オフィス・店舗は使用量が小さいため市場連動でも影響限定的ですが、2022〜2023年の市場高騰経験から固定プランが主流です。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              宮城県では2024年時点で約12社の新電力が法人向け高圧で新規受付中。仙台都市圏は東北エリアのなかでも新電力競争が活発です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              宮城県の新電力シェアは2024年時点で20〜25%。仙台都市圏では切替が進む一方、地方部では東北電力EP継続が多数です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "日本獣医師会・日本動物病院協会・農水省動物医薬品検査所統計によれば、動物病院の電気料金は売上高の3〜8%（CT/MRI保有の二次診療センターは高水準）。1動物病院あたりの電気代は規模により大きく異なる。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。年間150万kWh使用の中規模病院で年627万円の負担。",
  },
  {
    label: "入院動物の温度管理24h",
    detail:
...
const faqItems = [
  { question: "動物病院の電気代水準はどれくらいですか？", answer: "売上高比3〜8%（CT/MRI保有施設は高水準）が業界平均。小規模個人病院（年商1億円級）で年150万〜900万円、中規模動物病院（年商5億円級）で年1,500万〜6,000万円、大規模高度二次診療センター（年商30億円級）で年9,000万〜4.5億円規模の電気代になります。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。動物病院の中規模施設では負担額が請求総額の10〜15%に達します。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

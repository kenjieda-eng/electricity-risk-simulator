...
const electricSituation = [
  {
    ...
    detail:
      "新宿区は西新宿副都心の超高層オフィス・都庁、新宿三丁目の百貨店・商業、歌舞伎町の歓楽街・ホテル、高田馬場・落合・新大久保の住商・学生街、初台・西新宿五丁目の住商混在と、極めて多様な機能を併せ持つエリアです。新宿駅は乗降客数が非常に多いターミナル駅で、駅周辺商業の電力需要密度が極めて高い構造です。",
  },
  {
  ...
  },
  {
    label: "新宿駅商業集積の電力需要",
    detail:
      "新宿駅周辺はJR・小田急・京王・東京メトロ・都営の5社が乗り入れる大規模ターミナル。ルミネ・小田急百貨店・京王百貨店・伊勢丹新宿・新宿マルイ・新宿サザンテラス等の大型商業施設が密集し、土日祝の集中負荷と平日のオフィス負荷が混在する複合プロファイルです。",
  },
];

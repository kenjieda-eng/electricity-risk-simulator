...
const usageProfile = [
  ...
  },
  {
    ...
    detail:
      "瞬時電圧低下（瞬停）で数億〜数十億円の損失が発生するため、半導体工場は高い水準の電力品質要求。大規模UPS（10〜100MW）、無停電電源装置、自家発電バックアップが標準装備。常時稼働で電力消費の5〜10%を占める。",
  },
  {
...
const faqItems = [
  ...
  { question: "自家消費型太陽光は半導体工場で投資回収できますか？", answer: "工場敷地が広大、24h連続稼働の半導体業は相性が良好です。30MWで年3,300〜3,900万kWh発電、年30〜40億円削減、投資回収6〜8年（補助金後4〜6年）。100MW級でも検討余地。" },

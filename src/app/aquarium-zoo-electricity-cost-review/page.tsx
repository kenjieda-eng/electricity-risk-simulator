...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "日本動物園水族館協会（JAZA）・文科省社会教育調査・環境省動物関連統計によれば、水族館・動物園の電気料金は売上高（入園料収入＋運営費）の8〜18%（水族館は高め）。来園者数変動に関わらず生命維持の固定電力が大きく、電力依存度の高い業種。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。年間2,000万kWh使用の中規模水族館で年8,360万円超の負担。",
  },
  {
    label: "水温管理の季節変動",
    detail:
...
const faqItems = [
  { question: "水族館・動物園の電気代水準はどれくらいですか？", answer: "売上高比8〜18%（水族館は高め）が業界平均。小規模動物園（年間来園者20万人級）で年2,400万〜1.2億円、中規模水族館（年間来園者50万人級）で年1.5〜7.5億円、大規模水族館・動物園（年間来園者300万人級）で年9〜45億円規模の電気代になります。" },
  ...
  { question: "水族館・動物園の固定プランと市場連動プランどちらが向きますか？", answer: "生命維持装置24h稼働必須、停止不可、入園料への即時転嫁困難のため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続施設で月数千万円の追加負担が発生しました。" },
  ...
  { question: "自家消費型太陽光は水族館・動物園で投資回収できますか？", answer: "屋根面積3,000m²以上、24h生命維持稼働の施設は相性が良好です。1MWで年110〜130万kWh発電、年1,800〜2,200万円の削減、投資回収7〜10年（補助金後5〜7年）が目安です。BCP兼用蓄電池併設で投資効率さらに向上。" },
];
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。水族館・動物園の中規模施設では負担額が請求総額の10〜15%に達します。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

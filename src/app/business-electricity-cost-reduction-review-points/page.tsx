...
// --- 定数 ---
const pageTitle =
  "法人の電気料金を削減する見直しポイント7選｜契約区分別の削減効果と進め方を中立社団が解説【2026年5月版】";
const pageDescription =
  "法人の電気料金削減に効く見直しポイント7項目を一般社団法人エネルギー情報センターが中立解説。契約電力・燃調・容量拠出金・市場連動 vs 固定・デマンド制御・PPA・自家消費太陽光まで、契約区分別・業種別の削減効果と進め方を整理。再エネ賦課金 4.18 円/kWh・容量拠出金 409 円/kW など 2026 年度最新数値反映。";
const pageUrl =
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 rounded-xl border border-slate-200 bg-white p-5">
          <p className="text-sm leading-7 text-slate-700 sm:text-base">
            法人の電気料金は2022年以降高止まりが続き、2026年度はさらに再エネ賦課金（4.18円/kWh）・容量拠出金（409円/kW）・AIデータセンター需要急増による電力市場の上振れ圧力で、見直し未着手の法人ほど機会損失が拡大している。本記事は一般社団法人エネルギー情報センターが中立的立場から、法人電気料金を削減するために押さえるべき見直しポイント7項目を、契約区分別（特別高圧・高圧・低圧）の削減効果見積もり、業種別の推奨レバー、PPA・自家消費太陽光まで含めて整理する。削減幅5〜20%を狙う実務手順を体系的に解説する。
          </p>
        </section>

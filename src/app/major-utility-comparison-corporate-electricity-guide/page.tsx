...
const overview = [
  ...
  },
  {
    ...
    detail:
      "当サイトでは、エリア全体の市況・新電力動向を扱う『地域別電気料金事情』、各社個別のサービス詳細を扱う『電力会社別解説』、そして本ページのような『横断比較ガイド』の3層構造で電力会社情報を整理しています。本ページは横断比較の入口として、各社の特徴を整理し、自社条件に合う選定軸を見出した上で、個別ページ・エリア記事に深掘りする使い方を想定しています。",
  },
  {
    label: "横断比較で見るべき主要観点",
    detail:
...
const planTypes = [
  ...
  },
  {
    ...
    role: "エリア特有の構造・需要家層",
    detail:
      "各社の供給エリアには独自の特性があります。北海道（寒冷地・本州非連系の独立性・ブラックアウト経験）、東北（東日本大震災・水力・原発再稼働進行）、関東（首都圏・データセンター集積）、中部（自動車サプライチェーン・LNG火力）、北陸（水力・能登半島地震）、関西（原子力比率・産業集積）、中国（マツダ・島根原発再稼働進行）、四国（伊方原発稼働）、九州（玄海・川内原発4基・太陽光の大量導入）、沖縄（独立系統・離島・台風常襲・通年冷房）など、エリア特性が法人需要家の負荷プロファイルと密接に関係します。",
  },
  {
...
const dataPoints = [
  ...
  },
  {
    ...
    detail:
      "水力比率が相対的に高い: 北陸電力（黒部川等）・東北電力（奥只見等）。風力導入が比較的進む: 東北電力エリア（陸上風力）、北海道エリア（陸上・洋上）。地熱導入: 九州電力（八丁原等）、東北電力（澄川等）。太陽光導入量が大きい: 九州エリア。バイオマス: 各社で導入が進む。再エネ比率は各社の電源構成公表で確認できます（出典: 資源エネルギー庁エネルギー白書・各社統合報告書）。",
  },
  {
...
const compareViewpoints = [
  ...
  },
  {
    ...
    detail:
      "本ページの横断比較で大局的な特徴を把握した上で、関心のある社の個別ページ（9本の電力会社別解説記事）、所在エリアの地域別記事に深掘りする読み方が推奨されます。",
  },
];
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "本ページの横断比較で大局的な特徴を把握した後、（1）関心のある社の個別ページ（電力会社別解説の各社ページ）で詳細を確認、（2）所在エリアの地域別記事でエリア全体の市況・新電力動向を把握、（3）新電力（全国系・都市ガス系・商社系・地域系）の解説も参照、（4）同一条件で複数社から相見積を取得、（5）契約期間・燃調条件・解約条件・サポート体制を契約書で詳細確認、という流れで進めることを推奨します。",
  },
];

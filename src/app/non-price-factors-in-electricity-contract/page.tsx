...
const pageTitle =
  "電力契約で単価以外に確認すべき7項目｜法人実務で見落とされる契約条件・リスク配分";
const pageDescription =
  "電力契約で単価だけ比較すると見落とす重要7項目（契約期間、解約条件、燃調費上限、サービス品質、請求形態、サポート、リスク配分）を法人実務目線で整理。新電力切替や見積比較時に必ず確認すべきチェックリストを網羅。中立社団の解説です。";

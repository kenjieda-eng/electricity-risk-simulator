...
const pageDescription =
  "愛媛県の法人電気料金を地域特化で解説。四国電力エリアの単価水準を業種別に再加工して提示し、今治造船・今治タオル、新居浜住友化学コンビナート、伊予柑・みかん冷蔵倉庫、道後温泉観光業、伊方原発立地県の電力負荷プロファイル、契約見直し・補助金活用まで実務的に整理します。";
...
const electricSituation = [
  {
    ...
    detail:
      "愛媛県は四国電力のエリア。松山・今治・新居浜・西条・伊予・大洲・宇和島の7地域から構成。県内総電力需要は約75億kWhで四国電力管内の約30%を占める。今治造船・今治タオル、新居浜住友化学・住友金属コンビナート、伊予柑・みかん冷蔵倉庫、松山道後温泉観光業、そして伊方原発立地県という特性が県内電力消費を形成。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "今治市は今治造船と今治タオル（国産タオル50%超のシェア）。新居浜市は住友化学愛媛工場、住友金属鉱山新居浜工場の重化学工業コンビナート。西条市は半導体・電子部品（コカ・コーラ含む食品も集積）。松山市は四国の中心都市で道後温泉観光業。南予（八幡浜・宇和島）は伊予柑・みかんの果樹園と冷蔵倉庫、水産加工業。",
  },
];
...
const utilitiesList = [
  {
    ...
    role: "一般小売事業者・地元電力",
    detail:
      "県内シェア最大。四国電力本社所在県（高松市）と並び、伊方原発立地県として地域貢献も強い。高圧・特別高圧の標準メニューは『高圧電力A』『業務用季節別時間帯別電力』。2023年6月に規制料金値上げを実施した。",
  },
  {
...
const priceBenchmark = [
  ...
  },
  {
    label: "伊方原発立地県のメリット",
    detail:
      "愛媛県は伊方原発3号機立地県として電源立地地域対策交付金の対象。四国電力エリアの単価水準は、小売と卸で見え方が異なる二面性があるとされます。法人需要では年間1〜3億円規模の差が出ることもあり、関連事業者にとっては各種優遇制度の活用余地もある。",
  },
];
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、四国電力エリアの特別高圧電力単価は2024年度実績で約16〜19円/kWh（電力量料金ベース）。四国エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは低い水準で推移してきたという二面性があります。関西電力エリアと並んで全国でも安価な部類。県内大型事業者（今治造船・住友化学愛媛・住友金属鉱山）にとっては、新電力の競争入札で1〜2円/kWhの優遇を引き出せれば年間2〜10億円規模の差が出る。",
  },
  {
...
const industryImpact = [
  {
    ...
    before:
      "Before: 今治市の造船工場A社（今治造船系・コンテナ船・LNG運搬船・タンカー建造）。年間電気代 18億円。クレーン・溶接機・大型コンプレッサー・乾ドック排水が消費電力の主要要素。建造船型により電力需要変動大きい。",
    after:
...
const costFactors = [
  {
    ...
    detail:
      "愛媛県内の今治造船と新居浜住友化学・住友金属鉱山は年間使用量5〜15億kWh級。電気代の絶対額が巨額なため、単価1円/kWh変動でも年間5〜15億円規模のコスト変動。",
  },
  {
    label: "伊方原発立地県のプラス影響",
    detail:
...
const industryProfile = [
  {
    label: "造船・重工（今治・西条）",
    detail:
      "今治造船、新来島どっく、村上秀造船。年間使用量3〜8億kWh規模の大型事業者。",
  },
  {
    label: "化学・素材（新居浜）",
    detail:
...
const faqItems = [
  { question: "愛媛県の法人電気代水準は全国比どれくらいですか？", answer: "四国電力エリアは、小売の高圧単価でみると全国では割高グループに位置する一方、卸電力市場（JEPX）の四国エリアプライスは低い水準で推移してきたという二面性があります。固定型か市場連動型かで効く指標が異なるため、単価水準を一括りにはできません。今治造船・新居浜住友コンビナートは新電力切替で年間2〜10億円規模のコスト削減事例も。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            愛媛県は四国電力エリアで、今治造船・今治タオル（国産タオル50%超のシェア）、新居浜住友化学・住友金属鉱山の重化学コンビナート、八幡浜・宇和島の伊予柑みかん果樹園と冷蔵倉庫、松山道後温泉観光業など多様な産業構造を持ちます。伊方原発立地県として電源立地地域対策交付金の対象でもあります。本ページでは新電力ネット（pps-net.org/unit）のエリア別単価データを県の産業構造に紐づけて再加工し、業種別の契約見直し・補助金活用を実務的に整理します。
          </p>

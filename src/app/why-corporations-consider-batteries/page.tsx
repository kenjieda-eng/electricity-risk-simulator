...
const pageTitle =
  "法人が蓄電池を検討する理由｜電気料金対策とBCPを両立する経営判断ガイド";
const pageDescription =
  "法人で蓄電池導入が増えている2大理由「電気料金高騰対策（ピークカット・市場連動回避）」と「BCP対策（停電時の事業継続）」を経営判断目線で完全整理。投資回収期間・補助金活用・業種別の優先度・自家消費太陽光との連携まで、検討初期の経営層が押さえるべき判断軸を一般社団法人エネルギー情報センターが中立解説。";

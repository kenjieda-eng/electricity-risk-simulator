...
const pageTitle =
  "通信施設・データセンター・交換局の電気料金リスク｜24時間稼働と冗長設備を踏まえた契約戦略";
const pageDescription =
  "通信施設・データセンター・交換局の電気料金リスクを完全解説。24時間稼働の高密度負荷（ラックあたり 5-15kW）、冗長設備（UPS+発電機）、冷却システム（PUE 1.4-1.6）の特性、固定プランの優位性、設備対策まで一般社団法人エネルギー情報センターが中立解説。通信事業者・DC 運営者向け。";

...
const pageTitle =
  "大分県の法人電気料金ガイド｜九州電力エリア単価分析・大分臨海工業地帯・別府湯布院観光業・八丁原地熱の契約最適化";
const pageDescription =
  "大分県の法人電気料金を地域特化で解説。九州電力エリアの単価水準を業種別に再加工して提示し、大分臨海工業地帯（鉄鋼・化学コンビナート）、別府・湯布院温泉観光業、八丁原地熱発電、大分市の都市圏オフィス・物流の電力負荷プロファイル、契約見直し・補助金活用まで実務的に整理します。";
...
const electricSituation = [
  {
    ...
    detail:
      "大分県は九州電力エリアに属し、八丁原地熱発電（設備容量11万kW）の立地県。県内総電力需要は約100億kWhで、大分臨海工業地帯（鉄鋼・化学・LNG基地）が約35%、別府・湯布院温泉観光業が約10%、大分市の都市圏オフィス・商業が約20%、農業・林業（しいたけ・カボス）が約10%、住宅・小規模事業者が約25%の構成。",
  },
  {
    label: "電源構成 — 九州電力エリアと地熱発電",
    detail:
      "九州電力管内は原発再稼働（玄海3・4号機、川内1・2号機）と太陽光大量導入により、エリア電源構成は原子力約35%、太陽光等再エネ約20%（地熱含む）、LNG火力約25%、石炭火力約15%、その他5%。大分県は八丁原地熱発電（九重町）・大岳地熱発電等の地熱発電集積（地熱資源が豊富な県）。県内には九電の新大分火力（LNG）・大分共同火力（石炭・新日鐵住金大分共同）が立地。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "大分臨海工業地帯（大分市・佐伯市）は新日鐵住金大分製鉄所、JX大分石油化学、昭和電工大分、九州電力新大分火力、大分共同火力、LNG基地等が立地。別府温泉、湯布院温泉、九重連山・由布岳の観光業。八丁原地熱発電（九重町）・大岳地熱発電。大分港の物流（コンテナ・RORO）。しいたけ、カボス、農業・林業。",
  },
];
...
const priceBenchmark = [
  {
    ...
    detail:
      "九州電力『高圧電力A』の電力量料金は16〜20円/kWh（夏季・その他季・時間帯により変動）。燃料費調整額（2024〜2025年は+1.5〜+2.5円/kWh）と再エネ賦課金（2025年度3.98円/kWh）を加味すると実質単価は22〜27円/kWhレンジ。全国的な水準との差は契約区分・使用量・負荷率により変わります。新電力への切替余地は複数社からの相見積で確認します。",
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金14〜17円/kWh+調整項目。大分県内では新日鐵住金大分製鉄所、JX大分石油化学、昭和電工大分、大型観光リゾート（別府ハーモニーランド・湯布院温泉郷）が対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。競争入札による削減余地は個別条件により異なります。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "大分県は八丁原地熱発電（11万kW）・大岳地熱発電等の地熱集積。九電みらいエナジー等の地熱由来CO2フリー電源メニューを活用することで、RE100対応・CO2削減・電気代削減を同時に実現できる県固有の競争優位。",
  },
];
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、九州電力エリアの特別高圧電力単価は2024年度実績で約14〜17円/kWh（電力量料金ベース）。九州エリアは玄海・川内の原子力4基の稼働と大規模な太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。大分県では地熱発電も電源構成の一部を担います。大分県内の新日鐵住金大分・JX大分石油化学・昭和電工大分にとっては、競争入札による更なる1〜3円/kWh削減で年間1〜10億円規模のコスト削減余地。",
  },
  {
    label: "九州電力エリアの高圧単価水準",
    detail:
      "高圧電力（500〜2,000kW級）の単価は16〜20円/kWh。県内中規模事業者（別府湯布院温泉観光業、大分市内オフィス・データセンター、大分港物流中堅）にとっての標準帯域。pps-net.org のエリア別データを再加工して試算すると、大分県内の典型的な高圧契約（200〜500kW、年間使用量100〜400万kWh）では、新電力切替で年間100〜300万円規模のコスト削減が見込める。",
  },
  {
    label: "九州電力エリアの低圧単価水準",
    detail:
      "低圧電力9〜12円/kWh、低圧電灯17〜21円/kWhの水準。県内中小事業者（中小商店・農業法人・温泉宿中堅）は新電力切替で年間5〜30万円規模の削減余地が中心。太陽光自家消費・蓄電池併設で更なる効果。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "別府温泉・湯布院温泉の年中観光需要で、冷暖房・温泉ポンプ・客室照明の電力需要が高水準。冬季イルミネーション需要も加わり、季節変動の大きい契約が課題。",
  },
  {
    label: "八丁原地熱発電と地熱由来CO2フリー電源",
    detail:
      "大分県は八丁原地熱発電（11万kW）・大岳地熱発電等の地熱集積。九電みらいエナジー等の地熱由来CO2フリー電源メニューを活用することで、RE100対応・CO2削減・電気代削減を同時実現可能。",
  },
  {
...
const industryProfile = [
  ...
  },
  {
    ...
    detail:
      "別府温泉、湯布院温泉、九重連山・由布岳の観光業。年間使用量200万〜2,000万kWh規模。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "しいたけ、カボス、農業（米・麦・大豆）、林業（杉檜）、中小製造業（食品・建設資材）。年間使用量50万〜500万kWh規模。",
  },
];
...
const faqItems = [
  { question: "大分県の法人電気代水準は全国比どれくらいですか？", answer: "九州エリアは玄海・川内の原子力4基の稼働と大規模な太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。大分県内法人の実質単価は22〜27円/kWh（高圧）が標準帯域で、新電力切替により1〜2円/kWh改善余地があります。鉄鋼化学コンビナートの特高契約は競争入札で年間1〜10億円規模の削減も可能です。" },
  { question: "大分県の地熱由来CO2フリー電源はどのように活用できますか？", answer: "大分県は八丁原地熱発電（11万kW）・大岳地熱発電等の地熱集積で、九電みらいエナジー等が地熱由来CO2フリー電源メニューを提供しています。RE100対応・CO2削減・電気代削減を同時実現できる県固有の競争優位で、観光業・データセンター・大手企業の脱炭素戦略に直結します。地熱由来15〜20%＋太陽光自家消費20〜25%でRE100進捗40〜50%達成が可能です。" },
  ...
  { question: "地熱発電は大分県の電力供給にどう影響しますか？", answer: "大分県の八丁原地熱発電（11万kW）・大岳地熱発電は24時間安定供給のベースロード電源として系統安定に貢献しています。県内事業者は地熱由来CO2フリー電源を比較的安価に調達でき、RE100対応・CO2削減・電気代削減を同時実現できる県固有の競争優位として活用できます。観光業・データセンター・大手企業の脱炭素戦略に直結する戦略電源です。" },
];
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            大分県は九州電力エリアに属し、八丁原地熱発電（11万kW）の立地県として地熱由来CO2フリー電源活用が県固有の特異的競争優位です。大分臨海工業地帯（新日鐵住金大分・JX大分石油化学・昭和電工大分の鉄鋼化学コンビナート）、別府温泉・湯布院温泉の観光業、しいたけ・カボスの農業、大分市の都市圏オフィス・物流と多様な産業構造を持ちます。原発稼働メリット＋太陽光出力制御活用＋地熱由来CO2フリー電源の三段構成で電気代削減＋RE100対応を両立する契約最適化戦略が主流です。本ページでは新電力ネット（pps-net.org/unit）のエリア別単価データを県の産業構造に紐づけて再加工し、業種別の契約見直し・補助金活用を実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              大分県は九州電力エリアに属し、八丁原地熱発電の立地県。大分臨海工業地帯の鉄鋼化学コンビナート、別府・湯布院温泉観光業、地熱発電関連、大分市の都市圏オフィス・物流が県内電力消費の中核を形成します。地熱由来CO2フリー電源活用が県固有の特異的競争優位です。
            </p>

...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、九州電力エリアの特別高圧電力単価は2024年度実績で約14〜17円/kWh（電力量料金ベース）。九州エリアは玄海・川内の原子力4基の稼働と全国最大級の太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。大分県では地熱発電も電源構成の一部を担います。大分県内の新日鐵住金大分・JX大分石油化学・昭和電工大分にとっては、競争入札による更なる1〜3円/kWh削減で年間1〜10億円規模のコスト削減余地。",
  },
  {
...
const faqItems = [
  { question: "大分県の法人電気代水準は全国比どれくらいですか？", answer: "九州エリアは玄海・川内の原子力4基の稼働と全国最大級の太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。大分県内法人の実質単価は22〜27円/kWh（高圧）が標準帯域で、新電力切替により1〜2円/kWh改善余地があります。鉄鋼化学コンビナートの特高契約は競争入札で年間1〜10億円規模の削減も可能です。" },

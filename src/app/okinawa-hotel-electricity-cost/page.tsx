...
const utilitiesList = [
  {
    ...
    role: "一般小売事業者（旧一電）",
    detail:
      "県内宿泊業の最大シェア。独立系統のため小さい系統規模を運用。『高圧電力』『業務用電力』が主軸メニューで、本土と連系しないため燃料価格・需給の影響を直接受ける供給構造です。離島も離島ユニバーサルサービスで本島同一料金が適用されます。",
  },
  {
    name: "沖縄ガス系・地域新電力",
    role: "地域系新電力",
  ...
  },
  {
    ...
    role: "市場参照",
    detail:
      "沖縄電力の電力量料金は独立系統・燃料輸送コスト・小規模系統の事情から全国の旧一電で高めの水準。通年冷房で使用量も大きくなりやすいため、宿泊業の電気代負担は膨らみやすい傾向。省エネ投資・自家消費太陽光の経営価値が高い構造です。出典: 新電力ネット（https://pps-net.org/unit）を加工して整理。",
  },
];
...
const priceBenchmark = [
  {
    ...
    detail:
      "中堅〜大型ホテルの高圧電力（300kW〜2,000kW）の電力量料金は標準メニューで概ね19〜23円/kWh+調整項目（独立系統・燃料輸送コストという供給構造の違いがある）。燃料費調整額と再エネ賦課金（2025年度3.98円/kWh）を加算した実質単価は27〜33円/kWhレンジ。通年冷房で使用量も大きくなりやすく、年間電気代の絶対額が膨らみやすい傾向です。",
  },
  {
    label: "低圧電力 — 中小ホテル・民宿・ゲストハウスの単価",
    detail:
      "那覇・離島の中小ホテル・民宿・ゲストハウス（契約電力50kW未満）の『低圧電力（動力）』『低圧電灯』の単価水準。低圧自由化の選択肢は本土より限定的ですが、省エネ投資・自家消費太陽光の効果が大きいレンジです。",
  },
  {
    label: "宿泊業の電気代単位指標 — 客室当たり・売上比",
    detail:
      "沖縄のリゾートホテルでは客室1室・1ヶ月当たり電気代は2〜4万円が目安。売上に占める電気代比率は通常3〜6%、稼働率が低い時期や燃料高騰時には8〜12%まで拡大。通年冷房・プール・大規模厨房で電力消費が大きく、省エネ投資の経営インパクトが大きい構造です。",
  },
  {
    label: "離島系統の供給コストと料金",
    detail:
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "本土と連系しない独立系統・燃料輸送コスト・小規模系統という供給構造が、沖縄電力の電力量料金の前提になります。通年冷房で使用量も大きくなりやすいため、宿泊業の電気代負担は膨らみやすい傾向。省エネ投資・自家消費太陽光の経営価値が高い構造です。",
  },
  {
    label: "離島系統の供給コストと制約",
    detail:
...
const switchingReality = [
  ...
  },
  {
    ...
    detail:
      "メリット: 離島含む安定供給・離島ユニバーサルサービス・地域に根ざした保守体制・台風時復旧体制。デメリット: 独立系統で供給構造が異なる・新電力の選択肢が限られる。省エネ・自家消費での削減が現実的なアプローチです。",
  },
  {
...
const faqItems = [
  {
    ...
    answer:
      "高めの傾向にあります。沖縄電力は本土と連系しない独立系統で、燃料輸送コスト・小規模系統という供給構造が電力量料金の前提になります。加えて亜熱帯気候で通年冷房のため使用量も大きくなりやすく、宿泊業の電気代負担は膨らみやすい傾向。新電力の選択肢が限られるため、高効率空調・自家消費太陽光等の省エネ投資による削減の経営価値が本土以上に高い構造です（出典: 沖縄電力供給計画／エネ庁エネルギー白書）。",
  },
  {
    question: "沖縄のホテルで電力消費が最も大きいのは何ですか？",
    answer:
      "通年冷房（空調）が大きく、年間使用量の40〜55%を占める事業所が多くあります。次いで給湯（大浴場・シャワー）、プール循環ろ過、照明、厨房、ランドリーが続きます。本土の宿泊業が冬季暖房・夏季冷房の両面なのに対し、沖縄はほぼ通年冷房で年間を通じて冷房負荷が高止まりするのが最大の特徴。高効率空調・客室制御が単価最適化の最重要打ち手です。",
  },
  {

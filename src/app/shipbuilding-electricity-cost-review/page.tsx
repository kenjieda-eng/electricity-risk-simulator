...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。年間5,000万kWh使用の大型造船所で年2.09億円の負担。再エネ賦課金減免制度の対象になりやすい。",
  },
  {
...
const demandManagement = [
  ...
  },
  {
    label: "力率改善コンデンサ・SVC",
    detail:
      "大型溶接機・クレーンの誘導性負荷を力率改善コンデンサ・SVCで補償。力率82%→95%で、力率調整前の基本料金に対し▲13%、投資回収1〜2年。",
  },
];
...
const faqItems = [
  ...
  { question: "力率改善で基本料金はどれくらい下がりますか？", answer: "力率85%未満では基本料金が割増、85%超で割引が適用されます。力率82%→95%で、力率調整前の基本料金に対し▲13%、力率改善コンデンサ・SVC投資（造船所で1,000〜5,000万円）の回収は1〜2年と極めて効率的。大型溶接機・クレーンの多い造船所では必須の対策です。" },
  ...
  { question: "自家消費型太陽光は造船所で投資回収できますか？", answer: "屋根面積1万m²以上、遊休地利用可能な造船所は自家消費型太陽光との相性が良好です。1MWで年100〜130万kWh発電、年1,000〜1,500万円の削減、投資回収7〜10年（補助金後5〜7年）が目安です。自家消費率70〜80%になりやすく投資効率が高いです。" },
];
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。造船業の大型造船所では負担額が請求総額の10〜18%に達します。再エネ賦課金減免制度の対象になりやすい。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
            <div className="mt-4 space-y-3">
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-6 text-slate-600">
                  ...
                  <li>2026年度（4.18円/kWh）：年 2.926億円（+4,830万円）</li>
                </ul>
              </div>
            </div>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-2">
              ...
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-6 text-slate-600">
                  <li>力率82%→95%で、力率調整前の基本料金に対し▲13%</li>
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/what-is-power-factor", title: "力率改善の基本", description: "大型溶接機・クレーン用力率改善。" },

...
const caseStudies = [
  ...
  },
  {
    ...
    after: "電力契約の10年長期固定締結／自家消費太陽光 2 MW＋蓄電池 3 MWh／コージェネ 1.5MW／全プレスサーボ化／力率改善で力率調整前の基本料金に対し▲10%／需要家主導型PPA（オフサイト風力3MW）／DR契約締結。",
...
const demandManagement = [
  ...
  },
  {
    ...
    detail:
      "プレス機・溶接機の誘導性負荷を力率改善コンデンサで補償。力率82%→95%で、力率調整前の基本料金に対し▲13%、投資回収1〜2年。SVC（静止型無効電力補償装置）導入で動的補償も可能。",
  },
  {
    label: "レーザー加工機の負荷追従",
    detail:
...
const faqItems = [
  ...
  { question: "力率改善で基本料金はどれくらい下がりますか？", answer: "力率85%未満では基本料金が割増、85%超で割引が適用されます。力率82%→95%で、力率調整前の基本料金に対し▲13%、力率改善コンデンサ投資（中規模工場で200〜500万円）の回収は1〜2年と極めて効率的。プレス機・溶接機の多い工場では必須の対策です。" },
  ...
  { question: "自家消費型太陽光はプレス・板金工場で投資回収できますか？", answer: "屋根面積1,500m²以上、日中稼働中心の工場は相性が良好です。1MWで年100〜130万kWh発電、年1,000〜1,500万円の削減、投資回収7〜10年（補助金後5〜7年）が目安です。自家消費率80%超になりやすく投資効率が高いです。" },
];
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <div className="mt-4 rounded-lg border border-sky-300 bg-white p-4">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-7 text-slate-700">
              ...
              <li>力率改善による基本料金削減（力率調整前の基本料金に対し▲13%）</li>
        ...
        <section className="mt-6 space-y-6">
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/what-is-power-factor", title: "力率改善の基本", description: "力率85%を基準に基本料金が増減する仕組み。" },

...
const energySaving = [
  ...
  },
  {
    ...
    detail:
      "ドライエア・真空・純水などのユーティリティはモーター・ポンプ・コンプレッサー電力が積み上がる領域です。エア漏れ・過剰圧力設定の見直し＋高効率インバータ機更新＋台数制御で▲15〜25%の削減が見込めます。生産量に必ずしも比例しないため運用最適化の効果が大きく、SII補助1/2で回収可能（1.5〜2.5年）とされます（出典: 業界団体統計から整理）。",
  },
  {

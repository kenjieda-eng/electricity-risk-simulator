...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・セメント協会の統計によれば、セメント業の電気料金は売上高の8〜15%（粉砕ミル稼働で高水準）。生コン業は3〜8%。製造原価に占める比率はセメント10〜20%、生コン5〜12%。",
  },
  {
...
const faqItems = [
  ...
  { question: "セメント・生コン業の固定プランと市場連動プランどちらが向きますか？", answer: "粉砕ミル24h連続稼働、生コン需要期の集中出荷でベースロードが大きく、生産停止が困難なため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続企業で月数千万円の追加負担が発生しました。" },
  ...
  { question: "自家消費型太陽光はセメント・生コン工場で投資回収できますか？", answer: "屋根面積5,000m²以上、24h粉砕ミル稼働の工場は相性が良好です。1MWで年100〜130万kWh発電、年1,000〜1,500万円の削減、投資回収7〜10年（補助金後5〜7年）が目安です。自家消費率80%超になりやすく投資効率が高いです。" },
];
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            セメント・生コン業は、セメント粉砕ミルの24h連続大電力、コンクリートミキサの瞬間大電力、建設需要期の生産集中など多面的な電力負荷を持ち、製造原価に占める電気代比率が高い業種です。本ページでは業界特有の電力負荷特性、業界平均水準、規模別事例、補助金活用、契約見直しチェックリストまで実務に直結する観点を整理します。
          </p>

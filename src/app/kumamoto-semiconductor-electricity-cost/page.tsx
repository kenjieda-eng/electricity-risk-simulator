...
const electricSituation = [
  {
    ...
    detail:
      "熊本県菊池郡菊陽町・大津町には、TSMC（台湾積体電路製造）の合弁会社JASM（Japan Advanced Semiconductor Manufacturing）の第1工場が2024年に操業開始、第2工場の建設計画も進行中。さらにソニーセミコンダクタソリューションズ熊本（イメージセンサ）・東京エレクトロン九州・三菱電機半導体関連等が集積し、『ロジック半導体・イメージセンサ・装置・素材』のサプライチェーン形成が進んでいます（出典: 熊本県産業労働部・JETRO進出企業情報・JASM公式リリース）。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "九州電力エリアは玄海・川内の原子力（4基稼働中）＋大規模太陽光＋LNG火力で電源構成が比較的多様。エリア電源コストが他エリアより安定している傾向にあり、半導体ファブの長期立地判断において重要な優位性となりました。再生可能エネルギー比率の高さは、TSMCのRE100目標達成にも合致します（出典: 九州電力供給計画／エネ庁エネルギー基本計画）。",
  },
];
...
const priceBenchmark = [
  {
    ...
    detail:
      "ロジック半導体ファブ（特別高圧2,000kW超、年間1億kWh級）の電力量料金は標準メニューで概ね15〜18円/kWh+調整項目。九州エリアは原子力＋大規模太陽光の電源構成により燃料費調整額の変動幅が相対的に小さいとされ、実質単価は21〜25円/kWhレンジ。新電力競争入札では標準比1〜2円/kWh下げが目安で、年間10億kWh級のJASM級ファブでは数十億円規模のインパクトです。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "九州電力エリアは原子力＋太陽光比率が高く、燃料費調整額の変動幅は相対的に小さいとされます。これは半導体ファブ立地の優位性ですが、再エネ賦課金は全国一律で上昇するため、絶対額の負担は他エリア同様に拡大しています。",
  },
  {
...
const industryProfile = [
  {
    ...
    detail:
      "菊陽町の半導体集積はJASM第1工場操業＋第2工場計画進行中。周辺には装置・素材・ガス・部品サプライヤーが連続立地し、『TSMC型サプライチェーン』が形成。電力消費は熊本県全体の主要構成要素となり、九州電力供給計画にも反映されています。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "東京エレクトロン九州（合志市）はコーター・デベロッパー等の半導体製造装置の主力生産拠点。熊本県内の半導体集積を装置面から支え、JASM等への装置供給で存在感を持ちます。",
  },
  {
...
const switchingReality = [
  ...
  },
  {
    ...
    detail:
      "メリット: 安定供給・原子力＋太陽光中心の電源で燃調感応度が相対的に低いとされる・災害時復旧体制（熊本地震BCP）・大規模需要家対応の専属体制。デメリット: 新電力比1〜2円/kWh単価がやや高め、長期固定での競争余地は新電力に分がある場面も。",
  },
  {
...
const faqItems = [
  {
    ...
    answer:
      "①ソニーセミコンダクタ熊本の長年の半導体生産で人材・技術・周辺サプライチェーンが熟成、②九州電力の安定供給（原子力＋太陽光中心の電源構成）、③水資源（阿蘇水系の良質な地下水）、④熊本県・国（経産省）の積極的な集積促進政策、⑤TSMC親会社のリスク分散・地政学的判断、の5点が複合的に作用しています。電力面では九州エリアの燃調感応度が相対的に低いとされ、再エネ調達適地が豊富という優位性が立地評価に寄与しました（出典: JASM公式リリース・JETRO進出企業情報・熊本県産業労働部）。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "九州電力エリアは玄海・川内の原子力4基稼働＋大規模太陽光＋LNG火力という比較的多様な電源構成で、LNG/石炭依存度が他エリアより低い構造です。2022〜2023年の燃料高騰時の燃調変動幅も東京・関西・中部より小幅で推移し、半導体ファブの単価変動リスクが相対的に低位で抑えられています。半導体ファブ立地判断における重要な優位性となりました（出典: 九州電力供給計画／エネ庁エネルギー白書）。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            熊本県はTSMC/JASMの進出を契機に、菊陽町・大津町を中心とした大規模な半導体・電子部品集積地へと急速に変貌しています。本ページでは「熊本県 × 半導体・電子部品製造」というクロス領域に絞り、九州電力エリア固有の単価事情と、クリーンルーム24時間稼働・露光装置電力品質要求・超純水ユーティリティ・RE100調達・補助金活用までを実務目線で整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              熊本県、特に菊陽町・大津町はTSMC/JASMの進出を契機に、大規模なロジック半導体・イメージセンサ・製造装置サプライチェーンが急速に形成されつつあります。24時間連続のクリーンルーム空調と露光装置の電力品質要求が業種特性の中心です。
            </p>

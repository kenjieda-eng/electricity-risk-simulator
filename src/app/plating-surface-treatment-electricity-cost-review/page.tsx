...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・全国鍍金工業組合連合会の統計によれば、メッキ・表面処理業の電気料金は売上高の8〜18%（電気メッキ専業は高水準）。製造原価に占める比率は12〜25%。電解槽の直流大電力と排水処理24h稼働で電力依存度が極めて高い業種。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。年間2,000万kWh使用の中規模工場で年8,360万円の負担。",
  },
  {
...
const faqItems = [
  { question: "メッキ・表面処理業の電気代水準はどれくらいですか？", answer: "売上高比8〜18%（電気メッキ専業は高水準）、製造原価比12〜25%が業界平均で全業種高位。中規模メッキ工場（年商100億円級）で年2.4〜10.5億円、大規模メッキメーカー（年商200億円超）で年10.5〜45億円規模の電気代になります。" },
  ...
  { question: "メッキ業の固定プランと市場連動プランどちらが向きますか？", answer: "電解槽・排水処理の24h連続稼働でベースロードが大きく、停止が法令違反・品質劣化につながるため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続企業で月数千万円の追加負担が発生しました。" },
  ...
  { question: "自家消費型太陽光はメッキ工場で投資回収できますか？", answer: "屋根面積2,500m²以上、24h電解槽稼働の工場は相性が良好です。1MWで年100〜130万kWh発電、年1,000〜1,500万円の削減、投資回収7〜10年（補助金後5〜7年）が目安です。自家消費率80%超になりやすく投資効率が高いです。" },
];
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            メッキ・表面処理業は、電解槽・整流器の直流大電力、前処理槽の加温電力、排水処理24h連続稼働、スクラバー排煙処理など多面的な電力負荷を持ち、製造原価に占める電気代比率が高い業種です。本ページでは業界特有の電力負荷特性、業界平均水準、規模別事例、補助金活用、契約見直しチェックリストまで実務に直結する観点を整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。メッキ業の中規模工場では負担額が請求総額の10〜18%に達します。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

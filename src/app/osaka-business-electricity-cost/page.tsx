...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "関西電力管内は原発依存度が高い（高浜・大飯・美浜の再稼働で約30%）。LNG火力約30%、石炭火力約20%、再エネ・水力約20%。府内には泉北火力（LNG）・関電泉南発電所等が立地。原発再稼働により燃料費調整額は相対的に低めで推移しているとされます。",
  },
  {
...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "ガス・関電グループ系新電力",
    detail:
      "大阪ガスエナジーはガス・電気のセット契約に強み。中小商業施設・ホテル・オフィスビルで多数の実績。関電エネルギーソリューションは関電グループとして大規模法人需要を対応。",
  },
  {
    name: "イーレックス・エネット",
    role: "全国系新電力",
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金16〜19円/kWh+調整項目。堺・泉北の化学鉄鋼コンビナート、パナソニック・武田薬品・大型データセンターなどが対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。新電力の競争入札による価格圧力が働く市場です。",
  },
  {
  ...
  },
  {
    label: "関電原発再稼働メリット",
    detail:
      "関西エリアは原子力のベースロードが厚く、国際燃料価格の変動が燃料費調整額に反映される度合いが相対的に小さい局面があるとされます。法人需要では年間1〜5億円規模の差が出ることもあり、関電エリア事業者は相対的に有利。新電力経由でさらに優遇可能性がある。",
  },
];
...
const costFactors = [
  {
    ...
    detail:
      "堺・泉北の湾岸コンビナートは大規模な重化学工業集積。化学プラント・鉄鋼工場は年間使用量1〜30億kWh級。電気代の絶対額が巨額なため、単価1円/kWh変動でも年間1〜30億円規模のコスト変動。契約見直しと省エネ投資の優先度が極めて高い。",
  },
  {
    label: "データセンター集積の急増",
    detail:
  ...
  },
  {
    label: "関電原発再稼働メリット",
    detail:
      "関西エリアは原子力のベースロードが厚く、国際燃料価格の変動が燃料費調整額に反映される度合いが相対的に小さい局面があるとされます。法人需要では年間1〜5億円規模の差が出ることもあり、関電エリア事業者は相対的に有利。",
  },
  {
...
const switchingReality = [
  {
    label: "新電力切替の府内浸透度",
    detail:
      "2024年時点で府内法人の新電力シェアは28%前後（経産省統計）。堺泉北コンビナート・データセンターは競争入札による切替が標準化。商業施設は大阪ガスエナジー等のガス・電気セット契約も普及。",
  },
  {
    label: "市場連動プランのリスク認識",
    detail:
...
const faqItems = [
  { question: "大阪府の法人電気代水準は全国比どれくらいですか？", answer: "関西エリアは原子力のベースロードが厚く、国際燃料価格の変動が燃料費調整額に反映される度合いが相対的に小さい局面があるとされます。全国的な水準との差は契約区分・使用量・負荷率により変わります。堺泉北コンビナート・データセンターは新電力切替で年間2〜5億円規模のコスト削減事例も。府内新電力シェアは28%です。" },
  ...
  { question: "関電原発再稼働は電気代にどう影響しますか？", answer: "高浜・大飯・美浜の原発再稼働により、関電管内の燃料費調整額は相対的に低めで推移しているとされます。2024〜2025年は+1.5〜+3.0円/kWhレンジで、中部・東京エリア（+2.5〜+4.5円/kWh）より約1〜1.5円/kWh安い水準。年間10億kWh使用の事業者で年15億円規模のメリットです。" },
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              大阪府は関西電力エリアで、大阪市内・北摂・南河内・泉北泉南の4地域から構成されます。関西エリアは原子力のベースロードが厚く、国際燃料価格の変動が燃料費調整額に反映される度合いが相対的に小さい局面があるとされます。堺泉北コンビナートの超大規模需要、データセンター集積の急増が府内電力消費の特徴を形成します。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              大阪府の新電力シェアは2024年時点で28%前後。堺泉北コンビナート・データセンターは競争入札による切替が標準化、パナソニック・武田薬品等のRE100対応で需要家主導型PPAが急速に普及。市場連動プランから固定プランへの回帰トレンドが鮮明です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

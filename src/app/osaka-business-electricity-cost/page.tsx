...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "関西電力管内は原発依存度が国内最高（高浜・大飯・美浜の再稼働で約30%）。LNG火力約30%、石炭火力約20%、再エネ・水力約20%。府内には泉北火力（LNG）・関電泉南発電所等が立地。原発再稼働により燃料費調整額は相対的に低めで推移しているとされます。",
  },
  {
...
const faqItems = [
  { question: "大阪府の法人電気代水準は全国比どれくらいですか？", answer: "関西エリアは原子力のベースロードが厚く、国際燃料価格の変動が燃料費調整額に反映される度合いが相対的に小さい局面があるとされます。全国的な水準との差は契約区分・使用量・負荷率により変わります。堺泉北コンビナート・データセンターは新電力切替で年間2〜5億円規模のコスト削減事例も。府内新電力シェアは28%と全国上位です。" },

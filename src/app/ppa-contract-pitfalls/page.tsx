...
const institutionalRisk = [
  {
    ...
    detail:
      "再エネ賦課金は2025年度3.98円/kWh、2026年度4.18円/kWh（確定）。自己託送・特定卸供給での減免可否は制度改正対象になりやすく、契約条項でパス・スルー(改正影響を需要家が吸収する)とするか発電事業者が負担するかが論点。20年契約期間中の改正回数は3〜5回が見込まれ、改正前提の契約設計が必須。",
  },
  {

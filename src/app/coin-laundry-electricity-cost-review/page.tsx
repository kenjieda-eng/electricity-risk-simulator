...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "全国コインランドリー連合会・経産省商業統計によれば、コインランドリー業の電気料金は売上高の8〜18%（電気式乾燥機中心の店舗で高水準）。事業原価に占める比率は15〜30%。24h無人稼働と乾燥機ガス併用vs電気のコスト比較が業種固有のコスト構造を形成。",
  },
  {
...
const faqItems = [
  { question: "コインランドリーの電気代水準はどれくらいですか？", answer: "売上高比8〜18%（電気式乾燥機中心の店舗で高水準）、事業原価比15〜30%が業界平均。中規模FC加盟店（年商3,000万円級）で年330〜700万円、30店舗オペレーター（年商10億円超）で年6,500万〜3.5億円規模の電気代になります。" },
            ...
            <div className="mt-4 space-y-3">
              <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                ...
                <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-6 text-slate-600">
                  ...
                  <li>2026年度（4.18円/kWh）：年 2,090万円（+345万円）</li>
                </ul>
              </div>
            </div>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">

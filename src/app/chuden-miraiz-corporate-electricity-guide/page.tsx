...
const overview = [
  ...
  },
  {
    ...
    detail:
      "当サイトの『中部電力エリアの法人電気代事情』は、エリア全体の市況・新電力動向・JEPX中部エリア価格などの『面』の情報を扱います。一方、本ページは中部電力ミライズという『特定企業』の法人向けプラン体系・燃料費調整額の感応度・契約手続き・サポート体制という『個別企業のサービス詳細』を解説します。エリア全体の市況は地域一般記事を、特定企業のサービス詳細は本記事を、と読み分けてください。",
  },
  {

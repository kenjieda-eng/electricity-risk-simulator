...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・日本鍛造協会の統計によれば、鍛造・熱処理業の電気料金は売上高の7〜15%（熱処理専業は高水準）。製造原価に占める比率は10〜22%。加熱炉・熱処理炉の24h稼働で電力依存度が高い業種。",
  },
  {
...
const faqItems = [
  { question: "鍛造・熱処理業の電気代水準はどれくらいですか？", answer: "売上高比7〜15%（熱処理専業は高水準）、製造原価比10〜22%が業界平均。中規模熱処理工場（年商150億円級）で年3〜10.5億円、大規模鍛造メーカー（年商500億円超）で年12〜45億円規模の電気代になります。" },
  ...
  { question: "鍛造・熱処理業の固定プランと市場連動プランどちらが向きますか？", answer: "加熱炉・浸炭炉・焼入れ炉の連続稼働でベースロードが大きく、生産停止が困難なため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続企業で月数千万円の追加負担が発生しました。" },

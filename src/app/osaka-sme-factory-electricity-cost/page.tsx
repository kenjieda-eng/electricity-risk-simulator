...
const electricSituation = [
  {
    ...
    detail:
      "大阪府東大阪市は『日本一の町工場のまち』として全国的に知られ、人口当たり製造業事業所数・面積当たり工場密度ともに高い水準。金属プレス・切削加工・熱処理・表面処理・樹脂成形・電子部品・治工具・金型・組立まで多様な工程の中小工場が約5,500〜6,000事業所集積しています（出典: 東大阪市統計・経産省工業統計・大阪府工業統計）。八尾市・大東市・門真市・大阪市生野区・平野区・住之江区も含めれば、府全体で中小製造業事業所は1万を超え、高圧・低圧の中小契約需要家が極めて多い構造です。",
  },
  {
...
const priceBenchmark = [
  {
    ...
    detail:
      "中小製造業の高圧電力（300kW〜2,000kW）の電力量料金は標準メニューで概ね17〜21円/kWh+調整項目。燃料費調整額（2024〜2025年で+1.5〜+3.5円/kWh目安・原子力比率が高く変動幅は相対的に小さいとされる）と再エネ賦課金（2025年度3.98円/kWh）を加算した実質単価は23〜28円/kWhレンジ。新電力競争入札では標準比1〜3円/kWh下げが目安で、年間使用量200〜500万kWh級の町工場では年間数百万円規模のインパクトです。",
  },
  {
...
const energySaving = [
  ...
  },
  {
    ...
    detail:
      "工場のエア漏れ・過剰圧力設定の見直し＋高効率インバータコンプレッサー更新で電力▲15〜25%。中小工場ではエア漏れだけで全電力の10〜20%を浪費している事例も多く、投資効率の高い王道メニュー。SII補助1/2で回収可能（1.5〜2.5年）。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            大阪府、特に東大阪市・八尾市・大東市・門真市は中小製造業の集積地です。本ページでは「大阪府 × 中小製造業（町工場）」というクロス領域に絞り、関西電力エリア固有の単価事情と、金属プレス／切削／樹脂成形／電子部品の電力プロファイル、高圧契約の最適化、共同購入スキーム、補助金活用までを実務目線で整理します。
          </p>

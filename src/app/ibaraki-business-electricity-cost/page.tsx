...
const faqItems = [
  ...
  { question: "茨城県の電気代の平均・相場はいくらですか？", answer: "県単位の法人電気代の平均を示した公的統計はないため、契約区分ごとの全国確定単価を基準に読むのが実務的です。電力取引報の最新確定分である2026年4月分（全国計・検針期間ベース）は、特別高圧17.56円/kWh、高圧21.37円/kWh、低圧電灯25.94円/kWh、低圧電力32.12円/kWhでした（消費税・再エネ賦課金を含まない参考値）。茨城県は鹿島コンビナートの特別高圧から市内店舗の低圧まで幅が広く、区分をまたいだ平均には意味がありません。自社の契約区分に対応する全国値と、請求書から消費税と再エネ賦課金を差し引いた額（基本料金・電力量料金・燃料費調整額の合計）を使用量で割って求めた実質単価を比べてください。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計・検針期間ベースであり、茨城県または東京電力エリアの平均値ではありません。消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年4月分・確定）。この単価に含む費目・含まない費目の定義は{" "}

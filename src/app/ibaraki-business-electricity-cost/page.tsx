...
const pageDescription =
  "茨城県の法人電気代の相場・平均を、全国の確定単価（特別高圧17.45円/kWh等）を基準に契約区分別で整理。東京電力エリアの燃料費調整の効き方、電力会社を比較する5観点、鹿島臨海工業地帯・つくば研究機関・日立電機の負荷特性と契約見直しを実務目線で解説します。";
...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "市場動向",
    detail:
      "2022〜2023年の市場高騰で県内でも新電力の新規受付停止・撤退が複数発生したが、2024年以降は15社以上が法人向け高圧で新規受付中。東京電力エリアは新電力競争が活発。",
  },
];
...
const industryProfile = [
  ...
  },
  {
    label: "農業・食品加工（県全域）",
    detail:
      "茨城県は農業が盛んな県。メロン・水戸納豆・常陸牛・梨等の食品加工。冷蔵・冷凍・乾燥設備が中心。",
  },
];
...
const faqItems = [
  ...
  { question: "茨城県で固定プランと市場連動プランのどちらが向きますか？", answer: "24時間稼働の鹿島コンビナート・物流冷凍倉庫・大型研究所は固定プランが向きます。中小オフィス・店舗は使用量が小さいため市場連動でも影響限定的ですが、2022〜2023年の市場高騰経験から固定プランが主流です。" },
  ...
  { question: "茨城県の電気代の平均・相場はいくらですか？", answer: "県単位の法人電気代の平均を示した公的統計はないため、契約区分ごとの全国確定単価を基準に読むのが実務的です。電力取引報の最新確定分である2026年5月分（全国計・販売額÷販売電力量）は、特別高圧17.45円/kWh、高圧22.78円/kWh、低圧電灯27.85円/kWh、低圧電力34.42円/kWhでした（消費税・再エネ賦課金を含まない参考値）。茨城県は鹿島コンビナートの特別高圧から市内店舗の低圧まで幅が広く、区分をまたいだ平均には意味がありません。自社の契約区分に対応する全国値と、請求書から消費税と再エネ賦課金を差し引いた額（基本料金・電力量料金・燃料費調整額の合計）を使用量で割って求めた実質単価を比べてください。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              茨城県では2024年時点で約15社の新電力が法人向け高圧で新規受付中。東京電力エリアは新電力競争が活発です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
              下記は電力取引報の最新確定分である2026年5月分の実績単価です。自社の請求書に記載された契約種別を確認し、対応する区分の数値を基準値として使ってください。
            </p>
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計（多くの事業者が検針期間ベースで報告・暦月ベースも可）であり、茨城県または東京電力エリアの平均値ではありません。消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年5月分・確定）。この単価に含む費目・含まない費目の定義は{" "}
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/chemical-electricity-cost-review", title: "化学工業の電気料金見直し", description: "鹿島コンビナート向け。" },
              { href: "/data-center-electricity-cost-review", title: "データセンターの電気料金見直し", description: "つくば・水戸の研究所サーバ向け。" },

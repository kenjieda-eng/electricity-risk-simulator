...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・日本食肉加工協会の統計によれば、精肉加工業の電気料金は売上高の5〜10%（ハム・ソーセージ大手で高水準）。製造原価に占める比率は7〜15%。冷蔵冷凍と加熱の二極で電力依存度が高い。",
  },
  {
...
const faqItems = [
  { question: "精肉加工業の電気代水準はどれくらいですか？", answer: "売上高比5〜10%（ハム・ソーセージ大手で高水準）、製造原価比7〜15%が業界平均。中規模ハム・ソーセージ工場（年商200億円級）で年3〜7.5億円、大規模食肉メーカー（年商500億円超）で年7.5〜45億円規模の電気代になります。" },
  ...
  { question: "精肉加工業の固定プランと市場連動プランどちらが向きますか？", answer: "原料肉冷蔵・製品冷凍庫の24h連続稼働でベースロードが大きく、停止が即座に品質劣化につながるため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続企業で月数千万円の追加負担が発生しました。" },

...
const pageTitle =
  "宮崎県の法人電気料金ガイド｜九州電力エリア単価分析・ブロイラー肉用牛畜産・太陽光発電適地・フェニックス日南観光業の契約最適化";
const pageDescription =
  "宮崎県の法人電気料金を地域特化で解説。九州電力エリアの単価水準を業種別に再加工して提示し、ブロイラー・肉用牛の畜産業、太陽光発電適地としての自家消費活用、フェニックス・日南海岸の観光業、宮崎市の都市圏オフィス・水産業の電力負荷プロファイル、契約見直し・補助金活用まで実務的に整理します。";
...
const electricSituation = [
  {
    ...
    detail:
      "宮崎県は九州電力エリアに属し、太陽光発電適地（年間日照2,100時間超）として知られる。県内総電力需要は約60億kWhで、畜産（ブロイラー、肉用牛、豚）が約20%、農業（マンゴー・きゅうり・ピーマン施設園芸）が約15%、フェニックス・日南海岸の観光業が約10%、宮崎市・延岡市の都市圏オフィス・商業が約25%、化学（旭化成延岡）が約15%、住宅・小規模事業者が約15%の構成。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "県内は温暖湿潤気候で夏季は高温多湿、冬季も穏やか。年間冷房度日（CDD24）1,700〜1,900（高い水準）、暖房度日300〜500（全国下位）。年中冷房需要が経営課題で、特に畜舎の温度管理・施設園芸の温湿度制御で電力需要が高水準。台風常襲地域でもあり、BCP対応が経営課題。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "ブロイラー、肉用牛（宮崎牛ブランド）、豚等の畜産集積（県内ほぼ全域）。マンゴー、きゅうり・ピーマンの施設園芸農業（西都市・宮崎市・都城市）。フェニックス・青島・日南海岸・高千穂峡の観光業。宮崎市は都市圏オフィス・商業。延岡市は旭化成延岡工場（化学・繊維・電池素材）。日向港・細島港の物流。",
  },
];
...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "市場動向",
    detail:
      "宮崎県の新電力シェアは2024年時点で約15〜20%。延岡旭化成・宮崎市内オフィス・観光業大手で新電力切替が活発。畜産・農業の中小事業者は九州電力継続が多数派。",
  },
];
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金14〜17円/kWh+調整項目。宮崎県内では旭化成延岡工場、大型畜産・農業法人、フェニックス・日南海岸の大型観光リゾートが対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。競争入札による削減余地は個別条件により異なります。",
  },
  {
  ...
  },
  {
    ...
    detail:
      "宮崎県は年間日照時間2,100時間超の太陽光発電適地。屋根置き太陽光の自家消費とは相性がよい条件ですが、発電量や投資回収年数は屋根面積・設備構成・使用パターンにより変わります。畜産・施設園芸・観光業の電気代削減と太陽光自家消費の相性が極めて良い。",
  },
];
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、九州電力エリアの特別高圧電力単価は2024年度実績で約14〜17円/kWh（電力量料金ベース）。九州エリアは玄海・川内の原子力4基の稼働と大規模な太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。宮崎県内の旭化成延岡・大型畜産農業法人・フェニックス級観光リゾートにとっては、競争入札による更なる1〜3円/kWh削減で年間1,000万〜5億円規模のコスト削減余地。",
  },
  {
    label: "九州電力エリアの高圧単価水準",
    detail:
      "高圧電力（500〜2,000kW級）の単価は16〜20円/kWh。県内中規模事業者（宮崎市内オフィス、都城畜産中堅、観光業中堅、施設園芸大手）にとっての標準帯域。pps-net.org のエリア別データを再加工して試算すると、宮崎県内の典型的な高圧契約（200〜500kW、年間使用量100〜400万kWh）では、新電力切替で年間100〜300万円規模のコスト削減が見込める。",
  },
  {
    label: "九州電力エリアの低圧単価水準",
    detail:
      "低圧電力9〜12円/kWh、低圧電灯17〜21円/kWhの水準。県内中小事業者（中小畜産・農業法人・観光業中堅）は新電力切替で年間5〜30万円規模の削減余地が中心。太陽光自家消費・蓄電池併設で更なる効果。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "宮崎県は年間日照時間2,100時間超の太陽光発電適地。屋根置き太陽光の自家消費とは相性がよい条件ですが、発電量や投資回収年数は屋根面積・設備構成・使用パターンにより変わります。畜産・施設園芸・観光業の電気代削減と太陽光自家消費の相性が極めて良い県固有の競争優位。",
  },
  {
...
const industryProfile = [
  {
    ...
    detail:
      "ブロイラー、肉用牛（宮崎牛ブランド）、豚。畜舎温度管理・換気・冷蔵保管。年間使用量100万〜2,000万kWh規模。",
  },
  {
    label: "施設園芸農業（西都市・宮崎市・都城市）",
    detail:
      "マンゴー、きゅうり・ピーマンの施設園芸。ハウス空調・LED栽培照明・冷蔵倉庫。年間使用量50万〜1,000万kWh規模。",
  },
  {
    label: "化学・繊維工業（延岡市）",
    detail:
...
const switchingReality = [
  {
    label: "新電力切替の県内浸透度",
    detail:
      "2024年時点で県内法人の新電力シェアは約15〜20%。延岡旭化成・宮崎市内オフィス・観光業大手で新電力切替が活発。畜産・農業の中小事業者は九州電力継続が多数派。",
  },
  {
    label: "市場連動プランの選択肢",
    detail:
  ...
  },
  {
    ...
    detail:
      "宮崎県は太陽光発電適地（年間日照2,100時間超）として、太陽光自家消費＋蓄電池の組合せが電気代削減と台風BCP対応の両立に効果的。畜産・施設園芸・観光業の全業種で投資効果が極めて高い県固有の特異的競争優位。",
  },
];
...
const faqItems = [
  { question: "宮崎県の法人電気代水準は全国比どれくらいですか？", answer: "九州エリアは玄海・川内の原子力4基の稼働と大規模な太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。宮崎県内法人の実質単価は22〜27円/kWh（高圧）が標準帯域で、新電力切替により1〜2円/kWh改善余地があります。一方、日照条件から太陽光自家消費との相性がよく、自家消費＋蓄電池による削減余地を検討できます。削減率は屋根面積・設備構成・使用パターンにより変わります。" },
  { question: "宮崎県の太陽光発電適地メリットはどう活用できますか？", answer: "宮崎県は年間日照時間2,100時間超の太陽光発電適地。屋根置き太陽光の自家消費とは相性がよい条件ですが、発電量や投資回収年数は屋根面積・設備構成・使用パターンにより変わります。畜産・施設園芸・観光業の電気代削減と太陽光自家消費の相性が極めて良く、自家消費比率35%以上を実現できます。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            宮崎県は九州電力エリアに属し、年間日照時間2,100時間超の太陽光発電適地として知られます。ブロイラー・肉用牛（宮崎牛）・豚の畜産集積、マンゴー・きゅうり・ピーマンの施設園芸農業、旭化成延岡（化学・繊維・電池素材）、フェニックス・日南海岸の観光業、宮崎市・都城市の都市圏オフィス・商業と多様な産業構造を持ちます。日照条件から太陽光自家消費＋蓄電池との相性がよく、年中冷房需要＋畜舎温度管理＋観光業の電気代を太陽光自家消費で大幅削減する戦略が主流です。本ページでは新電力ネット（pps-net.org/unit）のエリア別単価データを県の産業構造に紐づけて再加工し、業種別の契約見直し・補助金活用を実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              宮崎県の新電力シェアは2024年時点で約15〜20%。延岡旭化成・宮崎市内オフィス・観光業大手で新電力切替が活発。畜産・農業の中小事業者は九州電力継続が多数派ですが、太陽光発電適地メリット活用が新電力選定の重要論点です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

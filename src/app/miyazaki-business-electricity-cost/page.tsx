...
const priceBenchmark = [
  ...
  },
  {
    ...
    detail:
      "宮崎県は年間日照時間2,100時間超（全国上位）の太陽光発電適地。屋根置き太陽光の自家消費とは相性がよい条件ですが、発電量や投資回収年数は屋根面積・設備構成・使用パターンにより変わります。畜産・施設園芸・観光業の電気代削減と太陽光自家消費の相性が極めて良い。",
  },
];
...
const ppsNetUnitData = [
  {
    ...
    detail:
      "新電力ネット（pps-net.org/unit）のエリア別単価データによれば、九州電力エリアの特別高圧電力単価は2024年度実績で約14〜17円/kWh（電力量料金ベース）。九州エリアは玄海・川内の原子力4基の稼働と全国最大級の太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。宮崎県内の旭化成延岡・大型畜産農業法人・フェニックス級観光リゾートにとっては、競争入札による更なる1〜3円/kWh削減で年間1,000万〜5億円規模のコスト削減余地。",
  },
  {
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "宮崎県は年間日照時間2,100時間超（全国上位）の太陽光発電適地。屋根置き太陽光の自家消費とは相性がよい条件ですが、発電量や投資回収年数は屋根面積・設備構成・使用パターンにより変わります。畜産・施設園芸・観光業の電気代削減と太陽光自家消費の相性が極めて良い県固有の競争優位。",
  },
  {
...
const faqItems = [
  { question: "宮崎県の法人電気代水準は全国比どれくらいですか？", answer: "九州エリアは玄海・川内の原子力4基の稼働と全国最大級の太陽光導入という電源構成により、燃料費調整額の変動幅が相対的に小さいとされます。宮崎県内法人の実質単価は22〜27円/kWh（高圧）が標準帯域で、新電力切替により1〜2円/kWh改善余地があります。一方、日照条件から太陽光自家消費との相性がよく、自家消費＋蓄電池による削減余地を検討できます。削減率は屋根面積・設備構成・使用パターンにより変わります。" },
  { question: "宮崎県の太陽光発電適地メリットはどう活用できますか？", answer: "宮崎県は年間日照時間2,100時間超（全国上位）の太陽光発電適地。屋根置き太陽光の自家消費とは相性がよい条件ですが、発電量や投資回収年数は屋根面積・設備構成・使用パターンにより変わります。畜産・施設園芸・観光業の電気代削減と太陽光自家消費の相性が極めて良く、自家消費比率35%以上を実現できます。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            宮崎県は九州電力エリアに属し、年間日照時間2,100時間超（全国上位）の太陽光発電適地として知られます。ブロイラー全国2位・肉用牛全国3位（宮崎牛）・豚全国2位の畜産集積、マンゴー全国1位・きゅうり・ピーマンの施設園芸農業、旭化成延岡（化学・繊維・電池素材）、フェニックス・日南海岸の観光業、宮崎市・都城市の都市圏オフィス・商業と多様な産業構造を持ちます。日照条件から太陽光自家消費＋蓄電池との相性がよく、年中冷房需要＋畜舎温度管理＋観光業の電気代を太陽光自家消費で大幅削減する戦略が主流です。本ページでは新電力ネット（pps-net.org/unit）のエリア別単価データを県の産業構造に紐づけて再加工し、業種別の契約見直し・補助金活用を実務的に整理します。
          </p>

...
const faqItems = [
  ...
  { question: "自家消費型太陽光は化学工場で投資回収できますか？", answer: "工場敷地が広大、24h連続稼働の化学工場は自家消費型太陽光との相性が良好です。10MWで年1,100〜1,300万kWh発電、年1.1〜1.3億円削減、投資回収6〜8年（補助金後4〜6年）。コンビナート遊休地で30〜100MW級も検討余地。" },

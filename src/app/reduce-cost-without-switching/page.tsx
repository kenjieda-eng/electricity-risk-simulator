...
// --- 定数 ---
const pageTitle =
  "電力会社を変えずに電気代を下げる5つの方法｜切替との比較で選ぶ見直し戦略";
const pageDescription =
  "電力会社の切替リスクを取りたくない法人向けに、同じ会社のまま電気代を3-15%下げる5つの実践手段を解説。①契約電力の最適化②プラン変更③時間帯別プラン④付帯サービス活用⑤値引き交渉。各手段の効果・難易度・対象法人を比較表で整理し、電力会社の切替と比べてどちらが自社に向くかを判断できるようにします。中立社団の解説です。";
const pageUrl =
          ...
          <RelatedLinks
            ...
            links={[
              ...
              },
              {
                ...
                description:
                  "契約電力・燃調・容量拠出金・市場連動・PPA 等 7 軸の削減ポイントを業種別・契約区分別に解説。",
              },

...
// --- 定数 ---
const pageTitle =
  "電力会社を変えずに電気代を下げる5つの方法｜切替に消極的な総務担当者向け実践ガイド";
const pageDescription =
  "電力会社の切替リスクを取りたくない法人向けに、同じ会社のまま電気代を3-15%下げる5つの実践手段を解説。①契約電力の最適化②プラン変更③時間帯別プラン④付帯サービス活用⑤値引き交渉。各手段の効果・難易度・対象法人を比較表で整理し、切替との総合比較も掲載します。中立社団の解説です。";
const pageUrl =

...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "関西電力管内は原発依存度が高い（高浜・大飯・美浜の再稼働で約30%）。LNG火力約30%、石炭火力約20%、再エネ・水力約20%。県内には関電の相生火力（重油）・姫路第一第二火力（LNG）等の主力電源が立地。原発再稼働により燃料費調整額は相対的に低めで推移しているとされます。",
  },
  {
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金16〜19円/kWh+調整項目。姫路製鉄化学コンビナート、神戸製鋼、川崎重工・三菱重工神戸などが対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。新電力の競争入札による価格圧力が働く市場です。",
  },
  {
...
const costFactors = [
  {
    ...
    detail:
      "姫路・加古川の製鉄化学コンビナートは大規模な集積。新日鉄住金姫路、日本触媒、神戸製鋼姫路、関西熱化学等は年間使用量1〜30億kWh級。電気代の絶対額が巨額なため、単価1円/kWh変動でも年間1〜30億円規模のコスト変動。",
  },
  {
    label: "神戸港国際物流ハブの冷凍倉庫集積",
    detail:
      "神戸港は大規模な貿易港。冷凍倉庫・荷役機械・港湾施設の電力消費が中心。冷凍倉庫は24時間稼働で電力負荷高い。輸出入対応で深夜時間帯の需要も発生。",
  },
  {
    label: "関電原発再稼働メリット",
    detail:
...
const faqItems = [
  { question: "兵庫県の法人電気代水準は全国比どれくらいですか？", answer: "関西エリアは原子力のベースロードが厚く、国際燃料価格の変動が燃料費調整額に反映される度合いが相対的に小さい局面があるとされます。全国的な水準との差は契約区分・使用量・負荷率により変わります。姫路コンビナート・神戸製鋼等の大規模事業者は新電力切替で年間2〜8億円規模のコスト削減事例も。" },

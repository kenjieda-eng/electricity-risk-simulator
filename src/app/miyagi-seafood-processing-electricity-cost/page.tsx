...
const electricSituation = [
  {
    ...
    detail:
      "宮城県は三陸沖の好漁場を背後に持ち、石巻・気仙沼・塩釜・女川を中心とする大規模な水産加工集積地です。石巻は水産加工・冷凍冷蔵の集積地で、東日本大震災後の復興過程で冷凍冷蔵設備の更新が進みました。気仙沼はカツオ・サンマ・サメ（フカヒレ）等の水揚げと冷凍・加工、塩釜はマグロ等の水揚げ・水産卸・冷蔵倉庫が集まります。練り製品・冷凍食品・素干し・節類・缶詰・燻製まで多様な業態が混在し、急速凍結・冷凍冷蔵倉庫・製氷の電力負荷が産地全体に分散している点が特徴です（出典: 水産庁 水産加工業統計・宮城県統計から整理／いずれも目安）。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            宮城県は三陸沖の好漁場を背後に、石巻・気仙沼・塩釜・女川を核とする大規模な水産加工集積地です。本ページでは「宮城県 × 水産加工業」というクロス領域に絞り、東北電力エリア固有の単価事情と燃調感応度、急速凍結・冷凍冷蔵倉庫・製氷の24時間稼働の電力プロファイル、震災後のBCP、特別高圧／高圧の契約最適化、補助金・PPA活用までを実務目線で整理します。なお本ページは特定の電力会社・契約形態を推奨するものではありません。
          </p>

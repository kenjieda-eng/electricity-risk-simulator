...
export default function MunicipalityFixedVsMarketLinkedPage() {
  return (
    <>
      <ArticleJsonLd
        headline="自治体施設は固定と市場連動のどちらが向くか｜年度予算制と説明責任から考える"
        description="自治体・公共施設が電力契約を検討する際の判断軸を整理します。年度予算制の制約、議会・住民への説明責任、入札・調達ルール、リスク説明の難しさなど、公共機関特有の観点から固定プランと市場連動プランを比較します。"
        url="https://simulator.eic-jp.org/municipality-fixed-vs-market-linked"
        datePublished="2026-04-17"
        breadcrumbItems={[
          { name: "ホーム", url: "https://simulator.eic-jp.org/" },
          { name: "自治体施設は固定と市場連動のどちらが向くか" },
        ]}

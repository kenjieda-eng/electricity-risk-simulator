...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・日本木材総合情報センターの統計によれば、木材加工・製材業の電気料金は売上高の4〜10%（乾燥工程多い工場は高水準）。製造原価に占める比率は6〜15%。乾燥機の24h稼働で電力依存度が高い業種。",
  },
  {
...
const faqItems = [
  { question: "木材加工・製材業の電気代水準はどれくらいですか？", answer: "売上高比4〜10%（乾燥工程多い工場は上限側）、製造原価比6〜15%が業界平均。中規模木材加工工場（年商50億円級）で年1.5〜7.5億円、大規模木材メーカー（年商200億円超）で年7.5〜30億円規模の電気代になります。" },
  ...
  { question: "木材加工・製材業の固定プランと市場連動プランどちらが向きますか？", answer: "乾燥機24h連続稼働、集塵機停止不可でベースロードが大きく、生産停止が困難なため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続企業で月数百万円〜千万円の追加負担が発生しました。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              再エネ賦課金は2024年度3.49円/kWh、2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇トレンド。木材加工業の中規模工場では負担額が請求総額の10〜15%に達します。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>

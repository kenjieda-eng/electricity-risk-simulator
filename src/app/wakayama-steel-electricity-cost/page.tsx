...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "熱間圧延・冷間圧延ラインは大型の駆動モータと補機（潤滑・冷却・油圧ポンプ）が連続稼働し、製鉄所内でも電力消費の大きい工程です。加えて環境設備である電気集塵機（EP）やバグフィルター送風機、転炉・焼結の排ガス処理、各種ポンプが常時運転するため、生産変動があってもベース電力が高止まりしやすい構造です。これら補機・環境設備の高効率化とインバータ化が買電単価最適化の主戦場となります。なお本記載は一般的な業態整理であり、特定の契約形態を勧めるものではない点に留意してください（出典: 業界団体・省エネ事例から整理）。",
  },
  {
...
const utilitiesList = [
  ...
  },
  {
    ...
    role: "全国展開新電力",
    detail:
      "和歌山県内の特別高圧・高圧の鉄鋼・化学需要家の競争入札における主要な対抗候補です。固定単価メニュー（2〜5年契約）が中心で、年間使用量の大きい大型案件で実績を積み上げています。ただし関西エリアは原子力寄与で燃調感応度が低めとされるため、大きな価格差が出にくい局面もあり、供給可能kWh枠と燃調条件を含めた総合比較が必要です。特に一貫製鉄所のような超大口は供給枠そのものの確保が論点になります。なお本記載は特定の電力会社・契約形態の優劣を述べるものではありません。",
  },
  {
...
const costFactors = [
  {
    ...
    detail:
      "熱間／冷間圧延の大型駆動モータと補機（潤滑・冷却・油圧ポンプ）、環境設備の電気集塵機（EP）・バグフィルター送風機、各種ポンプ・送風機が連続稼働し、製鉄所内でも大きな電力消費を構成します。生産変動があってもこれら補機・環境設備のベース電力は高止まりしやすく、工場全体の買電に占める比率が大きいのが特徴です。補機の高効率モータ化・インバータ化・運用最適化が買電単価最適化の主戦場です（出典: 業界団体・省エネ事例から整理）。",
  },
  {
...
const switchingReality = [
  ...
  },
  {
    ...
    detail:
      "メリット: 大口需要家向けエネルギーマネジメント支援・原子力中心の安定供給・災害時復旧体制。デメリット: 新電力との比較で単価がやや高めになる局面、燃料費調整額の条件差。関西は原子力寄与で燃調感応度が低めとされるため、新電力との価格差が出にくい局面もあり、継続か切替かは総合的な比較が必要です。いずれにせよ本記載は特定の電力会社を推奨するものではありません。",
  },
  {
...
const faqItems = [
  {
    ...
    answer:
      "関西電力エリアは美浜・高浜・大飯の原子力比率が全国的にも高く、電力単価が相対的に低位とされるのがエリア固有の特徴です。火力依存度が低いため燃料費調整額の感応度も相対的に低めで、燃料高騰局面で単価が急騰しにくいメリットがあります。ただし原子力の定期点検・長期停止時には火力比率が上がるため燃調がゼロになるわけではありません。水力比率の高さから燃調感応度が低めとされ、新電力切替による下げ幅が出にくい局面もある点に留意が必要です。なお本回答は特定の電力会社・契約形態を推奨するものではありません（出典: 関西電力 単価実績・エネ庁から整理）。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "全国系（ENEOSでんき・出光・サミットエナジー等）と地域系・ガス系新電力が主要なプレイヤーです。関西エリアは原子力寄与で燃調感応度が低めとされるため、大きな価格差が出にくい局面もあり、燃調条件・契約期間・非化石証書付の有無を含めた総合比較が重要になります。特に一貫製鉄所のような超大口は供給可能kWh枠の確保自体が論点で、対応できる事業者が限られます。特定企業の供給実績は入札情報公開やIR・業界紙の範囲で確認可能です。いずれにせよ本回答は実情の整理を目的としたものです。",
  },
  {

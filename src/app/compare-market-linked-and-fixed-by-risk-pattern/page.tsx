...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "ja_JP",
    type: "article",
    images: [{ url: "/api/og/plan-types", width: 1200, height: 630, alt: "市場連動と固定は安さではなく変動の受け方で比べる" }],
  },
  twitter: {
...
<div className="mt-6">
        ...
        <SourcesAndFaq
          ...
          sources={[
            ...
            { name: "電力・ガス取引監視等委員会", url: "https://www.egc.meti.go.jp", description: "電力取引監視に関する情報" },
          ]}

...
export default function AmusementFacilityElectricityCostReviewPage() {
  return (
    <>
      <ArticleJsonLd
        headline="アミューズメント施設の電気料金リスク｜照明・空調・設備の高負荷を踏まえた考え方"
        description="アミューズメント施設の電気料金が上がりやすい要因と、契約見直しの着眼点を解説。照明・空調・遊戯設備の大電力消費特性、固定プランと市場連動の向き不向き、設備対策との組み合わせ方まで整理します。"
        url="https://simulator.eic-jp.org/amusement-facility-electricity-cost-review"
    ...
    <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
      <nav aria-label="パンくず" className="text-sm text-slate-600">
        ...
        <span className="px-2">›</span>
        <span className="text-slate-800">アミューズメント施設</span>
      </nav>
        ...
        <RelatedLinks
          ...
          links={[
            ...
            },
            {
              ...
              description: "アミューズメント施設の電気料金水準を業界平均と比較し、コスト見直しの根拠を把握する。",
            },
          ]}
        />

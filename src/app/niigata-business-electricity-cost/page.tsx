...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "燕市・三条市の金属加工（洋食器・刃物・金属プレス・キッチン用品）は全国シェア9割超の特殊集積。中堅製造業が数百社、中小工場も加えると2,000社超。コシヒカリ米倉庫が集まり、農業協同組合所有の大規模倉庫が県内に多数。",
  },
];
...
const priceBenchmark = [
  {
    ...
    detail:
      "東北電力『業務用高圧電力』の電力量料金は18〜22円/kWh（夏季・その他季・時間帯により変動）。燃料費調整額（2024〜2025年は+3.0〜+4.5円/kWh）と再エネ賦課金（2025年度3.98円/kWh）を加味すると実質単価は25〜30円/kWhレンジ。雪国特有の冬季使用量増により、単価だけでなく年間電気代総額でも確認が必要。",
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
...
const costFactors = [
  ...
  },
  {
    ...
    detail:
      "新潟県の米生産量は年間60万トン超。低温米倉庫・玄米倉庫の年間連続冷蔵需要が県全体で年間2〜3億kWh規模の特殊需要。農協・農業生産法人が県内に大規模倉庫を多数所有。",
  },
  {
  ...
  },
  {
    label: "再エネ賦課金の負担増",
    detail:
      "2025年度3.98円/kWh、2026年度4.18円/kWh（確定）と上昇。年間500万kWh使用の中規模事業所で年2,000万円規模の負担。減免制度（年間1,000万kWh以上・電気使用密度要件）の対象になりやすい食品加工・米倉庫は申請を要検討。",
  },
];
...
const industryProfile = [
  ...
  },
  {
    ...
    detail:
      "米生産を支える低温米倉庫網。農協・農業法人所有で県内に100施設以上。CA冷蔵・15℃温度管理の年間連続稼働。",
  },
  {
...
const switchingReality = [
  {
    label: "新電力切替の県内浸透度",
    detail:
      "2024年時点で新潟県内法人の新電力シェアは15〜20%（経産省統計）。新潟市・長岡市の都市部では切替が進んだが、地方部では東北電力継続が多数。",
  },
  {
    label: "市場連動プランのリスク認識",
    detail:
...
const faqItems = [
  { question: "新潟県の法人電気代水準は全国比どれくらいですか？", answer: "高圧電力（業務用）の単価について、全国的な水準との差は契約区分・使用量・負荷率により変わります。冬季の暖房・融雪と夏季の冷房で年間使用量が伸びやすいため、単価だけでなく年間総額でも確認してください。請求書から消費税と再エネ賦課金を除いた金額を使用量で割った実質単価で確認してください。" },
  { question: "新潟県で固定プランと市場連動プランのどちらが向きますか？", answer: "冬季ピーク時のスポット価格高騰リスクを考えると、24時間稼働の工場・米倉庫・温泉スキーリゾートは固定プランが向きます。市場連動プランは、夏季のみ稼働・週末停止可能な事業所など限定的なケースのみ検討対象です。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              新潟県は冬季暖房・融雪・夏季冷房の三重ピークで使用量が多くなるため、年間総額では全国平均並み〜やや高めになります。実質単価（電力量料金+燃料費調整額+再エネ賦課金）ベースで比較することが重要です。
            </p>
            <p className="mt-2 text-xs text-slate-500">
              ※ 本記事は中立的な情報整理を目的としており、特定の電力会社・契約形態を推奨するものではありません。
            </p>
          ...
          <RelatedLinks
            ...
            links={[
              ...
              { href: "/food-processing-electricity-cost-review", title: "食品加工業の電気料金見直し", description: "新潟食品・酒造業の見直し論点。" },

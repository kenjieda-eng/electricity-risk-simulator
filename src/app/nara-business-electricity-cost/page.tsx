...
const pageDescription =
  "奈良県の法人電気代の平均・相場を、全国の確定単価（低圧電力34.42円/kWh・高圧22.78円/kWh等）を基準に整理。関西電力エリアの電源構成を踏まえた読み方、電力会社を比較する5観点、観光業・電機繊維製造業・大阪通勤圏商業の負荷特性と契約見直しを解説します。";
...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "関西電力管内は原発依存度が高い（高浜・大飯・美浜の再稼働で約30%）。LNG火力約30%、石炭火力約20%、再エネ・水力約20%。県内には関電・電源開発の吉野水系水力発電所が立地。原発再稼働により燃料費調整額は相対的に低めで推移しているとされます。",
  },
  {
...
const priceBenchmark = [
  ...
  },
  {
    label: "特別高圧電力の単価水準",
    detail:
      "特別高圧（2,000kW超）の標準メニューは電力量料金16〜19円/kWh+調整項目。生駒・大和郡山の中規模製造業、奈良市内の大型観光ホテル・複合商業施設などが対象。全国的な水準との差は契約区分・使用量・負荷率により変わります。新電力の競争入札による価格圧力が働く市場です。",
  },
  {
  ...
  },
  {
    label: "関電原発再稼働メリット",
    detail:
      "関西エリアは原子力のベースロードが厚く、国際燃料価格の変動が燃料費調整額に反映される度合いが相対的に小さい局面があるとされます。法人需要では年間500万〜2,000万円規模の差が出ることもあり、関電エリア事業者は相対的に有利。新電力経由でさらに優遇可能性がある。",
  },
];
...
const costFactors = [
  ...
  },
  {
    label: "関電原発再稼働メリット",
    detail:
      "関西エリアは原子力のベースロードが厚く、国際燃料価格の変動が燃料費調整額に反映される度合いが相対的に小さい局面があるとされます。中規模事業者でも年間500万〜2,000万円規模のメリットあり。",
  },
  {
...
const faqItems = [
  { question: "奈良県の法人電気代水準は全国比どれくらいですか？", answer: "関西エリアは原子力のベースロードが厚く、国際燃料価格の変動が燃料費調整額に反映される度合いが相対的に小さい局面があるとされます。全国的な水準との差は契約区分・使用量・負荷率により変わります。中規模事業者でも年間500万〜2,000万円規模のコスト削減事例があります。" },
  ...
  { question: "奈良県の電気代の平均・相場はいくらですか？", answer: "県単位で法人の電気代平均を示した公的統計はないため、契約区分別の全国確定単価を基準に読みます。電力取引報の最新確定分である2026年5月分（全国計・販売額÷販売電力量）は、特別高圧17.45円/kWh、高圧22.78円/kWh、低圧電灯27.85円/kWh、低圧電力34.42円/kWhでした（消費税・再エネ賦課金を含まない参考値）。奈良県は中小規模の事業所が中心で低圧の該当が多く、まず低圧電灯・低圧電力の水準を押さえると判断しやすくなります。自社の実質単価は、請求書から消費税と再エネ賦課金を差し引いた額（基本料金・電力量料金・燃料費調整額の合計）を使用量で割って算出し、同じ区分の全国値と比べてください。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            奈良県は関西電力エリアで、奈良市内の世界遺産観光業（東大寺・春日大社・興福寺等）、大和郡山・生駒の電機・電子部品工場、中和・南和の繊維・プラスチック・食品加工、大阪通勤圏（生駒・大和郡山）の住宅商業地、吉野林業と多様な産業構造を持ちます。関電の原発再稼働により燃料費調整額の変動が相対的に小さい局面があるとされる点が特徴。本ページでは県内法人の電気代水準、業種別影響度、観光業・文化財景観条例特有の論点、契約見直しの具体策、補助金活用までを実務的に整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-700 sm:text-base">
              下記は電力取引報の最新確定分である2026年5月分の実績単価です。奈良県内の中小事業所では低圧電灯・低圧電力の該当が多く、この2区分の水準を知っておくだけでも判断の精度が上がります。
            </p>
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計（多くの事業者が検針期間ベースで報告・暦月ベースも可）であり、奈良県または関西電力エリアの平均値ではありません。消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年5月分・確定）。この単価に含む費目・含まない費目の定義は{" "}

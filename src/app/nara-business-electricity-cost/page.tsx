...
const electricSituation = [
  ...
  },
  {
    ...
    detail:
      "関西電力管内は原発依存度が国内最高（高浜・大飯・美浜の再稼働で約30%）。LNG火力約30%、石炭火力約20%、再エネ・水力約20%。県内には関電・電源開発の吉野水系水力発電所が立地。原発再稼働により燃料費調整額は相対的に低めで推移しているとされます。",
  },
  {
...
const faqItems = [
  ...
  { question: "奈良県の電気代の平均・相場はいくらですか？", answer: "県単位で法人の電気代平均を示した公的統計はないため、契約区分別の全国確定単価を基準に読みます。電力取引報の最新確定分である2026年4月分（全国計・検針期間ベース）は、特別高圧17.56円/kWh、高圧21.37円/kWh、低圧電灯25.94円/kWh、低圧電力32.12円/kWhでした（消費税・再エネ賦課金を含まない参考値）。奈良県は中小規模の事業所が中心で低圧の該当が多く、まず低圧電灯・低圧電力の水準を押さえると判断しやすくなります。自社の実質単価は、請求書から消費税と再エネ賦課金を差し引いた額（基本料金・電力量料金・燃料費調整額の合計）を使用量で割って算出し、同じ区分の全国値と比べてください。" },
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-2 text-xs text-slate-500">
              ※ 上記4区分の数値は全国計・検針期間ベースであり、奈良県または関西電力エリアの平均値ではありません。消費税・再エネ賦課金は含みません。出典: 電力・ガス取引監視等委員会「電力取引報」から算出（2026年4月分・確定）。この単価に含む費目・含まない費目の定義は{" "}

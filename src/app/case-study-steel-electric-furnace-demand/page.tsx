...
const leadText = "本記事は実在企業ではなく業界統計・公開事例から再構成した代表シナリオであり、特定の電力会社・契約形態・設備ベンダーを推奨するものではありません。電炉でスクラップを溶解し、電力がコストの中心を占める鉄鋼工場が、デマンド制御・力率改善・操業時間帯の最適化・契約見直しによって、契約電力(基本料金)と電力量料金の構造をどう改善できるかを、中立な社団法人の視点で整理します。実数値は契約条件・操業実態・市況により異なるため、本記事の削減幅はあくまで目安(代表値)としてご覧ください。";

...
export default function PublicGymElectricityCostReviewPage() {
  return (
    <>
      <ArticleJsonLd
        headline="公共体育館の電気料金見直しポイント｜空調・照明と稼働パターンを踏まえた考え方"
        description="公共体育館の電気料金が上がりやすい要因と、契約見直しの着眼点を解説。空調・照明の大電力消費・稼働パターン、固定プランと市場連動の向き不向き、設備対策との組み合わせ方まで整理します。"
        url="https://simulator.eic-jp.org/public-gym-electricity-cost-review"
...
<div className="mt-6">
        ...
        />
          ...
          <GlossaryLinks currentSlug="public-gym-electricity-cost-review" terms={["燃料費調整額", "市場価格調整額", "再エネ賦課金", "市場連動プラン", "固定プラン", "デマンド値"]} />
        </div>

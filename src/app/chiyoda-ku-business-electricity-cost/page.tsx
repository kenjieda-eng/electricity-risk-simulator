...
const electricSituation = [
  {
    ...
    detail:
      "千代田区は約1平方キロの範囲に大企業本社が密集するエリア。大手町・丸の内・有楽町の特別高圧オフィスビルが多数立地し、霞が関・永田町には中央官庁・国会・最高裁が集中。区内日中人口は夜間人口の約20倍に達し、平日昼間の電力負荷が極端に高い構造です（出典: 千代田区統計）。",
  },
  {
...
const costFactors = [
  {
    ...
    detail:
      "1棟当たり延床5万〜15万m²級のオフィスが連続立地し、平日昼間の電力需要密度が高水準。空調・照明・OA機器・エレベーターの負荷が同時集中し、夏季・冬季のピーク料金（基本料金）が経営費に与える影響が大きい構造です。",
  },
  {
    label: "ヒートアイランドと冷房需要",
    detail:
...
const switchingReality = [
  {
    label: "千代田区の新電力浸透度",
    detail:
      "丸の内・大手町クラスの特別高圧では競争入札が標準化しており、新電力の落札比率は高水準。神田・秋葉原・麹町の中小ビルでも新電力切替が進み、区全体での新電力比率は東京都平均（30〜35%）を上回ると見られます。",
  },
  {
    label: "市場連動プランのリスク認識",
    detail:
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              千代田区は大企業本社・官公庁・大学・IT商業が極めて高密度に集積する特殊なエリアです。1平方キロ当たりの特別高圧需要家数は多く、平日昼間の電力負荷が極端に高い「業務都心型」プロファイルを示します。
            </p>

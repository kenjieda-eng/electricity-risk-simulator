...
const faqItems = [
  ...
  { question: "給食業の固定プランと市場連動プランどちらが向きますか？", answer: "大量調理ピーク（朝〜昼）・コールドチェーン24h維持・HACCP対応で連続稼働必須のため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続施設で月数千万円の追加負担が発生しました。給食委託費への即時転嫁が困難で固定優位性が極めて高い業種です。" },

...
const pageTitle = "サプライチェーンCN戦略のガイド｜Scope3対応・Tier1/Tier2への要請（CFO向け・代表シナリオ）";
...
const h1Text = "サプライチェーンCN戦略のガイド｜Scope3対応・Tier1/Tier2への要請";

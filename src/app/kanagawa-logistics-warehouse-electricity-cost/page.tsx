...
const electricSituation = [
  {
    ...
    detail:
      "神奈川県は横浜港・川崎港の京浜港湾を中心とする大規模な物流ハブ。輸出入コンテナ取扱量・冷凍冷蔵倉庫保管量・自動倉庫設置数のいずれでも全国上位の集積を誇り、横浜市本牧・南本牧・大黒・大井（東京港）、川崎市東扇島・浮島の各埠頭・物流団地に大型倉庫が連続立地しています（出典: 神奈川県港湾統計・国土交通省港湾統計）。3PL大手（日通NXグループ・センコー・センコーグループHD・ヤマトHD・佐川HD・SBSHD・SGHD・SRSHD等）の関東基幹拠点も多数所在し、24時間オペレーションの物流倉庫が県内総需要の主要構成要素です。",
  },
  {
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        ...
        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">
            神奈川県は横浜港・川崎港の京浜港湾を核とする大規模な物流ハブで、冷凍冷蔵倉庫・自動倉庫・3PL大手の関東基幹拠点が集積しています。本ページでは「神奈川県 × 物流倉庫」というクロス領域に絞り、東京電力エリア固有の単価事情と、24時間冷却・自動倉庫・EC拡大・PPA調達までを実務目線で整理します。
          </p>
        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-sky-200 bg-sky-50 p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              神奈川県、特に京浜港湾は大規模な物流ハブとして、冷凍冷蔵倉庫・自動倉庫・3PL大手の関東基幹拠点が連続立地しています。24時間冷却・自動仕分け・EC連携など特殊な電力プロファイルと、AI需要急増による系統容量逼迫が現在の最大論点です。
            </p>

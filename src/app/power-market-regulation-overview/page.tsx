...
const pageTitle = "電力制度改正の全体像｜2000年代から現在までのタイムライン";
const pageDescription =
  "電力自由化から容量市場まで、電力制度改正の主要イベントを時系列で整理し、法人電気料金への影響を振り返ります。";
const pageUrl = "https://simulator.eic-jp.org/power-market-regulation-overview";
    ...
    <>
      ...
      <main className="mx-auto min-h-screen w-full max-w-[1600px] bg-white px-4 py-8 text-slate-800 sm:px-6 lg:px-8">
        <nav aria-label="パンくず" className="text-sm text-slate-600">
          ...
          <span className="px-2">›</span>
          <span className="text-slate-800">電力制度改正の全体像</span>
        </nav>
        <div className="mt-2 flex justify-end" data-print="hide"><PrintButton /></div>

        <header className="mt-4 rounded-xl border border-sky-200 bg-sky-50 p-6">
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">電力制度改正の全体像｜2000年代から現在までのタイムライン</h1>
          <p className="mt-4 text-sm leading-7 text-slate-700 sm:text-base">電力自由化から容量市場まで、電力制度改正の主要イベントを時系列で整理し、法人電気料金への影響を振り返ります。</p>
        </header>
        ...
        <section className="mt-6 space-y-6">
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">FIT（固定価格買取制度）開始（2012年）、発送電分離（2020年）、送配電の中立化（2020年）、非化石証書制度導入（2017年）が主要イベントです。特にFITは再エネ賦課金を通じて現在も全法人の電気料金に影響しています。</p>
          </section>
          <section className="rounded-xl border border-slate-200 bg-white p-5">

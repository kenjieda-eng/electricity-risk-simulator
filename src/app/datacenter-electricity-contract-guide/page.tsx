        ...
        <section className="mt-6 space-y-6">
          <section className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">
              データセンターは一般的なオフィスビルや工場と異なり、<strong>24時間365日の定常負荷</strong>が続きます。負荷率（平均需要／契約電力）は一般オフィスの15〜25%に対し、DCは80〜95%に達することが珍しくありません。kWあたりの基本料金を稼働時間で割り戻すと、契約電力の安い単価が効いてくるため、2,000kW以上での特別高圧契約が有利になります。
            </p>
            <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">

...
const industryBenchmark = [
  {
    label: "業界全体の電気代水準",
    detail:
      "経産省工業統計・電子情報技術産業協会（JEITA）の統計によれば、電子部品業の電気料金は売上高の5〜12%（半導体系は高水準）。製造原価に占める比率は8〜18%。クリーンルーム空調と24h検査稼働で電力依存度が高い業種。",
  },
  {
...
const faqItems = [
  { question: "電子部品業の電気代水準はどれくらいですか？", answer: "売上高比5〜12%（半導体系は高水準）、製造原価比8〜18%が業界平均。中規模電子部品工場（年商200億円級）で年4.5〜18億円、大規模電子部品メーカー（年商500億円超）で年18〜90億円規模の電気代になります。" },
  ...
  { question: "電子部品業の固定プランと市場連動プランどちらが向きますか？", answer: "クリーンルーム空調・24h検査ラインの連続稼働でベースロードが大きく、品質保証のため停止できないため、固定プランが向きます。2022〜2023年の市場高騰局面では市場連動継続企業で月数千万円の追加負担が発生しました。" },
  ...
  { question: "自家消費型太陽光は電子部品工場で投資回収できますか？", answer: "屋根面積3,000m²以上、24hクリーンルーム稼働の工場は相性が良好です。1MWで年100〜130万kWh発電、年1,000〜1,500万円の削減、投資回収7〜10年（補助金後5〜7年）が目安です。自家消費率80%超になりやすく投資効率が高いです。" },
];
